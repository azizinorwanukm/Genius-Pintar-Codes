...
Partial Public Class jpn_pusatujian_view
    ...
    Private Sub Execute_02()
        Select Case getUserProfile_UserType()
            ...
            Case "KPM"
                Response.Redirect("kpm.pusatujian.student.select.aspx?pusatcode=" & Request.QueryString("pusatcode") & "&examyear=" & Request.QueryString("examyear"))
    ...
    Private Sub Execute_03()
        Select Case getUserProfile_UserType()
            ...
            Case "KPM"
                Response.Redirect("kpm.pusatujian.student.list.aspx?pusatcode=" & Request.QueryString("pusatcode") & "&examyear=" & Request.QueryString("examyear"))
            Case "JPN"
                Response.Redirect("jpn.pusatujian.student.list.aspx?pusatcode=" & Request.QueryString("pusatcode") & "&examyear=" & Request.QueryString("examyear"))
            Case Else
                lblMsg.Text = "Invalid user type:" & getUserProfile_UserType()
        End Select
    ...
    Private Sub Execute_04()
        Select Case getUserProfile_UserType()
            ...
            Case "KPM"
                Response.Redirect("kpm.pusatujian.petugas.select.aspx?pusatcode=" & Request.QueryString("pusatcode") & "&examyear=" & Request.QueryString("examyear"))
    ...
    Private Sub Execute_05()
        Select Case getUserProfile_UserType()
            ...
            Case "KPM"
                Response.Redirect("kpm.pusatujian.petugas.list.aspx?pusatcode=" & Request.QueryString("pusatcode") & "&examyear=" & Request.QueryString("examyear"))
    ...
    Private Sub Execute_07()
        Select Case getUserProfile_UserType()
            ...
            Case "KPM"
            Case "JPN"
                Response.Redirect("jpn.pusatujian.update.aspx?pusatcode=" & Request.QueryString("pusatcode") & "&examyear=" & Request.QueryString("examyear"))
