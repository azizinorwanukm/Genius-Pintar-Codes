...
Partial Public Class ukm1_schoolprofile_list_mas
    ...
    Private Function getSQL() As String
        ...
        Dim strGroupby As String = " GROUP BY a.SchoolID,a.SchoolState,b.SchoolName,b.SchoolCode"

        tmpSQL = "SELECT a.SchoolID,COUNT(a.SchoolID) as nSchool,b.SchoolName,b.SchoolCode,a.SchoolState FROM UKM1 a,SchoolProfile b"
