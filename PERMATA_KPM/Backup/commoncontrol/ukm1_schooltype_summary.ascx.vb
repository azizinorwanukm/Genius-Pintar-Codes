...
Partial Public Class ukm1_schooltype_summary
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT SchoolType, COUNT(*) as nTotal FROM UKM1"
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Select Case getUserProfile_UserType()
            Case "JPN"
                Response.Redirect("jpn.ukm1.schooltype.list.aspx?examyear=" & ddlExamYear.Text & "&schooltype=" + Server.UrlEncode(strKeyID))
            Case "KPM"
                Response.Redirect("kpm.ukm1.schooltype.list.aspx?examyear=" & ddlExamYear.Text & "&schooltype=" + Server.UrlEncode(strKeyID))
            Case "KPT"
            Case "MRSM"
            Case "ASASI"
            Case Else
