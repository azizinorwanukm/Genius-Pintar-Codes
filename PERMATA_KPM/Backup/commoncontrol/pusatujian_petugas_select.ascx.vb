...
Partial Public Class pusatujian_petugas_select
    ...
    Private Sub btnCalSearch_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnCalSearch.Click
    ...
    Private Sub myCalSearch_SelectionChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles myCalSearch.SelectionChanged
        txtTarikhSearch.Text = myCalSearch.SelectedDate.ToString("yyyy-MM-dd")
