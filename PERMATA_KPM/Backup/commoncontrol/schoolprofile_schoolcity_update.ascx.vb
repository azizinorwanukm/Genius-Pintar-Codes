...
Partial Public Class schoolprofile_schoolcity_update
    ...
    Private Sub btnSchoolcity_update_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSchoolcity_update.Click
        strSQL = "UPDATE SchoolProfile SET SchoolCity='" & oCommon.FixSingleQuotes(txtSchoolCity.Text.ToUpper) & "' WHERE SchoolState='" & ddlSchoolState.Text & "' AND SchoolCity='" & ddlSchoolCity.Text & "'"
        ...
        strSQL = "UPDATE UKM1 SET SchoolCity='" & oCommon.FixSingleQuotes(txtSchoolCity.Text.ToUpper) & "' WHERE SchoolState='" & ddlSchoolState.Text & "' AND SchoolCity='" & ddlSchoolCity.Text & "'"
        strRet = oCommon.ExecuteSQL(strSQL)
        If strRet = "0" Then
            lblMsg.Text = "Berjaya mengemaskini Bandar:[" & ddlSchoolCity.Text & "] Nama Baru:[" & txtSchoolCity.Text & "]"
        Else
