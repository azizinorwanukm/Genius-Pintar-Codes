<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ukm1_state_summary.ascx.vb"
    Inherits="permatapintar.ukm1_state_summary" %>
<table class="fbform">
    <tr class="fbform_header">
        <td>
            Ringkasan Ujian Negeri.[<asp:Label ID="lblDatetime" runat="server" Text=""></asp:Label>]&nbsp;
        </td>
    </tr>
    <tr>
        <td>
