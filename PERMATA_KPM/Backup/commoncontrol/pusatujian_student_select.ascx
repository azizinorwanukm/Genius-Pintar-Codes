...
<table class="fbform" width="100%">
    <tr class="fbform_header">
        <td colspan="4">
            Pilih Negeri atau PPD
        </td>
    </tr>
    <tr>
        <td colspan="4">
            Negeri:<asp:DropDownList ID="ddlSchoolState" runat="server" AutoPostBack="true" Width="200px">
            </asp:DropDownList>
            &nbsp; PPD:<asp:DropDownList ID="ddlSchoolPPD" runat="server" AutoPostBack="true"
                Width="250px">
            </asp:DropDownList>
            &nbsp; Tahun Ujian:<asp:DropDownList ID="ddlExamYear" runat="server" AutoPostBack="false"
                Width="150px">
            </asp:DropDownList>
        </td>
    </tr>
    ...
    <tr>
        <td>
            <table width="100%" border="0px">
                <tr>
                    <td>
                        <asp:Button ID="btnAssign" runat="server" Text="Assign to Pusat" CssClass="fbbutton" />&nbsp;Tarikh
                        Ujian:<asp:TextBox ID="txtTarikhUjian" Width="70pt" runat="server"></asp:TextBox>&nbsp;
                        <asp:ImageButton ID="btnCal" runat="server" ImageUrl="../icons/event.png" />
                        (YYYY-MM-DD)&nbsp;Sessi:<select name="selSessiUKM2" id="selSessiUKM2" style="width: 100px;"
                            runat="server">
                ...
                <tr>
                    <td style="vertical-align: top;">
                        <asp:Calendar ID="CalUKM2" runat="server" Visible="false"></asp:Calendar>
                    </td>
                </tr>
                <tr>
                    <td>
