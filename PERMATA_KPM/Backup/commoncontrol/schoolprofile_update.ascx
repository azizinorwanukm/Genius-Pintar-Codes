<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="schoolprofile_update.ascx.vb" Inherits="permatapintar.schoolprofile_update" %>
<table class="fbform">
    ...
    <tr>
        ...
        <td>
            :<asp:TextBox ID="txtSchoolCode" runat="server" Width="150px" MaxLength="10" Text=""></asp:TextBox>&nbsp;
        </td>
    </tr>
    <tr>
        <td style="width: 20%;">
