...
Partial Public Class ukm2_status_list
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT a.StudentID,a.IsHadir,a.ExamStart,a.ExamEnd,a.HostAddress,a.Status,a.IsLogin,a.LastPage,b.MYKAD,b.StudentFullname,b.DOB_Year,c.PusatState,c.PusatName FROM UKM2 a, StudentProfile b, PusatUjian c"
        strWhere = " WITH (NOLOCK) WHERE a.StudentID=b.StudentID AND a.PusatCode=c.PusatCode AND a.IsHadir='Y'"
        ...
        If Not ddlPusatState.Text = "ALL" Then
            strWhere += " AND c.PusatState='" & oCommon.FixSingleQuotes(ddlPusatState.Text) & "'"
        End If
        ...
        If Not txtPusatName.Text.Length = 0 Then
            strWhere += " AND c.PusatName LIKE '%" & oCommon.FixSingleQuotes(txtPusatName.Text) & "%'"
        End If

        ''status
        If Not selStatus.Value = "ALL" Then
            If selStatus.Value = "NULL" Then
                strWhere += " AND a.Status IS NULL"
            Else
        ...
        For i = 0 To datRespondent.Rows.Count - 1 Step i + 1
            ...
            If Not chkUpdate Is Nothing Then
                If chkUpdate.Checked = True Then
                    ...
                    ''INSERT BACK
                    strSQL = "INSERT INTO UKM2 (StudentID,ExamYear,IsHadir,PusatCode,SchoolID,TarikhUjian,SessiUKM2) VALUES ('" & strID & "','" & ddlExamYear.Text & "','Y','" & strPusatCode & "','" & strSchoolID & "','" & strTarikhUjian & "','" & strSessiUKM2 & "')"
                    strRet = oCommon.ExecuteSQL(strSQL)
                    If Not strRet = "0" Then
