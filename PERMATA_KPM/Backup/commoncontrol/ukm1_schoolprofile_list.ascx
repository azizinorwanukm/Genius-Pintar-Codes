...
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="4">
            Status Ujian Sekolah.[<asp:Label ID="lblDatetime" runat="server" Text=""></asp:Label>]
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            <select name="selStatus" id="selStatus" runat="server" style="width: 200px;">
...
<table class="fbform">
    <tr class="fbform_header">
        <td>
            Ringkasan Ujian Sekolah. Sekolah tertinggi di atas.
        </td>
    </tr>
    <tr>
        <td>
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="#">
                        <ItemTemplate>
                            <asp:Label ID="tCount" runat="server" Text='<%# Bind("tCount") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
