...
Partial Public Class petugas_list
    ...
    Private Function BindData(ByVal gvTable As GridView) As Boolean
        ...
        Try
            ...
            Else
                ...
                lblMsg.Text = "Senarai Petugas Pusat Ujian. Jumlah Petugas Pusat Ujian #:" & myDataSet.Tables(0).Rows.Count
            End If
    ...
    Private Function getSQL() As String
        ...
        strWhere = " WITH (NOLOCK) WHERE PetugasTahun='" & ConfigurationManager.AppSettings("ExamYear") & "'"
