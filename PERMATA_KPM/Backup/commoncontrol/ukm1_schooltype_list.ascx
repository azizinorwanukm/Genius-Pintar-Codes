<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ukm1_schooltype_list.ascx.vb"
    Inherits="permatapintar.ukm1_schooltype_list" %>
<table class="fbform">
    <tr class="fbform_header">
        <td>
            Ringkasan Ujian Jenis Sekolah>Senarai Sekolah.[<asp:Label ID="lblDatetime" runat="server"
                Text=""></asp:Label>]
        </td>
    </tr>
    <tr>
