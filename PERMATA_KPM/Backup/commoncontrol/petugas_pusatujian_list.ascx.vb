...
Partial Public Class petugas_pusatujian_list
    ...
    Private Function getSQL() As String
        ...
        strWhere = " WITH (NOLOCK) WHERE a.PetugasTahun='" & ConfigurationManager.AppSettings("ExamYear") & "' AND a.PetugasID=b.PetugasID and b.PusatCode=c.PusatCode"
