<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="schoolprofile_student_list.ascx.vb" Inherits="permatapintar.schoolprofile_student_list" %>
<table class="fbform">
        <tr class="fbform_header">
            <td>
                Senarai Pelajar Negeri. Senarai Pelajar Berdaftar.
            </td>
        </tr>
        <tr>
            <td>
    ...
    <div class="info" id="divMsg" runat="server">
        <asp:Label ID="lblMsg" runat="server" Text="Senarai Pelajar Negeri. Senarai pelajar berdaftar."></asp:Label></div>