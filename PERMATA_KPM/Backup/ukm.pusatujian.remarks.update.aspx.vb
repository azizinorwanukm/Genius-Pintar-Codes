...
Partial Public Class ukm_pusatujian_remarks_update
    ...
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnUpdate.Click
        ...
        strSQL = "UPDATE PusatUjian SET Komen='" & oCommon.FixSingleQuotes(txtRemarks.Text) & "' WHERE PusatCode='" & Request.QueryString("pusatcode") & "'"
