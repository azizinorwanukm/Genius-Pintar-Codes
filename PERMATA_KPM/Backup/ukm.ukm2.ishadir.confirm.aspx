<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ukm.Master" CodeBehind="ukm.ukm2.ishadir.confirm.aspx.vb" Inherits="permatapintar.ukm_ukm2_ishadir_confirm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="fbform">
        ...
        <tr>
            <td>
                Reset ExamStart: ExamStart=NULL,ExamEnd=NULL,Status=NEW,IsHadir='Y'.<br />
