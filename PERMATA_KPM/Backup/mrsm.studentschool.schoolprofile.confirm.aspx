<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/mara.Master" CodeBehind="mrsm.studentschool.schoolprofile.confirm.aspx.vb" Inherits="permatapintar.mrsm_studentschool_schoolprofile_confirm" %>
