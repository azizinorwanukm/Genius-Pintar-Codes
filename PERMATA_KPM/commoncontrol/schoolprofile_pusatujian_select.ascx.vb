...
Partial Public Class schoolprofile_pusatujian_select
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Select Case getUserProfile_UserType()
            Case "ADMIN"
                Response.Redirect("admin.schoolprofile.pusatujian.confirm.aspx?schoolid=" & strKeyID)
            Case "SUBADMIN"
                Response.Redirect("subadmin.schoolprofile.pusatujian.confirm.aspx?schoolid=" & strKeyID)
            Case "UKM"
                Response.Redirect("ukm.schoolprofile.pusatujian.confirm.aspx?schoolid=" & strKeyID)
            Case "JPN"
                Response.Redirect("jpn.schoolprofile.pusatujian.confirm.aspx?schoolid=" & strKeyID)
            Case "KPM"
                Response.Redirect("kpm.schoolprofile.pusatujian.confirm.aspx?schoolid=" & strKeyID)
            Case "KPT"
                Response.Redirect("kpt.schoolprofile.pusatujian.confirm.aspx?schoolid=" & strKeyID)
            Case "MRSM"
                Response.Redirect("mara.schoolprofile.pusatujian.confirm.aspx?schoolid=" & strKeyID)
            Case "ASASI"
                Response.Redirect("asasi.schoolprofile.pusatujian.confirm.aspx?schoolid=" & strKeyID)
            Case Else
    ...
    Private Sub btnCreate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCreate.Click
        Try
            Select Case getUserProfile_UserType()
                Case "ADMIN"
                    Response.Redirect("admin.pusatujian.create.aspx")
                Case "SUBADMIN"
                    Response.Redirect("subadmin.pusatujian.create.aspx")
                Case "JPN"
