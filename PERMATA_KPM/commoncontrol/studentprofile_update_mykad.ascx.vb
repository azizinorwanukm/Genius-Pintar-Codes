...
Partial Public Class studentprofile_update_mykad
        ...
        Try
            ...
            If MyTable.Rows.Count > 0 Then
                ...
                If Not IsDBNull(ds.Tables(0).Rows(0).Item("StudentType")) Then
                    selStudentType.Value = ds.Tables(0).Rows(0).Item("StudentType")
                Else
                    selStudentType.Value = ""
                End If
    ...
    Private Function StudentProfile_update() As String
        Try
            ...
            ''log
            oCommon.TransactionLog("studentprofile_update", oCommon.FixSingleQuotes(strSQL), Request.UserHostAddress, CType(Session.Item("kpmadmin_loginid"), String))
