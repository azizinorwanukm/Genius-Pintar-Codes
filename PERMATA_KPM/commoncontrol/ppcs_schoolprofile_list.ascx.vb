...
Partial Public Class ppcs_schoolprofile_list1
    ...
    Private Function getSQL() As String
        ...
        Dim strGroupby As String = " GROUP BY SchoolProfile.SchoolState,SchoolProfile.SchoolName,SchoolProfile.SchoolCode,SchoolProfile.SchoolPPD,SchoolProfile.SchoolLokasi,StudentSchool.SchoolID"
        ...
        'strWhere = " WITH (NOLOCK) WHERE a.StudentID=b.StudentID AND b.SchoolID=c.SchoolID AND a.PPCSStatus='LAYAK' AND a.PPCSDate='" & ddlPPCSDate.Text & "'"

        tmpSQL = "SELECT StudentSchool.SchoolID,SchoolProfile.SchoolState,SchoolProfile.SchoolName,SchoolProfile.SchoolCode,SchoolProfile.SchoolPPD,SchoolProfile.SchoolLokasi,COUNT(StudentSchool.SchoolID) as nschool FROM PPCS"
