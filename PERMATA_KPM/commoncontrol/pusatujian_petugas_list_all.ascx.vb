...
Partial Public Class pusatujian_petugas_list_all
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT * FROM PusatUjian_Petugas"
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Select Case getUserProfile_UserType()
            ...
            Case "JPN"
                Response.Redirect("jpn.pusatujian.petugas.update.aspx?petugasid=" & strKeyID)
            Case "KPM"
                Response.Redirect("kpm.pusatujian.petugas.update.aspx?petugasid=" & strKeyID)
            Case "KPT"
                Response.Redirect("kpt.pusatujian.petugas.update.aspx?petugasid=" & strKeyID)
            Case "MRSM"
                Response.Redirect("mara.pusatujian.petugas.update.aspx?petugasid=" & strKeyID)
            Case "ASASI"
                Response.Redirect("asasi.pusatujian.petugas.update.aspx?petugasid=" & strKeyID)
            Case Else
