...
Partial Public Class ukm1_schooltype_list
   ...
   Private Function BindData(ByVal gvTable As GridView) As Boolean
    ...
    Private Function getSQL() As String
        ...
        Try
            tmpSQL = "SELECT StudentProfile.StudentID,SchoolProfile.SchoolID,SchoolProfile.SchoolState,SchoolProfile.SchoolPPD,SchoolProfile.SchoolCity,SchoolProfile.SchoolCode,SchoolProfile.SchoolName,SchoolProfile.SchoolLokasi,UKM1.SchoolType,StudentProfile.StudentFullname,StudentProfile.MYKAD FROM UKM1"
            ...
            '--SchoolLokasi
            If Not Request.QueryString("schooltype") = "ALL" Then
                strWhere += " AND UKM1.SchoolType='" & Request.QueryString("schooltype") & "'"
            End If
