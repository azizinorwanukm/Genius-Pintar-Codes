<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ukm1_school_studentprofile_list_old.ascx.vb" Inherits="permatapintar.ukm1_school_studentprofile_list_old" %>
<table class="fbform">
    <tr class="fbform_header">
        <td>Senarai Pelajar Menduduki Ujian UKM1. Tahun Ujian:<asp:Label ID="lblExamYear" runat="server" Text=""></asp:Label>
        </td>
    </tr>
    <tr>
        <td>
