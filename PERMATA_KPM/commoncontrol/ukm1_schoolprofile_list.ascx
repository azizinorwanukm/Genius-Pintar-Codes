...
<table class="fbform">
            ...
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField Visible="false">
                        <HeaderTemplate>
                            <asp:CheckBox ID="chkboxSelectAll" Text="ALL" runat="server" onclick="CheckAllEmp(this);" />
                        </HeaderTemplate>
                        <ItemTemplate>
    ...
    <tr>
        <td><asp:Button ID="btnExport" runat="server" Text="Export " CssClass="fbbutton" />&nbsp;
            <asp:Button ID="btnPindah" runat="server" Text="Pindah Sekolah" CssClass="fbbutton" />&nbsp;
            <asp:Button ID="btnDelete" runat="server" Text="Delete Sekolah" CssClass="fbbutton" />&nbsp;
