...
Partial Public Class PPCS_Eval_End_update1
    ...
    Private Function ppcs_eval_update() As Boolean
        ...
        strSQL = "UPDATE PPCS_Eval_End WITH (UPDLOCK) SET LastUpdate='" & oCommon.getNow & "',Q001=" & Q1.SelectedValue & ",Q001Remarks='" & oCommon.FixSingleQuotes(Q001Remarks.Text) & "' WHERE ppcsevalendid=" & Request.QueryString("ppcsevalendid")
