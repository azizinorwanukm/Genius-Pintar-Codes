...
Partial Public Class ukm1_studentrace_summary
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT master_StudentRace.StudentRace,(SELECT COUNT(*) FROM UKM1,StudentProfile WHERE UKM1.StudentID=StudentProfile.StudentID AND StudentProfile.StudentRace=master_StudentRace.StudentRace AND UKM1.Examyear='" & ddlExamYear.Text & "'" & strWhereIn & ") as Jumlah FROM master_StudentRace"
        strWhere += ""
    ...
    Private Sub datRespondent_SelectedIndexChanging(sender As Object, e As GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Select Case getUserProfile_UserType()
            Case "ADMIN"
                Response.Redirect("admin.studentprofile.studentrace.list.aspx?studentrace=" & strKeyID & "&examyear=" & ddlExamYear.Text & "&iscount=" & chkRuleAge.Checked)
            Case "SUBADMIN"
                Response.Redirect("subadmin.studentprofile.studentrace.list.aspx?studentrace=" & strKeyID & "&examyear=" & ddlExamYear.Text & "&iscount=" & chkRuleAge.Checked)
            Case Else
