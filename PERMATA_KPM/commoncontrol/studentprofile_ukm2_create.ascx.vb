...
Partial Public Class studentprofile_ukm2_create
        ...
        Using connection As New SqlConnection(strconn)
            ...
            Try
                ...
                If oCommon.isExist(strSQL) = False Then
                    strSQL = "INSERT INTO UKM1 (StudentID,ExamYear,QuestionYear,HostAddress,HostName,Browser,SelectedLang,Status,DOB_Year) VALUES('" & lblStudentID.Text & "','" & ddlExamYear.Text & "','" & ddlExamYear.Text & "','" & Request.UserHostAddress & "','" & Request.UserHostName & "','" & Request.UserAgent & "','ms-MY','NEW','" & ddlDOB_Year.Text & "')"
                    command.CommandText = strSQL
                    command.ExecuteNonQuery()
    ...
    Private Function StudentProfile_Insert() As String
        ...
        ''log
        oCommon.TransactionLog("studentprofile_insert", oCommon.FixSingleQuotes(strSQL), Request.UserHostAddress, CType(Session.Item("kpmadmin_loginid"), String))
