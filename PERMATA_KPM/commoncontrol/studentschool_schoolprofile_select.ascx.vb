...
Partial Public Class studentschool_schoolprofile_select1
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Try
            Select Case getUserProfile_UserType()
                Case "ADMIN"
                    Response.Redirect("kpm.studentschool.schoolprofile.confirm.aspx?oldschoolid=" & Request.QueryString("oldschoolid") & "&schoolid=" & strKeyID & "&examyear=" & Request.QueryString("examyear"))
                Case "SUBADMIN"
                    Response.Redirect("subadmin.studentschool.schoolprofile.confirm.aspx?oldschoolid=" & Request.QueryString("oldschoolid") & "&schoolid=" & strKeyID & "&examyear=" & Request.QueryString("examyear"))
                Case Else
