...
Partial Public Class ukm2_schoolprofile_select1
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Try
            Select Case getUserProfile_UserType()
                ''ukm2.studentprofile.register.aspx?schoolid=94d9586b-5ed9-4541-bf9f-f44420471e35
                Case "ADMIN"
                    Response.Redirect("ukm2.studentprofile.register.aspx?schoolid=" & strKeyID)
                Case "SUBADMIN"
                    Response.Redirect("subadmin.ukm2.studentprofile.register.aspx?schoolid=" & strKeyID)
                Case Else
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT SchoolID, SchoolState, SchoolPPD, SchoolCity, SchoolCode, SchoolName,SchoolNoTel,SchoolNoFax,SchoolLokasi,SchoolType,(SELECT COUNT(*) FROM StudentSchool WHERE StudentSchool.SchoolID=SchoolProfile.SchoolID) AS Jumlah FROM SchoolProfile"
