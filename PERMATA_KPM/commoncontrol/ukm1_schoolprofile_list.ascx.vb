...
Partial Public Class ukm1_schoolprofile_list
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Try
            Select Case getUserProfile_UserType()
                ...
                Case "MRSM"
                    Response.Redirect("mara.schoolprofile.students.list.aspx?examyear=" & ddlExamYear.Text & "&schoolid=" & strKeyID & "&iscount=" & chkRuleAge.Checked)
                Case "KPT"
                    Response.Redirect("kpt.schoolprofile.students.list.aspx?examyear=" & ddlExamYear.Text & "&schoolid=" & strKeyID & "&iscount=" & chkRuleAge.Checked)
                Case "ASASI"
                    Response.Redirect("asasi.schoolprofile.students.list.aspx?examyear=" & ddlExamYear.Text & "&schoolid=" & strKeyID & "&iscount=" & chkRuleAge.Checked)
                Case "UKM"
                    Response.Redirect("ukm.schoolprofile.students.list.aspx?examyear=" & ddlExamYear.Text & "&schoolid=" & strKeyID & "&iscount=" & chkRuleAge.Checked)
                Case Else
                    lblMsg.Text = "Invalid User Type:" & getUserProfile_UserType()
            End Select
            'jpn.schoolprofile.students.list.aspx?examyear=2015&schoolid=ed646f4f-9d82-44c2-88d4-9d71e0c95e00&iscount=True
        Catch ex As Exception
    ...
    Private Sub btnPindah_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPindah.Click
        ...
        If strSource.Length = 0 Then
            lblMsg.Text = "Sila pilih sekurang-kurangnya satu sekolah."
        ...
        Select Case getUserProfile_UserType()
            Case "ADMIN"
                Response.Redirect("admin.ukm1.schoolprofile.list.pindah.aspx?examyear=" & ddlExamYear.Text & "&source=" & strSource)
            Case "SUBADMIN"
                Response.Redirect("subadmin.ukm1.schoolprofile.list.pindah.aspx?examyear=" & ddlExamYear.Text & "&source=" & strSource)
            Case "KPT"
            Case "ASASI"
            Case Else
                lblMsg.Text = "Invalid User Type:" & getUserProfile_UserType()
