...
Partial Public Class ukm1_state_summary
    ...
    Private Function getSQL() As String
        ...
        Dim strOrder As String = " ORDER BY SchoolState.SchoolStateID"
        ...
        tmpSQL += "(SELECT COUNT(*) FROM UKM1 WHERE UKM1.SchoolState=SchoolState.SchoolState AND UKM1.Status<>'DONE' AND UKM1.ExamYear='" & ddlExamYear.Text & "'" & strWhereIn & ") as JumlahNEW,"
        tmpSQL += "(SELECT COUNT(*) FROM UKM1 WHERE UKM1.SchoolState=SchoolState.SchoolState AND UKM1.Status='DONE' AND UKM1.ExamYear='" & ddlExamYear.Text & "'" & strWhereIn & ") as JumlahDONE,"
        tmpSQL += "(SELECT COUNT(*) FROM UKM1 WHERE UKM1.SchoolState=SchoolState.SchoolState AND UKM1.ExamYear='" & ddlExamYear.Text & "'" & strWhereIn & ") as Jumlah"
        tmpSQL += " FROM SchoolState"
        strWhere += " WHERE SchoolState.SchoolState<>'UKM2-KPT' AND SchoolState.SchoolState<>'UKM2-ASASI'"
