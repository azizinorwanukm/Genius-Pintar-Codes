<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ukm1_dobyear_list.ascx.vb" Inherits="permatapintar.ukm1_dobyear_list" %>
<table class="fbform">
    <tr class="fbform_header">
        <td>Senarai Pelajar. Tahun Lahir: <asp:Label ID="lbldob_year"
