...
Partial Public Class ukm1_studentgender_summary
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT master_Gender.StudentGender,(SELECT COUNT(*) FROM UKM1,StudentProfile WHERE UKM1.StudentID=StudentProfile.StudentID AND StudentProfile.StudentGender=master_Gender.StudentGender AND UKM1.Examyear='" & ddlExamYear.Text & "'" & strWhereIn & ") as Jumlah FROM master_Gender"
        strWhere += " WHERE master_Gender.StudentGender<>'NA'"
