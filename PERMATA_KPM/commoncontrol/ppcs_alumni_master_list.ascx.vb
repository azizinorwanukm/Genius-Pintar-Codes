...
Partial Public Class ppcs_alumni_master_list
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT DISTINCT(a.StudentID),b.StudentFullname,b.MYKAD,b.AlumniID,b.DOB_Year,b.StudentRace,b.StudentReligion,b.StudentCity,b.StudentState FROM PPCS a,StudentProfile b"
        ...
        If selSort.Value = "0" Then
            strOrder = " ORDER BY b.StudentFullname,a.StudentID ASC"
        Else
            strOrder = " ORDER BY b.AlumniID ASC"
        End If
