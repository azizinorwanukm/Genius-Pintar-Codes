...
Partial Public Class PPCS_Eval_Weekly_create1
    ...
    Private Function ppcs_eval_update() As Boolean
        ...
        strSQL = "UPDATE PPCS_Eval_Weekly WITH (UPDLOCK) SET LastUpdate='" & oCommon.getNow & "',Q001Remarks='" & oCommon.FixSingleQuotes(Q001Remarks.Text) & "',Q002Remarks='" & oCommon.FixSingleQuotes(Q002Remarks.Text) & "',Q003Remarks='" & oCommon.FixSingleQuotes(Q003Remarks.Text) & "' WHERE studentid='" & Request.QueryString("studentid") & "' AND ClassID=" & Request.QueryString("classid")
    ...
    Private Function ppcs_eval_insert() As Boolean
        ...
        strSQL = "INSERT INTO ppcs_eval_weekly (StudentID,DateCreated,CreateBy,PPCSDate,ClassCode,ClassID,LastUpdate,Q001Remarks,Q002Remarks,Q003Remarks) Values ('" & Request.QueryString("studentid") & "','" & oCommon.getToday & "','" & Server.HtmlEncode(CType(Session.Item("kpmadmin_loginid"), String)) & "','" & Request.QueryString("ppcsdate") & "','" & strClassCode & "'," & Request.QueryString("classid") & ",'" & oCommon.getNow & "','" & oCommon.FixSingleQuotes(Q001Remarks.Text) & "','" & oCommon.FixSingleQuotes(Q002Remarks.Text) & "','" & oCommon.FixSingleQuotes(Q003Remarks.Text) & "')"
        strRet = oCommon.ExecuteSQL(strSQL)
        If strRet = "0" Then
            lblMsgTop.Text = "Rekod berjaya dikemaskini."
            lblMsg.Text = "Rekod berjaya dikemaskini."
