...
Partial Public Class ukm2_schooltype_summary1
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT SchoolType, COUNT(*) as nTotal FROM UKM2"
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Select Case getUserProfile_UserType()
            Case "ADMIN"
                Response.Redirect("ukm2.schooltype.list.aspx?schooltype=" + Server.UrlEncode(strKeyID) & "&examyear=" & ddlExamYear.Text)
            Case "SUBADMIN"
                Response.Redirect("subadmin.ukm2.schooltype.list.aspx?schooltype=" + Server.UrlEncode(strKeyID) & "&examyear=" & ddlExamYear.Text)
            Case "KPT"
            Case "ASASI"
            Case Else
