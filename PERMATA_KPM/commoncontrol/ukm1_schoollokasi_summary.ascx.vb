...
Partial Public Class ukm1_schoollokasi_summary
    ...
    Private Function getSQL() As String
        ...
        tmpSQL += "(SELECT COUNT(*) FROM UKM1 WHERE UKM1.SchoolLokasi=master_SchoolLokasi.SchoolLokasi AND UKM1.ExamYear='" & ddlExamYear.Text & "'" & strWhereIn & ") as Jumlah"
    ...
    Private Sub datRespondent_SelectedIndexChanging(sender As Object, e As GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Select Case getUserProfile_UserType()
            Case "ADMIN"
                Response.Redirect("admin.schoolprofile.schoollokasi.list.aspx?schoollokasi=" & strKeyID & "&examyear=" & ddlExamYear.Text & "&iscount=" & chkRuleAge.Checked)
            Case "SUBADMIN"
                Response.Redirect("subadmin.schoolprofile.schoollokasi.list.aspx?schoollokasi=" & strKeyID & "&examyear=" & ddlExamYear.Text & "&iscount=" & chkRuleAge.Checked)
            Case Else
