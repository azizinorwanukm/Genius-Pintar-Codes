...
Public Class SchoolProfile_search
    ...
    Private Function getSQL() As String
        ...
        Dim strOrder As String = " ORDER BY SchoolState,SchoolPPD,SchoolCity,SchoolName"

        tmpSQL = "SELECT SchoolID,SchoolCode,SchoolName,SchoolAddress,SchoolPostcode,SchoolCity,SchoolState,SchoolPPD,SchoolType,SchoolLokasi,SchoolNoTel,SchoolEmail FROM SchoolProfile"
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Try
            Select Case getUserProfile_UserType()
                Case "ADMIN"
                    Response.Redirect("admin.schoolprofile.view.aspx?schoolid=" & strKeyID)
                Case "KPM"
                    Response.Redirect("kpm.schoolprofile.view.aspx?schoolid=" & strKeyID)
                Case "JPN"
                    Response.Redirect("jpn.schoolprofile.view.aspx?schoolid=" & strKeyID)
                Case "UKM"
                    Response.Redirect("ukm.schoolprofile.view.aspx?schoolid=" & strKeyID)
                Case Else
