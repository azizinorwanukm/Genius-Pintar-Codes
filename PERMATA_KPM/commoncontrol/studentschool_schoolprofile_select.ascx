<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="studentschool_schoolprofile_select.ascx.vb"
    Inherits="permatapintar.studentschool_schoolprofile_select1" %>
<table class="fbform">
