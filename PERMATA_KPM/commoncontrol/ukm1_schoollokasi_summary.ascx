<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ukm1_schoollokasi_summary.ascx.vb"
    Inherits="permatapintar.ukm1_schoollokasi_summary" %>
<table class="fbform">
    ...
    <tr>
        <td class="fbtd_left">Tahun Ujian:</td>
        <td>
        ...
        <td>
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:CommandField SelectText="[Pilih]" ShowSelectButton="True" HeaderText="Senarai" />
                </Columns>
...
<p>
    B=Bandar | LB=Luar Bandar | NA=Not Available (Sekolah didaftarkan oleh Pelajar)
</p>
