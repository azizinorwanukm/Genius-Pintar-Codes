...
Public Class ukm2_state_student_list
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If Not IsPostBack Then
                ...
                SchoolState_list()
                ddlSchoolState.Text = Request.QueryString("schoolstate")
    ...
    Private Function getSQL() As String
        ...
        Dim strOrder As String = " ORDER BY SchoolProfile.SchoolName,StudentProfile.StudentFullname"
        ...
        tmpSQL = "SELECT UKM2.StudentID,UKM2.HostAddress,StudentProfile.MYKAD,StudentProfile.StudentFullname,StudentProfile.DOB_Year,StudentProfile.StudentState,StudentProfile.StudentCity,StudentProfile.StudentRace,StudentProfile.StudentGender,StudentProfile.AlumniID,SchoolProfile.SchoolID,SchoolProfile.SchoolCode,SchoolProfile.Schoolname,SchoolProfile.SchoolState,SchoolProfile.Schoolcity,SchoolProfile.SchoolPPD,UKM2.ExamStart,UKM2.ExamEnd,UKM2.SelectedLang,UKM2.LastPage,UKM2.IsHadir,UKM2.IsLogin,UKM2.SessiUKM2,UKM2.TarikhUjian,UKM2.Status,UKM2.ExamYear as UKM2ExamYear,ParentProfile.FamilyContactNo,ParentProfile.FatherFullname FROM UKM2"
