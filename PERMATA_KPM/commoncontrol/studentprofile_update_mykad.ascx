...
<table class="fbform">
    ...
    <tr>
        ...
        <td>
            <select name="selStudentType" id="selStudentType" style="width: 250PX;" runat="server">
                <option value="PELAJAR" selected="selected">PELAJAR</option>
                <option value="PPCS JUN">PPCS JUN</option>
                <option value="PPCS DISEMBER">PPCS DISEMBER</option>
                <option value="PERKHEMAHAN KHAS">PERKHEMAHAN KHAS</option>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtAlumniID" runat="server" Width="100px" MaxLength="10"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td>No Pelajar:
        ...
        <td>
            <asp:TextBox ID="txtNoPelajar" runat="server" Width="100px" MaxLength="10"></asp:TextBox>
        </td>
    </tr>
