...
Partial Public Class schoolprofile_student_list
    ...
    Private Function getSQL() As String
        ...
        '--get from UKM1
        tmpSQL = "SELECT StudentProfile.StudentProfileID,StudentProfile.StudentID,StudentProfile.MYKAD,StudentProfile.StudentFullname,StudentProfile.DOB_Year,StudentProfile.StudentGender,StudentProfile.StudentRace,StudentProfile.StudentReligion FROM UKM1"
