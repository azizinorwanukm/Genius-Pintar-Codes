...
Partial Public Class ppcs_kelayakan_select
    ...
    Private Function getSQL() As String
        ...
        tmpSQL += " LEFT OUTER JOIN PPCS ON UKM2.StudentID=PPCS.StudentID AND PPCS.PPCSDate='" & ddlPPCSDate.Text & "'"
        ...
        If Not txtExamEnd.Text.Length = 0 Then
            strWhere += " AND UKM2.ExamEnd LIKE '" & oCommon.FixSingleQuotes(txtExamEnd.Text) & "%'"
        End If
    ...
    Private Sub calExamEnd_SelectionChanged(sender As Object, e As EventArgs) Handles calExamEnd.SelectionChanged
