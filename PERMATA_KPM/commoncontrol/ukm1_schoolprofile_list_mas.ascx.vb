...
Partial Public Class ukm1_schoolprofile_list_mas
   ...
   Private Sub SchoolState_list()
        ...
        Try
            ...
            '--purposely allow JPN to view others country
    ...
    Private Function getSQL() As String
        ...
        Try
            ...
            tmpSQL += "(SELECT COUNT(*) FROM UKM1 WHERE SchoolProfile.SchoolID=UKM1.SchoolID AND UKM1.Examyear='" & ddlExamYear.Text & "'" & strWhereIn & ") as Jumlah"
            tmpSQL += " FROM SchoolProfile"
