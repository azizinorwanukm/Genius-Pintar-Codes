...
Partial Public Class PPCS_Eval_Weekly_update1
    ...
    Private Function ppcs_eval_update() As Boolean
        ...
        strSQL = "UPDATE PPCS_Eval_Weekly WITH (UPDLOCK) SET LastUpdate='" & oCommon.getNow & "',Q001Remarks='" & oCommon.FixSingleQuotes(Q001Remarks.Text) & "',Q002Remarks='" & oCommon.FixSingleQuotes(Q002Remarks.Text) & "',Q003Remarks='" & oCommon.FixSingleQuotes(Q003Remarks.Text) & "' WHERE ppcsevalweekid=" & Request.QueryString("ppcsevalweekid")
