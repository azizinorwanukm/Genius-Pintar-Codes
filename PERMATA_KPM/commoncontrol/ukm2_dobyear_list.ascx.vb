...
Partial Public Class ukm2_dobyear_list
    ...
    Private Function BindData(ByVal gvTable As GridView) As Boolean
        ...
        Try
            ...
            Else
                ...
                lblMsg.Text = "Senarai pelajar yang menduduki Ujian UKM2. Jumlah pelajar#:" & myDataSet.Tables(0).Rows.Count
            End If
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT b.StudentID,b.StudentFullname,b.MYKAD,b.DOB_Year,b.StudentRace,a.Status FROM UKM2 a,StudentProfile b WHERE a.StudentID=b.StudentID"

        If Not Request.QueryString("examyear") = "ALL" Then
