...
Partial Public Class schoolprofile_list
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT SchoolID,SchoolCode,SchoolName,SchoolAddress,SchoolPostcode,SchoolCity,SchoolState,SchoolPPD,SchoolType,SchoolLokasi,SchoolNoTel FROM SchoolProfile"
        ...
        Try
            ...
            Select Case getUserProfile_UserType()
                ...
                Case "KPM"
                    Response.Redirect("kpm.schoolprofile.update.aspx?schoolid=" & strKeyID)
                Case "JPN"
                    Response.Redirect("jpn.schoolprofile.update.aspx?schoolid=" & strKeyID)
                Case Else
