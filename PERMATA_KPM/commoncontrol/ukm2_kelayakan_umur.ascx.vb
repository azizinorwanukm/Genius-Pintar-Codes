...
Partial Public Class ukm2_kelayakan_umur
    ...
    Private Function getSQL() As String
        ...
        strWhere += " WHERE master_dobyear.DOB_Year >=" & oCommon.getValidYear(ddlExamYear.Text, 15)
    ...
    Private Sub dat_Age_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles dat_Age.SelectedIndexChanging
        ...
        Response.Redirect("admin.ukm2.kelayakan.list.aspx?examyear=" & ddlExamYear.Text & "&dob_year=" + Server.UrlEncode(strKeyID) & "&iscount=" & chkRuleAge.Checked)

    End Sub

    Private Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        strRet = BindData(dat_Age)
