...
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">
            Kemaskini Maklumat Pusat Ujian
        </td>
    </tr>
    <tr>
        <td style="width: 15%;">
    ...
    <tr>
        ...
        <td>
            :<asp:TextBox ID="txtPusatJumlahLab" runat="server" Width="150px" MaxLength="5"></asp:TextBox>*
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            :<asp:TextBox ID="txtPusatJumlahKomp" runat="server" Width="150px" MaxLength="5"></asp:TextBox>*
        </td>
    </tr>
    <tr>
        ...
        <td style="vertical-align:top;">
            :<asp:TextBox ID="txtKomen" runat="server" Width="450px" MaxLength="500" TextMode="MultiLine" Rows="3"></asp:TextBox>*
        </td>
    </tr>
    <tr>
        <td>
