<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="studentschool.schoolprofile.select.ascx.vb" Inherits="permatapintar.studentschool_schoolprofile_select" %>
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="4">
            Pindah Sekolah: Pilih Negeri, PPD atau Bandar <asp:Label ID="lblUserType" runat="server" Text=""></asp:Label>
        </td>
    </tr>
    <tr>
        <td>
