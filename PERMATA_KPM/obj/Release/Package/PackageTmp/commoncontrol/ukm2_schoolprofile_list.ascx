<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ukm2_schoolprofile_list.ascx.vb"
    Inherits="permatapintar.ukm2_schoolprofile_list1" %>
<table class="fbform">
    ...
    <tr>
        ...
        <td>
            <asp:DropDownList ID="ddlExamYear" runat="server" Width="200px">
            </asp:DropDownList>
        </td>
    </tr>
    <tr>
...
<table class="fbform">
    <tr class="fbform_header">
        <td>Senarai Sekolah. Urutan mengikut penyertaan tertinggi.
        </td>
    </tr>
    <tr>
        <td>
...
<div class="info" id="divMsg" runat="server">
    <asp:Label ID="lblMsg" runat="server" Text="Senarai sekolah berdasarkan negeri mengikut jumlah pelajar yang menduduki Ujian UKM2 tertinggi."></asp:Label>
</div>
