...
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Kemaskini Maklumat PPCS
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="width: 20%;">Kursus
        </td>
        <td>:<asp:DropDownList ID="ddlPPCSCourse" runat="server" Width="100px" AutoPostBack="true"
            Visible="true">
        </asp:DropDownList>
    ...
    <tr>
        <td style="width: 20%;">Kelas
        </td>
        <td>:<asp:DropDownList ID="ddlPPCSClass" runat="server" Width="100px" AutoPostBack="true"
            Visible="true">
        </asp:DropDownList>
    ...
    <tr>
        ...
        <td>:<asp:TextBox ID="txtNamaAsrama" runat="server" Width="250px" MaxLength="150"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td style="width: 20%;">No Bilik
        </td>
        <td>:<asp:TextBox ID="txtNoBilik" runat="server" Width="50px" MaxLength="50"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td style="width: 20%;">Saiz Baju
        </td>
        <td>:<asp:TextBox ID="txtSaizBaju" runat="server" Width="50px" MaxLength="10"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td style="width: 20%;">Sakit/Alahan
        </td>
        <td>:<asp:TextBox ID="txtSakitAlahan" runat="server" Width="250px" MaxLength="250"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td>&nbsp;
...
<div class="info" id="divMsg" runat="server">
    <asp:Label ID="lblMsg" runat="server" Text="Medan bertanda * adalah wajib diisi. Perlu berhati-hati, jika terlalu banyak field yang tidak lengkap, akan terdapat rekod yang tidak seragam pada masa akan datang."></asp:Label>
</div>
