...
<table class="fbform">
    ...
    <tr>
        <td class="fbtd_left">Nama Pelajar:</td>
        <td>
    ...
    <tr>
        <td>PPCS Alumni ID:</td>
        <td>
            <asp:TextBox ID="txtAlumniID" runat="server" Width="200px" MaxLength="20"></asp:TextBox>&nbsp;</td>
        <td>Tahun Lahir:</td>
        <td>
    ...
    <tr>
        ...
        <td>
            <select name="selSort" id="selSort" style="width: 200px;" runat="server">
                ...
                <option value="1">Alumni ID</option>
            </select></td>
    </tr>
</table>
&nbsp;
