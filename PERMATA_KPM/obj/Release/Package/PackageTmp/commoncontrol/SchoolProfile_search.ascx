<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="SchoolProfile_search.ascx.vb" Inherits="permatapintar.SchoolProfile_search" %>
            ...
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Email">
                        <ItemTemplate>
                            <asp:Label ID="SchoolEmail" runat="server" Text='<%# Bind("SchoolEmail")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
