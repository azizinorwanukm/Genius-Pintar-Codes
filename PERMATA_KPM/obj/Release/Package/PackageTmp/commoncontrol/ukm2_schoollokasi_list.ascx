<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ukm2_schoollokasi_list.ascx.vb"
    Inherits="permatapintar.ukm2_schoollokasi_list1" %>
<table class="fbform">
    <tr class="fbform_header">
        <td>
            Senarai Sekolah berdasarkan Lokasi.
        </td>
    </tr>
    <tr>
        <td>
