<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/mara.Master"
    CodeBehind="mrsm.ukm1.schoolprofile.student.list.aspx.vb" Inherits="permatapintar.mrsm_ukm1_schoolprofile_student_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    &nbsp; &nbsp;<uc1:ukm1_school_studentprofile_list ID="ukm1_school_studentprofile_list1"
        runat="server" />
    <table class="fbform">
        <tr>
            <td>
