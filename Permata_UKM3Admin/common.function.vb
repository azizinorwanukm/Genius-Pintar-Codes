...
Public Class Commonfunction
    ...
    Public Function ExecuteSQLMaster(ByVal strSQL As String) As String
        ExecuteSQLMaster = "0"

        If strSQL.Length = 0 Then
            ExecuteSQLMaster = "*System error (Contact system admin): No query string pass."
            Exit Function
        End If
        ...
        Try
            ...
            Return "0"
        Catch ex As SqlException
            ExecuteSQLMaster = "Error." & Err.Description & "." & strSQL
            'do not exposed it to end user. hacker might used the info
        Finally
            If Not (objConn Is Nothing) Then
                objConn.Close()
    ...
    Public Function getFieldValueMaster(ByVal strSQL As String) As String
        If strSQL.Length = 0 Then
            Return ""
        End If
        'If isBlockText(strSQL) = True Then
    ...
    Public Shared Function getUkm3SessionID(ppcsDate As String) As String

        Dim SessionID As String = ""

        Dim strSQL As String = "SELECT id FROM UKM3Session WHERE ppcsdate = '" & ppcsDate & "'"
    ...
    Public Shared Function getPpcsDate(sessionID As String) As String

        Dim ppcsdate As String = ""

        Dim strSQL As String = "SELECT ppcsdate FROM UKM3Session WHERE id = '" & sessionID & "'"
