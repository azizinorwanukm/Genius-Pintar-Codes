<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ppcs_eval_weekly_view.ascx.vb" Inherits="permatapintar.ppcs_eval_weekly_view1" %>

<table class="fbform">
    <tr class="fbform_header">
        <td class="fbsection_sap" colspan="2">LAPORAN MINGGUAN.
