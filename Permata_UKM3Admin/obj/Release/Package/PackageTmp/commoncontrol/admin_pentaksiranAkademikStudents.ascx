<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="admin_pentaksiranAkademikStudents.ascx.vb" Inherits="permatapintar.admin_pentaksiranAkademikStudents" %>
<table class="fbform">
        ...
        <td>
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Bandar & Negeri">
                        <ItemTemplate>
    ...
    <tr>
        <td style="text-align: left;">
            ...
            <asp:Button ID="btnPrint" runat="server" Text="Cetak Laporan Akhir" CssClass="fbbutton"
                Visible="True" />&nbsp;<asp:HyperLink ID="hyPDF" runat="server" Target="_blank" Visible="false">Klik disini untuk muat turun.</asp:HyperLink>
        </td>
    </tr>
</table>
