<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="kpp_studentlist_checklist_update.ascx.vb" Inherits="permatapintar.kpp_studentlist_checklist_update1" %>
...
<table class="fbform">
    ...
    <tr>
        <td> <asp:Label runat ="server" ID="lbl_stfId" Text='<%# Bind("stf_id") %>' visibe ="false"></asp:Label></td>
    </tr>
    <tr>
        <td class="td1">
...
<table id="InfoTable" runat="server" class="fbform">
    ...
    <tr>
         <td>
           <asp:Label ID="question" runat="server" Text="Komen"></asp:Label>
        </td>          
    </tr>
    <tr>
             <td>
