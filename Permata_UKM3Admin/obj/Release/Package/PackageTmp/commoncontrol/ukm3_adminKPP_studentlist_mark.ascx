<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ukm3_adminKPP_studentlist_mark.ascx.vb" Inherits="permatapintar.ukm3_adminKPP_studentlist_mark" %>
            ...
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Status Penilaian">
                        <ItemTemplate>
                            <asp:Label ID="Kpp_update" runat="server" Text='<%# Bind("Kpp_update") %>'></asp:Label>
                        </ItemTemplate>
                         <HeaderStyle HorizontalAlign="Left" VerticalAlign="Top" />
                        <ItemStyle VerticalAlign="Middle" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Sokong">
                        <ItemTemplate>
                            <asp:Label ID="Sokong" runat="server" Text='<%# Bind("isSokong_kpp") %>'></asp:Label>
                        </ItemTemplate>
                         <HeaderStyle HorizontalAlign="Left" VerticalAlign="Top" />
                        <ItemStyle VerticalAlign="Middle" />
                    </asp:TemplateField>
