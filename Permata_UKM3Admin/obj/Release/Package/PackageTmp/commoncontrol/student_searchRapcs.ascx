<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="student_searchRapcs.ascx.vb" Inherits="permatapintar.student_searchRapcs" %>
    ...
    <tr>
        <td>
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                CellPadding="4" ForeColor="#333333" GridLines="None" DataKeyNames="std_id"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Simpanan Rekod">
                        <ItemTemplate>
                            <asp:Label ID="record" runat="server" Text='<%# Bind("Rapcs_update") %>' ></asp:Label>
                        </ItemTemplate>
                         <HeaderStyle HorizontalAlign="Left" VerticalAlign="Top" />
                        <ItemStyle VerticalAlign="Middle" />
                    </asp:TemplateField>
