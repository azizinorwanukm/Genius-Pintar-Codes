<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="admin_asas_classSelect.ascx.vb" Inherits="permatapintar.admin_asas_classSelect" %>
...
<table style="width :100%" class="fbform">
     ...
     <%--<tr>
      ...
      <tr>
        ...
        <td style="text-align :right">
          ...
          <td>
                <asp:DropDownList runat="server" ID ="ddlSortbys" >
    ...
    <tr>
        <td class="auto-style2">Mean STEM (Asas 1) :
        </td>
        <td>
