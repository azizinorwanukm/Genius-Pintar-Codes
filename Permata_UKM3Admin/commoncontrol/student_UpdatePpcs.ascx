<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="student_UpdatePpcs.ascx.vb" Inherits="permatapintar.student_UpdatePpcs" %>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Simpanan Rekod">
                        <ItemTemplate>
                            ...
                            <asp:Label ID="rekod" runat ="server" text=""></asp:Label>
                        </ItemTemplate>
