...
Public Class admin_pentaksiranAkademikStudents
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Try
            ...
            Response.Redirect("laporan.keseluruhan.view.aspx?studentid=" & strKeyID & "&ppcsdate=" & Request.QueryString("ppcsdate") & "&courseid=" & Request.QueryString("courseid") & "&classid=" & Request.QueryString("classid"))
