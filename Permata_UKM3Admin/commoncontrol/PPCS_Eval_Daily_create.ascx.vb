...
Partial Public Class PPCS_Eval_Daily_create1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim strSelectedDdate As String = "01/12/" & oCommon.getAppsettings("DefaultExamYear")
    ...
    Private Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        strSQL = "SELECT DateCreated FROM ppcs_eval_daily WHERE StudentID='" & Request.QueryString("studentid") & "' AND DateCreated='" & lblSelectedDate.Text & "'"
    ...
    Private Function ppcs_eval_insert() As Boolean
        ...
        strSQL = "INSERT INTO ppcs_eval_daily (StudentID,DateCreated,CreateBy,PPCSYear,PPCSDate,ClassCode,ClassID,LastUpdate,Q001,Q002,Q003,Q004,Q005,Q006,Q007,Q008,Q009,Q010,Q001Remarks,Q002Remarks,Q003Remarks,Q004Remarks,Q005Remarks,Q006Remarks,Q007Remarks,Q008Remarks,Q009Remarks,Q010Remarks,TotalMark) Values ('" & Request.QueryString("studentid") & "','" & lblSelectedDate.Text & "','" & Server.HtmlEncode(CType(Session.Item("permata_admin"), String)) & "','" & calToday.SelectedDate.Year & "','" & Request.QueryString("ppcsdate") & "','" & Request.QueryString("classcode") & "'," & Request.QueryString("classid") & ",'" & oCommon.getNow & "'," & nQ1 & "," & nQ2 & "," & nQ3 & "," & nQ4 & "," & nQ5 & "," & nQ6 & "," & nQ7 & "," & nQ8 & "," & nQ9 & "," & nQ10 & ",'" & oCommon.FixSingleQuotes(Q001Remarks.Text) & "','" & oCommon.FixSingleQuotes(Q002Remarks.Text) & "','" & oCommon.FixSingleQuotes(Q003Remarks.Text) & "','" & oCommon.FixSingleQuotes(Q004Remarks.Text) & "','" & oCommon.FixSingleQuotes(Q005Remarks.Text) & "','" & oCommon.FixSingleQuotes(Q006Remarks.Text) & "','" & oCommon.FixSingleQuotes(Q007Remarks.Text) & "','" & oCommon.FixSingleQuotes(Q008Remarks.Text) & "','" & oCommon.FixSingleQuotes(Q009Remarks.Text) & "','" & oCommon.FixSingleQuotes(Q010Remarks.Text) & "'," & nTotalMark & ")"
        strRet = oCommon.ExecuteSQL(strSQL)
        If strRet = "0" Then
            lblMsgTop.Text = "Rekod berjaya dikemaskini."
            lblMsg.Text = "Rekod berjaya dikemaskini."
