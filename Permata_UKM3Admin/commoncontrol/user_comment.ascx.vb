...
Partial Public Class user_comment
    ...
    Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSubmit.Click
        strSQL = "INSERT INTO user_comment (user_postid,Message,PostBy) VALUES (" & oCommon.FixSingleQuotes(Request.QueryString("postid")) & ",'" & oCommon.FixSingleQuotes(txtMessage.Text) & "','" & CType(Session.Item("permata_admin"), String) & "')"
