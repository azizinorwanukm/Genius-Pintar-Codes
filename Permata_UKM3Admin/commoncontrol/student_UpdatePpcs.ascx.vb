...
Public Class student_UpdatePpcs
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "select distinct instruktorExam_result.instruktorExam_id,student_info.std_ID,student_info.student_Name,student_info.student_ID,student_info.student_Mykad,student_info.student_FonNo,config_question.Question_year,student_info.Ppcs_update from student_info 
        ...
        strWhere += " where student_info.std_ID is not null and student_info.Ppcs_update = 'Y' and instruktorExam_result.instruktorExam_type = '" & getUserProfile_UserType() & "'"
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        Dim marksid As String = datRespondent.DataKeys(e.NewSelectedIndex).Values("instruktorExam_id").ToString()
        ...
        Try
            Select Case getUserProfile_UserType()
                Case "Instruktor PPCS"
                    Response.Redirect("ukm3_ppcs.updatemarkah.aspx?studentid=" & encrypt_stdid & "&totalmarksid=" & marksid)
                Case Else
