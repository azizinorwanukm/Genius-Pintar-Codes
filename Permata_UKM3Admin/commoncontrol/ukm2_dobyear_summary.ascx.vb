...
Partial Public Class ukm2_dobyear_summary
    ...
    Private Function BindData(ByVal gvTable As GridView) As Boolean
        ...
        tmpSQL = "select SUM(Jumlah) totalStudent
                  FROM(SELECT master_dobyear.DOB_Year,(SELECT COUNT(*) FROM UKM2 
LEFT OUTER JOIN StudentSchool ON UKM2.StudentID=StudentSchool.StudentID and StudentSchool.IsLatest='Y'
LEFT JOIN schoolprofile on studentschool.schoolID=schoolprofile.schoolID WHERE UKM2.DOB_Year=master_dobyear.DOB_Year" & strWhereIn & ") as Jumlah FROM master_dobyear"
