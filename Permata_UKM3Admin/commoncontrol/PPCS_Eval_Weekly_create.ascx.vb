...
Partial Public Class PPCS_Eval_Weekly_create1
    ...
    Private Function ppcs_eval_insert() As Boolean
        ...
        strSQL = "INSERT INTO ppcs_eval_weekly (StudentID,DateCreated,CreateBy,PPCSDate,ClassCode,ClassID,LastUpdate,Q001Remarks,Q002Remarks,Q003Remarks) Values ('" & Request.QueryString("studentid") & "','" & oCommon.getToday & "','" & Server.HtmlEncode(CType(Session.Item("permata_admin"), String)) & "','" & Request.QueryString("ppcsdate") & "','" & strClassCode & "'," & Request.QueryString("classid") & ",'" & oCommon.getNow & "','" & oCommon.FixSingleQuotes(Q001Remarks.Text) & "','" & oCommon.FixSingleQuotes(Q002Remarks.Text) & "','" & oCommon.FixSingleQuotes(Q003Remarks.Text) & "')"
        strRet = oCommon.ExecuteSQL(strSQL)
        If strRet = "0" Then
            lblMsgTop.Text = "Rekod berjaya dikemaskini."
            lblMsg.Text = "Rekod berjaya dikemaskini."
