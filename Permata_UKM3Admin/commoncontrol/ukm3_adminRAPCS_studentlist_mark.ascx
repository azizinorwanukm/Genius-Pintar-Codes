<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ukm3_adminRAPCS_studentlist_mark.ascx.vb" Inherits="permatapintar.ukm3_adminRAPCS_studentlist_mark_ascx" %>
            ...
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Status Penilaian">
                        <ItemTemplate>
                            <asp:Label ID="Kpp_update" runat="server" Text='<%# Bind("Rapcs_update") %>'></asp:Label>
                        </ItemTemplate>
                         <HeaderStyle HorizontalAlign="Left" VerticalAlign="Top" />
                        <ItemStyle VerticalAlign="Middle" />
                    </asp:TemplateField>
