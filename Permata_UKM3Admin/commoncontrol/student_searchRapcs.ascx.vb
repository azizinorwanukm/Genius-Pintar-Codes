...
Public Class student_searchRapcs
    ...
    Private Function getSQL() As String
        ...
        tmpSQL += "CASE WHEN A.Rapcs_update = 'Y' THEN 'Penilaian Sudah Dilakukan' ELSE 'Tiada Simpanan' END Rapcs_update "
        ...
        If Not txtsearch.Text.Length = 0 Then
            ...
            strWhere += " OR student_Mykad LIKE '%" & txtsearch.Text & "%')"
        End If
        ...
        Try
            Select Case getUserProfile_UserType()
                Case "Instruktor Ra PPCS"
                    Response.Redirect("ukm3_Rapcs.masukmarkah.aspx?studentid=" & encyptid & "&rapcs_update=" & rapcs_status.Text)
                Case Else
