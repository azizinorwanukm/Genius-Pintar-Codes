...
Partial Public Class ppcs_student_list_sub
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT a.StudentID,b.StudentFullname,b.MYKAD,b.AlumniID,b.DOB_Year,b.StudentRace,b.StudentReligion,b.StudentCity,b.StudentState,a.PPCSStatus,a.StatusTawaran FROM PPCS a, StudentProfile b"
        strWhere = " WITH (NOLOCK) WHERE a.StudentID=b.StudentID AND a.PPCSDate='" & ddlPPCSDate.Text & "'"
        ...
        If Not ddlPPCSStatus.Text = "ALL" Then
            strWhere += " AND a.PPCSStatus ='" & ddlPPCSStatus.Text & "'"
        End If
    ...
    Private Function SQLExportData(ByVal dsTable As DataSet) As String
        ''-Dim strFilename As String = Server.MapPath(".") & "log\" & "Export." & oCommon.getRandom & ".txt"
        Dim strFilename As String = "PPCS_Student_A" & oCommon.getRandom & ".txt"
    ...
    Private Function getSQLExport() As String
        ...
        tmpSQL = "SELECT a.StudentID,b.StudentFullname,b.MYKAD,b.DOB_Year,b.StudentRace,b.StudentReligion,b.StudentCity,b.StudentState,b.AlumniID,a.PPCSStatus,a.StatusTawaran FROM PPCS a, StudentProfile b"
        strWhere = " WITH (NOLOCK) WHERE a.StudentID=b.StudentID AND a.PPCSDate='" & ddlPPCSDate.Text & "'"
