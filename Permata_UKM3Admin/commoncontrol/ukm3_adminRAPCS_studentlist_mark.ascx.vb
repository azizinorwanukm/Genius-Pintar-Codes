...
Public Class ukm3_adminRAPCS_studentlist_mark_ascx
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT D.id,A.student_Name,A.student_Mykad,B.AlumniID,E.ClassCode,C.ClassID,C.CourseID,H.SchoolID,G.staff_name as staff_name
                ,CASE WHEN D.rapcs_pengesahan = 'Y' THEN 'Lengkap' ELSE 'Tidak lengkap' END Rapcs_update,
                CASE WHEN M.isSokong = 'Y' THEN 'Sokong' WHEN M.isSokong = 'N' THEN 'Tidak sokong' ELSE 'Belum disemak' END isSokong,
                convert(decimal(5,2),round(M.instruktorExam_marks*100/150,2)) instruktorExam_marks , convert(varchar, M.dateValid, 0) dateValid
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Try
            Select Case getUserProfile_UserType()
                Case "Admin"
                    Response.Redirect("ukm3_Rapcs.updatemarkah.aspx?studentid=" & encryptid & "&classid=" & encryptClass & "&courseid=" & encryptCourse & "&schoolid=" & encryptSchool)
                Case Else
    ...
    Private Sub btnResetDir_Click(sender As Object, e As EventArgs) Handles btnResetDir.Click
        Response.Redirect("ukm3_adminRaPPCS_resetPenilaian.aspx")
    End Sub
End Class
