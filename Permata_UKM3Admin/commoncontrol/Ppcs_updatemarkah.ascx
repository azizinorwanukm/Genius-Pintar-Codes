<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Ppcs_updatemarkah.ascx.vb" Inherits="permatapintar.Ppcs_updatemarkah" %>
<style type="text/css">
    .auto-style1 {
        height: 10px;
    }
    ...
    <tr>
        <td>
            <asp:GridView ID="datrespondent_komunikasi" runat="server" AutoGenerateColumns="False"
                CellPadding="4" ForeColor="#333333" GridLines="None" DataKeyNames="insMarkList_id"
                Width="100%" CssClass="gridview_footer">
                <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                <Columns>
                    <asp:TemplateField HeaderText="#">
