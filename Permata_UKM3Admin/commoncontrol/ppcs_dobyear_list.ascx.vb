...
Public Class ppcs_dobyear_list
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                lblUmur.Text = nAge.ToString & " Tahun"
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT b.StudentID,b.StudentFullname,b.MYKAD,b.AlumniID,b.DOB_Year,b.StudentRace,a.PPCSStatus FROM PPCS a,StudentProfile b WHERE a.StudentID=b.StudentID"
        ...
        If Not Request.QueryString("ppcsstatus") = "ALL" Then
            strWhere += " AND a.PPCSStatus='" & Request.QueryString("ppcsstatus") & "'"
        End If
