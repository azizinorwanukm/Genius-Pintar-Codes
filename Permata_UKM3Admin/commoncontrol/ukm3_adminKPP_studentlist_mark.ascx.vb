...
Class ukm3_adminKPP_studentlist_mark
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT D.id,A.student_Name,A.student_Mykad,B.AlumniID,E.ClassCode,C.ClassID,C.CourseID,H.SchoolID,G.staff_name as staff_name
                ,CASE WHEN D.kpp_pengesahan = 'Y' THEN 'Lengkap' ELSE 'Tidak lengkap' END Kpp_update,
                CASE WHEN F.isSokong_kpp = 'Y' THEN 'Sokong' WHEN F.isSokong_kpp = 'N' THEN 'Tidak sokong' ELSE 'Belum disemak' END isSokong_kpp,
                convert(decimal(5,2),round(M.instruktorExam_marks*100/140,2)) instruktorExam_marks , convert(varchar, M.dateValid, 0) dateValid
                from UKM3 D     
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Try
            Select Case getUserProfile_UserType()
                Case "Admin"
                    Response.Redirect("kpp_studentlist_checklist_update.aspx?studentid=" & encryptid & "&classid=" & encryptClass & "&courseid=" & encryptCourse & "&schoolid=" & encryptSchool)
    ...
    Private Sub btnResetDir_Click(sender As Object, e As EventArgs) Handles btnResetDir.Click
        Response.Redirect("ukm3_adminKPP_resetPenilaian.aspx")
    End Sub
End Class
