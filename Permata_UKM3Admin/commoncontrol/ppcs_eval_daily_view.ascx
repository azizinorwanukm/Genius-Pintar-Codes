<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ppcs_eval_daily_view.ascx.vb" Inherits="permatapintar.ppcs_eval_daily_view1" %>

<table class="fbform">
    <tr class="fbform_header">
        <td class="fbsection_sap" colspan="2">LAPORAN HARIAN. Tarikh Pilihan:<asp:Label ID="lblSelectedDate" runat="server" Text=""></asp:Label>&nbsp;
            <asp:Label ID="lblMsgTop" runat="server" Text="" ForeColor="Red" Visible="false"></asp:Label>
        </td>
        <td>
            <asp:LinkButton ID="lnkStudentProfileView" runat="server">Maklumat Pelajar</asp:LinkButton></td>
    </tr>
    <tr>
        <td colspan="3">
            Pilih Tarikh:<asp:ImageButton ID="btnDate" runat="server" ImageUrl="~/img/cal.jpg" AlternateText=".." Width="15" Height="15" />
            <asp:Calendar ID="calDate" runat="server" Visible="false" BackColor="White"></asp:Calendar>&nbsp;
    ...
    <tr>
        ...
        <td>Catatan (500 aksara sahaja):<br />
