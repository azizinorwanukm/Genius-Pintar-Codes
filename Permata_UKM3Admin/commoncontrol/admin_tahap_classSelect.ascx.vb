...
Public Class admin_tahap_classSelect
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT B.id,C.StudentFullname student_Name,C.MYKAD student_Mykad , C.StudentGender as Jantina ,C.AlumniID,Y.ClassCode as classcode,
                    ...
                    I.TotalPercentage as ukm2TotalPercentage,B.markPretest as pretest,B.markPosttest as posttest,(B.markPosttest-B.markPretest) as difference,
            ...
            If chkUpdate IsNot Nothing Then
                ...
                If chkUpdate.Checked = True Then
                    ...
                    If ddl_kelayakan.SelectedValue = "L1" Then
                        strSQL += " UPDATE permatapintar.dbo.ukm3 SET Program = 'TAHAP 1', PPMT = 'Y' WHERE UKM3ID = '" & ukm3id & "'"
                    Else
                        strSQL += " UPDATE permatapintar.dbo.ukm3 SET Program = null, PPMT = 'N' WHERE UKM3ID = '" & ukm3id & "'"
                    End If
    ...
    Private Sub setDdlClass()
        ...
        query += " WHERE D.active = 1 AND D.session_id = " & ddlSession.SelectedValue & " AND N.CourseType = 'SECONDARY'  GROUP BY A.ClassID) M  "
    ...
    Private Sub ExportToCSV(ByVal strQuery As String)
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Kelayakan_Tahap1.csv")
        Response.Charset = ""
