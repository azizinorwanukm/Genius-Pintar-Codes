...
Partial Public Class userprofile_master
    ...
    Private Sub UserProfile_load()
        Try
            ...
            ''Response.Write("loginid:" & Server.HtmlEncode(CType(Session.Item("permata_admin"), String)))

            strSQL = "SELECT Fullname FROM UserProfile WHERE loginid='" & Server.HtmlEncode(CType(Session.Item("permata_admin"), String)) & "'"
            lblFullname.Text = oCommon.getFieldValue(strSQL)
            lblLoginID.Text = CType(Session.Item("permata_admin"), String)
