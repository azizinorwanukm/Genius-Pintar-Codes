...
Public Class ppcs_course_view
    ...
    Private Sub Load_courseDetails(ByVal strValue As String)
        ...
        strSQL = "SELECT A.CourseCode FROM permatapintar.dbo.ppcs_course A WHERE A.CourseID=" & strCourseID
        txtCourseCode.Text = oCommon.getFieldValue(strSQL)

        strSQL = "SELECT A.CourseNameBM FROM permatapintar.dbo.ppcs_course A WHERE A.CourseID=" & strCourseID
