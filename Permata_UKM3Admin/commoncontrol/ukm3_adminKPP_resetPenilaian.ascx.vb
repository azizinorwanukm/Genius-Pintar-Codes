...
Public Class ukm3_adminKPP_resetPenilaian
    ...
    Private Sub setDDLInstruktor()
        ...
        Dim query As String = "SELECT Distinct G.staff_name as staff_name,G.stf_id 
				...
				where G.staff_name is not null AND D.session_id = " & ddlSesi.SelectedValue
        Dim strconn As String = ConfigurationManager.AppSettings("ConnectionUkm")
    ...
    Private Sub btnConfirm_Click(sender As Object, e As EventArgs) Handles btnConfirm.Click
        strSQL = "UPDATE ukm3.dbo.UKM3 SET kpp_pengesahan = null, kpp_datePengesahan = null where kpp_stf = '" & ddlNamaInstruktor.SelectedValue & "'"
