...
Partial Public Class ukm2_select
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT UKM2.StudentID,StudentProfile.MYKAD,StudentProfile.AlumniID,StudentProfile.StudentFullname,StudentProfile.DOB_Year,StudentProfile.StudentEmail,StudentProfile.StudentState,SchoolProfile.SchoolID,SchoolProfile.SchoolCode,SchoolProfile.Schoolname,SchoolProfile.SchoolPPD,SchoolProfile.Schoolcity,SchoolProfile.SchoolState,UKM2.ExamYear,UKM2.SessiUKM2,UKM2.TarikhUjian,UKM2.IsHadir,UKM2.IsLogin,UKM2.flag,ParentProfile.FamilyContactNo,ParentProfile.FatherFullname,PusatUjian.PusatCode,PusatUjian.PusatName,PusatUjian.PusatCity,PusatUjian.PusatState FROM UKM2"
        ...
        If chkNull.Checked = True Then
            strWhere += " AND UKM2.PusatCode IS NULL"
        End If

        '--flag
        If Not flag.Value = "ALL" Then
            strWhere += " AND UKM2.flag='" & flag.Value & "'"
        End If
