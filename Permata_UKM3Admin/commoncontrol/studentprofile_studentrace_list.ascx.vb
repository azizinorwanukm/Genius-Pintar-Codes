...
Public Class studentprofile_studentrace_list
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT UKM1.StudentID,UKM1.ExamEnd,UKM1.ExamStart,StudentProfile.Studentfullname,StudentProfile.MYKAD,StudentProfile.AlumniID,StudentProfile.DOB_Year,UKM1.Status,UKM1.Lastpage,UKM1.QuestionYear,UKM1.SchoolState,SchoolProfile.SchoolCode,SchoolProfile.Schoolname FROM UKM1"
