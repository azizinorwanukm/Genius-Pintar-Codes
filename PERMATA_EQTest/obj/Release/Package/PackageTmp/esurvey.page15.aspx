<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/main.Master" CodeBehind="esurvey.page15.aspx.vb" Inherits="PERMATA_EQTest.esurvey_page15" %>
        ...
        <tr>
            ...
            <td>
                <applet name="mymaze" code="Maze.class" codebase="MazeJava" width="400" height="300"
                                ...
                                <param name="num_columns" value="6" />
