<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/main.Master" CodeBehind="esurvey.page16.aspx.vb" Inherits="PERMATA_EQTest.esurvey_page16" %>
        ...
        <tr>
            ...
            <td>
                <applet name="mymaze" code="Maze.class" codebase="MazeJava" width="400" height="300"
                                ...
                                <param name="num_rows" value="7" />
                                <param name="num_columns" value="7" />
