<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/main.Master" CodeBehind="esurvey.page19.aspx.vb" Inherits="PERMATA_EQTest.esurvey_page19" %>
        ...
        <tr>
            ...
            <td>
                <applet name="mymaze" code="Maze.class" codebase="MazeJava" width="400" height="300"
                                ...
                                <param name="num_rows" value="13" />
                                <param name="num_columns" value="13" />
