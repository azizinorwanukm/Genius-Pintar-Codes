<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/main.Master"
    CodeBehind="esurvey.page02.aspx.vb" Inherits="PERMATA_EQTest.esurvey_page02" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table id="mycustomtable">
        ...
        <tr>
            ...
            <td>
                <asp:Image ID="img01" runat="server" Width="150px" Height="120px" ImageUrl="img/Face1.jpg" ImageAlign="AbsBottom"></asp:Image><br />
                <br />
        ...
        <tr class="alt">
            ...
            <td>
                <asp:Image ID="img02" runat="server" Width="150px" Height="120px" ImageUrl="img/Face2.jpg" ImageAlign="AbsBottom"></asp:Image><br />
                <br />
        ...
        <tr>
            ...
            <td>
                <asp:Image ID="img03" runat="server" Width="150px" Height="120px" ImageUrl="img/Face3.jpg" ImageAlign="AbsBottom"></asp:Image><br />
                <br />
        ...
        <tr class="alt">
            ...
            <td>
                <asp:Image ID="img04" runat="server" Width="150px" Height="120px" ImageUrl="img/Face4.jpg" ImageAlign="AbsBottom"></asp:Image><br />
                <br />
        ...
        <tr>
            ...
            <td>
                <asp:Image ID="img05" runat="server" Width="150px" Height="120px" ImageUrl="img/Face5.jpg" ImageAlign="AbsBottom"></asp:Image><br />
                <br />
