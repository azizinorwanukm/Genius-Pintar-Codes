...
Partial Public Class ukm1_modE_page03
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If oCommon.isAnswered("Q050", Request.QueryString("studentid"), oCommon.getAppsettings("UKM1ExamYear")) = False Then
                SavePage()
            End If
    ...
    Private Sub SavePage()
        ...
        'update MARK
        strSQL = "UPDATE UKM1 WITH (ROWLOCK) SET Q050=" & nMark & ",LastPage='ukm1.modE.page03.aspx?',ExamEnd='" & oCommon.getNow & "',WrongCounter=" & nWrongCounter.ToString & " WHERE StudentID='" & Request.QueryString("studentid") & "' AND ExamYear='" & oCommon.getAppsettings("UKM1ExamYear") & "'"
        ...
        'update ANSWER
        strSQL = "UPDATE UKM1_Answer WITH (ROWLOCK) SET Q050='" & strAns & "' WHERE StudentID='" & Request.QueryString("studentid") & "' AND ExamYear='" & oCommon.getAppsettings("UKM1ExamYear") & "'"
        strRet = oCommon.ExecuteSQL(strSQL)
        If Not strRet = "0" Then
            lblMsg.Text = strRet
        End If
    ...
    Private Sub LoadImages(ByVal strSet As String)
        Image0.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/E3.0.gif"
        Image1.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/E3.1.gif"
        Image2.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/E3.2.gif"
        Image3.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/E3.3.gif"
        Image4.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/E3.4.gif"
        Image5.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/E3.5.gif"
        Image6.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/E3.6.gif"
        Image7.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/E3.7.gif"
        Image8.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/E3.8.gif"
    ...
    Private Sub LoadStrings(ByVal ci As CultureInfo)
        ...
        strSystemAns = rm.GetString("A050", ci)
