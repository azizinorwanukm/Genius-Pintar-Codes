<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ukm1.main.Master"
    CodeBehind="ukm1.modD.page05.aspx.vb" Inherits="permatapintar.ukm1_modD_page05"
    Title="" %>
        ...
        <tr>
            ...
            <td style="vertical-align: top;">
                <table class="fbgreybox" width="100%" border="0px">
                    ...
                    <tr>
                        <td>
                            <a id="A1" href="ukm1.modD.page06.aspx?ans=1&lang=<%=Request.QueryString("lang") %>&studentid=<%=Request.QueryString("studentid") %>">
                                <asp:Image ID="Image1" runat="server" AlternateText="images" BorderStyle="Solid"
                                    BorderWidth="0px" BorderColor="Black" /></a>
                        </td>
                        <td>
                            <a id="A2" href="ukm1.modD.page06.aspx?ans=2&lang=<%=Request.QueryString("lang") %>&studentid=<%=Request.QueryString("studentid") %>">
                    ...
                    <tr>
                        <td>
                            <a id="A3" href="ukm1.modD.page06.aspx?ans=3&lang=<%=Request.QueryString("lang") %>&studentid=<%=Request.QueryString("studentid") %>">
                                <asp:Image ID="Image3" runat="server" AlternateText="images" BorderStyle="Solid"
                                    BorderWidth="0px" BorderColor="Black" /></a>
                        </td>
                        <td>
                            <a id="A4" href="ukm1.modD.page06.aspx?ans=4&lang=<%=Request.QueryString("lang") %>&studentid=<%=Request.QueryString("studentid") %>">
                    ...
                    <tr>
                        <td>
                            <a id="A5" href="ukm1.modD.page06.aspx?ans=5&lang=<%=Request.QueryString("lang") %>&studentid=<%=Request.QueryString("studentid") %>">
                                <asp:Image ID="Image5" runat="server" AlternateText="images" BorderStyle="Solid"
                                    BorderWidth="0px" BorderColor="Black" /></a>
                        </td>
                        <td>
                            <a id="A6" href="ukm1.modD.page06.aspx?ans=6&lang=<%=Request.QueryString("lang") %>&studentid=<%=Request.QueryString("studentid") %>">
                    ...
                    <tr>
                        <td>
                            <a id="A7" href="ukm1.modD.page06.aspx?ans=7&lang=<%=Request.QueryString("lang") %>&studentid=<%=Request.QueryString("studentid") %>">
                                <asp:Image ID="Image7" runat="server" AlternateText="images" BorderStyle="Solid"
                                    BorderWidth="0px" BorderColor="Black" /></a>
                        </td>
                        <td>
                            <a id="A8" href="ukm1.modD.page06.aspx?ans=8&lang=<%=Request.QueryString("lang") %>&studentid=<%=Request.QueryString("studentid") %>">
