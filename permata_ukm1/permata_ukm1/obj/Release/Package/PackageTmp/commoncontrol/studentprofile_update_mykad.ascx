...
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Kemaskini Maklumat Pelajar
        </td>
    </tr>
    <tr>
        <td>Gambar
            ...
            <table>
                ...
                <tr>
                    <td>
                        ...
                        <asp:Button ID="btnUpload" runat="server" Text="Muatnaik Gambar" CssClass="fbbutton" />&nbsp;*[Terhad kepada < 1024KB sahaja.]&nbsp;<asp:Label ID="lblFilesize" runat="server" CssClass="fblabel_msg" Text=""></asp:Label>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        <td style="width: 20%;">MYKAD/MYKID#</td>
        <td>
            : <asp:TextBox ID="txtMYKAD" runat="server" Width="300px" MaxLength="50"></asp:TextBox>&nbsp;*&nbsp;[Contoh:020820086011.
    ...
    <tr>
        <td>Nama Penuh</td>
        <td>
            : <asp:TextBox ID="txtStudentFullname" runat="server" Width="300px" MaxLength="250"></asp:TextBox>&nbsp;*&nbsp;
        </td>
    </tr>
    <tr>
        <td>Jantina</td>
        <td>
            : <select name="selStudentGender" id="selStudentGender" style="width: 300px;" runat="server">
    ...
    <tr>
        ...
        <td>
            ...
            <asp:DropDownList ID="ddlDobYear" runat="server" Width="95px">
            </asp:DropDownList>&nbsp;*
        </td>
    </tr>
    <tr>
        <td>Darjah/Tingkatan</td>
        <td>
            : <select name="selStudentForm" id="selStudentForm" style="width: 200px;" runat="server" onchange="GetSelectedTextValue(this)">
                <option value="" selected="selected"></option>
    ...
    <tr>
        ...
        <td>
            : 
            <asp:DropDownList ID="ddlRace" runat="server" Width="200px"></asp:DropDownList>
            &nbsp;*&nbsp;Agama:&nbsp;
            <asp:DropDownList ID="ddlReligion" runat="server" Width="200px"></asp:DropDownList>
            &nbsp;*&nbsp;
        </td>
    </tr>
    <tr>
        <td style="text-align: left; vertical-align: top;">Kebolehan Berbahasa</td>
        <td>
            <table class="fbform">
                <tr>
    ...
    <tr>
        ...
        <td>
            ...
            Bandar:<asp:TextBox ID="txtStudentCity" runat="server" Width="350px" MaxLength="150"></asp:TextBox>&nbsp;*
        </td>
    </tr>
    <tr>
        <td>Negeri</td>
        <td>
            : <select name="selStudentState" id="selStudentState" style="width: 250px;" runat="server">
                <option value=""></option>
    ...
    <tr>
        <td>Tel#</td>
        <td>
            : <asp:TextBox ID="txtStudentContactNo" runat="server" Width="250px" MaxLength="250"></asp:TextBox>&nbsp;[Telefon untuk dihubungi mengenai status PERMATApintar.]
        </td>
    </tr>
    <tr>
        <td>
            Kecenderungan program
        </td>
        <td>
