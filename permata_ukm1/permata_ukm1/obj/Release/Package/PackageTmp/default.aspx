<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ukm1.default.Master" CodeBehind="default.aspx.vb" Inherits="permatapintar.default_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <tr >
            ...
            <td style="vertical-align: top; text-align: left; width: 20%;" rowspan="4">
                <table style="border: 1px solid #dd3c10;">
                    ...
                    <tr>
                        <td>
                            <a href="pic/permata2019-process.png" target="_blank">
                                <img src="pic/permata2019-process-small.png" width="250px" height="176px" alt="permata-process" /></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            ...
                            <table style="width: 100%; text-align: left; vertical-align: top; border: none 0px;">
                                ...
                                <tr class="fbnav_items">
                                    ...
                                    <td class="fbnav_items">
                                        <img style="vertical-align: middle;" src="icons/friend.png" width="16px" height="16px" alt="::" />
                                        <a href="public.ukm1.kodsekolah.summary.aspx" target="_blank">Ringkasan Ujian Mengikut Kod Sekolah</a>
                                    </td>
                                </tr>
                                <tr class="fbnav_items">
                                    <td style="width: 1%;"></td>
    ...
    <asp:Label ID="lblDebug" runat="server" Text=""></asp:Label>
     <div id="dialog-message" title="MAKLUMAN PENTING" style="background-color: #810000; color:#E6E6E6; width:400px; " >
        <p>
           Jika terdapat sebarang masalah, pihak tuan/puan boleh terus emailkan ke :
        </p>
        <p>
           <%--<b><u>permatapintar@ukm.edu.my</u></b>--%> 
           <b><u>permatapintar@km.edu.my</u></b> 
        </p>
    </div>
</asp:Content>
