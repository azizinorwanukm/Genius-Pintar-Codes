<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ukm1.default.Master" CodeBehind="default.01.aspx.vb" Inherits="permatapintar.default_011" %>
    ...
    <table class="fbform">
        ...
        <tr>
            <td>*MYKAD/MYKID#:
                    ...
                    <asp:Label ID="lblMsg" runat="server" CssClass="labelMsgRed" Text="[12 digit tanpa tanda '-']"></asp:Label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="fbform_sap" style="color:red;">* Jika MYKAD/MYKID# yang sudah didaftarkan sebelum ini mempunyai bukan nombor yg betul, sila emel permatapintar@ukm.edu.my  dengan memberi nombor yang betul  untuk mykid/kad pelajar dan mykad ibu dan bapa.
            </td>
        </tr>
        <tr>
            <td>
