...
Partial Public Class default_01
    ...
    Private Function isExamEnd() As Boolean
        ...
        Dim getEndDate As String = "Select configString from master_Config where configCode = 'UKM1END'"
        Dim EndDate As String = oCommon.getFieldValue(getEndDate)

        ''--exam END
        Dim strUKM1END As String = EndDate 'YYYYMMDD 20161130 - 20160914
