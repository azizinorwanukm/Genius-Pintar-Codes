...
<table class="fbform">
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtMYKAD" runat="server" Width="250px" MaxLength="20" ReadOnly="true"
                BackColor="#CCCCCC"></asp:TextBox>&nbsp;*&nbsp;[Contoh:020820086011. Tanpa "-"
            atau ruang kosong]<br />
    ...
    <tr>
        <td>Negara:</td>
        <td><asp:DropDownList ID="ddlCountry" runat="server" Width="250px">
        </asp:DropDownList></td>
    </tr>
    <tr>
        <td>Email:
        ...
        <td>
            <asp:TextBox ID="txtStudentEmail" runat="server" Width="250px" MaxLength="250"></asp:TextBox>&nbsp;*&nbsp;[Keputusan
            kelayakan ke Ujian UKM2 dan PPCS akan di hantar ke email ini.]
        </td>
    </tr>
    <tr>
        <td>Tel#:
