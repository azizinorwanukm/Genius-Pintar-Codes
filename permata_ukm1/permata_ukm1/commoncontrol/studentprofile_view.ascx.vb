...
Partial Public Class studentprofile_view1
    ...
    Private Sub LoadPage()
        strSQL = "SELECT A.*, B.kecenderungan cenderung FROM StudentProfile A WITH (NOLOCK) "
        strSQL += " LEFT JOIN master_cenderung B ON A.Kecenderungan = B.id "
        ...
        Try
            ...
            If MyTable.Rows.Count > 0 Then
                ...
                If Not IsDBNull(ds.Tables(0).Rows(0).Item("StudentForm")) Then
                    lblStudentForm.Text = Trim(ds.Tables(0).Rows(0).Item("StudentForm"))
                Else
                    lblStudentForm.Text = ""
                End If
