...
Partial Public Class Parentprofile_update
    ...
    Private Function Parentprofile_update() As String
        strSQL = "UPDATE ParentProfile SET IsUpdated='Y',FatherMYKADNo='" & oCommon.FixSingleQuotes(txtFatherMYKADNo.Text) & "',FatherFullname='" & oCommon.FixSingleQuotes(txtFatherFullname.Text.ToUpper) & "',FatherJob='" & oCommon.FixSingleQuotes(txtFatherJob.Text.ToUpper) & "',MotherMYKADNo='" & oCommon.FixSingleQuotes(txtMotherMYKADNo.Text) & "',MotherFullname='" & oCommon.FixSingleQuotes(txtMotherFullname.Text.ToUpper) & "',MotherJob='" & oCommon.FixSingleQuotes(txtMotherJob.Text.ToUpper) & "',FamilyContactNo='" & oCommon.FixSingleQuotes(txtFamilyContactNo.Text) & "' WHERE StudentID='" & Request.QueryString("studentid") & "'"
