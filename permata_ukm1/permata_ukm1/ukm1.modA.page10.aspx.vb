...
Partial Public Class ukm1_modA_page10
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If oCommon.isAnswered("Q009", Request.QueryString("studentid"), oCommon.getAppsettings("UKM1ExamYear")) = False Then
                SavePage()
            End If
    ...
    Private Sub SavePage()
        ...
        'update MARK
        strSQL = "UPDATE UKM1 WITH (ROWLOCK) SET Q009=" & nMark & ",LastPage='ukm1.modA.page10.aspx?',ExamEnd='" & oCommon.getNow & "',WrongCounter=" & nWrongCounter.ToString & " WHERE StudentID='" & Request.QueryString("studentid") & "' AND ExamYear='" & oCommon.getAppsettings("UKM1ExamYear") & "'"
        ...
        'update ANSWER
        strSQL = "UPDATE UKM1_Answer WITH (ROWLOCK) SET Q009='" & strAns & "' WHERE StudentID='" & Request.QueryString("studentid") & "' AND ExamYear='" & oCommon.getAppsettings("UKM1ExamYear") & "'"
        strRet = oCommon.ExecuteSQL(strSQL)
        If Not strRet = "0" Then
            lblMsg.Text = strRet
        End If
    ...
    Private Sub LoadImages(ByVal strSet As String)
        Image0.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/A10.0.gif"
        Image1.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/A10.1.gif"
        Image2.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/A10.2.gif"
        Image3.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/A10.3.gif"
        Image4.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/A10.4.gif"
        Image5.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/A10.5.gif"
        Image6.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/A10.6.gif"
    ...
    Private Sub LoadStrings(ByVal ci As CultureInfo)
        ...
        strSystemAns = rm.GetString("A009", ci)
