...
Partial Public Class ukm1_modA_page02
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            '--check if user answer before. If NOT. Save it
            If oCommon.isAnswered("Q001", Request.QueryString("studentid"), oCommon.getAppsettings("UKM1ExamYear")) = False Then
                SavePage()
            End If
            ...
            If oCommon.getFieldValueInt(strSQL) > 2 Then
                Response.Redirect("ukm1.modB.page01.aspx?ans=0&lang=" & Request.QueryString("lang") & "&studentid=" & Request.QueryString("studentid"), False)
            End If
    ...
    Private Sub LoadStrings(ByVal ci As CultureInfo)
        ...
        strSystemAns = rm.GetString("A001", ci)

    End Sub

    Private Function SavePage() As Boolean

        'save previous page answer and marks
        ...
        'update MARK
        strSQL = "UPDATE UKM1 WITH (ROWLOCK) SET Q001=" & nMark & ",LastPage='ukm1.modA.page02.aspx?',ExamEnd='" & oCommon.getNow & "',WrongCounter=" & nWrongCounter.ToString & " WHERE StudentID='" & Request.QueryString("studentid") & "' AND ExamYear='" & oCommon.getAppsettings("UKM1ExamYear") & "'"
        ...
        'update ANSWER
        strSQL = "UPDATE UKM1_Answer WITH (ROWLOCK) SET Q001='" & strAns & "' WHERE StudentID='" & Request.QueryString("studentid") & "' AND ExamYear='" & oCommon.getAppsettings("UKM1ExamYear") & "'"
        strRet = oCommon.ExecuteSQL(strSQL)
        If Not strRet = "0" Then
            lblMsg.Text = strRet
            Return False
    ...
    Private Sub LoadImages(ByVal strSet As String)
        Image0.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/A2.0.gif"
        Image1.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/A2.1.gif"
        Image2.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/A2.2.gif"
        Image3.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/A2.3.gif"
        Image4.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/A2.4.gif"
        Image5.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/A2.5.gif"
        Image6.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/A2.6.gif"
