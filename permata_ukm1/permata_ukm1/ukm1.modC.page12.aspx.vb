...
Partial Public Class ukm1_modC_page12
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If oCommon.isAnswered("Q035", Request.QueryString("studentid"), oCommon.getAppsettings("UKM1ExamYear")) = False Then
                SavePage()
            End If
            ...
            If oCommon.getFieldValueInt(strSQL) > 2 Then
                Response.Redirect("ukm1.modD.page01.aspx?ans=0&lang=" & Request.QueryString("lang") & "&studentid=" & Request.QueryString("studentid"), False)
            End If
    ...
    Private Sub SavePage()
        ...
        'update MARK
        strSQL = "UPDATE UKM1 WITH (ROWLOCK) SET Q035=" & nMark & ",LastPage='ukm1.modC.page12.aspx?',ExamEnd='" & oCommon.getNow & "',WrongCounter=" & nWrongCounter.ToString & " WHERE StudentID='" & Request.QueryString("studentid") & "' AND ExamYear='" & oCommon.getAppsettings("UKM1ExamYear") & "'"
        ...
        'update ANSWER
        strSQL = "UPDATE UKM1_Answer WITH (ROWLOCK) SET Q035='" & strAns & "' WHERE StudentID='" & Request.QueryString("studentid") & "' AND ExamYear='" & oCommon.getAppsettings("UKM1ExamYear") & "'"
        strRet = oCommon.ExecuteSQL(strSQL)
        If Not strRet = "0" Then
            lblMsg.Text = strRet
        End If
    ...
    Private Sub LoadImages(ByVal strSet As String)
        Image0.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/C12.0.gif"
        Image1.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/C12.1.gif"
        Image2.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/C12.2.gif"
        Image3.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/C12.3.gif"
        Image4.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/C12.4.gif"
        Image5.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/C12.5.gif"
        Image6.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/C12.6.gif"
        Image7.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/C12.7.gif"
        Image8.ImageUrl = strSet & "/" & Request.QueryString("lang") & "/img/C12.8.gif"
    ...
    Private Sub LoadStrings(ByVal ci As CultureInfo)
        ...
        strSystemAns = rm.GetString("A035", ci)
