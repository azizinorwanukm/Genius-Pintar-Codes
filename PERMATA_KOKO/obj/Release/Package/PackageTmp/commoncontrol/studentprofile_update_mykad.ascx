...
<table class="fbform">
    ...
    <tr>
        ...
        <td>Bagi pelajar berumur 8-12 tahun, nyatakan kecenderungan anda :
            <select name="selKecenderungan" id="selKecenderungan" style="width: 255px;" runat="server">
                <option value="" selected="selected">--Pilih--</option>
                <option value="PERMATApintar">PERMATApintar</option>
                <option value="PERMATA Insan">PERMATA Insan</option>
            </select>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <asp:Label ID="lblStudentType" runat="server" Text="" ForeColor="Red"></asp:Label>
        </td>
    </tr>
    ...
    <tr>
        <td style="text-align: left;" colspan="2">
            ...
            <asp:LinkButton ID="lnkStudentProfileView" runat="server" Visible="false">Maklumat Pelajar</asp:LinkButton>
        </td>
    </tr>
</table>
