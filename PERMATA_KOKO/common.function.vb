...
Public Class Commonfunction
    ...
    Public Function koko_txnlog(ByVal TxnType As String, ByVal TxnLog As String) As String
        Dim strSQL As String = ""
        Dim strRet As String = ""

        strSQL = "INSERT INTO koko_txnlog (TxnType,TxnLog) VALUES('" & TxnType & "','" & FixSingleQuotes(TxnLog) & "')"
    ...
    Public Function getFieldValueKPP(ByVal strSQL As String) As String
        If strSQL.Length = 0 Then
            Return ""
        End If

        Dim strconn As String = ConfigurationManager.AppSettings("KPPConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strconn)
        Dim sqlDA As New SqlDataAdapter(strSQL, objConn)
        Dim strFieldValue As String = ""
        Try
