...
Public Class pelajar_list
    ...
    Private Function getSQL() As String
        ...
        If Not selStatusTawaran.Value = "ALL" Then
            strWhere += " AND koko_pelajar.StatusTawaran='" & selStatusTawaran.Value & "'"
        End If
        ...
        If chkUpdated.Checked = True Then
            strWhere += " AND (koko_pelajar.UniformID IS NULL OR koko_pelajar.PersatuanID IS NULL OR koko_pelajar.SukanID IS NULL)"
        End If
    ...
    Private Sub datRespondent_SelectedIndexChanging(sender As Object, e As GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Try
            Select Case Server.HtmlEncode(Request.Cookies("koko_usertype").Value)
                Case "ADMIN"
                    Response.Redirect("admin.pelajar.view.aspx?studentid=" & strKeyID & "&pengarah_ID=" & Request.QueryString("pengarah_ID"))
                Case "INSTRUKTOR"
                    Response.Redirect("instruktor.pelajar.view.aspx?studentid=" & strKeyID & "&pengarah_ID=" & Request.QueryString("pengarah_ID"))
                Case "PENSYARAH"
                Case "PENGARAH"
                    Response.Redirect("pengarah.pelajar.view.aspx?studentid=" & strKeyID & "&pengarah_ID=" & Request.QueryString("pengarah_ID"))
                Case Else
