...
Public Class koko_pelajar_mark_sukan
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        For i As Integer = 0 To datRespondent.Rows.Count - 1
            ...
            strSQL = "UPDATE koko_pelajar SET Sukan_PencapaianP1=" & txtPencapaian.Text & ",Sukan_PenglibatanP1=" & txtPenglibatan.Text & ",Sukan_JawatanP1=" & txtJawatan.Text & ",Sukan_KehadiranP1=" & txtKehadiran.Text & " WHERE StudentID='" & datRespondent.DataKeys(i).Value.ToString & "' AND Tahun='" & Request.QueryString("tahun") & "'"
