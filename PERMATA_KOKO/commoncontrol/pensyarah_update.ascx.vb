...
Public Class pensyarah_update
    ...
    Private Sub koko_pensyarah_load()
        strSQL = "SELECT * FROM koko_pensyarah WHERE PensyarahID='" & Request.QueryString("pensyarahid") & "'"
        '--debug
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        'UPDATE
        strSQL = "UPDATE koko_pensyarah SET Tahun='" & ddlTahun.Text & "',Fullname='" & oCommon.FixSingleQuotes(txtFullname.Text.ToUpper) & "',ContactNo='" & oCommon.FixSingleQuotes(txtContactNo.Text.ToUpper) & "',Email='" & oCommon.FixSingleQuotes(txtEmail.Text) & "',MYKAD='" & oCommon.FixSingleQuotes(txtMYKAD.Text.ToUpper) & "',BankName='" & oCommon.FixSingleQuotes(txtBankName.Text.ToUpper) & "',AcctNo='" & oCommon.FixSingleQuotes(txtAcctNo.Text.ToUpper) & "',Address1='" & oCommon.FixSingleQuotes(txtAddress1.Text.ToUpper) & "',Address2='" & oCommon.FixSingleQuotes(txtAddress2.Text.ToUpper) & "',PostCode='" & oCommon.FixSingleQuotes(txtPostcode.Text.ToUpper) & "',City='" & oCommon.FixSingleQuotes(txtCity.Text.ToUpper) & "',State='" & ddlState.Text & "' WHERE PensyarahID='" & Request.QueryString("pensyarahid") & "'"
    ...
    Protected Sub lnkView_Click(sender As Object, e As EventArgs) Handles lnkView.Click
        Response.Redirect("admin.pensyarah.view.aspx?pensyarahid=" & Request.QueryString("pensyarahid"))
