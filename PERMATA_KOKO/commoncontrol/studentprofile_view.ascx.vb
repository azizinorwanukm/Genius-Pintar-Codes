...
Partial Public Class studentprofile_view1
    ...
    Private Sub lnkEdit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkEdit.Click
        ...
        Select Case Server.HtmlEncode(Request.Cookies("koko_usertype").Value)
            Case "ADMIN"
                Response.Redirect("pelajar.profil.update.aspx?studentid=" & Request.QueryString("studentid") & "&admin_ID=" & Request.QueryString("admin_ID"))
            Case "PENSYARAH"
                Response.Redirect("pengarah.pelajar.view.aspx?studentid=" & Request.QueryString("studentid") & "&stf_ID=" & Request.QueryString("stf_ID"))
            Case "PENGARAH"
                Response.Redirect("pengarah.pelajar.view.aspx?studentid=" & Request.QueryString("studentid") & "&pengarah_ID=" & Request.QueryString("pengarah_ID"))
            Case "PELAJAR"
                Response.Redirect("pelajar.profil.update.aspx?studentid=" & Request.QueryString("studentid") & "&std_ID=" & Request.QueryString("std_ID"))
        End Select
