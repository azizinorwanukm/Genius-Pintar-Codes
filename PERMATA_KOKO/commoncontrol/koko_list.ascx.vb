    ...
    Private Sub datRespondent_SelectedIndexChanging(sender As Object, e As GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Try
            Select Case Server.HtmlEncode(Request.Cookies("koko_usertype").Value)
                Case "ADMIN"
                    Response.Redirect("admin.koko.update.aspx?studentid=" & Request.QueryString("studentid") & "&tahun=" & strKeyID & "&std_ID=" & Request.QueryString("std_ID"))
                Case "INSTRUKTOR"
                Case "PENSYARAH"
                Case "PENGARAH"
                Case "PELAJAR"
                    Response.Redirect("pelajar.koko.pencapaian.update.aspx?studentid=" & Request.QueryString("studentid") & "&tahun=" & strKeyID & "&std_ID=" & Request.QueryString("std_ID"))
                Case Else
