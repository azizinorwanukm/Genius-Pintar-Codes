...
Public Class koko_pelajar_mark_uniform_p2
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        For i As Integer = 0 To datRespondent.Rows.Count - 1
            ...
            strSQL = "UPDATE koko_pelajar SET Uniform_PencapaianP2=" & txtPencapaian.Text & ",Uniform_PenglibatanP2=" & txtPenglibatan.Text & ",Uniform_JawatanP2=" & txtJawatan.Text & ",Uniform_KehadiranP2=" & txtKehadiran.Text & " WHERE StudentID='" & datRespondent.DataKeys(i).Value.ToString & "' AND Tahun='" & Request.QueryString("tahun") & "'"
        ...
        '--calculate P2
        strRet = oCommon.set_pelajar_Gred(Request.QueryString("tahun"), "P2")
        '--debug
        'Response.Write(strRet)

        strRet = oCommon.set_pelajar_Jumlah(Request.QueryString("tahun"), "P2")
        '--debug
        'Response.Write(strRet)
