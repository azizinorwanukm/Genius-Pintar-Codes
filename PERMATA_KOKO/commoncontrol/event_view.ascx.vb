    ...
    Protected Sub lnkUpdate_Click(sender As Object, e As EventArgs) Handles lnkUpdate.Click
        Try
            Select Case Server.HtmlEncode(Request.Cookies("koko_usertype").Value)
                Case "ADMIN"
                    Response.Redirect("admin.event.update.aspx?eventid=" & Request.QueryString("eventid") & "&instruktorid=" & Request.QueryString("instruktorid") & "&tahun=" & Request.QueryString("tahun"))
                Case "INSTRUKTOR"
                    Response.Redirect("instruktor.event.update.aspx?eventid=" & Request.QueryString("eventid") & "&instruktorid=" & Request.QueryString("instruktorid") & "&tahun=" & Request.QueryString("tahun"))
                Case "PENSYARAH"
                Case "PENGARAH"
                Case Else
            End Select
