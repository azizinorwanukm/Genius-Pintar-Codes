...
Public Class koko_jadual_rumahsukan
    ...
    Protected Sub lnkPersatuan_Click(sender As Object, e As EventArgs) Handles lnkPersatuan.Click
        Select Case Server.HtmlEncode(Request.Cookies("koko_usertype").Value)
            ...
            Case "INSTRUKTOR"
                Response.Redirect("instruktor.koko.jadual.persatuan.aspx")
            Case "PENSYARAH"
            Case "PENGARAH"
            Case "PELAJAR"
                Response.Redirect("pelajar.koko.jadual.persatuan.aspx")
            Case Else
    ...
    Protected Sub lnkSukan_Click(sender As Object, e As EventArgs) Handles lnkSukan.Click
        Select Case Server.HtmlEncode(Request.Cookies("koko_usertype").Value)
            ...
            Case "INSTRUKTOR"
                Response.Redirect("instruktor.koko.jadual.sukan.aspx")
            Case "PENSYARAH"
            Case "PENGARAH"
            Case "PELAJAR"
                Response.Redirect("pelajar.koko.jadual.sukan.aspx")
            Case Else
                lblMsg.Text = "Anda tiada kebenaran untuk meneruskan fungsi ini. Sila berhubung dengan admin jika ini satu kesilapan."
        End Select
    ...
    Protected Sub lnkUniform_Click(sender As Object, e As EventArgs) Handles lnkUniform.Click
        Select Case Server.HtmlEncode(Request.Cookies("koko_usertype").Value)
            ...
            Case "INSTRUKTOR"
                Response.Redirect("instruktor.koko.jadual.uniform.aspx")
            Case "PENSYARAH"
            Case "PENGARAH"
            Case "PELAJAR"
                Response.Redirect("pelajar.koko.jadual.uniform.aspx")
            Case Else
                lblMsg.Text = "Anda tiada kebenaran untuk meneruskan fungsi ini. Sila berhubung dengan admin jika ini satu kesilapan."
        End Select
