<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="koko_pelajar_mark_sukan_p1.ascx.vb" Inherits="permatapintar.koko_pelajar_mark_sukan_p1" %>
            ...
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Pencapaian">
                        <ItemTemplate>
                            <asp:TextBox ID="txtPencapaian" runat="server" Width="50px" MaxLength="3" Text='<%# Bind("Sukan_PencapaianP1", "{0:n0}")%>'></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Penglibatan">
                        <ItemTemplate>
                            <asp:TextBox ID="txtPenglibatan" runat="server" Width="50px" MaxLength="3" Text='<%# Bind("Sukan_PenglibatanP1", "{0:n0}")%>'></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Jawatan">
                        <ItemTemplate>
                            <asp:TextBox ID="txtJawatan" runat="server" Width="50px" MaxLength="3" Text='<%# Bind("Sukan_JawatanP1", "{0:n0}")%>'></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Kehadiran">
                        <ItemTemplate>
                            <asp:TextBox ID="txtKehadiran" runat="server" Width="50px" MaxLength="3" Text='<%# Bind("Sukan_KehadiranP1", "{0:n0}")%>'></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
