...
Public Class pengumuman_update
    ...
    Private Sub koko_pengumuman_load()
        strSQL = "SELECT * FROM koko_pengumuman WHERE PengumumanID=" & Request.QueryString("pengumumanid")
        '--debug
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        Try
            ...
            strSQL = "UPDATE koko_pengumuman SET Tahun='" & ddlTahun.Text & "',IsDisplay='" & selIsDisplay.Value & "',Title='" & oCommon.FixSingleQuotes(txtTitle.Text.ToUpper) & "',Body='" & oCommon.FixSingleQuotes(txtBody.Text) & "' WHERE PengumumanID=" & Request.QueryString("pengumumanid")
