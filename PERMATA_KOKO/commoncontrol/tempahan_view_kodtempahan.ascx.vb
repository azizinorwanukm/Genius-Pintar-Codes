...
Public Class tempahan_view_kodtempahan
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If Not IsPostBack Then
                lblKodTempahan.Text = Request.QueryString("kodtempahan")
    ...
    Private Sub koko_tempahandetail_load()
        ...
        strWhere = " AND a.KodTempahan='" & Request.QueryString("kodtempahan") & "'"
        ...
        Try
            ...
            If MyTable.Rows.Count > 0 Then
                ...
                '--koko_tempahan
                If Not IsDBNull(ds.Tables(0).Rows(0).Item("TempahanID")) Then
                    lblTempahanID.Text = ds.Tables(0).Rows(0).Item("TempahanID")
                Else
                    lblTempahanID.Text = ""
                End If
