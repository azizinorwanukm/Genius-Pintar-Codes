        ...
        For i = 0 To datRespondent.Rows.Count - 1 Step i + 1
            ...
            If Not chkUpdate Is Nothing Then
                If chkUpdate.Checked = True Then
                    ...
                    strSQL = "UPDATE koko_instruktor WITH (UPDLOCK) SET KelasID=" & Request.QueryString("kelasid") & " WHERE InstruktorID='" & strKey & "' AND Tahun='" & ddlTahun.Text & "'"
                    ''--debug
