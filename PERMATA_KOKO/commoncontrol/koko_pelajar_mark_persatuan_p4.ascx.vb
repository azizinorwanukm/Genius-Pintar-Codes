...
Public Class koko_pelajar_mark_persatuan_p4
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        For i As Integer = 0 To datRespondent.Rows.Count - 1
            ...
            strSQL = "UPDATE koko_pelajar SET Persatuan_PencapaianP4=" & txtPencapaian.Text & ",Persatuan_PenglibatanP4=" & txtPenglibatan.Text & ",Persatuan_JawatanP4=" & txtJawatan.Text & ",Persatuan_KehadiranP4=" & txtKehadiran.Text & " WHERE StudentID='" & datRespondent.DataKeys(i).Value.ToString & "' AND Tahun='" & Request.QueryString("tahun") & "'"
