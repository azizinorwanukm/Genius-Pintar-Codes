...
Public Class uniform_list
    ...
    Private Function getSQL() As String
        ...
        Dim strOrder As String = " ORDER BY Uniform"

        tmpSQL = "SELECT * FROM koko_uniform"
    ...
    Private Sub datRespondent_SelectedIndexChanging(sender As Object, e As GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Try
            Select Case Server.HtmlEncode(Request.Cookies("koko_usertype").Value)
                Case "ADMIN"
                    Response.Redirect("admin.uniform.view.aspx?uniformid=" & strKeyID)
                Case "PENSYARAH"
                Case "PENGARAH"
                Case Else
    ...
    Protected Sub btnCreate_Click(sender As Object, e As EventArgs) Handles btnCreate.Click
        Response.Redirect("admin.uniform.create.aspx")
    End Sub
