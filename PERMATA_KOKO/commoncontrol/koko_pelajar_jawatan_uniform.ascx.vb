...
Public Class koko_pelajar_jawatan_uniform
        ...
        For i = 0 To datRespondent.Rows.Count - 1 Step i + 1
            ...
            If Not chkUpdate Is Nothing Then
                ...
                If chkUpdate.Checked = True Then
                    strSQL = "UPDATE koko_pelajar SET Jawatan_Uniform='" & ddlJawatan.Text & "' WHERE StudentID='" & strKey & "' AND Tahun='" & Request.QueryString("tahun") & "'"
