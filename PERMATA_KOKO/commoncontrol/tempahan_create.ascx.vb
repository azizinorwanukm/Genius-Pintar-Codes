...
Public Class tempahan_create
    ...
    Protected Sub lnkList_Click(sender As Object, e As EventArgs) Handles lnkList.Click
        Select Case Server.HtmlEncode(Request.Cookies("koko_usertype").Value)
            ...
            Case "PENGARAH"
            Case Else
                Response.Redirect("public.kemudahan.list.aspx")
        End Select
    ...
    Private Sub setCheckboxChecked(ByVal bEnable As Boolean)
        Time07.Checked = bEnable
        Time08.Checked = bEnable
        Time09.Checked = bEnable
        Time10.Checked = bEnable
        Time11.Checked = bEnable
        Time12.Checked = bEnable
        Time13.Checked = bEnable
        Time14.Checked = bEnable
        Time15.Checked = bEnable
        Time16.Checked = bEnable
        Time17.Checked = bEnable
        Time18.Checked = bEnable
        Time19.Checked = bEnable
        Time20.Checked = bEnable
        Time21.Checked = bEnable
        Time22.Checked = bEnable
        Time23.Checked = bEnable

    End Sub

    Private Sub setCheckboxEnable(ByVal bEnable As Boolean)
        Time07.Enabled = bEnable
        Time08.Enabled = bEnable
        Time09.Enabled = bEnable
        Time10.Enabled = bEnable
        Time11.Enabled = bEnable
        Time12.Enabled = bEnable
        Time13.Enabled = bEnable
        Time14.Enabled = bEnable
        Time15.Enabled = bEnable
        Time16.Enabled = bEnable
        Time17.Enabled = bEnable
        Time18.Enabled = bEnable
        Time19.Enabled = bEnable
        Time20.Enabled = bEnable
        Time21.Enabled = bEnable
        Time22.Enabled = bEnable
        Time23.Enabled = bEnable
    ...
    Private Function koko_tempahandetail_insert() As Boolean
        ...
        Using connection As New SqlConnection(strconn)
            ...
            Try
                ...
                transaction.Commit()
                lblMsg.Text = "Tempahan berjaya. Sila simpan Kod Tempahan bagi tujuan cetakan atau pembatalan tempahan."
                Return True
            Catch ex As Exception
                strRet = ex.Message
    ...
    Private Function ValidateForm() As Boolean
        ...
        'at least select a time
        If ValidateCheckbox() = False Then
            lblMsg.Text = "Sila pilih sekurang-kurangnya satu waktu!"
            Return False
        End If
    ...
    Private Function ValidateCheckbox() As Boolean
        For Each ctrl As Control In pnlDisplay.Controls
