...
Public Class pensyarah_list
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT koko_pensyarah.PensyarahID,koko_pensyarah.Fullname,koko_pensyarah.MYKAD,koko_pensyarah.ContactNo,koko_pensyarah.Email,koko_pensyarah.Tahun,koko_pensyarah.BankName,koko_pensyarah.AcctNo,koko_pensyarah.Kelas,koko_pensyarah.Uniform,koko_pensyarah.Persatuan,koko_pensyarah.Sukan FROM koko_pensyarah"
        ...
        If Not txtFullname.Text.Length = 0 Then
            strWhere += " AND koko_pensyarah.Fullname LIKE '%" & oCommon.FixSingleQuotes(txtFullname.Text) & "%'"
        End If
    ...
    Private Sub datRespondent_SelectedIndexChanging(sender As Object, e As GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Try
            Select Case Server.HtmlEncode(Request.Cookies("koko_usertype").Value)
                Case "ADMIN"
                    Response.Redirect("admin.pensyarah.view.aspx?pensyarahid=" & strKeyID)
                Case "PENSYARAH"
                Case "PENGARAH"
                Case Else
    ...
    Protected Sub btnCreate_Click(sender As Object, e As EventArgs) Handles btnCreate.Click
        Response.Redirect("admin.pensyarah.create.aspx")
