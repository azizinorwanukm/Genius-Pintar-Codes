...
Public Class koko_pelajar_mark_persatuan_p2
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        For i As Integer = 0 To datRespondent.Rows.Count - 1
            ...
            strSQL = "UPDATE koko_pelajar SET Persatuan_PencapaianP2=" & txtPencapaian.Text & ",Persatuan_PenglibatanP2=" & txtPenglibatan.Text & ",Persatuan_JawatanP2=" & txtJawatan.Text & ",Persatuan_KehadiranP2=" & txtKehadiran.Text & " WHERE StudentID='" & datRespondent.DataKeys(i).Value.ToString & "' AND Tahun='" & Request.QueryString("tahun") & "'"
