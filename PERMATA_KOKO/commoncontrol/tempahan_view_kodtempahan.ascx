<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="tempahan_view_kodtempahan.ascx.vb" Inherits="permatapintar.tempahan_view_kodtempahan" %>
...
<table class="fbform">
    <tr class="fbform_header">
     ...
     <tr>
        <td class="fbtd_left">Kod Tempahan:
        </td>
        <td>
            <asp:Label ID="lblKodTempahan" runat="server" Text=""></asp:Label>
        </td>
        <td></td>
        <td></td>
    </tr>
