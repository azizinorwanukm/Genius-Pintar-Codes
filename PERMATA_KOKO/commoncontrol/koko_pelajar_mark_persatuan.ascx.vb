...
Public Class koko_pelajar_mark_persatuan
    ...
    Private Sub getKOKOName()
        ...
        Select Case strField
            Case "UniformID"
                strSQL = "SELECT Uniform FROM koko_uniform WHERE UniformID=" & strValue
            Case "PersatuanID"
                strSQL = "SELECT Persatuan FROM koko_persatuan WHERE PersatuanID=" & strValue
            Case "SukanID"
                strSQL = "SELECT Sukan FROM koko_sukan WHERE SukanID=" & strValue
            Case "RumahsukanID"
                strSQL = "SELECT Rumahsukan FROM koko_rumahsukan WHERE RumahsukanID=" & strValue
            Case Else
        End Select
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        For i As Integer = 0 To datRespondent.Rows.Count - 1
            ...
            strSQL = "UPDATE koko_pelajar SET Persatuan_PencapaianP1=" & txtPencapaian.Text & ",Persatuan_PenglibatanP1=" & txtPenglibatan.Text & ",Persatuan_JawatanP1=" & txtJawatan.Text & ",Persatuan_KehadiranP1=" & txtKehadiran.Text & " WHERE StudentID='" & datRespondent.DataKeys(i).Value.ToString & "' AND Tahun='" & Request.QueryString("tahun") & "'"
