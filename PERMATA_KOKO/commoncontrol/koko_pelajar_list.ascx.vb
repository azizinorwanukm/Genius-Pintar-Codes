...
Public Class koko_pelajar_list
    ...
    Private Sub datRespondent_SelectedIndexChanging(sender As Object, e As GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Try
            Select Case Server.HtmlEncode(Request.Cookies("koko_usertype").Value)
                Case "ADMIN"
                    Response.Redirect("admin.pelajar.view.aspx?studentid=" & strKeyID & "&std_ID=" & Request.QueryString("std_ID"))
                Case "INSTRUKTOR"
                    Response.Redirect("instruktor.pelajar.view.aspx?studentid=" & strKeyID & "&std_ID=" & Request.QueryString("std_ID"))
                Case "PENSYARAH"
                Case "PENGARAH"
                Case "PELAJAR"
                Case Else
