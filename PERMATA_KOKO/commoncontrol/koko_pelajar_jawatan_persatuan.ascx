<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="koko_pelajar_jawatan_persatuan.ascx.vb" Inherits="permatapintar.koko_pelajar_jawatan_persatuan" %>
                ...
                <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Jawatan">
                            <ItemTemplate>
                                <asp:Label ID="Jawatan_Persatuan" runat="server" Text='<%# Bind("Jawatan_Persatuan")%>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
