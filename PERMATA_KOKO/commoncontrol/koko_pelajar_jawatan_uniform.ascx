<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="koko_pelajar_jawatan_uniform.ascx.vb" Inherits="permatapintar.koko_pelajar_jawatan_uniform" %>
                ...
                <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Jawatan">
                            <ItemTemplate>
                                <asp:Label ID="Jawatan_Uniform" runat="server" Text='<%# Bind("Jawatan_Uniform")%>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
