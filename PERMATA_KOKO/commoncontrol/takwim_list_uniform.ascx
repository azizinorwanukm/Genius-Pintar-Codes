<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="takwim_list_uniform.ascx.vb" Inherits="permatapintar.takwim_list_uniform" %>

<table class="fbform">
    <tr class="fbform_header">
        <td style="width:80%;">Senarai Takwim&nbsp;<asp:Label ID="lblKategori" runat="server" Text="Badan Beruniform"></asp:Label>&nbsp;<asp:Label ID="lblTahun" runat="server" Text="" ForeColor="Red"></asp:Label>
