<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="rappcs_studentlist.ascx.vb" Inherits="UKM3.rappcs_studentlist" %>
            ...
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Simpanan Rekod">
                        <ItemTemplate>
                            <asp:Label ID="record" runat="server" Text='<%# Bind("rapcs_simpan") %>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left" VerticalAlign="Top" />
                        <ItemStyle VerticalAlign="Middle" />
                    </asp:TemplateField>
