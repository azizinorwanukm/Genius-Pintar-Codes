<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="login_trail.ascx.vb" Inherits="UKM3.login_trail" %>
<table class="fbform">
    ...
    <tr>
        ...
        <td>
            ...
            <asp:Button ID="btnBackToUkm3" runat ="server" Text="Kembali" CssClass="fbbutton" />
        </td>
    </tr>
</table>
