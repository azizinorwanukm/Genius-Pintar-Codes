...
Public Class kpp_studentselection1
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "  SELECT B.id, A.std_ID, A.student_Name, A.student_Mykad, C.AlumniID, Y.ClassCode, B.kpp_stf,CASE WHEN A.student_sex = 1 THEN 'Lelaki' ELSE 'Perempuan' END student_sex, STAFFINFO.staff_name
                    ...
                    LEFT JOIN ukm3.dbo.staff_info STAFFINFO ON STAFFINFO.staff_id = B.kpp_stf"
    ...
    Private Sub btnSimpan_Click(sender As Object, e As EventArgs) Handles btnSimpan.Click
        ...
        For i = 0 To datRespondent.Rows.Count - 1
            ...
            If chkselect.Checked = True Then
                ...
                strSQL = " UPDATE UKM3 SET kpp_stf = '" & staff_id & "' WHERE id = '" & strkey & "'"
