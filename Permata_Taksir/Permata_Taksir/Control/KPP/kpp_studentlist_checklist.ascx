<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="kpp_studentlist_checklist.ascx.vb" Inherits="UKM3.kpp_studentlist_checklist" %>
...
<table class="fbform">
    <tr>
        <td>
            <p class="maintext">
                For every statement, please make a reference to the student that you would like to observe:
                <br />
                Mark strongly agree (SA) to strongly disagree (SD), or DK if you don’t know.
            </p>
        </td>
    </tr>
    <tr class="fbform_header">
        ...
        <td class="td1">
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-CssClass="tfield1" HeaderText="SD 1 - 10 SA">
...
<table id="InfoTable" runat="server" class="fbform">
    ...
    <tr>
         <td>
           <asp:Label ID="lbl_text" runat="server" Text="" Width="1000px"></asp:Label>
        </td>          
    </tr>
    <tr>
             <td>
                  <asp:TextBox ID="txtQuestion15" runat="server" Height="70px" TextMode="MultiLine" Width="1000px"></asp:TextBox>
    ...
    <tr>
        <td>PENCAPAIAN (NYATAKAN JIKA ADA) :
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>Secara keseluruhan, Adakah anda MENYOKONG jika pelajar ini diterima masuk ke Kolej PERMATApintar NEGARA?
