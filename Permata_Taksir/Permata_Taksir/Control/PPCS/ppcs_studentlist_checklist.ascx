<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ppcs_studentlist_checklist.ascx.vb" Inherits="UKM3.ppcs_studentlist_checklist" %>
<style type="text/css">
    .auto-style1 {
        height: 10px;
    }
...
<table class="fbform">
    <tr class="fbform_header">
        <td><asp:DropDownList ID="ddlYear" runat ="server" width ="200px" OnSelectedIndexChanged ="ddlyear_onselectedindexChanged" AutoPostBack="true" Visible="false"></asp:DropDownList>
        </td>
     
    </tr>
        <tr><td></td></tr>
    <tr>
<td style="text-align: center;"><h3>PENILAIAN BAHAGIAN KETRAMPILAN KECEKAPAN BELAJAR</h3></td>
</tr>
    <tr><td></td></tr>
    <tr>
        <td>
            <asp:GridView ID="datrespondent_kecekapan" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Skor(1-5)">
    ...
    <tr><td></td></tr>
     <tr><td></td></tr>
    <tr><td style="text-align: center;"><h3>PENILAIAN BAHAGIAN KETRAMPILAN BERKOMUNIKASI</h3></td></tr>
    <tr>
        <td>
    ...
    <tr><td></td></tr>
        <tr><td></td></tr>
    <tr>
        <td style="text-align: center;"><h3>PENILAIAN KETRAMPILAN KEPIMPINAN</h3></td>
    </tr>
    <tr>
        <td>
