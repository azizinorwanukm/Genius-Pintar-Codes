Public Class upsi_mod07_24
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "7"
    Private QuestionNo As String = "24"
    Private Answer() As String = {"mod07.24.01", "mod07.24.04", "mod07.24.09"}
    Private NextQuestion As String = "~/mod07/upsi.mod07.25.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.24.aspx", ex.Message + " " + ex.StackTrace)
        End Try
