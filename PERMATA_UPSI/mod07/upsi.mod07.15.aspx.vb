Public Class upsi_mod07_15
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "7"
    Private QuestionNo As String = "15"
    Private Answer() As String = {"mod07.15.01", "mod07.15.04"}
    Private NextQuestion As String = "~/mod07/upsi.mod07.16.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.15.aspx", ex.Message + " " + ex.StackTrace)
        End Try
