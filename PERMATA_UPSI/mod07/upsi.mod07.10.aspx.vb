Public Class upsi_mod07_10
    Inherits System.Web.UI.Page

 Private ModuleNo As String = "7"
    Private QuestionNo As String = "10"
    Private Answer() As String = {"mod07.10.01", "mod07.10.04"}
    Private NextQuestion As String = "~/mod07/upsi.mod07.11.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.10.aspx", ex.Message + " " + ex.StackTrace)
        End Try
