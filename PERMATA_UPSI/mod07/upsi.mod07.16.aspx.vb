Public Class upsi_mod07_16
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "7"
    Private QuestionNo As String = "16"
    Private Answer() As String = {"mod07.16.01", "mod07.16.06"}
    Private NextQuestion As String = "~/mod07/upsi.mod07.17.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.16.aspx", ex.Message + " " + ex.StackTrace)
        End Try
