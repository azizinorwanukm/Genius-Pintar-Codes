Public Class upsi_mod07_12
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "7"
    Private QuestionNo As String = "12"
    Private Answer() As String = {"mod07.12.01", "mod07.12.06"}
    Private NextQuestion As String = "~/mod07/upsi.mod07.13.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.12.aspx", ex.Message + " " + ex.StackTrace)
        End Try
