Public Class upsi_mod07_34
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "7"
    Private QuestionNo As String = "34"
    Private Answer() As String = {"mod07.34.02", "mod07.34.04", "mod07.34.08"}
    Private NextQuestion As String = "~/mod08/upsi.mod08.01.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.34.aspx", ex.Message + " " + ex.StackTrace)
        End Try
