Public Class upsi_mod07_29
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "7"
    Private QuestionNo As String = "29"
    Private Answer() As String = {"mod07.29.02", "mod07.29.04", "mod07.29.09"}
    Private NextQuestion As String = "~/mod07/upsi.mod07.30.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.29.aspx", ex.Message + " " + ex.StackTrace)
        End Try
