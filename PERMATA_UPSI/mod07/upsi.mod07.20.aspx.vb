Public Class upsi_mod07_20
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "7"
    Private QuestionNo As String = "20"
    Private Answer() As String = {"mod07.20.02", "mod07.20.04"}
    Private NextQuestion As String = "~/mod07/upsi.mod07.21.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.20.aspx", ex.Message + " " + ex.StackTrace)
        End Try
