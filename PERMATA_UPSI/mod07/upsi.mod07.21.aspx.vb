Public Class upsi_mod07_21
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "7"
    Private QuestionNo As String = "21"
    Private Answer() As String = {"mod07.21.03", "mod07.21.04"}
    Private NextQuestion As String = "~/mod07/upsi.mod07.22.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.21.aspx", ex.Message + " " + ex.StackTrace)
        End Try
