Public Class upsi_mod07_09
    Inherits System.Web.UI.Page

  Private ModuleNo As String = "7"
    Private QuestionNo As String = "9"
    Private Answer() As String = {"mod07.09.02", "mod07.09.04"}
    Private NextQuestion As String = "~/mod07/upsi.mod07.10.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.09.aspx", ex.Message + " " + ex.StackTrace)
        End Try
