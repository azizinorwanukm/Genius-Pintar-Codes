Public Class upsi_mod07_26
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "7"
    Private QuestionNo As String = "26"
    Private Answer() As String = {"mod07.26.03", "mod07.26.04", "mod07.26.08"}
    Private NextQuestion As String = "~/mod07/upsi.mod07.27.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.26.aspx", ex.Message + " " + ex.StackTrace)
        End Try
