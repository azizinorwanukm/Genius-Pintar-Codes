Public Class upsi_mod07_19
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "7"
    Private QuestionNo As String = "19"
    Private Answer() As String = {"mod07.19.03", "mod07.19.04"}
    Private NextQuestion As String = "~/mod07/upsi.mod07.20.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.19.aspx", ex.Message + " " + ex.StackTrace)
        End Try
