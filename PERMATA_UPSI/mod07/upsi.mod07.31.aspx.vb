Public Class upsi_mod07_31
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "7"
    Private QuestionNo As String = "31"
    Private Answer() As String = {"mod07.31.01", "mod07.31.05", "mod07.31.08"}
    Private NextQuestion As String = "~/mod07/upsi.mod07.32.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.31.aspx", ex.Message + " " + ex.StackTrace)
        End Try
