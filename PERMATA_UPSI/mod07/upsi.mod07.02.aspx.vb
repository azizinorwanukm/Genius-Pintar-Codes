Public Class upsi_mod07_02
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "7"
    Private QuestionNo As String = "2"
    Private Answer() As String = {"mod07.02.02", "mod07.02.04"}
    Private NextQuestion As String = "~/mod07/upsi.mod07.03.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.02.aspx", ex.Message + " " + ex.StackTrace)
        End Try
