Public Class upsi_mod07_30
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "7"
    Private QuestionNo As String = "30"
    Private Answer() As String = {"mod07.30.02", "mod07.30.04", "mod07.30.08"}
    Private NextQuestion As String = "~/mod07/upsi.mod07.31.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.30.aspx", ex.Message + " " + ex.StackTrace)
        End Try
