Public Class upsi_mod07_01
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "7"
    Private QuestionNo As String = "1"
    Private Answer() As String = {"mod07.01.01", "mod07.01.04"}
    Private NextQuestion As String = "~/mod07/upsi.mod07.02.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.01.aspx", ex.Message + " " + ex.StackTrace)
        End Try
