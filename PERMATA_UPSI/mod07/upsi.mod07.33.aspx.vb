Public Class upsi_mod07_33
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "7"
    Private QuestionNo As String = "33"
    Private Answer() As String = {"mod07.33.02", "mod07.33.04", "mod07.33.07"}
    Private NextQuestion As String = "~/mod07/upsi.mod07.34.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.33.aspx", ex.Message + " " + ex.StackTrace)
        End Try
