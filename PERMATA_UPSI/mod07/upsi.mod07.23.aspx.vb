Public Class upsi_mod07_23
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "7"
    Private QuestionNo As String = "23"
    Private Answer() As String = {"mod07.23.02", "mod07.23.04", "mod07.23.07"}
    Private NextQuestion As String = "~/mod07/upsi.mod07.24.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.23.aspx", ex.Message + " " + ex.StackTrace)
        End Try
