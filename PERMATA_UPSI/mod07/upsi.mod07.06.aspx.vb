Public Class upsi_mod07_06
    Inherits System.Web.UI.Page

   Private ModuleNo As String = "7"
    Private QuestionNo As String = "6"
    Private Answer() As String = {"mod07.06.02", "mod07.06.04"}
    Private NextQuestion As String = "~/mod07/upsi.mod07.07.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.06.aspx", ex.Message + " " + ex.StackTrace)
        End Try
