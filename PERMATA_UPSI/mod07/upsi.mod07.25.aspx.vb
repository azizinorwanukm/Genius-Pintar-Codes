Public Class upsi_mod07_25
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "7"
    Private QuestionNo As String = "25"
    Private Answer() As String = {"mod07.25.02", "mod07.25.05", "mod07.25.07"}
    Private NextQuestion As String = "~/mod07/upsi.mod07.26.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.25.aspx", ex.Message + " " + ex.StackTrace)
        End Try
