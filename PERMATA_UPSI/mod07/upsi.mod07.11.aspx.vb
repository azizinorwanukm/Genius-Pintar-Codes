Public Class upsi_mod07_11
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "7"
    Private QuestionNo As String = "11"
    Private Answer() As String = {"mod07.11.01", "mod07.11.03"}
    Private NextQuestion As String = "~/mod07/upsi.mod07.12.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.11.aspx", ex.Message + " " + ex.StackTrace)
        End Try
