Public Class upsi_mod07_28
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "7"
    Private QuestionNo As String = "28"
    Private Answer() As String = {"mod07.28.02", "mod07.28.04", "mod07.28.08"}
    Private NextQuestion As String = "~/mod07/upsi.mod07.29.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.28.aspx", ex.Message + " " + ex.StackTrace)
        End Try
