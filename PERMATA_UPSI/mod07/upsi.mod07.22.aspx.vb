Public Class upsi_mod07_22
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "7"
    Private QuestionNo As String = "22"
    Private Answer() As String = {"mod07.22.01", "mod07.22.06", "mod07.22.07"}
    Private NextQuestion As String = "~/mod07/upsi.mod07.23.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.22.aspx", ex.Message + " " + ex.StackTrace)
        End Try
