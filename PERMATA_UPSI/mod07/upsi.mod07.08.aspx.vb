Public Class upsi_mod07_08
    Inherits System.Web.UI.Page

 Private ModuleNo As String = "7"
    Private QuestionNo As String = "8"
    Private Answer() As String = {"mod07.08.01", "mod07.08.03"}
    Private NextQuestion As String = "~/mod07/upsi.mod07.09.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.08.aspx", ex.Message + " " + ex.StackTrace)
        End Try
