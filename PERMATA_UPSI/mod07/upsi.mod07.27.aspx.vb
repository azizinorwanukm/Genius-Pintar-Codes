Public Class upsi_mod07_27
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "7"
    Private QuestionNo As String = "27"
    Private Answer() As String = {"mod07.27.02", "mod07.27.05", "mod07.27.07"}
    Private NextQuestion As String = "~/mod07/upsi.mod07.28.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.27.aspx", ex.Message + " " + ex.StackTrace)
        End Try
