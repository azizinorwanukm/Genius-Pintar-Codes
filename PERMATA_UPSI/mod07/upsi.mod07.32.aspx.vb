Public Class upsi_mod07_32
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "7"
    Private QuestionNo As String = "32"
    Private Answer() As String = {"mod07.32.03", "mod07.32.05", "mod07.32.07"}
    Private NextQuestion As String = "~/mod07/upsi.mod07.33.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod07.32.aspx", ex.Message + " " + ex.StackTrace)
        End Try
