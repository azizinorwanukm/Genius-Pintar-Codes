<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/upsi.Master" CodeBehind="upsi.mod01.07.aspx.vb" Inherits="permata_upsi.upsi_mod1_07" %>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div style="margin-left: 300px">
                                            <asp:ImageButton ID="img00" ImageUrl="~/images/mod01/mod01.07.00.png" runat="server" OnClientClick="return false;" />
                                        </div>
                                    </div>
                                </div>
                                <br />
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <table border="0" style="width: 210px" class="col-sm-offset-5 col-lg-offset-1">
                                            <tr style="height: 105px">
                                                <td>
                                                    <asp:Image ID="img01" ImageUrl="~/images/mod01/mod01.04.blue.png" data-choose="mod01.07.02" runat="server" Style="cursor: pointer" onclick="pushImage1(this);" />
                                                </td>
                                                <td>
                                                    <asp:Image ID="img02" ImageUrl="~/images/mod01/mod01.01.01.png" data-choose="mod01.07.01" runat="server" Style="cursor: pointer" onclick="pushImage1(this);" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:Image ID="img03" ImageUrl="~/images/mod01/mod01.01.01.png" data-choose="mod01.07.01" runat="server" Style="cursor: pointer" onclick="pushImage1(this);" />
                                                </td>
                                                <td>
                                                    <asp:Image ID="img04" ImageUrl="~/images/mod01/mod01.04.blue.png" data-choose="mod01.07.02" runat="server" Style="cursor: pointer" onclick="pushImage1(this);" />
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
