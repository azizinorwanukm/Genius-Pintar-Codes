<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/upsi.Master" CodeBehind="upsi.mod10.08.aspx.vb" Inherits="permata_upsi.upsi_mod10_08" %>
                                ...
                                <div class="row">
                                    <div class="col-md-12">                                         
                                        ...
                                        <table style="border-collapse: collapse; outline: 1px solid black; cursor: pointer;">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Image ID="Image3" runat="server" CssClass="dimension" ImageUrl="~/images/mod10/blank.png" onclick="setImage(this,3);" /></td>                                        
                                            </tr>    
                                            <tr>
                                                
                                                <td>
                                                    <asp:Image ID="Image4" runat="server" CssClass="dimension" ImageUrl="~/images/mod10/blank.png" onclick="setImage(this,4);" /></td> 
                                                <td>
                                                    <asp:Image ID="Image8" runat="server" CssClass="dimension" ImageUrl="~/images/mod10/blank.png" onclick="setImage(this,5);" /></td>    
                                                <td>
                                                    <asp:Image ID="Image5" runat="server" CssClass="dimension" ImageUrl="~/images/mod10/blank.png" onclick="setImage(this,6);" /></td>
                                                <td>
                                                    <asp:Image ID="Image6" runat="server" CssClass="dimension" ImageUrl="~/images/mod10/blank.png" onclick="setImage(this,7);" /></td>                                          
                                            </tr>
                                            <tr>                                                 
                                                <td>
                                                    <asp:Image ID="Image9" runat="server" CssClass="dimension" ImageUrl="~/images/mod10/blank.png" onclick="setImage(this,8);" /></td>    
                                                <td>
                                                    <asp:Image ID="Image12" runat="server" CssClass="dimension" ImageUrl="~/images/mod10/blank.png" onclick="setImage(this,9);" /></td>
                                                <td>
                                                    <asp:Image ID="Image13" runat="server" CssClass="dimension" ImageUrl="~/images/mod10/blank.png" onclick="setImage(this,10);" /></td>
                                                <td>
                                                    <asp:Image ID="Image14" runat="server" CssClass="dimension" ImageUrl="~/images/mod10/blank.png" onclick="setImage(this,11);" /></td>                                          
                                            </tr>                                          
                                        </table>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table border="0" >
                                            <tr>
                                                <td>
                                                    <asp:Image ID="img01" runat="server" CssClass="dimension" ImageUrl="~/images/mod10/mod10.08.01.gif" data-choose="mod10.08.01" Style="cursor: pointer" onclick="pushImage(this);" />
                                                </td>
                                                <td>
                                                    <asp:Image ID="img02" runat="server" CssClass="dimension" ImageUrl="~/images/mod10/mod10.08.02.gif" data-choose="mod10.08.02" Style="cursor: pointer" onclick="pushImage(this);" />
                                                </td>
                                                <td>
                                                    <asp:Image ID="Image10" runat="server" CssClass="dimension" ImageUrl="~/images/mod10/mod10.08.03.gif" data-choose="mod10.08.03" Style="cursor: pointer" onclick="pushImage(this);" />
                                                </td>
                                                <td>
                                                    <asp:Image ID="Image11" runat="server" CssClass="dimension" ImageUrl="~/images/mod10/mod10.08.04.gif" data-choose="mod10.08.04" Style="cursor: pointer" onclick="pushImage(this);" />
                                                </td>
                                            </tr>                                           
                                        </table>
                                    </div>
