<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/upsi.Master" CodeBehind="upsi.mod09.17.aspx.vb" Inherits="permata_upsi.upsi_mod9_17" %>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="row question" style="display:none;">
                                        <div class="col-sm-12">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Image ID="Image3" runat="server" ImageUrl="~/images/mod09/08.gif" /></td>                                                                                              
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:Image ID="Image5" runat="server" ImageUrl="~/images/mod09/blank.png" /></td>
                                                <td>
                                                    <asp:Image ID="Image6" runat="server" ImageUrl="~/images/mod09/07.gif" /></td>
                                                <td>
                                                    <asp:Image ID="Image7" runat="server" ImageUrl="~/images/mod09/02.gif"  /></td>                                                                                              
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:Image ID="Image9" runat="server" ImageUrl="~/images/mod09/06.gif" /></td>
                                                <td>
                                    ...
                                    <div class="row answer" style="display:none;">
                                        ...
                                        <table style="border-collapse: collapse; cursor: pointer;">
                                            <tr>
                                                <td>
                                                    <asp:Image ID="Image13" runat="server" ImageUrl="~/images/mod09/01.gif" data-choose="mod09.17.01" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                                <td>
                                                    <asp:Image ID="Image14" runat="server" ImageUrl="~/images/mod09/02.gif" data-choose="mod09.17.02" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                                <td>
                                                    <asp:Image ID="Image15" runat="server" ImageUrl="~/images/mod09/03.gif" data-choose="mod09.17.03" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                                <td>
                                                    <asp:Image ID="Image16" runat="server" ImageUrl="~/images/mod09/04.gif" data-choose="mod09.17.04" Style="cursor: pointer" onclick="pushImage(this);" /></td>                                            
                                                <td>
                                                    <asp:Image ID="Image17" runat="server" ImageUrl="~/images/mod09/05.gif" data-choose="mod09.17.05" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                                <td>
                                                    <asp:Image ID="Image18" runat="server" ImageUrl="~/images/mod09/07.gif" data-choose="mod09.17.06" Style="cursor: pointer" onclick="pushImage(this);" /></td> 
                                            </tr>
                                            <tr> 
                                                <td>
                                                    <asp:Image ID="Image19" runat="server" ImageUrl="~/images/mod09/08.gif" data-choose="mod09.17.07" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                                <td>
                                                    <asp:Image ID="Image20" runat="server" ImageUrl="~/images/mod09/06.gif" data-choose="mod09.17.08" Style="cursor: pointer" onclick="pushImage(this);" /></td>   
                                            </tr>
                                        </table>
                                        </div>
