<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/upsi.Master" CodeBehind="upsi.mod05.06.aspx.vb" Inherits="permata_upsi.upsi_mod5_06" %>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="row question" style="display:none;">
                                        <div class="col-md-12">
                                            <asp:Image ID="ImageButton1" ImageUrl="~/images/mod05/mod05.06.01.png" runat="server" CssClass=" center-block " />
                                        </div>
                                    ...
                                    <div class="row answer" style="display:none;">
                                        <div class="col-md-2 col-md-offset-1">
                                            <asp:Image ID="ImageButton2" ImageUrl="~/images/mod05/mod05.06.02.png" runat="server" CssClass=" pull-right " style="cursor:pointer" data-choose="mod05.06.01" onclick="setImage(this);" />
                                        </div>
                                        <div class="col-md-2">
                                            <asp:Image ID="ImageButton3" ImageUrl="~/images/mod05/mod05.06.03.png" runat="server" CssClass=" center-block "  style="cursor:pointer" data-choose="mod05.06.02" onclick="setImage(this);" />
                                        </div>
                                        <div class="col-md-2">
                                            <asp:Image ID="ImageButton4" ImageUrl="~/images/mod05/mod05.06.04.png" runat="server" CssClass=" center-block "  style="cursor:pointer" data-choose="mod05.06.03" onclick="setImage(this);" />
                                        </div>
                                        <div class="col-md-2">
                                            <asp:Image ID="ImageButton5" ImageUrl="~/images/mod05/mod05.06.05.png" runat="server" CssClass=" center-block "  style="cursor:pointer" data-choose="mod05.06.04" onclick="setImage(this);" />
                                        </div>
                                        <div class="col-md-2">
                                            <asp:Image ID="ImageButton6" ImageUrl="~/images/mod05/mod05.06.01.png" runat="server" CssClass=" pull-left "  style="cursor:pointer" data-choose="mod05.06.05" onclick="setImage(this);" />
                                        </div>
                                    </div>
