<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/upsi.Master" CodeBehind="upsi.mod09.06.aspx.vb" Inherits="permata_upsi.upsi_mod9_06" %>
                                    ...
                                    <div class="row question" style="display:none;">
                                        <div class="col-sm-12">
                                            ...
                                            <tr>                                                
                                                ...
                                                <td>
                                                    <asp:Image ID="Image4" runat="server" ImageUrl="~/images/mod09/02.gif" /></td>                                                
                                            </tr>                                        
                                        </table>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row answer" style="display:none;">
                                        ...
                                        <div class="col-sm-12">
                                            <table style="border-collapse: collapse; cursor: pointer;">
                                                <tr>
                                                    <td>
                                                        <asp:Image ID="Image13" runat="server" ImageUrl="~/images/mod09/01.gif" data-choose="mod09.06.01" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                                    <td>
                                                        <asp:Image ID="Image14" runat="server" ImageUrl="~/images/mod09/02.gif" data-choose="mod09.06.02" Style="cursor: pointer" onclick="pushImage(this);" /></td>
