<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/upsi.Master" CodeBehind="upsi.mod09.04.aspx.vb" Inherits="permata_upsi.upsi_mod9_04" %>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="row answer" style="display:none;">
                                        ...
                                        <table style="border-collapse: collapse; cursor: pointer;">
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Image ID="Image20" runat="server" ImageUrl="~/images/mod09/08.gif" data-choose="mod09.04.01" Style="cursor: pointer" onclick="pushImage(this);" /></td>   
                                            </tr>                                           
