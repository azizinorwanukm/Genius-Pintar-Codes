<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/upsi.Master" CodeBehind="upsi.mod09.15.aspx.vb" Inherits="permata_upsi.upsi_mod9_15" %>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="row question" style="display:none;">
                                        <div class="col-sm-12">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Image ID="Image3" runat="server" ImageUrl="~/images/mod09/04.gif" /></td>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Image ID="Image9" runat="server" ImageUrl="~/images/mod09/03.gif" /></td>
                                                <td>
                                                    <asp:Image ID="Image10" runat="server" ImageUrl="~/images/mod09/blank.png" /></td>
                                                <td>
                                                    <asp:Image ID="Image11" runat="server" ImageUrl="~/images/mod09/07.gif" /></td>
                                    ...
                                    <div class="row answer" style="display:none;">
                                        ...
                                        <table style="border-collapse: collapse; cursor: pointer;">
                                            <tr>
                                                <td>
                                                    <asp:Image ID="Image13" runat="server" ImageUrl="~/images/mod09/01.gif" data-choose="mod09.15.01" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                                <td>
                                                    <asp:Image ID="Image14" runat="server" ImageUrl="~/images/mod09/02.gif" data-choose="mod09.15.02" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                                <td>
                                                    <asp:Image ID="Image15" runat="server" ImageUrl="~/images/mod09/03.gif" data-choose="mod09.15.03" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                                <td>
                                                    <asp:Image ID="Image16" runat="server" ImageUrl="~/images/mod09/04.gif" data-choose="mod09.15.04" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                                <td>
                                                    <asp:Image ID="Image17" runat="server" ImageUrl="~/images/mod09/05.gif" data-choose="mod09.15.05" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                                <td>
                                                    <asp:Image ID="Image18" runat="server" ImageUrl="~/images/mod09/07.gif" data-choose="mod09.15.06" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:Image ID="Image19" runat="server" ImageUrl="~/images/mod09/08.gif" data-choose="mod09.15.07" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                                <td>
                                                    <asp:Image ID="Image20" runat="server" ImageUrl="~/images/mod09/06.gif" data-choose="mod09.15.08" Style="cursor: pointer" onclick="pushImage(this);" /></td>   
                                            </tr>                                          
