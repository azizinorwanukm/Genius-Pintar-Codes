<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/upsi.Master" CodeBehind="upsi.mod09.14.aspx.vb" Inherits="permata_upsi.upsi_mod9_14" %>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="row question" style="display:none;">
                                        <div class="col-sm-12">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Image ID="Image2" runat="server" ImageUrl="~/images/mod09/02.gif" /></td>
                                                <td>
                                                    <asp:Image ID="Image3" runat="server" ImageUrl="~/images/mod09//blank.png" /></td>
                                                <td>
                                                    <asp:Image ID="Image4" runat="server" ImageUrl="~/images/mod09/03.gif" /></td>                                                
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:Image ID="Image5" runat="server" ImageUrl="~/images/mod09/06.gif" /></td>
                                                <td>
                                                    <asp:Image ID="Image6" runat="server" ImageUrl="~/images/mod09/04.gif" /></td>
                                                <td>
                                                    <asp:Image ID="Image7" runat="server" ImageUrl="~/images/mod09/01.gif"  /></td>
                                                <td>
                                    ...
                                    <div class="row answer" style="display:none;">
                                        ...
                                        <table style="border-collapse: collapse; cursor: pointer;">
                                            <tr>
                                                <td>
                                                    <asp:Image ID="Image13" runat="server" ImageUrl="~/images/mod09/01.gif" data-choose="mod09.14.01" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                                <td>
                                                    <asp:Image ID="Image14" runat="server" ImageUrl="~/images/mod09/02.gif" data-choose="mod09.14.02" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                                <td>
                                                    <asp:Image ID="Image15" runat="server" ImageUrl="~/images/mod09/03.gif" data-choose="mod09.14.03" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                                <td>
                                                    <asp:Image ID="Image16" runat="server" ImageUrl="~/images/mod09/04.gif" data-choose="mod09.14.04" Style="cursor: pointer" onclick="pushImage(this);" /></td>                                                      
                                                <td>
                                                    <asp:Image ID="Image17" runat="server" ImageUrl="~/images/mod09/06.gif" data-choose="mod09.14.05" Style="cursor: pointer" onclick="pushImage(this);" /></td>                                                
                                            </tr> 
                                        </table>
                                        </div>
