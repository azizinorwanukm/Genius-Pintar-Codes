<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/upsi.Master" CodeBehind="upsi.mod10.02.aspx.vb" Inherits="permata_upsi.upsi_mod10_02" %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table style="border-spacing: 10px;border-collapse: separate;" >
                                            <tr>
                                                <td>
                                                    <asp:Image ID="img01" runat="server" CssClass="dimension" ImageUrl="~/images/mod10/mod10.02.01.gif" data-choose="mod10.02.01" Style="cursor: pointer" onclick="pushImage(this);" />
                                                </td>
                                                <td>
                                                    <asp:Image ID="img02" runat="server" CssClass="dimension" ImageUrl="~/images/mod10/mod10.02.02.gif" data-choose="mod10.02.02" Style="cursor: pointer" onclick="pushImage(this);" />
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
