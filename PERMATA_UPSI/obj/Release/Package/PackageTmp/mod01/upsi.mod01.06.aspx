<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/upsi.Master" CodeBehind="upsi.mod01.06.aspx.vb" Inherits="permata_upsi.upsi_mod1_06" %>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div style="margin-left: 250px;">
                                            <asp:ImageButton ID="img00" ImageUrl="~/images/mod01/mod01.06.00.png" runat="server" Width="200px" Height="200px" OnClientClick="return false;" />
                                        </div>
                                    </div>
                                </div>
                                <br />
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <table style="border-collapse: collapse; margin-left: 100px; outline: 1px solid black; width: 500px; cursor: pointer">
                                            ...
                                            <tr>
                                                <td colspan="5">
                                                    <table style="border-collapse: collapse; margin-left: auto; margin-right: auto; width: 500px; cursor: pointer">
                                                        <tr>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <table border="0" style="width: 210px" class="col-sm-offset-5 col-lg-offset-1">
                                            <tr style="height: 105px">
                                                <td>
                                                    <asp:Image ID="img01" ImageUrl="~/images/mod01/mod01.01.01.png" data-choose="mod01.06.01" runat="server" Style="cursor: pointer" onclick="pushImage1(this);" />
                                                </td>
                                                <td>
                                                    <asp:Image ID="img02" ImageUrl="~/images/mod01/mod01.01.01.png" data-choose="mod01.06.01" runat="server" Style="cursor: pointer" onclick="pushImage1(this);" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:Image ID="img03" ImageUrl="~/images/mod01/mod01.01.01.png" data-choose="mod01.06.01" runat="server" Style="cursor: pointer" onclick="pushImage1(this);" />
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
