<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/upsi.Master" CodeBehind="upsi.mod01.02.aspx.vb" Inherits="permata_upsi.upsi_mod1_02" %>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div style="margin-left: 300px;">
                                            <asp:Image ID="img00" ImageUrl="~/images/mod01/mod01.02.00.png" Width="200px" Height="100px" runat="server"  />
                                        </div>
                                    </div>
                                </div>
                                <br />
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <table border="0" style="width: 210px" class="col-sm-offset-5 col-lg-offset-1">
                                            <tr style="height: 105px">
                                                <td>
                                                    <asp:Image ID="img01" runat="server" ImageUrl="~/images/mod01/mod01.01.01.png" data-choose="mod01.02.01" Style="cursor: pointer" onclick="pushImage1(this);" />
                                                </td>
                                                <td>
                                                    <asp:Image ID="img02" runat="server" ImageUrl="~/images/mod01/mod01.01.01.png" data-choose="mod01.02.01" Style="cursor: pointer" onclick="pushImage1(this);" />
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
