<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/upsi.Master" CodeBehind="upsi.mod09.05.aspx.vb" Inherits="permata_upsi.upsi_mod9_05" %>
                                    ...
                                    <div class="row question" style="display:none;">
                                        <div class="col-sm-12">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Image ID="Image2" runat="server" ImageUrl="~/images/mod09/06.gif" /></td>
                                                <td>
                                        ...
                                        <div class="col-sm-12">
                                            <table style="border-collapse: collapse; cursor: pointer;">
                                                ...
                                                <tr>                                                
                                                    ...
                                                    <td>
                                                        <asp:Image ID="Image17" runat="server" ImageUrl="~/images/mod09/05.gif" data-choose="mod09.05.01" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                                    <td>
                                                        <asp:Image ID="Image18" runat="server" ImageUrl="~/images/mod09/06.gif" data-choose="mod09.05.02" Style="cursor: pointer" onclick="pushImage(this);" /></td> 
