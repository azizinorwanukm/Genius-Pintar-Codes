<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/upsi.Master" CodeBehind="upsi.mod10.03.aspx.vb" Inherits="permata_upsi.upsi_mod10_03" %>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <table style="border-collapse: collapse; outline: 1px solid black; cursor: pointer;">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Image ID="Image3" runat="server" CssClass="dimension" ImageUrl="~/images/mod10/blank.png" onclick="setImage(this,2);" /></td>
                                               
                                            </tr> 
                                            <tr>
                                                <td>
                                                    <asp:Image ID="Image4" runat="server" CssClass="dimension" ImageUrl="~/images/mod10/blank.png" onclick="setImage(this,3);" /></td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Image ID="Image8" runat="server" CssClass="dimension" ImageUrl="~/images/mod10/blank.png" onclick="setImage(this,7);" /></td>
                                                <td>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table style="border-spacing: 10px;border-collapse: separate;" >
                                            <tr>
                                                <td>
                                                    <asp:Image ID="img01" runat="server" CssClass="dimension" ImageUrl="~/images/mod10/mod10.03.01.gif" data-choose="mod10.03.01" Style="cursor: pointer" onclick="pushImage(this);" />
                                                </td>
                                                <td>
                                                    <asp:Image ID="img02" runat="server" CssClass="dimension" ImageUrl="~/images/mod10/mod10.03.02.gif" data-choose="mod10.03.02" Style="cursor: pointer" onclick="pushImage(this);" />
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
