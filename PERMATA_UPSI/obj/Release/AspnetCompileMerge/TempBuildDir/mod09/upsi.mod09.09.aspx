<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/upsi.Master" CodeBehind="upsi.mod09.09.aspx.vb" Inherits="permata_upsi.upsi_mod9_09" %>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="row question" style="display:none;">
                                        <div class="col-sm-12">
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Image ID="Image5" runat="server" ImageUrl="~/images/mod09/04.gif" /></td>
                                                <td>
                                    ...
                                    <div class="row answer" style="display:none;">
                                        <div class="col-sm-12">
                                            <table class="table1" style="cursor: pointer;">
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:Image ID="Image28" runat="server" ImageUrl="~/images/mod09/blank.png" onclick="setImage(this,2);" /></td>
                                                    <td>
                                                        <asp:Image ID="Image29" runat="server" ImageUrl="~/images/mod09/blank.png" onclick="setImage(this,3);" /></td>
                                        ...
                                        <table style="border-collapse: collapse; cursor: pointer;">
                                            <tr>
                                                <td>
                                                    <asp:Image ID="Image20" runat="server" ImageUrl="~/images/mod09/08.gif" data-choose="mod09.09.01" Style="cursor: pointer" onclick="pushImage(this);" /></td> 
                                                <td>
                                                    <asp:Image ID="Image13" runat="server" ImageUrl="~/images/mod09/04.gif" data-choose="mod09.09.02" Style="cursor: pointer" onclick="pushImage(this);" /></td>                                               
                                                <td>
                                                    <asp:Image ID="Image16" runat="server" ImageUrl="~/images/mod09/01.gif" data-choose="mod09.09.03" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                            </tr>
