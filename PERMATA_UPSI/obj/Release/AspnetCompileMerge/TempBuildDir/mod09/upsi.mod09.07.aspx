<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/upsi.Master" CodeBehind="upsi.mod09.07.aspx.vb" Inherits="permata_upsi.upsi_mod9_07" %>
                                    ...
                                    <div class="row answer" style="display:none;">
                                        ...
                                        <div class="col-sm-12">
                                            <table style="border-collapse: collapse; cursor: pointer;">
                                                <tr>                                              
                                                    <td>
                                                        <asp:Image ID="Image16" runat="server" ImageUrl="~/images/mod09/04.gif" data-choose="mod09.07.01" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                                </tr>
