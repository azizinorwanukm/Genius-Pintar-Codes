<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/upsi.Master" CodeBehind="upsi.mod05.05.aspx.vb" Inherits="permata_upsi.upsi_mod5_05" %>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="row question" style="display:none;">
                                        <div class="col-sm-12">
                                            <asp:Image ID="ImageButton1" ImageUrl="~/images/mod05/mod05.05.01.png" runat="server" CssClass=" center-block " />
                                        </div>
                                    ...
                                    <div class="row answer" style="display:none;">
                                        <div class="col-sm-3">
                                            <asp:Image ID="ImageButton2" ImageUrl="~/images/mod05/mod05.05.02.png" runat="server" CssClass=" pull-right " style="cursor:pointer" data-choose="mod05.05.01" onclick="setImage(this);" />
                                        </div>
                                        <div class="col-sm-3">
                                            <asp:Image ID="ImageButton3" ImageUrl="~/images/mod05/mod05.05.03.png" runat="server" CssClass=" center-block " style="cursor:pointer" data-choose="mod05.05.02" onclick="setImage(this);" />
                                        </div>
                                        <div class="col-sm-3">
                                            <asp:Image ID="ImageButton4" ImageUrl="~/images/mod05/mod05.05.04.png" runat="server" CssClass=" center-block " style="cursor:pointer" data-choose="mod05.05.03" onclick="setImage(this);" />
                                        </div>
                                        <div class="col-sm-3">
                                            <asp:Image ID="ImageButton5" ImageUrl="~/images/mod05/mod05.05.01.png" runat="server" CssClass=" pull-left " style="cursor:pointer" data-choose="mod05.05.04" onclick="setImage(this);" />
                                        </div>
