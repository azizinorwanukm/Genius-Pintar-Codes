Public Class upsi_mod5_30
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "5"
    Private QuestionNo As String = "30"
    Private Answer As String = "mod05.30.03,mod05.30.06,mod05.30.08,mod05.30.09,mod05.30.10"
    Private NextQuestion As String = "~/mod01/upsi.mod01.01.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod05.30.aspx", ex.Message + " " + ex.StackTrace)
        End Try
