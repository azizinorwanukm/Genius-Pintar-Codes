Public Class upsi_mod5_08
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "5"
    Private QuestionNo As String = "8"
    Private Answer As String = "mod05.08.05,mod05.08.02"
    Private NextQuestion As String = "~/mod05/upsi.mod05.09.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod05.08.aspx", ex.Message + " " + ex.StackTrace)
        End Try
