Public Class upsi_mod5_27
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "5"
    Private QuestionNo As String = "27"
    Private Answer As String = "mod05.27.02,mod05.27.06,mod05.27.05,mod05.27.08"
    Private NextQuestion As String = "~/mod05/upsi.mod05.28.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod05.27.aspx", ex.Message + " " + ex.StackTrace)
        End Try
