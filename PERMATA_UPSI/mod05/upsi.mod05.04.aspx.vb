Public Class upsi_mod5_04
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "5"
    Private QuestionNo As String = "4"
    Private Answer As String = "mod05.04.01"
    Private NextQuestion As String = "~/mod05/upsi.mod05.05.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod05.04.aspx", ex.Message + " " + ex.StackTrace)
        End Try
