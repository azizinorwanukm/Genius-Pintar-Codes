Public Class upsi_mod5_21
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "5"
    Private QuestionNo As String = "21"
    Private Answer As String = "mod05.21.03,mod05.21.08,mod05.21.01"
    Private NextQuestion As String = "~/mod05/upsi.mod05.22.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod05.21.aspx", ex.Message + " " + ex.StackTrace)
        End Try
