Public Class upsi_mod5_24
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "5"
    Private QuestionNo As String = "24"
    Private Answer As String = "mod05.24.07,mod05.24.03,mod05.24.05,mod05.24.08"
    Private NextQuestion As String = "~/mod05/upsi.mod05.25.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod05.24.aspx", ex.Message + " " + ex.StackTrace)
        End Try
