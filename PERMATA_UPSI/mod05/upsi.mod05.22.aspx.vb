Public Class upsi_mod5_22
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "5"
    Private QuestionNo As String = "22"
    Private Answer As String = "mod05.22.01,mod05.22.03,mod05.22.05,mod05.22.06"
    Private NextQuestion As String = "~/mod05/upsi.mod05.23.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod05.22.aspx", ex.Message + " " + ex.StackTrace)
        End Try
