Public Class upsi_mod5_20
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "5"
    Private QuestionNo As String = "20"
    Private Answer As String = "mod05.20.02,mod05.20.06,mod05.20.08"
    Private NextQuestion As String = "~/mod05/upsi.mod05.21.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod05.20.aspx", ex.Message + " " + ex.StackTrace)
        End Try
