Public Class upsi_mod5_11
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "5"
    Private QuestionNo As String = "11"
    Private Answer As String = "mod05.11.02,mod05.11.06"
    Private NextQuestion As String = "~/mod05/upsi.mod05.12.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod05.11.aspx", ex.Message + " " + ex.StackTrace)
        End Try
