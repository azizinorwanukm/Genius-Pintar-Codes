Public Class upsi_mod5_18
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "5"
    Private QuestionNo As String = "18"
    Private Answer As String = "mod05.18.01,mod05.18.02,mod05.18.03"
    Private NextQuestion As String = "~/mod05/upsi.mod05.19.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod05.18.aspx", ex.Message + " " + ex.StackTrace)
        End Try
