Public Class upsi_mod5_13
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "5"
    Private QuestionNo As String = "13"
    Private Answer As String = "mod05.13.03,mod05.13.04,mod05.13.05"
    Private NextQuestion As String = "~/mod05/upsi.mod05.14.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod05.13.aspx", ex.Message + " " + ex.StackTrace)
        End Try
