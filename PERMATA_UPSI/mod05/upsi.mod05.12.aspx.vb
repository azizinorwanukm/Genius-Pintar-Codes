Public Class upsi_mod5_12
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "5"
    Private QuestionNo As String = "12"
    Private Answer As String = "mod05.12.02,mod05.12.04,mod05.12.05"
    Private NextQuestion As String = "~/mod05/upsi.mod05.13.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod05.12.aspx", ex.Message + " " + ex.StackTrace)
        End Try
