Public Class upsi_mod5_15
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "5"
    Private QuestionNo As String = "15"
    Private Answer As String = "mod05.15.03,mod05.15.05,mod05.15.06"
    Private NextQuestion As String = "~/mod05/upsi.mod05.16.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod05.15.aspx", ex.Message + " " + ex.StackTrace)
        End Try
