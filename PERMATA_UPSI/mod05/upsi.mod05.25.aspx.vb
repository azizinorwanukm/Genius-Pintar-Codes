Public Class upsi_mod5_25
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "5"
    Private QuestionNo As String = "25"
    Private Answer As String = "mod05.25.01,mod05.25.03,mod05.25.05,mod05.25.04"
    Private NextQuestion As String = "~/mod05/upsi.mod05.26.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod05.25.aspx", ex.Message + " " + ex.StackTrace)
        End Try
