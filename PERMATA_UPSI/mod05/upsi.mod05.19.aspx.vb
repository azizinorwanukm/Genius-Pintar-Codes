Public Class upsi_mod5_19
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "5"
    Private QuestionNo As String = "19"
    Private Answer As String = "mod05.19.01,mod05.19.02,mod05.19.06"
    Private NextQuestion As String = "~/mod05/upsi.mod05.20.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod05.19.aspx", ex.Message + " " + ex.StackTrace)
        End Try
