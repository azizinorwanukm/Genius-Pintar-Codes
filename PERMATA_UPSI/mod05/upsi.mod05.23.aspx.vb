Public Class upsi_mod5_23
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "5"
    Private QuestionNo As String = "23"
    Private Answer As String = "mod05.23.01,mod05.23.03,mod05.23.05,mod05.23.04"
    Private NextQuestion As String = "~/mod05/upsi.mod05.24.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod05.23.aspx", ex.Message + " " + ex.StackTrace)
        End Try
