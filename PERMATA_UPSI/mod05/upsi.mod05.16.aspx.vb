Public Class upsi_mod5_16
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "5"
    Private QuestionNo As String = "16"
    Private Answer As String = "mod05.16.02,mod05.16.03,mod05.16.05"
    Private NextQuestion As String = "~/mod05/upsi.mod05.17.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod05.16.aspx", ex.Message + " " + ex.StackTrace)
        End Try
