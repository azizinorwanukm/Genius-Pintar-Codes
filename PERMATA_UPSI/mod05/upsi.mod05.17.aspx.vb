Public Class upsi_mod5_17
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "5"
    Private QuestionNo As String = "17"
    Private Answer As String = "mod05.17.03,mod05.17.06,mod05.17.01"
    Private NextQuestion As String = "~/mod05/upsi.mod05.18.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod05.17.aspx", ex.Message + " " + ex.StackTrace)
        End Try
