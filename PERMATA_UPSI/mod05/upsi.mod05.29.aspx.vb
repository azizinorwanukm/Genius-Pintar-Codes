Public Class upsi_mod5_29
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "5"
    Private QuestionNo As String = "29"
    Private Answer As String = "mod05.29.02,mod05.29.03,mod05.29.04,mod05.29.05,mod05.29.06"
    Private NextQuestion As String = "~/mod05/upsi.mod05.30.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod05.29.aspx", ex.Message + " " + ex.StackTrace)
        End Try
