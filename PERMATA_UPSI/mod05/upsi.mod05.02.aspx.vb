Public Class upsi_mod5_02
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "5"
    Private QuestionNo As String = "2"
    Private Answer As String = "mod05.02.01"
    Private NextQuestion As String = "~/mod05/upsi.mod05.03.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod05.02.aspx", ex.Message + " " + ex.StackTrace)
        End Try
