Public Class upsi_mod5_26
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "5"
    Private QuestionNo As String = "26"
    Private Answer As String = "mod05.26.01,mod05.26.07,mod05.26.05,mod05.26.09"
    Private NextQuestion As String = "~/mod05/upsi.mod05.27.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod05.26.aspx", ex.Message + " " + ex.StackTrace)
        End Try
