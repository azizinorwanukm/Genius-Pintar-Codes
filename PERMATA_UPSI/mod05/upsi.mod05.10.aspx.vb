Public Class upsi_mod5_10
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "5"
    Private QuestionNo As String = "10"
    Private Answer As String = "mod05.10.01,mod05.10.06"
    Private NextQuestion As String = "~/mod05/upsi.mod05.11.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod05.10.aspx", ex.Message + " " + ex.StackTrace)
        End Try
