Public Class upsi_mod5_01
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "5"
    Private QuestionNo As String = "1"
    Private Answer As String = "mod05.01.02"
    Private NextQuestion As String = "~/mod05/upsi.mod05.02.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod05.01.aspx", ex.Message + " " + ex.StackTrace)
        End Try
