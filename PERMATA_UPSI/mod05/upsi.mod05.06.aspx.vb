Public Class upsi_mod5_06
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "5"
    Private QuestionNo As String = "6"
    Private Answer As String = "mod05.06.05"
    Private NextQuestion As String = "~/mod05/upsi.mod05.07.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod05.06.aspx", ex.Message + " " + ex.StackTrace)
        End Try
