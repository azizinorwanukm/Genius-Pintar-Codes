Public Class upsi_mod5_14
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "5"
    Private QuestionNo As String = "14"
    Private Answer As String = "mod05.14.01,mod05.14.04,mod05.14.06"
    Private NextQuestion As String = "~/mod05/upsi.mod05.15.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod05.14.aspx", ex.Message + " " + ex.StackTrace)
        End Try
