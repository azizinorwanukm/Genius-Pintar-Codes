...
Public Class upsi_mod10_01
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "10"
    Private QuestionNo As String = "1"

    Private NoOfBlokUsed As Integer = 2
    Private ZeroMarkLimit As Integer = 3
    Private NextQuestion As String = "~/mod10/upsi.mod10.02.aspx"
    ...
    Private HorizontalAnswerPair As List(Of CorrectPair) = New List(Of CorrectPair) From {New CorrectPair("mod10.01.02", "mod10.01.01")}
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod10.01.aspx", ex.Message & "-" & ex.StackTrace)
        End Try
