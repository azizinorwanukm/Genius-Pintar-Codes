...
Public Class upsi_mod10_05
    ...
    Private HorizontalAnswerPair As List(Of CorrectPair) = New List(Of CorrectPair) From {New CorrectPair("mod10.05.03", "mod10.05.02"), New CorrectPair("mod10.05.02", "mod10.05.01")}
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod10.05.aspx", ex.Message & "-" & ex.StackTrace)
        End Try
