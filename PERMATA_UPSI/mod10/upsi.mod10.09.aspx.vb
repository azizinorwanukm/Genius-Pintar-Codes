...
Public Class upsi_mod10_09
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "10"
    Private QuestionNo As String = "9"
    Private ZeroMarkLimit As Integer = 3
    Private NextQuestion As String = "~/mod10/upsi.mod10.10.aspx"
    ...
    Private HorizontalAnswerPair As List(Of CorrectPair) = New List(Of CorrectPair) From {New CorrectPair("mod10.09.01", "mod10.09.06"), New CorrectPair("mod10.09.03", "mod10.09.04"), New CorrectPair("mod10.09.05", "mod10.09.02")}
    Private VerticalAnswerPair As List(Of CorrectPair) = New List(Of CorrectPair) From {New CorrectPair("mod10.09.01", "mod10.09.03"), New CorrectPair("mod10.09.03", "mod10.09.05"), New CorrectPair("mod10.09.06", "mod10.09.04"), New CorrectPair("mod10.09.04", "mod10.09.02")}
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod10.09.aspx", ex.Message & "-" & ex.StackTrace)
        End Try
