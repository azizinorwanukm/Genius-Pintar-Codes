...
Public Class upsi_mod10_13
    ...
    Private Row As Integer = 4
    Private Col As Integer = 4
    Private HorizontalAnswerPair As List(Of CorrectPair) = New List(Of CorrectPair) From {New CorrectPair("mod10.13.03", "mod10.13.06"), New CorrectPair("mod10.13.06", "mod10.13.10"), New CorrectPair("mod10.13.10", "mod10.13.05"), New CorrectPair("mod10.13.07", "mod10.13.04"), New CorrectPair("mod10.13.04", "mod10.13.11"), New CorrectPair("mod10.13.11", "mod10.13.02"), New CorrectPair("mod10.13.12", "mod10.13.09"), New CorrectPair("mod10.13.09", "mod10.13.01"), New CorrectPair("mod10.13.01", "mod10.13.08")}
    Private VerticalAnswerPair As List(Of CorrectPair) = New List(Of CorrectPair) From {New CorrectPair("mod10.13.03", "mod10.13.07"), New CorrectPair("mod10.13.07", "mod10.13.12"), New CorrectPair("mod10.13.06", "mod10.13.04"), New CorrectPair("mod10.13.04", "mod10.13.09"), New CorrectPair("mod10.13.10", "mod10.13.11"), New CorrectPair("mod10.13.11", "mod10.13.01"), New CorrectPair("mod10.13.05", "mod10.13.02"), New CorrectPair("mod10.13.02", "mod10.13.08")}
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Try
            ...
            UserMark = mod10GetMark(HorizontalAnswerPair, VerticalAnswerPair, user_answer.Value, Row, Col, 0.5)
        ...
        Catch ex As Exception
            LogError("upsi.mod10.13.aspx", ex.Message & "-" & ex.StackTrace)
        End Try
