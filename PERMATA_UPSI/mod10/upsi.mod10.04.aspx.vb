...
Public Class upsi_mod10_04
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "10"
    Private QuestionNo As String = "4"
    Private ZeroMarkLimit As Integer = 3
    Private NextQuestion As String = "~/mod10/upsi.mod10.05.aspx"
    ...
    Private HorizontalAnswerPair As List(Of CorrectPair) = New List(Of CorrectPair) From {New CorrectPair("mod10.04.03", "mod10.04.01"), New CorrectPair("mod10.04.01", "mod10.04.02")}
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod10.04.aspx", ex.Message & "-" & ex.StackTrace)
        End Try
