...
Public Class upsi_mod10_08
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "10"
    Private QuestionNo As String = "8"
    Private ZeroMarkLimit As Integer = 3
    Private NextQuestion As String = "~/mod10/upsi.mod10.09.aspx"
    ...
    Private Row As Integer = 3
    Private Col As Integer = 4
    Private HorizontalAnswerPair As List(Of CorrectPair) = New List(Of CorrectPair) From {New CorrectPair("mod10.08.04", "mod10.08.02"), New CorrectPair("mod10.08.03", "mod10.08.01")}
    Private VerticalAnswerPair As List(Of CorrectPair) = New List(Of CorrectPair) From {New CorrectPair("mod10.08.04", "mod10.08.03"), New CorrectPair("mod10.08.02", "mod10.08.01")}
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod10.08.aspx", ex.Message & "-" & ex.StackTrace)
        End Try
