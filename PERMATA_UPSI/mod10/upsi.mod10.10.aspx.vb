...
Public Class upsi_mod10_10
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "10"
    Private QuestionNo As String = "10"
    Private ZeroMarkLimit As Integer = 3
    Private NextQuestion As String = "~/mod10/upsi.mod10.11.aspx"
    ...
    Private HorizontalAnswerPair As List(Of CorrectPair) = New List(Of CorrectPair) From {New CorrectPair("mod10.10.05", "mod10.10.01"), New CorrectPair("mod10.10.06", "mod10.10.02"), New CorrectPair("mod10.10.04", "mod10.10.03")}
    Private VerticalAnswerPair As List(Of CorrectPair) = New List(Of CorrectPair) From {New CorrectPair("mod10.10.05", "mod10.10.06"), New CorrectPair("mod10.10.06", "mod10.10.04"), New CorrectPair("mod10.10.01", "mod10.10.02"), New CorrectPair("mod10.10.02", "mod10.10.03")}
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod10.10.aspx", ex.Message & "-" & ex.StackTrace)
        End Try
