Public Class upsi_mod03_29
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "3"
    Private QuestionNo As String = "29"
    Private Mark As Integer = 1
    Private Answer As String = "mod03.29.03"
    Private ZeroMarkLimit As Integer = 3
    Private NextQuestion As String = "~/mod04/upsi.mod04.01.aspx"
    Private NextModule As String = "~/mod04/upsi.mod04.01.aspx"
    Private NextQuestionInterval As Integer = 120
    ...
    Protected Sub Image_Clicked(sender As Object, e As ImageClickEventArgs) Handles ImageButton1.Click, ImageButton2.Click, ImageButton3.Click, ImageButton4.Click, ImageButton5.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod03.29.aspx", ex.StackTrace)
        End Try
