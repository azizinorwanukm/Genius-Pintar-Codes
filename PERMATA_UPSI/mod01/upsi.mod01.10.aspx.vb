Public Class upsi_mod1_10
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "1"
    Private QuestionNo As String = "10"
    Private Mark As Integer = 1
    Private Answer As String(,) = {{"mod01.10.04"}}
    Private NoOfBlokUsed As Integer = 1
    Private ZeroMarkLimit As Integer = 3
    Private NextQuestion As String = "~/mod01/upsi.mod01.11.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod01.10.aspx", ex.Message & "-" & ex.StackTrace)
        End Try
