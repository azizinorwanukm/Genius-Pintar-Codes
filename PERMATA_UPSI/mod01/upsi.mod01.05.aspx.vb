Public Class upsi_mod1_05
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod01.05.aspx", ex.Message & "-" & ex.StackTrace)
        End Try
