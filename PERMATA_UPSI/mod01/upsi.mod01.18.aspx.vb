Public Class upsi_mod1_18
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "1"
    Private QuestionNo As String = "18"
    Private Mark As Integer = 1
    Private Answer As String(,) = {{"mod01.18.04", "mod01.18.06", "mod01.18.04"}, {"mod01.18.05", "mod01.18.03", "mod01.18.05"}, {"mod01.18.04", "mod01.18.06", "mod01.18.04"}}
    ...
    'Private NextQuestion As String = "~/mod06/upsi.mod06.00.aspx"
    'Private NextModule As String = "~/mod06/upsi.mod06.00.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod01.18.aspx", ex.Message & "-" & ex.StackTrace)
        End Try
