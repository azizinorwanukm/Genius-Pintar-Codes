<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/upsi.Master" CodeBehind="upsi.mod01.11.aspx.vb" Inherits="permata_upsi.upsi_mod1_11" %>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div style="margin-left: 300px;">
                                            <asp:Image ID="img00" ImageUrl="~/images/mod01/mod01.11.00.png" Height="200px" Width="200px" runat="server"  />
                                        </div>
                                    </div>
                                </div>
                                <br />
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <table border="0" style="width: 210px;" class="col-sm-offset-5 col-lg-offset-1">
                                            <tr style="height: 105px">
                                                <td>
                                                    <asp:Image ID="img01" ImageUrl="~/images/mod01/mod01.04.blue.png" data-choose="mod01.11.02" runat="server" Style="cursor: pointer" onclick="pushImage2(this);" />
                                                </td>
                                                <td>
                                                    <asp:Image ID="img02" ImageUrl="~/images/mod01/mod01.01.01.png" data-choose="mod01.11.01" runat="server" Style="cursor: pointer" onclick="pushImage2(this);" />
                                                </td>
                                            </tr>
                                            <tr style="height: 105px">
                                                <td>
                                                    <asp:Image ID="img03" ImageUrl="~/images/mod01/mod01.09.01.png" data-choose="mod01.11.03" runat="server" Style="cursor: pointer" onclick="pushImage2(this);" />
                                                </td>
                                                <td>
                                                    <asp:Image ID="img04" ImageUrl="~/images/mod01/mod01.09.02.png" data-choose="mod01.11.04" runat="server" Style="cursor: pointer" onclick="pushImage2(this);" />
                                                </td>
                                            </tr>
                                            <tr style="height: 105px">
                                                <td>
                                                    <asp:Image ID="img05" ImageUrl="~/images/mod01/mod01.09.03.png" data-choose="mod01.11.05" runat="server" Style="cursor: pointer" onclick="pushImage2(this);" />
                                                </td>
                                                <td>
                                                    <asp:Image ID="img06" ImageUrl="~/images/mod01/mod01.09.04.png" data-choose="mod01.11.06" runat="server" Style="cursor: pointer" onclick="pushImage2(this);" />
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
