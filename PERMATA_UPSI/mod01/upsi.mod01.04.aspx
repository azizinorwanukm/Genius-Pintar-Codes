<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/upsi.Master" CodeBehind="upsi.mod01.04.aspx.vb" Inherits="permata_upsi.upsi_mod1_04" %>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div style="margin-left: 300px;">
                                            <asp:Image ID="img00" ImageUrl="~/images/mod01/mod01.04.00.png" Width="100px" Height="200px" runat="server" />
                                        </div>
                                    </div>
                                </div>
                                <br />
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <table border="0" style="width: 210px" class="col-sm-offset-5 col-lg-offset-1">
                                            <tr style="height: 105px">
                                                <td>
                                                    <asp:Image ID="img01" ImageUrl="~/images/mod01/mod01.01.01.png" runat="server" data-choose="mod01.04.01" Style="cursor: pointer" onclick="pushImage1(this);" />
                                                </td>
                                                <td>
                                                    <asp:Image ID="img02" ImageUrl="~/images/mod01/mod01.04.blue.png" runat="server" data-choose="mod01.04.02" Style="cursor: pointer" onclick="pushImage1(this);" />
                                                </td>
                                            </tr>
