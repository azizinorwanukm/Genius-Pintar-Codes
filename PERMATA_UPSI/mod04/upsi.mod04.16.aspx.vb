Public Class upsi_mod04_16
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "4"
    Private QuestionNo As String = "16"
    Private Answer As String() = {"mod04.16.05", "mod04.16.08", "mod04.16.16"}
    Private NextQuestion As String = "~/mod04/upsi.mod04.17.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod04.16.aspx", ex.Message + " " + ex.StackTrace)
        End Try
