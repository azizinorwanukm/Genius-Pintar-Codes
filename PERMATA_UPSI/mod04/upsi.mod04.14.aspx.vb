Public Class upsi_mod04_14
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "4"
    Private QuestionNo As String = "14"
    Private Answer As String() = {"mod04.14.06", "mod04.14.09", "mod04.14.18"}
    Private NextQuestion As String = "~/mod04/upsi.mod04.15.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod04.14.aspx", ex.Message + " " + ex.StackTrace)
        End Try
