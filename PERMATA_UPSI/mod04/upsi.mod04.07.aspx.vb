Public Class upsi_mod04_07
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "4"
    Private QuestionNo As String = "7"
    Private Answer As String() = {"mod04.07.02", "mod04.07.12", "mod04.07.15"}
    Private NextQuestion As String = "~/mod04/upsi.mod04.08.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod04.07.aspx", ex.Message + " " + ex.StackTrace)
        End Try
