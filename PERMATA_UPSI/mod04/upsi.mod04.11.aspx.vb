Public Class upsi_mod04_11
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "4"
    Private QuestionNo As String = "11"
    Private Answer As String() = {"mod04.11.03", "mod04.11.12", "mod04.11.14"}
    Private NextQuestion As String = "~/mod04/upsi.mod04.12.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod04.11.aspx", ex.Message + " " + ex.StackTrace)
        End Try
