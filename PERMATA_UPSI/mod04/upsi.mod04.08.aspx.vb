Public Class upsi_mod04_08
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "4"
    Private QuestionNo As String = "8"
    Private Answer As String() = {"mod04.08.05", "mod04.08.12", "mod04.08.14"}
    Private NextQuestion As String = "~/mod04/upsi.mod04.09.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod04.08.aspx", ex.Message + " " + ex.StackTrace)
        End Try
