Public Class upsi_mod04_03
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "4"
    Private QuestionNo As String = "3"
    Private Answer As String() = {"mod04.03.04", "mod04.03.12", "mod04.03.17"}
    Private NextQuestion As String = "~/mod04/upsi.mod04.04.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod04.03.aspx", ex.Message + " " + ex.StackTrace)
        End Try
