Public Class upsi_mod04_04
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "4"
    Private QuestionNo As String = "4"
    Private Answer As String() = {"mod04.04.02", "mod04.04.12", "mod04.04.14"}
    Private NextQuestion As String = "~/mod04/upsi.mod04.05.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod04.04.aspx", ex.Message + " " + ex.StackTrace)
        End Try
