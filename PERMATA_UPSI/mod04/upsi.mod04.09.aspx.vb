Public Class upsi_mod04_09
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "4"
    Private QuestionNo As String = "9"
    Private Answer As String() = {"mod04.09.04", "mod04.09.12", "mod04.09.16"}
    Private NextQuestion As String = "~/mod04/upsi.mod04.10.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod04.09.aspx", ex.Message + " " + ex.StackTrace)
        End Try
