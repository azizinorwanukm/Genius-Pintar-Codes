Public Class upsi_mod04_22
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "4"
    Private QuestionNo As String = "22"
    Private Answer As String() = {"mod04.22.03", "mod04.22.09", "mod04.22.14"}
    Private NextQuestion As String = "~/mod04/upsi.mod04.23.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod04.22.aspx", ex.Message + " " + ex.StackTrace)
        End Try
