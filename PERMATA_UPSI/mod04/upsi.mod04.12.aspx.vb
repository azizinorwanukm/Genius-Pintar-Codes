Public Class upsi_mod04_12
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "4"
    Private QuestionNo As String = "12"
    Private Answer As String() = {"mod04.12.02", "mod04.12.09", "mod04.12.17"}
    Private NextQuestion As String = "~/mod04/upsi.mod04.13.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod04.12.aspx", ex.Message + " " + ex.StackTrace)
        End Try
