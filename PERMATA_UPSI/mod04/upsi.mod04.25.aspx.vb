Public Class upsi_mod04_25
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "4"
    Private QuestionNo As String = "25"
    Private Answer As String() = {"mod04.25.03", "mod04.25.12", "mod04.25.15"}
    Private NextQuestion As String = "~/mod05/upsi.mod05.01.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod04.24.aspx", ex.Message + " " + ex.StackTrace)
        End Try
