Public Class upsi_mod04_15
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "4"
    Private QuestionNo As String = "15"
    Private Answer As String() = {"mod04.15.02", "mod04.15.12", "mod04.15.15"}
    Private NextQuestion As String = "~/mod04/upsi.mod04.16.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod04.15.aspx", ex.Message + " " + ex.StackTrace)
        End Try
