Public Class upsi_mod04_20
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "4"
    Private QuestionNo As String = "20"
    Private Answer As String() = {"mod04.20.04", "mod04.20.11", "mod04.20.15"}
    Private NextQuestion As String = "~/mod04/upsi.mod04.21.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod04.18.aspx", ex.Message + " " + ex.StackTrace)
        End Try
