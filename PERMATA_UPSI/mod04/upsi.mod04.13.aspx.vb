Public Class upsi_mod04_13
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "4"
    Private QuestionNo As String = "13"
    Private Answer As String() = {"mod04.13.04", "mod04.13.09", "mod04.13.14"}
    Private NextQuestion As String = "~/mod04/upsi.mod04.14.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod04.13.aspx", ex.Message + " " + ex.StackTrace)
        End Try
