Public Class upsi_mod04_21
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "4"
    Private QuestionNo As String = "21"
    Private Answer As String() = {"mod04.21.05", "mod04.21.10", "mod04.21.16"}
    Private NextQuestion As String = "~/mod04/upsi.mod04.22.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod04.21.aspx", ex.Message + " " + ex.StackTrace)
        End Try
