Public Class upsi_mod04_06
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "4"
    Private QuestionNo As String = "6"
    Private Answer As String() = {"mod04.06.06", "mod04.06.11", "mod04.06.14"}
    Private NextQuestion As String = "~/mod04/upsi.mod04.07.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod04.06.aspx", ex.Message + " " + ex.StackTrace)
        End Try
