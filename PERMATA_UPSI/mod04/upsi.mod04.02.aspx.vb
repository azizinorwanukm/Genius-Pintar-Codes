Public Class upsi_mod04_02
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "4"
    Private QuestionNo As String = "2"
    Private Answer As String() = {"mod04.02.06", "mod04.02.10", "mod04.02.15"}
    Private NextQuestion As String = "~/mod04/upsi.mod04.03.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod04.02.aspx", ex.Message + " " + ex.StackTrace)
        End Try
