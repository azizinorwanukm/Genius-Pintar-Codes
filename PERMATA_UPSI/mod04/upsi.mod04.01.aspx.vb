Public Class upsi_mod04_01
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "4"
    Private QuestionNo As String = "1"
    Private Answer As String() = {"mod04.01.05", "mod04.01.08", "mod04.01.18"}
    Private NextQuestion As String = "~/mod04/upsi.mod04.02.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod04.01.aspx", ex.Message + " " + ex.StackTrace)
        End Try
