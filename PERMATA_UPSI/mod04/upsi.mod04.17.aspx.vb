Public Class upsi_mod04_17
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "4"
    Private QuestionNo As String = "17"
    Private Answer As String() = {"mod04.17.05", "mod04.17.10", "mod04.17.18"}
    Private NextQuestion As String = "~/mod04/upsi.mod04.18.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod04.17.aspx", ex.Message + " " + ex.StackTrace)
        End Try
