Public Class upsi_mod04_10
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "4"
    Private QuestionNo As String = "10"
    Private Answer As String() = {"mod04.10.05", "mod04.10.12", "mod04.10.17"}
    Private NextQuestion As String = "~/mod04/upsi.mod04.11.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod04.10.aspx", ex.Message + " " + ex.StackTrace)
        End Try
