...
Public Class upsi_mod9_03
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "9"
    Private QuestionNo As String = "3"
    Private Answer As String = ",mod09.03.01,"
    Private NextQuestion As String = "~/mod09/upsi.mod09.04.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod09.03.aspx", ex.Message & "-" & ex.StackTrace)
        End Try
