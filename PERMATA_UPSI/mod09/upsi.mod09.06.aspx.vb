...
Public Class upsi_mod9_06
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "9"
    Private QuestionNo As String = "6"
    Private Answer As String = ",mod09.06.01,mod09.06.02"
    Private NextQuestion As String = "~/mod09/upsi.mod09.07.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod09.06.aspx", ex.Message & "-" & ex.StackTrace)
        End Try
