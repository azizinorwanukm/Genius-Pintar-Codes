...
Public Class upsi_mod9_20
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "9"
    Private QuestionNo As String = "20"
    Private Answer As String = "mod09.20.08,,,mod09.20.05,,mod09.20.04,,,mod09.20.09,,mod09.20.01,mod09.20.10"
    Private NextQuestion As String = "~/mod09/upsi.mod09.21.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod09.20.aspx", ex.Message & "-" & ex.StackTrace)
        End Try
