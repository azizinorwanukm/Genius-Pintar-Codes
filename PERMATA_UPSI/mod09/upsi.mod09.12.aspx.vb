...
Public Class upsi_mod9_12
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "9"
    Private QuestionNo As String = "12"
    Private Answer As String = "mod09.12.04,mod09.12.02,,mod09.12.03,mod09.12.01,mod09.12.05"
    Private NextQuestion As String = "~/mod09/upsi.mod09.13.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod09.12.aspx", ex.Message & "-" & ex.StackTrace)
        End Try
