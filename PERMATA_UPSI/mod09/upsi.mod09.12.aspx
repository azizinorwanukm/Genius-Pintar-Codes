<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/upsi.Master" CodeBehind="upsi.mod09.12.aspx.vb" Inherits="permata_upsi.upsi_mod9_12" %>
                                ...
                                <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <tr>
                                                <td style="border:1px solid black">
                                                    <asp:Image ID="Image1" runat="server" ImageUrl="~/images/mod09/07.gif" /></td>
                                                <td>
                                                    <asp:Image ID="Image2" runat="server" ImageUrl="~/images/mod09/08.gif" /></td>
                                                <td>
                                    ...
                                    <div class="row answer" style="display:none;">
                                        ...
                                        <table style="border-collapse: collapse; cursor: pointer;">
                                            <tr>
                                                <td>
                                                    <asp:Image ID="Image13" runat="server" ImageUrl="~/images/mod09/04.gif" data-choose="mod09.12.01" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                                <td>
                                                    <asp:Image ID="Image14" runat="server" ImageUrl="~/images/mod09/08.gif" data-choose="mod09.12.02" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                                <td>
                                                    <asp:Image ID="Image15" runat="server" ImageUrl="~/images/mod09/06.gif" data-choose="mod09.12.03" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                                <td>
                                                    <asp:Image ID="Image16" runat="server" ImageUrl="~/images/mod09/07.gif" data-choose="mod09.12.04" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                                <td>
                                                    <asp:Image ID="Image17" runat="server" ImageUrl="~/images/mod09/01.gif" data-choose="mod09.12.05" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                            </tr>
