...
Public Class upsi_mod9_04
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "9"
    Private QuestionNo As String = "4"
    Private Answer As String = "mod09.04.01,,"
    Private NextQuestion As String = "~/mod09/upsi.mod09.05.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod09.04.aspx", ex.Message & "-" & ex.StackTrace)
        End Try
