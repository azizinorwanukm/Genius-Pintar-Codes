...
Public Class upsi_mod9_11
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "9"
    Private QuestionNo As String = "11"
    Private Answer As String = "mod09.11.02,,mod09.11.03,,mod09.11.04,mod09.11.01"
    Private NextQuestion As String = "~/mod09/upsi.mod09.12.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod09.11.aspx", ex.Message & "-" & ex.StackTrace)
        End Try
