<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/upsi.Master" CodeBehind="upsi.mod09.03.aspx.vb" Inherits="permata_upsi.upsi_mod9_03" %>
                                        ...
                                        <div class="col-sm-12">
                                            <table style="border-collapse: collapse; cursor: pointer;">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Image ID="Image14" runat="server" ImageUrl="~/images/mod09/02.gif" data-choose="mod09.03.01" Style="cursor: pointer" onclick="pushImage(this);" /></td>
