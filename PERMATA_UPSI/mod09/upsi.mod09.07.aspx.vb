...
Public Class upsi_mod9_07
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "9"
    Private QuestionNo As String = "7"
    Private Answer As String = ",,mod09.07.01,"
    Private NextQuestion As String = "~/mod09/upsi.mod09.08.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod09.07.aspx", ex.Message & "-" & ex.StackTrace)
        End Try
