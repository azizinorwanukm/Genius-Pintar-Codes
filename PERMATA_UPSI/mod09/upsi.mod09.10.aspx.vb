...
Public Class upsi_mod9_10
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "9"
    Private QuestionNo As String = "10"
    Private Answer As String = ",mod09.10.01,mod09.10.03,mod09.10.02,,"
    Private NextQuestion As String = "~/mod09/upsi.mod09.11.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod09.02.aspx", ex.Message & "-" & ex.StackTrace)
        End Try
