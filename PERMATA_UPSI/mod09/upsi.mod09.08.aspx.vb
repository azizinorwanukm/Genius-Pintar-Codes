...
Public Class upsi_mod9_08
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "9"
    Private QuestionNo As String = "8"
    Private Answer As String = ",mod09.08.01,mod09.08.02,"
    Private NextQuestion As String = "~/mod09/upsi.mod09.09.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod09.08.aspx", ex.Message & "-" & ex.StackTrace)
        End Try
