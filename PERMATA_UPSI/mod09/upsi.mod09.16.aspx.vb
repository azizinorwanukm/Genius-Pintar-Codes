...
Public Class upsi_mod9_16
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "9"
    Private QuestionNo As String = "16"
    Private Answer As String = ",mod09.16.01,,mod09.16.02,mod09.16.03,,,mod09.16.08,mod09.16.04"
    Private NextQuestion As String = "~/mod09/upsi.mod09.17.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod09.16.aspx", ex.Message & "-" & ex.StackTrace)
        End Try
