...
Public Class upsi_mod9_15
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "9"
    Private QuestionNo As String = "15"
    Private Answer As String = ",,mod09.15.04,mod09.15.07,,,mod09.15.03,,mod09.15.06"
    Private NextQuestion As String = "~/mod09/upsi.mod09.16.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod09.15.aspx", ex.Message & "-" & ex.StackTrace)
        End Try
