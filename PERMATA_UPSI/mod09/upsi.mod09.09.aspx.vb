...
Public Class upsi_mod9_09
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "9"
    Private QuestionNo As String = "9"
    Private Answer As String = "mod09.09.01,,mod09.09.02,mod09.09.03"
    Private NextQuestion As String = "~/mod09/upsi.mod09.10.aspx"
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod09.09.aspx", ex.Message & "-" & ex.StackTrace)
        End Try
