...
Public Class upsi_mod9_22
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "9"
    Private QuestionNo As String = "22"
    Private Answer As String = "mod09.22.05,,mod09.22.07,mod09.22.04,mod09.22.03,mod09.22.01,mod09.22.02,mod09.22.11,mod09.22.09,mod09.22.10,,mod09.22.08"
    Private NextQuestion As String = "~/mod10/upsi.mod10.01.aspx"
    Private NextModule As String = "~/mod10/upsi.mod10.01.aspx"
    Private ZeroMarkLimit As Integer = 3
    Private NextQuestionInterval As Integer = 3
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod09.22.aspx", ex.Message & "-" & ex.StackTrace)
        End Try
