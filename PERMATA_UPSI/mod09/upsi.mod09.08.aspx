<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/upsi.Master" CodeBehind="upsi.mod09.08.aspx.vb" Inherits="permata_upsi.upsi_mod9_08" %>
                                    ...
                                    <div class="row answer" style="display:none;">
                                        ...
                                        <div class="col-sm-12">
                                            <table style="border-collapse: collapse; cursor: pointer;">
                                                <tr>
                                                    <td>
                                                        <asp:Image ID="Image15" runat="server" ImageUrl="~/images/mod09/05.gif" data-choose="mod09.08.01" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                                    <td>
                                                        <asp:Image ID="Image16" runat="server" ImageUrl="~/images/mod09/03.gif" data-choose="mod09.08.02" Style="cursor: pointer" onclick="pushImage(this);" /></td>
                                                </tr>
