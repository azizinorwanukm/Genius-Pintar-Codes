Public Class upsi_mod06_00
    Inherits System.Web.UI.Page

    Private ModuleNo As String = "6"
    Private QuestionNo As String = "0"
    Private Answer As String = ""
    Private ZeroMarkLimit As Integer = 3
    Private NextQuestion As String = "~/mod06/upsi.mod06.01.aspx"
    ...
    Private Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod06.01.aspx", ex.Message & "-" & ex.StackTrace)
        End Try
