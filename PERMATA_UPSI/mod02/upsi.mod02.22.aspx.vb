Public Class upsi_mod02_22
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        Catch ex As Exception
            LogError("upsi.mod02.22.aspx", ex.Message & " - " & ex.StackTrace)
        End Try
