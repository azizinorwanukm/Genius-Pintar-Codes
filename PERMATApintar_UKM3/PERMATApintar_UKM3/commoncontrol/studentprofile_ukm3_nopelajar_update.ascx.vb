...
Partial Public Class studentprofile_ukm3_nopelajar_update
    ...
    Private Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        Try
            For i As Integer = 0 To datRespondent.Rows.Count - 1
                ...
                Dim gridTextBox As TextBox = DirectCast(row.FindControl("txtNoPelajar"), TextBox)

                strSQL = "UPDATE StudentProfile SET NoPelajar='" & gridTextBox.Text & "' WHERE StudentID='" & datRespondent.DataKeys(i).Value.ToString & "'"
            ...
            If lblMsgFunc.Text.Length = 0 Then
                lblMsgFunc.Text = "Berjaya kemaskini Profil Pelajar. No Pelajar."
            Else
