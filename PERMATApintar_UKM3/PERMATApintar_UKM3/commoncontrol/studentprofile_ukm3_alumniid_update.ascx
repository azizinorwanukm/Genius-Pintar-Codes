<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="studentprofile_ukm3_alumniid_update.ascx.vb" Inherits="permatapintar.studentprofile_ukm3_alumniid_update" %>
<table class="fbform">
    ...
    <tr>
        ...
        <td>
            <asp:DropDownList ID="ddlPPCSDate" runat="server" Width="200px" AutoPostBack="true">
            </asp:DropDownList>
        </td>
    ...
    <tr>
        ...
        <td>
             <asp:DropDownList ID="ddlClassCode" runat="server" AutoPostBack="false" Width="200px">
            </asp:DropDownList>
        </td>
    </tr>
    <tr>
            ...
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="AlumniID">
                        <ItemTemplate>
                            <asp:TextBox ID="txtAlumniID" runat="server" Width="60px" MaxLength="10" Text='<%# Bind("AlumniID") %>'></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
