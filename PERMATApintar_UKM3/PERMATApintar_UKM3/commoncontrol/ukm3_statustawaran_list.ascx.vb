...
Partial Public Class ukm3_statustawaran_list
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT a.StudentID,b.StudentFullname,b.MYKAD,b.AlumniID,b.DOB_Year,b.StudentGender,d.CourseCode,e.ClassCode,a.TotalPercentage,a.PPMT,a.Program,a.StatusTawaran,a.StatusDate,a.StatusReason FROM UKM3 a, StudentProfile b, PPCS c,PPCS_Course d,PPCS_Class e"
        ...
        For i = 0 To datRespondent.Rows.Count - 1 Step i + 1
            ...
            If Not chkUpdate Is Nothing Then
                If chkUpdate.Checked = True Then
                    '--UPDATE IF EXIST
                    strSQL = "UPDATE UKM3 SET StatusDate='" & oCommon.getNow & "',StatusTawaran='" & selStatusTawaranUpdate.Value & "',StatusReason='" & oCommon.FixSingleQuotes(txtStatusReason.Text) & "' WHERE StudentID='" & datRespondent.DataKeys(i).Value.ToString & "' AND PPCSDate='" & ddlPPCSDate.Text & "'"
