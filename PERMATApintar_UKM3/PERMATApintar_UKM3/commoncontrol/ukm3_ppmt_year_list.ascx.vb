...
Public Class ukm3_ppmt_year_list
    ...
    Private Sub SchoolState_list()
        strSQL = "SELECT SchoolState FROM SchoolState ORDER BY SchoolState"
        Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strConn)
        Dim sqlDA As New SqlDataAdapter(strSQL, objConn)
    ...
    Private Sub master_Examyear_list()
        ...
        Select Case Server.HtmlEncode(Request.Cookies("ppcs_usertype").Value)
            ...
            Case Else
                strSQL = "SELECT ExamYear FROM master_Examyear WHERE ExamYear='" & Now.Year & "' ORDER BY ExamYear ASC"
        End Select
        Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strConn)
        Dim sqlDA As New SqlDataAdapter(strSQL, objConn)
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT UKM3.UKM3ID,UKM3.StudentID,StudentProfile.StudentFullname,StudentProfile.MYKAD,StudentProfile.AlumniID,StudentProfile.NoPelajar,StudentProfile.DOB_Year,StudentProfile.StudentGender,StudentProfile.StudentRace,StudentProfile.StudentReligion,StudentProfile.StudentEmail,StudentProfile.StudentAddress1,StudentProfile.StudentAddress2,StudentProfile.StudentPostcode,StudentProfile.StudentCity,StudentProfile.StudentState,ParentProfile.FamilyContactNo,ParentProfile.FatherMYKADNo,ParentProfile.FatherFullname,ParentProfile.FatherJob,ParentProfile.MotherMYKADNo,ParentProfile.MotherFullname,ParentProfile.MotherJob,ParentProfile.FamilyContactNoIbu,ParentProfile.FamilyIncome,UKM3.PPMT,UKM3.Program,UKM3.StatusTawaran,UKM3.StatusReason,UKM3.TotalPercentage,SchoolProfile.SchoolCode,SchoolProfile.SchoolName,SchoolProfile.SchoolAddress,SchoolProfile.SchoolPostcode,SchoolProfile.SchoolCity,SchoolProfile.SchoolState,SchoolProfile.SchoolPPD,PPCS_Course.CourseCode,PPCS_Class.ClassCode FROM UKM3"
        ...
        strWhere = " WHERE UKM3.PPYear='" & ddlExamYear.Text & "'"
