...
Partial Public Class ukm3_ppmt_update
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT UKM3.StudentID,StudentProfile.StudentFullname,StudentProfile.MYKAD,StudentProfile.AlumniID,StudentProfile.DOB_Year,StudentProfile.StudentGender,PPCS_Course.CourseCode,PPCS_Class.ClassCode,UKM3.PPMT,UKM3.DisplayStatus,UKM3.Program,UKM3.TotalPercentage FROM UKM3"
