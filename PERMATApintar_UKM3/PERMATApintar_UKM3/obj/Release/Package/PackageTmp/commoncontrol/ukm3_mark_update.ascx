<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ukm3_mark_update.ascx.vb"
    Inherits="permatapintar.ukm3_mark_update" %>
...
<table class="fbform">
        ...
        <td>
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Markah UKM3(%)">
                        <ItemTemplate>
                            <asp:TextBox ID="txtTotalPercentage" runat="server" Width="50px" MaxLength="6" Text='<%# Bind("TotalPercentage", "{0:n2}") %>'></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
    ...
    <tr>
        <td>
            <asp:Button ID="btnTransfer" runat="server" Text="Transfer ke UKM3" CssClass="fbbutton"
                Visible="true" />&nbsp;<asp:Button ID="btnUpdate" runat="server" Text="Kemaskini UKM3" CssClass="fbbutton" />&nbsp;<asp:Button
...
<div class="info" id="divMsg" runat="server">
    <asp:Label ID="lblMsg" runat="server" Text="Sila lakukan carian terlebih dahulu. Transfer ke UKM3 sekali sahaja. Semua pelajar PPCS LAYAK dan TERIMA akan ditransfer jika belum dilakukan lagi."></asp:Label><br />
    isTransfered:<asp:Label ID="lblIsTransfered" runat="server" Text=""></asp:Label>
</div>
