...
Public Class ppcs_ukm
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If Not IsPostBack Then
                ...
                lblPPCSTitle.Text = oCommon.getAppsettings("PPCSTitleUKM")
                lblPPCSSessi.Text = oCommon.getAppsettings("PPCSSessiUKM")
                lblTarikhTutup.Text = oCommon.getAppsettings("PPCSTarikhTutupUKM")
                lblPPCSPPNTradeMark.Text = oCommon.getAppsettings("PPCSPPNTradeMark")

                imgPDF.Visible = False

                '--check if allow publish or not
                If oCommon.getAppsettings("PPCSResultUKM") = "N" Then
    ...
    Private Sub getPPCSInfo()
        ...
        lblPPCSTarikhProgram.Text = oCommon.getAppsettings("PPCSTarikhProgramUKM")
        lblPPCSLokasiProgram.Text = oCommon.getAppsettings("PPCSLokasiProgramUKM")
        lblPPCSTarikhDaftar.Text = oCommon.getAppsettings("PPCSTarikhDaftarUKM")
        lblPPCSMasa.Text = oCommon.getAppsettings("PPCSMasaUKM")
        lblPPCSTempatDaftar.Text = oCommon.getAppsettings("PPCSTempatDaftarUKM")
        'lblPPCSYuran.Text = oCommon.getAppsettings("PPCSYuranUKM")
    ...
    Private Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            msFileName = "surat-tawaran-ukm2017" & lblMYKAD.Text & ".pdf"
            ...
            phrase1.Add(New Chunk("pcspermata@gmail.com ", boldFont))
            ...
            Dim myAlamat01 As New Paragraph("Ketua Unit Program Perkhemahan Cuti Sekolah", FontFactory.GetFont("Arial", 10, Font.NORMAL))
            myAlamat01.Alignment = Element.ALIGN_LEFT
            myDocument.Add(myAlamat01)

            Dim myAlamat02 As New Paragraph("Pusat PERMATApintar Negara", FontFactory.GetFont("Arial", 10, Font.NORMAL))
            myAlamat02.Alignment = Element.ALIGN_LEFT
            myDocument.Add(myAlamat02)

            Dim myAlamat03 As New Paragraph("Universiti Kebangsaan Malaysia", FontFactory.GetFont("Arial", 10, Font.NORMAL))
            myAlamat03.Alignment = Element.ALIGN_LEFT
            myDocument.Add(myAlamat03)

            Dim myAlamat04 As New Paragraph("43600 UKM Bangi, Selangor Darul Ehsan", FontFactory.GetFont("Arial", 10, Font.NORMAL))
            ...
            'myDocument.NewPage()
            '-----
            Dim myPendaftaran00 As New Paragraph("5. Sebarang maklumat atau pertanyaan lanjut boleh menghubungi urusetia  PPCS di talian 0389217521/ 7524/ 7532/ 7533.", FontFactory.GetFont("Arial", 10, Font.NORMAL))
