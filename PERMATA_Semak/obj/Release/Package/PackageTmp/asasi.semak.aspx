<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/default.Master" CodeBehind="asasi.semak.aspx.vb" Inherits="UKM_SEMAKAN.asasi_semak" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table id="mycustomtable">
        <tr>
            <th colspan="2">
                <asp:Label ID="lblASASITitle" runat="server" Text="" ForeColor="Red"></asp:Label>
            </th>
        </tr>
        <tr>
            <td style="width: 20%;">
            ...
            <td>
                <asp:Label ID="lblASASIExamYear" runat="server" Text="" Font-Bold="true"></asp:Label>
            </td>
        </tr>
        <tr>
            <td style="width: 20%;">
        ...
        <tr>
            ...
            <td>
                ...
                <a href="download/asasi2017/Lampiran_1_Tatacara_Pembayaran_Yuran_Pemprosesan_UKM_ASASI.pdf" target="_blank">Lampiran_1_Tatacara_Pembayaran_Yuran_Pemprosesan_UKM_ASASI.pdf</a><br />
                <a href="download/asasi2017/Lampiran_2_Akuan_Pembayaran_Yuran_UKM_ASASIpintar.pdf" target="_blank">Lampiran_2_Akuan_Pembayaran_Yuran_UKM_ASASIpintar.pdf</a><br />
                </asp:Panel>
                    <asp:HyperLink ID="hyPDF" runat="server" Target="_blank" Visible="false">Klik disini.</asp:HyperLink>&nbsp;<br />
            </td>
        </tr>
    ...
    <asp:Panel ID="pnlDisplay" runat="server" Visible="false">
        <table id="mycustomtable">
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="lblSessiASASI" runat="server" Text="" Font-Bold="true"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="vertical-align: top;">
    ...
    <asp:Label ID="lblASASIEnd" runat="server" Text="2" Visible="false"></asp:Label>
