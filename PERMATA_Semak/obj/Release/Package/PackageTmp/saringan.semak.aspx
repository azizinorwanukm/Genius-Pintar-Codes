<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/default.Master" CodeBehind="saringan.semak.aspx.vb" Inherits="UKM_SEMAKAN.saringan_semak" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table id="mycustomtable">
        <tr>
            <th colspan="2">
                <asp:Label ID="lblSaringanTitle" runat="server" Text="" ForeColor="Red"></asp:Label>
            </th>
        </tr>
        <tr>
            <td style="width: 20%;">
            ...
            <td>
                <asp:Label ID="lblSaringanExamYear" runat="server" Text="" Font-Bold="true"></asp:Label>
            </td>
        </tr>
        <tr>
            <td style="width: 20%;">
    ...
    <asp:Panel ID="pnlDisplay" runat="server" Visible="false">
        <table id="mycustomtable">
            ...
            <tr>
                <td style="vertical-align: top;">
                    <asp:Label ID="Label11" runat="server" Text="Muat turun:"></asp:Label>
                </td>
                <td>
                    <ul>
                        <li><a href="download/asasi2016/Lampiran_1_Tatacara_Pembayaran_Yuran.pdf" target="_blank">Lampiran 1: Tatacara Pembayaran Yuran</a></li>
                        <li><a href="download/asasi2016/Lampiran_2_Akuan_Pembayaran_Yuran.pdf" target="_blank">Lampiran 2: Akuan Pembayaran Yuran</a></li>
                    </ul>
                </td>
            </tr>
            <tr>
    ...
    <asp:Label ID="lblSaringanEnd" runat="server" Text="2" Visible="false"></asp:Label>
