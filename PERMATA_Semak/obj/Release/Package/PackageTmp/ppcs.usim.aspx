<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/default.Master" CodeBehind="ppcs.usim.aspx.vb" Inherits="UKM_SEMAKAN.ppcs_usim" %>
            ...
            <td>
                <asp:Panel ID="pnlDisplay" runat="server" Visible="false">
                    ...
                    <p>
                        ...
                        ini.&nbsp;<a href="download\ppcs201712\PPCS_201712_USIM.zip" target="_blank">Klik disini
                            (2.5MB).</a>
                    </p>
                    <p>
                        a) Polisi dan Borang perlu dihantar melalui cara emel:
 Mengimbas/ mengambil gambar borang dan polisi yang telah dilengkapkan terlebih dahulu sebelum dihantar melalui emel <b>keminsan2017@gmail.com</b>. Urusetia akan membuat semakan sama ada borang lengkap atau tidak dan akan dihubungi sekiranya tidak lengkap.
                    </p>
                    <p>
                        b) Dokumen original  boleh dihantar sendiri ke pejabat PPCS  atau dipos kepada:<br />
                        Penyelaras Pra Kolej<br />
                        Program Perkhemahan Cuti Sekolah<br />
                        Kompleks PERMATA Insan<br />
                        Universiti Sains Islam Malaysia<br />
                        71800, Nilai, Negeri Sembilan<br />
                    </p>
                    <p>Sebarang maklumat atau pertanyaan lanjut boleh menghubungi hubungi <b>Encik Nor Adlyizan Bin Theis di 067980117 (tel. pejabat) atau 0132861985 (tel. bimbit)</b></p>
                </asp:Panel>
