<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/default.Master" CodeBehind="kolej_asas1.aspx.vb" Inherits="UKM_SEMAKAN.kolej_asas1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table id="mycustomtable">
        <tr>
            <th colspan="2">SEMAKAN KELAYAKAN KE Kolej PERMATApintar ASAS 1
            </th>
        </tr>
        <tr>
            <td style="width: 20%;">
