...
Public Class kolej_asas1
    ...
    Protected Sub btnSemak_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSemak.Click
        ...
        If ConfigurationManager.AppSettings("ASASResult") = "N" Then
            lblMsg.Text = "Keputusan ASAS belum dimuktamadkan lagi!"
        ...
        If isKolejEND() = True Then
            ...
            lblMsg.Text = "Tarikh akhir penerimaan dan penolakan tawaran telah tamat."
            Exit Sub
        Else
