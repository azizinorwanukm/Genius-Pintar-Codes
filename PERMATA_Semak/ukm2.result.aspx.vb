...
Public Class ukm2_result
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If Not IsPostBack Then
                ...
                lblUKM2ID.Text = Request.QueryString("ukm2id")
    ...
    Private Sub Screen_load()
        ...
        strSQL = "SELECT StudentID FROM UKM2 WHERE StudentID='" & oCommon.FixSingleQuotes(lblStudentID.Text) & "' AND UKM2ID=" & oCommon.FixSingleQuotes(lblUKM2ID.Text)
        ...
        '--ExamYear
        strSQL = "SELECT ExamYear FROM UKM2 WHERE StudentID='" & oCommon.FixSingleQuotes(lblStudentID.Text) & "' AND UKM2ID=" & oCommon.FixSingleQuotes(lblUKM2ID.Text)
        lblExamYear.Text = oCommon.getFieldValue(strSQL)

        '--jika ada cubaan menukar URL
        If lblExamYear.Text.Length > 0 Then
            divMsg.Attributes("class") = "info"
            lblMsg.Text = "TAHNIAH! Anda LAYAK ke Ujian UKM2 bagi tahun " & lblExamYear.Text & "."
        Else
            divMsg.Attributes("class") = "error"
            lblMsg.Text = "Maklumat mengenai UKM2 anda tidak ditemui!"
            Exit Sub
        End If
    ...
    Private Sub PusatUjian_view()
        ...
        strWhere += " WHERE UKM2ID=" & lblUKM2ID.Text
    ...
    Private Function ValidatePage() As Boolean
        If lblMYKAD.Text.Length = 0 Then
            lblMYKAD.Focus()
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            msFileName = "surat-tawaran-" & oCommon.getToday & "-" & lblMYKAD.Text & ".pdf"
            ...
            myDocument.AddSubject("Menamatkan Ujian Dalam Talian UKM1 " & oCommon.getAppsettings("DefaultExamYear"))
            ...
            Dim myPara4 As New Paragraph(lblMYKAD.Text, FontFactory.GetFont("Arial", 12, Font.NORMAL))
