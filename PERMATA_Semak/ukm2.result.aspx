<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/default.Master" CodeBehind="ukm2.result.aspx.vb" Inherits="UKM_SEMAKAN.ukm2_result" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table id="mycustomtable">
        <tr>
            <th colspan="2">KELAYAKAN KE UJIAN UKM2 TAHUN
        ...
        <tr>
            <td></td>
            <td>
                <asp:Button ID="btnPrint" runat="server" Text="Cetak PDF" CssClass="fbbutton" Enabled="false" />
                &nbsp;
    ...
    <asp:Label ID="lblUKM2ID" runat="server" Text="1" Visible="false"></asp:Label>
