<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/default.Master" CodeBehind="ukm2.semak.aspx.vb" Inherits="UKM_SEMAKAN.ukm2_semak" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table id="mycustomtable">
        ...
        <tr>
            <td><a href="https://get.adobe.com/reader/" target="_blank"><img id="imgPDF" src="images/get-adobe-reader.gif" alt="get-adobe" style="height:25px;width:150px; vertical-align:bottom;" runat="server"/></a></td>
            <td>
    ...
    <asp:Panel ID="pnlDisplay" runat="server" Visible="false">
        <table id="mycustomtable">
            ...
            <tr>
                <td>
                    <asp:Label ID="Label2" runat="server" Text="Nama Pusat Ujian:" Font-Bold="true"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td colspan="2">
                    <b>Sila berpakaian sekolah dengan tag nama dan lencana sekolah dan pastikan anda membawa bersama MYKAD/MYKID/Surat Beranak sebagai bukti pengesahan.</b>
                </td>
            </tr>
        </table>
        <br />
