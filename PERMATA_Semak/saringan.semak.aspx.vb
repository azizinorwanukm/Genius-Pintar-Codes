...
Public Class saringan_semak
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If Not IsPostBack Then
                If oCommon.isConfigEnable("SEMAK_ASASI") = False Then
                    Response.Redirect("default.aspx")
                End If

                lblSaringanExamYear.Text = oCommon.getAppsettings("SaringanExamYear")
                lblSaringanEnd.Text = oCommon.getAppsettings("SaringanEnd")
                lblSaringanTitle.Text = oCommon.getAppsettings("SaringanTitle")
    ...
    Protected Sub btnSemak_Click(sender As Object, e As EventArgs) Handles btnSemak.Click
        ...
        If oCommon.getAppsettings("SaringanResult") = "N" Then
            lblMsg.Text = "Keputusan " & lblSaringanTitle.Text & " belum dimuktamadkan lagi!"
        ...
        If IsLayak() = True Then
            ...
            lblMsg.Text = "TAHNIAH! Anda BERJAYA ke " & oCommon.getAppsettings("SaringanTitle")
        ...
        Else
            divMsg.Attributes("class") = "error"
            lblMsg.Text = "Anda tidak berjaya ke " & oCommon.getAppsettings("SaringanTitle")
            lblMsgTop.Text = lblMsg.Text
    ...
    Private Sub UKM2_view()
        ...
        strWhere = " WHERE StudentID='" & lblStudentID.Text & "' AND ExamYear='" & oCommon.getAppsettings("SaringanExamYear") & "'"
        strSQL = tmpSQL + strWhere
        '--debug
        'Response.Write(strSQL)
    ...
    Private Function IsLayak() As Boolean
        ...
        strSQL = "SELECT StudentID FROM UKM2 WHERE StudentID='" & strStudentID & "' AND ExamYear='" & oCommon.getAppsettings("SaringanExamYear") & "'"
    ...
    Private Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            myDocument.AddSubject("TAHNIAH! Anda BERJAYA ke " & lblSaringanTitle.Text)
            ...
            Dim myTitle As New Paragraph(lblSaringanTitle.Text, FontFactory.GetFont("Arial", 10, Font.BOLD))
            ...
            '--body
            Dim strBody As String = "Adalah dengan sukacitanya dimaklumkan bahawa saudara/i dikehendaki untuk hadir mengikuti ujian saringan UKM-ASASIpintar bagi kemasukan ke Program ASASIpintar UKM sesi akademik 2016 – 2017. Ujian saringan UKM-ASASIpintar ini adalah ujian atas talian dan wajib bagi pelajar yang ingin meneruskan pengajian ke ASASIpintar UKM. Saudara/i dikehendaki untuk membuat pembayaran sebanyak RM 20.00 sebagai yuran pemprosesan ujian ini.  Sila rujuk Lampiran 1 untuk Tatacara Pembayaran Yuran."
            ...
            strBody = "Saudara/i juga dikehendaki berpakaian kemas dan membawa kad pengenalan diri semasa menghadiri ujian saringan UKM-ASASIpintar ini. Sebarang pertanyaan lanjut boleh berhubung terus dengan Puan Siti Hawa bt Abu Samah di atas talian 03-89217513 / 03-89217512 atau melalui email permatapintar@ukm.edu.my"
            ...
            '----
            strBody = "Sekian. Kehadiran saudara/i dalam sesi ujian saringan tersebut didahului dengan ucapan ribuan terima kasih."
