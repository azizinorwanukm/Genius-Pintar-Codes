...
Public Class kolej
    ...
    Protected Sub btnSemak_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSemak.Click
        ...
        If ConfigurationManager.AppSettings("KOLEJResult") = "N" Then
            lblMsg.Text = "Keputusan KOLEJ belum dimuktamadkan lagi!"
    ...
    Private Sub StudentProfile_view()
        ...
        Try
            ...
            If MyTable.Rows.Count > 0 Then
                ...
                lnkTawaran.NavigateUrl = "download\2015surat_tawaran_kolej\" & lblNoPelajar.Text & ".pdf"
