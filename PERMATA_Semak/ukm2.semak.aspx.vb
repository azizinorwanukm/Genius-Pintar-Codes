...
Public Class ukm2_semak
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If Not IsPostBack Then
                If oCommon.getAppsettings("SEMAK_UKM2") = "N" Then
    ...
    Private Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            msFileName = "surat-tawaran-" & oCommon.getTodayHHMM & "-" & txtMYKAD.Text & ".pdf"
            ...
            myDocument.AddSubject("Surat tawaran: " & oCommon.getAppsettings("UKM2Title"))
            ...
            Dim myPara2 As New Paragraph("Tarikh :" & oCommon.getDateTime(), FontFactory.GetFont("Arial", 12, Font.BOLD))
            ...
            Dim myPara12 As New Paragraph("Pusat Ujian :" & lblPusatName.Text, FontFactory.GetFont("Arial", 12, Font.BOLD))
            myPara12.Alignment = Element.ALIGN_LEFT
            myDocument.Add(myPara12)

            Dim myPara12a As New Paragraph(lblPusatAddress.Text, FontFactory.GetFont("Arial", 12, Font.NORMAL))
            myPara12.Alignment = Element.ALIGN_LEFT
            myDocument.Add(myPara12a)
            Dim myPara12b As New Paragraph(lblPusatPostcode.Text & ", " & lblPusatCity.Text & ", " & lblPusatState.Text, FontFactory.GetFont("Arial", 12, Font.NORMAL))
            myPara12.Alignment = Element.ALIGN_LEFT
            myDocument.Add(myPara12b)
            ...
            Dim myPara14 As New Paragraph("Sessi :" & lblSessiUKM2.Text, FontFactory.GetFont("Arial", 12, Font.BOLD))
            ...
            myDocument.Add(chnkLINE)
            Dim myPara18 As New Paragraph("Anda perlu tiba di pusat ujian, 30 minit sebelum sesi ujian dijalankan. Sila berpakaian sekolah dengan tag nama dan lencana sekolah dan pastikan anda membawa bersama MYKAD/MYKID/Surat Beranak sebagai bukti pengesahan.", FontFactory.GetFont("Arial", 12, Font.NORMAL))
            ...
            hyPDF.Text = "Klik disini untuk buka surat tawaran (PDF Format)."
            imgPDF.Visible = True
