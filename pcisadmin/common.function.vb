...
Public Class Commonfunction
    ...
    Public Function getAppsettings(ByVal strsettingname As String) As String
        Dim strRet As String = ""
        Dim strSQL As String = ""

        strSQL = "SELECT configString FROM pcis_config WHERE configCode='" & strsettingname & "'"
        strRet = getFieldValue(strSQL)

        Return strRet
    End Function

    Public Function getpcis_setting(ByVal strsettingname As String) As String
        Dim strRet As String = ""
        Dim strSQL As String = ""
    ...
    Public Function isDebug() As Boolean
        ...
        tmpSQL = "SELECT configString FROM pcis_config WHERE configCode='isDebug'"
        If getFieldValue(tmpSQL) = "Y" Then
            Return True
        Else
            Return False
        End If
