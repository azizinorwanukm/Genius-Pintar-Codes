<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="pcis_summary_age.ascx.vb" Inherits="araken.pcisadmin.pcis_summary_age" %>
<table class="fbform">
    ...
    <tr>
        <td>
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                CellPadding="4" ForeColor="#333333" GridLines="None" DataKeyNames="year"
