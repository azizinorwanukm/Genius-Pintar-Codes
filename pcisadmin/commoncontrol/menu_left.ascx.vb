...
Public Class menu_left
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If Not IsPostBack Then
                '--debug
                'Response.Write("menu_left:" & Request.Cookies("pcis_admin").Value)
    ...
    Private Sub pcis_admin_load()


        strSQL = "SELECT LoginID,Fullname,UserType FROM pcis_admin WHERE loginid='" & Request.Cookies("pcis_admin").Value & "'"
