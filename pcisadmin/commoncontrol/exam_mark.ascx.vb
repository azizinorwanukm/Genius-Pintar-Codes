...
Public Class exam_mark
    ...
    Protected Sub btnExportDetail_Click(sender As Object, e As EventArgs) Handles btnExportDetail.Click
        Try
            Dim strFilename As String = "ExportDetail-" & oCommon.getRandom & ".csv"
            ExportToCSVSP("spReportAnalysis", strFilename)
