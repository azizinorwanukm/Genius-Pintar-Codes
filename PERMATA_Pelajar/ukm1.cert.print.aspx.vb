...
Partial Public Class ukm1_cert_print
    ...
    Private Sub StudentProfile_load()
        ...
        strSQL = "SELECT MYKAD,StudentFullname FROM StudentProfile WITH (NOLOCK) WHERE StudentID='" & CType(Session.Item("permata_studentid"), String) & "'"
    ...
    Private Sub btnCreate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCreate.Click
        ...
        Try
            ...
            msFileName = CType(Session.Item("permata_studentid"), String) & "-" & ExamYear.Text & ".pdf"
            ...
            myDocument.Add(New Paragraph("E-Mail: permatapintar@ukm.edu.my"))
