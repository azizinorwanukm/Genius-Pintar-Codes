...
Partial Public Class ukm2_semak
    ...
    Private Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        strSQL = "SELECT StudentID FROM UKM2 WHERE StudentID='" & CType(Session.Item("permata_studentid"), String) & "' AND ExamYear='" & ddlExamYear.Text & "' AND Status='DONE'"
        ...
        Response.Redirect("ukm2.permata.end.aspx?studentid=" & CType(Session.Item("permata_studentid"), String) & "&examyear=" & ddlExamYear.Text)
    End Sub
