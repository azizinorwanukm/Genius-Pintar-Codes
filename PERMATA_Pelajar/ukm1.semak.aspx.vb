...
Partial Public Class ukm1_semak
    ...
    Private Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        strSQL = "SELECT StudentID FROM UKM1 WITH (NOLOCK) WHERE StudentID='" & CType(Session.Item("permata_studentid"), String) & "' AND ExamYear='" & ddlExamYear.Text & "' AND Status='DONE'"
        ...
        Response.Redirect("ukm1.permata.end.aspx?studentid=" & CType(Session.Item("permata_studentid"), String) & "&examyear=" & ddlExamYear.Text)
    End Sub
    ...
    Private Sub getDuration()
        ...
        strSQL = "SELECT ExamStart FROM UKM1 WITH (NOLOCK) WHERE StudentID='" & CType(Session.Item("permata_studentid"), String) & "' AND ExamYear='" & ddlExamYear.Text & "'"
        ...
        strSQL = "SELECT ExamEnd FROM UKM1 WITH (NOLOCK) WHERE StudentID='" & CType(Session.Item("permata_studentid"), String) & "' AND ExamYear='" & ddlExamYear.Text & "'"
