<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/main.Master" CodeBehind="student.schoolprofile.search.change.aspx.vb" Inherits="permatapintar.student_schoolprofile_search_change" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p>
        <asp:Label Font-Size="Large" ID="lblNewSchool" runat="server" Text="Note: Jika Pelajar / Guru / Ibu bapa  tidak memilih sekolah sedia ada dalam senarai database KPM dan MARA, maka pelajar tidak akan dipertimbangkan untuk ke ujian UKM2.<br />Kod XXX hanya untuk <b>sekolah antarabangsa dan persendirian sahaja.</b>"></asp:Label>
