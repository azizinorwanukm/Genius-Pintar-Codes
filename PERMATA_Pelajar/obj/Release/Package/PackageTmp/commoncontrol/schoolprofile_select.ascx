<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="schoolprofile_select.ascx.vb"
    Inherits="permatapintar.schoolprofile_select1" %>
<table class="fbform">
    ...
    <tr>
        ...
        <td>
            ...
            <asp:Button ID="btnSearch" runat="server" Text="Carian Sekolah" CssClass="fbbutton" />&nbsp;
        </td>
    </tr>
</table>
<div class="info">
    • Carian hanya untuk sekolah yang berdaftar dengan Kem. Pelajaran Malaysia sahaja.<br />
    • Masukkan Nama Sekolah atau Kod Sekolah. Contoh masukkan 'Telok Intan' untuk carian
    'SM (SAINS) TELOK INTAN'</div>
<div class="warning">
