...
Partial Public Class ppcs_view
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            '--ppcsdate_list
            ppcsdate_list()
            ddlPPCSDate.Text = "PPCS DIS 2013"  '--TODO: update this next year
        End If
    ...
    Private Function getUserProfile_UserType() As String
        strSQL = "SELECT UserType FROM PPCS_Users WHERE loginid='" & Request.Cookies("ppcs_loginid").Value & "'"
    ...
    Private Sub ppcsdate_list()
        strSQL = "SELECT PPCSDate FROM master_PPCSDate ORDER BY ppcsid DESC"
    ...
    Private Sub ppcs_view()
        ...
        strSQL = "SELECT * FROM PPCS WHERE StudentID='" & CType(Session.Item("permata_studentid"), String) & "' AND PPCSDate='" & ddlPPCSDate.Text & "'"
        Dim sqlDA As New SqlDataAdapter(strSQL, objConn)
        Try
            Dim ds As DataSet = New DataSet
            sqlDA.Fill(ds, "AnyTable")
    ...
    Private Sub lnkEdit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkEdit.Click
        Response.Redirect("ppcs.update.aspx?studentid=" & CType(Session.Item("permata_studentid"), String) & "&ppcsdate=" & ddlPPCSDate.Text)
