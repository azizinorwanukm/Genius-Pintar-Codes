...
<table class="fbform">
    ...
    <tr>
        ...
        <td>
            :<asp:Label ID="lblPwd" runat="server" Text="" CssClass="fblabel_view"></asp:Label>&nbsp;[Kata
    ...
    <tr>
        <td></td>
        <td>:Kecenderungan bagi pelajar berumur 8-12 tahun :
            <asp:Label ID="lblKecenderungan" runat="server" Text="" CssClass="fblabel_view"></asp:Label>
        </td>
    </tr>
     <tr>
        <td>&nbsp;
...
<asp:Label ID="lblStudentType" runat="server" Text="" CssClass="fblabel_view" Visible="false"></asp:Label>
