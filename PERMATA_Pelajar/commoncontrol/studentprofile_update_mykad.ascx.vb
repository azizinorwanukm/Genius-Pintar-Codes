...
Partial Public Class studentprofile_update_mykad
    ...
    Private Sub master_State_list()
        ...
        Try
            ...
            '--TO HANDLE LUAR NEGARA
            ddlStudentState.Items.Add(New ListItem("LAIN-LAIN", "LAIN-LAIN"))
    ...
    Private Sub Cenderung_list()
        strSQL = "SELECT id, kecenderungan FROM master_cenderung ORDER BY idx"
        Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strConn)
        Dim sqlDA As New SqlDataAdapter(strSQL, objConn)
    ...
    Private Sub LoadPage()
        strSQL = "Select * FROM StudentProfile Where StudentID='" & CType(Session.Item("permata_studentid"), String) & "'"
        Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strConn)
        Dim sqlDA As New SqlDataAdapter(strSQL, objConn)
        ...
        Try
            ...
            If MyTable.Rows.Count > 0 Then
                ...
                If Not IsDBNull(ds.Tables(0).Rows(0).Item("AlumniID")) Then
                    ...
                    lblAlumniID_ori.Text = lblAlumniID.Text
                Else
                    lblAlumniID.Text = ""
                End If
                ...
                If Not IsDBNull(ds.Tables(0).Rows(0).Item("NoPelajar")) Then
                    ...
                    lblNoPelajar_ori.Text = lblNoPelajar.Text
                Else
                    lblNoPelajar.Text = ""
                ...
                imgStudent.ImageUrl = "~/ShowImage.ashx?studentid=" & CType(Session.Item("permata_studentid"), String)
    ...
    Private Function StudentProfile_update() As String
        Try
            '--AlumniID=NULL
            If ddlCenderung.SelectedValue.Length = 0 Then
                strSQL = "UPDATE StudentProfile SET IsUpdated='Y',MYKAD='" & oCommon.FixSingleQuotes(txtMYKAD.Text) & "',StudentFullname='" & oCommon.FixSingleQuotes(txtStudentFullname.Text.ToUpper) & "',StudentGender='" & selStudentGender.Value & "',DOB_day='" & selStudentDOB_day.Value & "',DOB_month='" & selStudentDOB_month.Value & "',DOB_year='" & ddlDOB_Year.Text & "',StudentForm='" & ddlStudentForm.Text & "',StudentRace='" & ddlStudentRace.Text & "',StudentReligion='" & ddlStudentReligion.Text & "',TalkBM='" & chkTalkBM.Checked & "',TalkBI='" & chkTalkBI.Checked & "',TalkMan='" & chkTalkMan.Checked & "',TalkTamil='" & chkTalkTamil.Checked & "',TalkArab='" & chkTalkArab.Checked & "',WriteBM='" & chkWriteBM.Checked & "',WriteBI='" & chkWriteBI.Checked & "',WriteMan='" & chkWriteMan.Checked & "',WriteTamil='" & chkWriteTamil.Checked & "',WriteArab='" & chkWriteArab.Checked & "',StudentAddress1='" & oCommon.FixSingleQuotes(txtStudentAddress1.Text.ToUpper) & "',StudentAddress2='" & oCommon.FixSingleQuotes(txtStudentAddress2.Text.ToUpper) & "',StudentPostcode='" & txtStudentPostcode.Text & "',StudentCity='" & oCommon.FixSingleQuotes(txtStudentCity.Text.ToUpper) & "',StudentState='" & ddlStudentState.Text & "',StudentCountry='" & ddlStudentCountry.Text & "',StudentEmail='" & oCommon.FixSingleQuotes(txtStudentEmail.Text) & "',Pwd='" & oCommon.FixSingleQuotes(txtPwd.Text) & "',StudentContactNo='" & oCommon.FixSingleQuotes(txtStudentContactNo.Text) & "',Kecenderungan='8',StudentType='" & lblStudentType.Text & "',AlumniID='" & oCommon.FixSingleQuotes(lblAlumniID.Text) & "',NoPelajar='" & oCommon.FixSingleQuotes(lblNoPelajar.Text) & "' WHERE StudentID='" & CType(Session.Item("permata_studentid"), String) & "'"
            Else
                strSQL = "UPDATE StudentProfile SET IsUpdated='Y',MYKAD='" & oCommon.FixSingleQuotes(txtMYKAD.Text) & "',StudentFullname='" & oCommon.FixSingleQuotes(txtStudentFullname.Text.ToUpper) & "',StudentGender='" & selStudentGender.Value & "',DOB_day='" & selStudentDOB_day.Value & "',DOB_month='" & selStudentDOB_month.Value & "',DOB_year='" & ddlDOB_Year.Text & "',StudentForm='" & ddlStudentForm.Text & "',StudentRace='" & ddlStudentRace.Text & "',StudentReligion='" & ddlStudentReligion.Text & "',TalkBM='" & chkTalkBM.Checked & "',TalkBI='" & chkTalkBI.Checked & "',TalkMan='" & chkTalkMan.Checked & "',TalkTamil='" & chkTalkTamil.Checked & "',TalkArab='" & chkTalkArab.Checked & "',WriteBM='" & chkWriteBM.Checked & "',WriteBI='" & chkWriteBI.Checked & "',WriteMan='" & chkWriteMan.Checked & "',WriteTamil='" & chkWriteTamil.Checked & "',WriteArab='" & chkWriteArab.Checked & "',StudentAddress1='" & oCommon.FixSingleQuotes(txtStudentAddress1.Text.ToUpper) & "',StudentAddress2='" & oCommon.FixSingleQuotes(txtStudentAddress2.Text.ToUpper) & "',StudentPostcode='" & txtStudentPostcode.Text & "',StudentCity='" & oCommon.FixSingleQuotes(txtStudentCity.Text.ToUpper) & "',StudentState='" & ddlStudentState.Text & "',StudentCountry='" & ddlStudentCountry.Text & "',StudentEmail='" & oCommon.FixSingleQuotes(txtStudentEmail.Text) & "',Pwd='" & oCommon.FixSingleQuotes(txtPwd.Text) & "',StudentContactNo='" & oCommon.FixSingleQuotes(txtStudentContactNo.Text) & "',Kecenderungan='" & ddlCenderung.SelectedValue & "',StudentType='" & lblStudentType.Text & "',AlumniID='" & oCommon.FixSingleQuotes(lblAlumniID.Text) & "',NoPelajar='" & oCommon.FixSingleQuotes(lblNoPelajar.Text) & "' WHERE StudentID='" & CType(Session.Item("permata_studentid"), String) & "'"
            End If
            strRet = oCommon.ExecuteSQL(strSQL)

            ''log
            Dim strLog As String = oCommon.TransactionLog("studentprofile_update", oCommon.FixSingleQuotes(strSQL), Request.UserHostAddress, CType(Session.Item("permata_mykad"), String))
            lblDebug.Text = oCommon.displayDebug(strLog)
    ...
    Private Function ukm1_DOBYear_StudentReligion_update() As Boolean
        ...
        ''update UKM1
        strSQL = "UPDATE UKM1 WITH (UPDLOCK) SET IsCount=" & nIsCount & ",DOB_Year='" & oCommon.FixSingleQuotes(ddlDOB_Year.Text) & "',StudentReligion='" & oCommon.FixSingleQuotes(ddlStudentReligion.Text) & "' WHERE StudentID='" & CType(Session.Item("permata_studentid"), String) & "' AND ExamYear='" & Now.Year & "'"
        '--debug
        ...
        '--log
        'lblLog.Text += "ukm1_DOBYear_StudentReligion_update:" & strRet & "<br />"

    End Function

    Private Function getIsCount() As Integer
        '--DOB_YEAR. 8-15 tahun?
        strSQL = "SELECT DOB_Year FROM StudentProfile WHERE StudentID='" & CType(Session.Item("permata_studentid"), String) & "'"
        Dim nDOB_Year As Integer = oCommon.getFieldValueInt(strSQL)

        '--current year
        Dim nYear As Integer = oCommon.getAppsettings("DefaultExamYear")
        ...
        '--get StudentReligion
        strSQL = "SELECT StudentReligion FROM StudentProfile WHERE StudentID='" & CType(Session.Item("permata_studentid"), String) & "'"
    ...
    Private Sub btnUpload_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpload.Click
        ...
        strSQL = "SELECT StudentID FROM StudentPhoto WHERE StudentID='" & CType(Session.Item("permata_studentid"), String) & "'"
        If oCommon.isExist(strSQL) = True Then
            Studentphoto_Update()
        Else
            Studentphoto_Insert()
    ...
    Private Sub Studentphoto_Insert()
        ...
        Try
            ...
            cmd.Parameters.AddWithValue("@StudentID", CType(Session.Item("permata_studentid"), String))
    ...
    Private Sub Studentphoto_Update()
        ...
        Try
            ...
            objConn.Open()
            strSQL = "UPDATE StudentPhoto SET SmallPhoto=@SmallPhoto WHERE StudentID='" & CType(Session.Item("permata_studentid"), String) & "'"
