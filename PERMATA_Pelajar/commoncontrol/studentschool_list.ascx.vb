...
Public Class studentschool_list
    ...
    Private Function getSQL() As String
        ...
        strWhere = " WHERE StudentID='" & CType(Session.Item("permata_studentid"), String) & "'"
    ...
    ''Case "ADMIN"
    ''              Response.Redirect("admin.studentschool.update.aspx?studentschoolid=" & strKeyID & "&studentid=" & CType(Session.Item("permata_studentid"), String))
    ''Case "ADMINOP"
    ''              Response.Redirect("studentschool.update.aspx?studentschoolid=" & strKeyID & "&studentid=" & CType(Session.Item("permata_studentid"), String))
    ''Case Else
