...
<table class="fbform">
    ...
    <tr>
        ...
        <td>
            :<asp:Label ID="lblFamilyIncome" runat="server" Text="" CssClass="fblabel_view"></asp:Label>&nbsp;sebulan
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            :<asp:Label ID="lblJumlahAnak" runat="server" Text="" CssClass="fblabel_view"></asp:Label>&nbsp;[Yang masih bersekolah]
        </td>
    </tr>
    <tr>
        <td>
