...
Partial Public Class studentprofile_view1
    ...
    Private Sub LoadPage()
        strSQL = "SELECT A.*, B.kecenderungan cenderung FROM StudentProfile A left join master_cenderung B on A.kecenderungan = B.id WHERE StudentID='" & CType(Session.Item("permata_studentid"), String) & "'"
        ''debug
        ...
        Try
            ...
            If MyTable.Rows.Count > 0 Then
                ...
                If Not IsDBNull(ds.Tables(0).Rows(0).Item("cenderung")) Then
                    lblKecenderungan.Text = ds.Tables(0).Rows(0).Item("cenderung")
                Else
    ...
    Private Sub lnkEdit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkEdit.Click
        Response.Redirect("studentprofile.update.mykad.aspx")
