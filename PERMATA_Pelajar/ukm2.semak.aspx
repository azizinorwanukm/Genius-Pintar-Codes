<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/main.Master" CodeBehind="ukm2.semak.aspx.vb" Inherits="permatapintar.ukm2_semak" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="fbform">
        ...
        <tr>
            ...
            <td>
                Nota: Untuk yang menghabiskan Ujian UKM2 sahaja. Status=DONE.
            </td>
        </tr>
        <tr>
