...
Partial Public Class studentprofile_update_mykad
    ...
    Private Sub Studentphoto_Insert()
        ...
        Try
            ...
            imgStudent.ImageUrl = "~/ShowImage.ashx?studentid=" & Request.QueryString("studentid")
        Catch
            lblMsg.Text = "System Error. Contact Admin"
        Finally
            objConn.Close()
        End Try
