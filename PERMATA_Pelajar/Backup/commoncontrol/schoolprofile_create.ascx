...
<table class="fbform">
    ...
    <tr>
        ...
        <td>
            :<asp:TextBox ID="txtSchoolCode" runat="server" Width="250px" MaxLength="50" Text="XXX"
...
<div class="info" id="divMsg" runat="server">
    <asp:Label Font-Size="Large" ID="lblMsg" runat="server" Text="*Jika Pelajar / Guru / Ibu bapa tidak memilih sekolah sedia ada dalam senarai database KPM dan MARA, maka pelajar tidak akan dipertimbangkan untuk ke ujian UKM2. Kod XXX hanya untuk <b>sekolah antarabangsa, dan persendirian sahaja.</b>"></asp:Label></div>
