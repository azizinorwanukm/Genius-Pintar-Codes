...
Partial Public Class schoolprofile_create
    ...
    Private Function schoolprofile_view() As Boolean
        ...
        strSQL = "SELECT SchoolID FROM StudentSchool WITH (NOLOCK) WHERE StudentID='" & Request.QueryString("studentid") & "'"
    ...
    Private Sub btnConfirm_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnConfirm.Click
        ...
        strSQL = "SELECT StudentID from StudentSchool WHERE StudentID='" & Request.QueryString("studentid") & "'"
    ...
    Private Function StudentSchool_update() As String
        ...
        strSQL = "UPDATE StudentSchool WITH (UPDLOCK) SET SchoolID='" & lblSchoolID.Text & "',StartDate='" & strStartDate & "',EndDate='" & strEndDate & "' WHERE StudentID='" & Request.QueryString("studentid") & "'"
        strRet = oCommon.ExecuteSQL(strSQL)
