...
Partial Public Class ukm2_permata_end
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If Not IsPostBack Then
                ...
                UKM2Result.Text = ConfigurationManager.AppSettings("UKM2Result")
    ...
    Private Function getTotalscore() As String
        strSQL = "SELECT TotalScore FROM UKM2 WHERE StudentID='" & Request.QueryString("studentid") & "' AND ExamYear='" & Request.QueryString("examyear") & "'"
    ...
    Private Sub setUKM2DONE()
        ''--update once only
        strSQL = "SELECT Status FROM UKM2 WITH (NOLOCK) WHERE StudentID='" & Request.QueryString("studentid") & "' AND ExamYear='" & Request.QueryString("examyear") & "'"
    ...
    Private Sub GenerateIndex()
        ...
        strSQL = "SELECT SUM(isnull(Mod02,0)+isnull(Mod06,0)+isnull(Mod09,0)+isnull(Mod13,0)+isnull(Mod15,0)) as SumA FROM UKM2 WHERE StudentID='" & Request.QueryString("studentid") & "' AND ExamYear='" & Request.QueryString("examyear") & "'"
        strVCI = oCommon.getFieldValue(strSQL)

        'PRI (Perseptual Reasoning Index)	1+4+8+12 (science+math)
        strSQL = "SELECT SUM(isnull(Mod01,0)+isnull(Mod04,0)+isnull(Mod08,0)+isnull(Mod12,0)) as SumA FROM UKM2 WHERE StudentID='" & Request.QueryString("studentid") & "' AND ExamYear='" & Request.QueryString("examyear") & "'"
        strPRI = oCommon.getFieldValue(strSQL)

        'WMI(Working Memory Index)	3+7+14 (sokongan VCI/PRI)
        strSQL = "SELECT SUM(isnull(Mod03,0)+isnull(Mod07,0)+isnull(Mod14,0)) as SumA FROM UKM2 WHERE StudentID='" & Request.QueryString("studentid") & "' AND ExamYear='" & Request.QueryString("examyear") & "'"
        strWMI = oCommon.getFieldValue(strSQL)

        'PSI(Processing Speed Index)	5+10+11 (sokongan VCI/PRI)
        strSQL = "SELECT SUM(isnull(Mod05,0)+isnull(Mod10,0)+isnull(Mod11,0)) as SumA FROM UKM2 WHERE StudentID='" & Request.QueryString("studentid") & "' AND ExamYear='" & Request.QueryString("examyear") & "'"
        strPSI = oCommon.getFieldValue(strSQL)

        ''OK
        strSQL = "UPDATE UKM2 WITH (UPDLOCK) SET VCI=" & strVCI & ",PRI=" & strPRI & ",WMI=" & strWMI & ",PSI=" & strPSI & " WHERE StudentID='" & Request.QueryString("studentid") & "' AND ExamYear='" & Request.QueryString("examyear") & "'"
        strRet = oCommon.ExecuteSQL(strSQL)

        'get strTotalScore. NOK
        strSQL = "SELECT SUM(isnull(VCI,0)+isnull(PRI,0)+isnull(WMI,0)+isnull(PSI,0)) as SumA FROM UKM2 WHERE StudentID='" & Request.QueryString("studentid") & "' AND ExamYear='" & Request.QueryString("examyear") & "'"
        ...
        strSQL = "UPDATE UKM2 WITH (UPDLOCK) SET FullMark=692,TotalPercentage=" & strTotalPercentage & ",TotalScore=" & strTotalScore & " WHERE StudentID='" & Request.QueryString("studentid") & "' AND ExamYear='" & Request.QueryString("examyear") & "'"
        strRet = oCommon.ExecuteSQL(strSQL)
    ...
    Private Sub StudentProfile_load()
        ...
        strSQL = "SELECT MYKAD,StudentFullname,DOB_Year FROM StudentProfile WITH (NOLOCK) WHERE StudentID='" & Request.QueryString("studentid") & "'"
    ...
    Private Sub getDuration()
        ...
        strSQL = "SELECT ExamStart FROM UKM2 WHERE StudentID='" & Request.QueryString("studentid") & "' AND ExamYear='" & Request.QueryString("examyear") & "'"
        ...
        strSQL = "SELECT ExamEnd FROM UKM2 WHERE StudentID='" & Request.QueryString("studentid") & "' AND ExamYear='" & Request.QueryString("examyear") & "'"
    ...
    Private Sub btnCreate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCreate.Click
        ...
        Try
            ...
            msFileName = Request.QueryString("studentid") & "-UKM2-" & lblExamYear.Text & ".pdf"
