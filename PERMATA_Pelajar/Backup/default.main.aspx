...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="info">
        ...
        <ul>
            <li>Anda dikehendaki mengemaskini maklumat diri, sekolah dan ibubapa/penjaga anda. <a href="studentprofile.complete.view.aspx?studentid=<%=Request.QueryString("studentid")%>" rel="nofollow" target="_self">Klik di sini.</a></li>
