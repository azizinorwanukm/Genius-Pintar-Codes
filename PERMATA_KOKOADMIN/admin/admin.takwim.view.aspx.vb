...
Public Class admin_takwim_view
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        Response.Redirect("admin.takwim.update.aspx?takwimid=" & Request.QueryString("takwimid") & "&admin_ID=" & Request.QueryString("admin_ID"))

    End Sub

    Protected Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        strSQL = "DELETE koko_takwim WHERE TakwimID=" & Request.QueryString("takwimid")
