...
Public Class instruktor_create
    ...
    Private Sub btnCreate_Click(sender As Object, e As EventArgs) Handles btnCreate.Click
        Try
            ...
            'insert into koko_instruktor
            strSQL = "INSERT INTO koko_instruktor(InstruktorID,Tahun,Fullname,ContactNo,Email,MYKAD,BankName,AcctNo,Address1,Address2,PostCode,City,State,KelasID,UniformID,PersatuanId,SukanID,RumahsukanID,LoginID,Pwd) VALUES ('" & strInstruktorID & "','" & txtTahun.Text & "','" & oCommon.FixSingleQuotes(txtFullname.Text.ToUpper) & "','" & oCommon.FixSingleQuotes(txtContactNo.Text) & "','" & oCommon.FixSingleQuotes(txtEmail.Text) & "','" & oCommon.FixSingleQuotes(txtMYKAD.Text.ToUpper) & "','" & oCommon.FixSingleQuotes(txtBankName.Text.ToUpper) & "','" & oCommon.FixSingleQuotes(txtAcctNo.Text) & "','" & oCommon.FixSingleQuotes(txtAddress1.Text.ToUpper) & "','" & oCommon.FixSingleQuotes(txtAddress2.Text.ToUpper) & "','" & oCommon.FixSingleQuotes(txtPostcode.Text) & "','" & oCommon.FixSingleQuotes(txtCity.Text.ToUpper) & "','" & oCommon.FixSingleQuotes(ddlState.Text.ToUpper) & "'," & ddlKelas.SelectedValue & "," & ddlUniform.SelectedValue & "," & ddlPersatuan.SelectedValue & "," & ddlSukan.SelectedValue & "," & ddlRumahsukan.SelectedValue & ",'" & oCommon.FixSingleQuotes(txtLoginID.Text) & "','" & oDes.EncryptData(txtPwd.Text) & "')"
