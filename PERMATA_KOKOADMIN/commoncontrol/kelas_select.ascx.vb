            ...
            Select Case Server.HtmlEncode(Request.Cookies("kokoadmin_usertype").Value)
                Case "ADMIN"
                    Select Case Request.QueryString("set")
                        Case "pelajar"
                            Response.Redirect("admin.kelas.pelajar.assign.aspx?kelasid=" & strKeyID & "&tahun=" & ddlTahun.Text & "&admin_ID=" & Request.QueryString("admin_ID"))
                        Case "senaraipelajar"
                            Response.Redirect("admin.kelas.pelajar.list.aspx?kelasid=" & strKeyID & "&tahun=" & ddlTahun.Text & "&admin_ID=" & Request.QueryString("admin_ID"))
                        Case "instruktor"
                            Response.Redirect("admin.kelas.instruktor.assign.aspx?kelasid=" & strKeyID & "&tahun=" & ddlTahun.Text & "&admin_ID=" & Request.QueryString("admin_ID"))
                        Case "pensyarah"
                            Response.Redirect("admin.kelas.pensyarah.assign.aspx?kelasid=" & strKeyID & "&tahun=" & ddlTahun.Text & "&admin_ID=" & Request.QueryString("admin_ID"))
                        Case Else
                            Response.Redirect("admin.kelas.view.aspx?kelasid=" & strKeyID & "&tahun=" & ddlTahun.Text & "&admin_ID=" & Request.QueryString("admin_ID"))
                    End Select
                Case "INSTRUKTOR"
                    Response.Redirect("instruktor.kelas.pelajar.list.aspx?kelasid=" & strKeyID & "&tahun=" & ddlTahun.Text & "&admin_ID=" & Request.QueryString("admin_ID"))
                Case "PENSYARAH"
                Case "PENGARAH"
                Case Else
