...
Public Class sukan_update
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        'UPDATE
        strSQL = "UPDATE koko_sukan SET Tahun='" & ddlTahun.Text & "',Sukan='" & oCommon.FixSingleQuotes(txtSukan.Text.ToUpper) & "',Hari='" & oCommon.FixSingleQuotes(txtHari.Text.ToUpper) & "',Masa='" & oCommon.FixSingleQuotes(txtMasa.Text.ToUpper) & "',Tempat='" & oCommon.FixSingleQuotes(txtTempat.Text.ToUpper) & "',IsMandatory='" & selIsMandatory.Value & "' WHERE SukanID=" & Request.QueryString("sukanid")
