...
Public Class kelas_list
            ...
            Select Case Server.HtmlEncode(Request.Cookies("kokoadmin_usertype").Value)
                Case "ADMIN"
                    Select Case Request.QueryString("set")
                        Case "pelajar"
                            Response.Redirect("admin.kelas.pelajar.assign.aspx?kelasid=" & strKeyID & "&admin_ID=" & Request.QueryString("admin_ID"))
                        Case "instruktor"
                            Response.Redirect("admin.kelas.instruktor.assign.aspx?kelasid=" & strKeyID & "&admin_ID=" & Request.QueryString("admin_ID"))
                        Case "pensyarah"
                            Response.Redirect("admin.kelas.pensyarah.assign.aspx?kelasid=" & strKeyID & "&admin_ID=" & Request.QueryString("admin_ID"))
                        Case Else
                            Response.Redirect("admin.kelas.view.aspx?kelasid=" & strKeyID & "&admin_ID=" & Request.QueryString("admin_ID"))
                    End Select
                Case "INSTRUKTOR"
                Case "PENSYARAH"
                Case "PENGARAH"
    ...
    Protected Sub btnCreate_Click(sender As Object, e As EventArgs) Handles btnCreate.Click
        Response.Redirect("admin.kelas.create.aspx?admin_ID=" & Request.QueryString("admin_ID"))
