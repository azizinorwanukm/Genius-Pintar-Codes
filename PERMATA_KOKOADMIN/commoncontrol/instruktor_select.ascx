<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="instruktor_select.ascx.vb" Inherits="permatapintar.instruktor_select" %>
...
<asp:Label ID="lblKelas" runat="server" Text="" ForeColor="Red"></asp:Label>