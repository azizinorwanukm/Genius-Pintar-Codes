...
Public Class koko_pelajar_mark_sukanmandatory_p1
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT
                        ...
                        (SELECT koko_pelajarmandatory_markah.Markah FROM koko_pelajarmandatory_markah WHERE koko_pelajarmandatory_markah.StudentID = StudentProfile.StudentID AND koko_pelajarmandatory_markah.Peperiksaan = 'Peperiksaan 1') AS 'Markah'
                        FROM
                        StudentProfile
        ...
        strWhere = " WHERE
                        koko_kelaskoko.KelasKokoID = '" & ddlKumpulan.SelectedValue & "'
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        For i As Integer = 0 To datRespondent.Rows.Count - 1
            ...
            strSQL = "SELECT Markah FROM koko_pelajarmandatory_markah WHERE StudentID = '" & strKeyID & "' AND Tahun = '" & Request.QueryString("tahun") & "' AND Peperiksaan = 'Peperiksaan 1'"

            If Not oCommon.isExist(strSQL) Then
                strSQL = "INSERT INTO koko_pelajarmandatory_markah (StudentID, PPCSDate, Semester, Tahun, Date, Program, KelasID, SukanID, Markah, Peperiksaan) VALUES('" & strKeyID & "', '" & strPPCSdate & "', 'Semester 1', '" & Request.QueryString("tahun") & "', '" & Now.Date.ToString("yyyy-MM-dd") & "', '" & strProgram & "', '" & strKelasID & "', '" & Request.QueryString("value") & "', '" & txtMarkah.Text & "', 'Peperiksaan 1')"
            Else
                strSQL = "UPDATE koko_pelajarmandatory_markah SET Markah ='" & txtMarkah.Text & "' WHERE StudentID='" & strKeyID & "' AND Tahun='" & Request.QueryString("tahun") & "' AND Peperiksaan = 'Peperiksaan 1'"
            End If
    ...
    Protected Sub ddlKumpulan_SelectedIndexChanged(sender As Object, e As EventArgs)
        strRet = BindData(datRespondent)
    End Sub
End Class