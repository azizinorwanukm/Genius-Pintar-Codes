<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="laporan_koko_list.ascx.vb" Inherits="permatapintar.laporan_koko_list" %>
...
<table class="fbform">
    ...
    <tr>
        <td></td>
        <td>
            <asp:CheckBox ID="chkMARKAH" runat="server" Text="MARKAH 0" />
        </td>
        <td></td>
        <td></td>
    </tr>
...
<asp:Label ID="lblMsgTop" runat="server" Text="A:Kehadiran. B:Jawatan. C:Penglibatan. D:Pencapaian.  Status Tawaran=TERIMA" ForeColor="Red"></asp:Label>
