<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="koko_list_persatuan.ascx.vb" Inherits="permatapintar.koko_list_persatuan" %>
...
<asp:Panel ID="pnlContents" runat="server">
    ...
    <table class="fbform">
        <tr class="fbform_header">
            <td style="width: 80%;">Senarai Kelab & Persatuan&nbsp;<asp:Label ID="lblTahun" runat="server" Text="" ForeColor="Red"></asp:Label>&nbsp;|
...
<asp:Label ID="lblFieldname" runat="server" Text='PersatuanID'></asp:Label>
