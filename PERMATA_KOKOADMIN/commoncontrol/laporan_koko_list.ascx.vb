...
Public Class laporan_koko_list
    ...
    Private Function getSQL() As String
        ...
        '                                                                        Uniform_KehadiranP1/P2,                                                          Uniform_JawatanP1/P2,                                                              Uniform_PenglibatanP1/P2,                                                             Uniform_PencapaianP1/P2,                                                         Uniform_JumlahP1/P2,                                                       Uniform_GredP1/P2"
        ...
        '                                                                          Persatuan_KehadiranP1/P2,                                                            Persatuan_JawatanP1/P2,                                                                Persatuan_PenglibatanP1/P2,                                                               Persatuan_PencapaianP1/P2,                                                           Persatuan_JumlahP1/P2,                                                         Persatuan_GredP1/P2,
        ...
        '                                                                      Sukan_KehadiranP1/P2,                                                        Sukan_JawatanP1/P2,                                                            Sukan_PenglibatanP1/P2,                                                           Sukan_PencapaianP1,                                                       Sukan_JumlahP1/P2,                                                     Sukan_GredP1/P2
        ...
        '                                                            BonusP1/P2,                                                 JumlahP1/P2,                                                 MarkahP1/P2,                                               GredP1/P2,                                              PNGP1/P2,                                               KOKOP1/P2,
        ...
        If chkMARKAH.Checked Then
            strWhere += " AND koko_pelajar.MarkahP1=0"
        End If
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        For i As Integer = 0 To datRespondent.Rows.Count - 1
            ...
            strSQL = "UPDATE koko_pelajar SET Bonus" & selPeperiksaan.Value & " =" & txtBonus.Text & " WHERE StudentID='" & datRespondent.DataKeys(i).Value.ToString & "' AND Tahun='" & ddlTahun.Text & "'"
        ...
        If lblMsg.Text.Length = 0 Then
            lblMsg.Text = "Berjaya kemaskini BONUS."
        End If
        lblMsgTop.Text = lblMsg.Text
    ...
    Public Sub Bonus()
        Dim strPeperiksaan As String = selPeperiksaan.Value
    ...
    Protected Sub btnGred_Click(sender As Object, e As EventArgs) Handles btnGred.Click
        ...
        '--set_pelajar_Jumlah
        strRet = oCommon.set_pelajar_Jumlah(ddlTahun.Text, selPeperiksaan.Value)
        If Not strRet = "0" Then
        ...
        '--set_pelajar_Gred
        strRet = oCommon.set_pelajar_Gred(ddlTahun.Text, selPeperiksaan.Value)
        If Not strRet = "0" Then
    ...
    Private Sub lnkMarkahPenuh_Click(sender As Object, e As EventArgs) Handles lnkMarkahPenuh.Click
        Dim queryString As String = "admin.laporan.koko.pelajar.list.full.aspx?tahun=" & ddlTahun.Text & "&field=" & Request.QueryString("field") & "&value=" & Request.QueryString("value") & "&admin_ID=" & Request.QueryString("admin_ID")
    ...
    Private Sub ddlTahun_TextChanged(sender As Object, e As EventArgs) Handles ddlTahun.TextChanged
        koko_kelas_list()
        ddlKelas.SelectedValue = "ALL"

    End Sub

    Private Sub btnGenSijil_Click(sender As Object, e As EventArgs) Handles btnGenSijil.Click
        lblMsg.Text = "Dalam proses pengujian."
        lblMsgTop.Text = lblMsg.Text
