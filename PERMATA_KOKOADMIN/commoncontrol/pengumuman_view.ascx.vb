...
Public Class pengumuman_view
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        Response.Redirect("admin.pengumuman.update.aspx?pengumumanid=" & Request.QueryString("pengumumanid") & "&admin_ID=" & Request.QueryString("admin_ID"))

    End Sub

    Protected Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        strSQL = "DELETE koko_pengumuman WHERE PengumumanID=" & Request.QueryString("pengumumanid")
