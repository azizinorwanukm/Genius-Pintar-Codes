...
Public Class persatuan_list
    ...
    Private Function getSQL() As String
        ...
        Dim strOrder As String = " ORDER BY Persatuan"

        tmpSQL = "SELECT * FROM koko_persatuan"
    ...
    Private Sub datRespondent_SelectedIndexChanging(sender As Object, e As GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Try
            Select Case Server.HtmlEncode(Request.Cookies("koko_usertype").Value)
                Case "ADMIN"
                    Response.Redirect("admin.persatuan.view.aspx?persatuanid=" & strKeyID)
                Case "INSTRUKTOR"
                    Response.Redirect("instruktor.persatuan.view.aspx?persatuanid=" & strKeyID)
                Case "PENSYARAH"
                Case "PENGARAH"
                Case Else
    ...
    Protected Sub btnCreate_Click(sender As Object, e As EventArgs) Handles btnCreate.Click
        Response.Redirect("admin.persatuan.create.aspx")
