...
Public Class rumahsukan_view
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        Response.Redirect("admin.rumahsukan.update.aspx?rumahsukanid=" & Request.QueryString("rumahsukanid"))

    End Sub

    Protected Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click

        strSQL = "DELETE koko_rumahsukan WHERE RumahsukanID=" & Request.QueryString("rumahsukanid")
