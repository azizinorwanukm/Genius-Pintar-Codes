...
Public Class instruktor_list
            ...
            Select Case Server.HtmlEncode(Request.Cookies("kokoadmin_usertype").Value)
                Case "ADMIN"
                    Select Case Request.QueryString("set")
                        Case "koko"
                            Response.Redirect("admin.koko.instruktor.assign.aspx?instruktorid=" & strKeyID & "&tahun=" & ddlTahun.Text & "&admin_ID=" & Request.QueryString("admin_ID"))
                        Case "kehadiran"
                            Response.Redirect("admin.event.list.aspx?instruktorid=" & strKeyID & "&tahun=" & ddlTahun.Text & "&admin_ID=" & Request.QueryString("admin_ID"))
                        Case "markah"
                            Response.Redirect("admin.instruktor.mark.aspx?set=markah&instruktorid=" & strKeyID & "&tahun=" & ddlTahun.Text & "&admin_ID=" & Request.QueryString("admin_ID"))
                        Case Else
    ...
    Protected Sub btnCreate_Click(sender As Object, e As EventArgs) Handles btnCreate.Click
        Response.Redirect("admin.instruktor.create.aspx?tahun=" & ddlTahun.Text & "&admin_ID=" & Request.QueryString("admin_ID"))
