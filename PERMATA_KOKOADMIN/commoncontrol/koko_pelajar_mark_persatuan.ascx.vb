...
Public Class koko_pelajar_mark_persatuan
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        For i As Integer = 0 To datRespondent.Rows.Count - 1
            ...
            strSQL = "UPDATE koko_pelajar SET Persatuan_Pencapaian=" & txtPencapaian.Text & ",Persatuan_Penglibatan=" & txtPenglibatan.Text & ",Persatuan_Jawatan=" & txtJawatan.Text & ",Persatuan_Kehadiran=" & txtKehadiran.Text & " WHERE StudentID='" & datRespondent.DataKeys(i).Value.ToString & "' AND Tahun='" & Request.QueryString("tahun") & "'"
