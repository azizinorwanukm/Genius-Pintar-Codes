...
Public Class uniform_update
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        'UPDATE
        strSQL = "UPDATE koko_uniform SET Tahun='" & ddlTahun.Text & "',Uniform='" & oCommon.FixSingleQuotes(txtUniform.Text.ToUpper) & "',Hari='" & oCommon.FixSingleQuotes(txtHari.Text.ToUpper) & "',Masa='" & oCommon.FixSingleQuotes(txtMasa.Text.ToUpper) & "',Tempat='" & oCommon.FixSingleQuotes(txtTempat.Text.ToUpper) & "' WHERE UniformID=" & Request.QueryString("uniformid")
