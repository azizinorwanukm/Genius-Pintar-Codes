<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="koko_jadual_uniform.ascx.vb" Inherits="permatapintar.koko_jadual_uniform" %>

<table class="fbform">
    <tr class="fbform_header">
        <td style="width: 80%;">Jadual Badan Beruniform 
