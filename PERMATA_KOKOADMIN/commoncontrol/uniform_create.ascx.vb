...
Public Class uniform_create
    ...
    Protected Sub btnadd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnadd.Click
        Try
            ...
            strSQL = "INSERT INTO koko_uniform(Tahun,Uniform,Hari,Masa,Tempat) VALUES ('" & ddlTahun.Text & "','" & oCommon.FixSingleQuotes(txtUniform.Text.ToUpper) & "','" & oCommon.FixSingleQuotes(txtHari.Text.ToUpper) & "','" & oCommon.FixSingleQuotes(txtMasa.Text.ToUpper) & "','" & oCommon.FixSingleQuotes(txtTempat.Text.ToUpper) & "')"
