...
Public Class koko_kolejpermata_list
    ...
    Private Function getSQL() As String
        ...
        strWhere = " WHERE Jenis='" & Request.QueryString("jenis") & "'"
    ...
    Private Sub datRespondent_SelectedIndexChanging(sender As Object, e As GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Try
            Select Case Server.HtmlEncode(Request.Cookies("kokoadmin_usertype").Value)
                Case "ADMIN"
                    Response.Redirect("admin.koko.kolejpermata.view.aspx?jenis=" & Request.QueryString("jenis") & "&kokoid=" & strKeyID & "&admin_ID=" & Request.QueryString("admin_ID"))
                Case "INSTRUKTOR"
                Case "PENSYARAH"
                Case "PENGARAH"
                Case Else
    ...
    Protected Sub btnCreate_Click(sender As Object, e As EventArgs) Handles btnCreate.Click
        Response.Redirect("admin.koko.kolejpermata.create.aspx?jenis=" & Request.QueryString("jenis") & "&admin_ID=" & Request.QueryString("admin_ID"))
