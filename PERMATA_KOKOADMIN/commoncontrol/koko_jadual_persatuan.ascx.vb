...
Public Class koko_jadual_persatuan
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                '--default
                strRet = BindData(datPersatuan, "PERSATUAN")
            End If
    ...
    Protected Sub lnkPersatuan_Click(sender As Object, e As EventArgs) Handles lnkPersatuan.Click
        Response.Redirect("admin.koko.jadual.persatuan.aspx?admin_ID=" & Request.QueryString("admin_ID"))

    End Sub

    Protected Sub lnkSukan_Click(sender As Object, e As EventArgs) Handles lnkSukan.Click
        Response.Redirect("admin.koko.jadual.sukan.aspx?admin_ID=" & Request.QueryString("admin_ID"))

    End Sub

    Protected Sub lnkUniform_Click(sender As Object, e As EventArgs) Handles lnkUniform.Click
        Response.Redirect("admin.koko.jadual.uniform.aspx?admin_ID=" & Request.QueryString("admin_ID"))
    End Sub
End Class