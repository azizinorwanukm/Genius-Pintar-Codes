...
Public Class config_list
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT * FROM koko_config"
    ...
    Private Sub datRespondent_SelectedIndexChanging(sender As Object, e As GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Response.Redirect("admin.config.update.aspx?configid=" & strKeyID & "&admin_ID=" & Request.QueryString("admin_ID"))

    End Sub

    Protected Sub btnCreate_Click(sender As Object, e As EventArgs) Handles btnCreate.Click
        Response.Redirect("admin.config.create.aspx?tahun=" & ddlTahun.Text & "&admin_ID=" & Request.QueryString("admin_ID"))
