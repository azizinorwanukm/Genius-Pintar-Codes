...
Public Class koko_pelajar_list_mark_full
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                koko_tahun_list()
                ddlTahun.SelectedValue = Request.QueryString("tahun")
    ...
    Private Sub getKOKOName()
        ...
        strSQL = "SELECT Nama FROM koko_kolejpermata WHERE KokoID=" & strValue
    ...
    Private Function getSQL() As String
        ...
        '--P1
        tmpSQL += "koko_pelajar.Uniform_KehadiranP1,koko_pelajar.Uniform_JawatanP1,koko_pelajar.Uniform_PenglibatanP1,koko_pelajar.Uniform_PencapaianP1,koko_pelajar.Uniform_JumlahP1,koko_pelajar.Uniform_GredP1,"
        tmpSQL += "koko_pelajar.Persatuan_KehadiranP1,koko_pelajar.Persatuan_JawatanP1,koko_pelajar.Persatuan_PenglibatanP1,koko_pelajar.Persatuan_PencapaianP1,koko_pelajar.Persatuan_JumlahP1,koko_pelajar.Persatuan_GredP1,"
        tmpSQL += "koko_pelajar.Sukan_KehadiranP1,koko_pelajar.Sukan_JawatanP1,koko_pelajar.Sukan_PenglibatanP1,koko_pelajar.Sukan_PencapaianP1,koko_pelajar.Sukan_JumlahP1,koko_pelajar.Sukan_GredP1,"
        tmpSQL += "koko_pelajar.BonusP1,koko_pelajar.JumlahP1,koko_pelajar.MarkahP1,koko_pelajar.GredP1,koko_pelajar.PNGP1,koko_pelajar.KOKOP1,"
