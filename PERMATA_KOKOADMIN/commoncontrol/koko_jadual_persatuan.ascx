<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="koko_jadual_persatuan.ascx.vb" Inherits="permatapintar.koko_jadual_persatuan" %>

<table class="fbform">
    <tr class="fbform_header">
        <td style="width: 80%;">Jadual Kelab & Persatuan
