...
Public Class persatuan_create
    ...
    Protected Sub btnadd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnadd.Click
        Try
            ...
            strSQL = "INSERT INTO koko_persatuan(Tahun,Persatuan,Hari,Masa,Tempat) VALUES ('" & ddlTahun.Text & "','" & oCommon.FixSingleQuotes(txtPersatuan.Text.ToUpper) & "','" & oCommon.FixSingleQuotes(txtHari.Text.ToUpper) & "','" & oCommon.FixSingleQuotes(txtMasa.Text.ToUpper) & "','" & oCommon.FixSingleQuotes(txtTempat.Text.ToUpper) & "')"
