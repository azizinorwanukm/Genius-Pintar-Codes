<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="config_list.ascx.vb" Inherits="permatapintar.config_list" %>
    ...
    <tr>
        <td>
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                CellPadding="3" ForeColor="Black" GridLines="Vertical" PageSize="25" DataKeyNames="ConfigID"
                Width="100%" Style="text-align: left;" HeaderStyle-HorizontalAlign="Left" EnableModelValidation="True" >
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Kod Konfigurasi">
                        <ItemTemplate>
                            <asp:Label ID="ConfigCODE" runat="server" Text='<%# Bind("ConfigCODE")%>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Tetapan">
                        <ItemTemplate>
