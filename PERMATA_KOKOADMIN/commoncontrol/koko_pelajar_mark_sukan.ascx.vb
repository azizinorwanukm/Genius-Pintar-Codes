...
Public Class koko_pelajar_mark_sukan
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        For i As Integer = 0 To datRespondent.Rows.Count - 1
            ...
            strSQL = "UPDATE koko_pelajar SET Sukan_Pencapaian=" & txtPencapaian.Text & ",Sukan_Penglibatan=" & txtPenglibatan.Text & ",Sukan_Jawatan=" & txtJawatan.Text & ",Sukan_Kehadiran=" & txtKehadiran.Text & " WHERE StudentID='" & datRespondent.DataKeys(i).Value.ToString & "' AND Tahun='" & Request.QueryString("tahun") & "'"
