<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="kemudahan_list.ascx.vb" Inherits="permatapintar.kemudahan_list" %>
...
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Senarai Kemudahan
        </td>
    </tr>
    <tr>
        <td>
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                CellPadding="3" ForeColor="Black" GridLines="Vertical" PageSize="25" DataKeyNames="KemudahanID"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Nama Kemudahan">
                        <ItemTemplate>
                            <asp:Label ID="Kemudahan" runat="server" Text='<%# Bind("Kemudahan")%>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left" />
                    </asp:TemplateField>
                    <asp:CommandField SelectText="[Tempah]" ShowSelectButton="True" HeaderText="Pilih" />
                </Columns>
