...
Public Class koko_pelajar_mark_sukan_p3
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        For i As Integer = 0 To datRespondent.Rows.Count - 1
            ...
            strSQL = "UPDATE koko_pelajar SET Sukan_PencapaianP3=" & txtPencapaian.Text & ",Sukan_PenglibatanP3=" & txtPenglibatan.Text & ",Sukan_JawatanP3=" & txtJawatan.Text & ",Sukan_KehadiranP3=" & txtKehadiran.Text & " WHERE StudentID='" & datRespondent.DataKeys(i).Value.ToString & "' AND Tahun='" & Request.QueryString("tahun") & "'"
