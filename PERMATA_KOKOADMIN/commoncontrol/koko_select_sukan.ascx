<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="koko_select_sukan.ascx.vb" Inherits="permatapintar.koko_select_sukan" %>
...
<asp:Label ID="lblFieldname" runat="server" Text='SukanID'></asp:Label>
