...
Public Class kemudahan_list
    ...
    Private Function getSQL() As String
        ...
        Dim strOrder As String = " ORDER BY Kemudahan"

        tmpSQL = "SELECT * FROM koko_kemudahan"
        ...
        If Not txtKemudahan.Text.Length = 0 Then
            strWhere += " AND Kemudahan LIKE '%" & txtKemudahan.Text & "%'"
        End If
    ...
    Private Sub datRespondent_SelectedIndexChanging(sender As Object, e As GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Try
            Select Case Server.HtmlEncode(Request.Cookies("kokoadmin_usertype").Value)
                Case "ADMIN"
                    Response.Redirect("admin.tempahan.create.aspx?kemudahanid=" & strKeyID & "&admin_ID=" & Request.QueryString("admin_ID"))
                Case "INSTRUKTOR"
                Case "PENSYARAH"
                Case "PENGARAH"
                Case Else
    ...
    Protected Sub btnCreate_Click(sender As Object, e As EventArgs) Handles btnCreate.Click
        Response.Redirect("admin.kemudahan.create.aspx?admin_ID=" & Request.QueryString("admin_ID"))
