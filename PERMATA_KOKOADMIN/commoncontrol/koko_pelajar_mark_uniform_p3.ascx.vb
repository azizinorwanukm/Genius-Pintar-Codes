...
Public Class koko_pelajar_mark_uniform_p3
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        For i As Integer = 0 To datRespondent.Rows.Count - 1
            ...
            strSQL = "UPDATE koko_pelajar SET Uniform_PencapaianP3=" & txtPencapaian.Text & ",Uniform_PenglibatanP3=" & txtPenglibatan.Text & ",Uniform_JawatanP3=" & txtJawatan.Text & ",Uniform_KehadiranP3=" & txtKehadiran.Text & " WHERE StudentID='" & datRespondent.DataKeys(i).Value.ToString & "' AND Tahun='" & Request.QueryString("tahun") & "'"
        ...
        '--calculate P3
        strRet = oCommon.set_pelajar_Gred(Request.QueryString("tahun"), "P3")
        '--debug
        'Response.Write(strRet)

        strRet = oCommon.set_pelajar_Jumlah(Request.QueryString("tahun"), "P3")
        '--debug
        'Response.Write(strRet)
    End Sub
