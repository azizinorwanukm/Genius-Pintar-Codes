...
Public Class pelajar_status_update
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        btnUpdate.Attributes.Add("onclick", "return confirm('Pasti ingin menukar status rekod tersebut?');")
    ...
    Private Function getSQL() As String
        ...
        If Not selStatus.Value = "ALL" Then
            strWhere += " AND koko_pelajar.StatusTawaran='" & selStatus.Value & "'"
        End If
        ...
        For i = 0 To datRespondent.Rows.Count - 1 Step i + 1
            ...
            If Not chkUpdate Is Nothing Then
                If chkUpdate.Checked = True Then
                    ...
                    strSQL = "UPDATE koko_pelajar WITH (UPDLOCK) SET StatusTawaran='" & selStatusUpdate.Value & "',Keterangan='" & oCommon.FixSingleQuotes(txtKeterangan.Text.ToUpper) & "' WHERE StudentID='" & strKey & "' AND Tahun='" & ddlTahun.Text & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                    If Not strRet = "0" Then
                        lblMsg.Text += ":" & datRespondent.DataKeys(i).Value.ToString & ":" & strRet
                    End If

                    If selStatusUpdate.Value = "TOLAK" Then
                        '--clear kelas,uniform,persatuan,sukan dan rumahsukan
                        strSQL = "UPDATE koko_pelajar WITH (UPDLOCK) SET KelasID=NULL,UniformID=NULL,PersatuanID=NULL,SukanID=NULL,RumahsukanID=NULL WHERE StudentID='" & strKey & "' AND Tahun='" & ddlTahun.Text & "'"
                        strRet = oCommon.ExecuteSQL(strSQL)
                    End If
