...
Public Class pengarah_login1
    ...
    Private Sub btnLogin_Click(sender As Object, e As EventArgs) Handles btnLogin.Click
        ...
        strSQL = "SELECT PengarahID FROM koko_pengarah WITH (NOLOCK) WHERE LoginID='" & oCommon.FixSingleQuotes(txtLoginID.Text) & "' AND Pwd='" & oCommon.FixSingleQuotes(txtPwd.Text) & "' AND Tahun='" & lblTahun.Text & "'"
        '--debug
        ...
        If oCommon.isExist(strSQL) = True Then
            ...
            Response.Cookies("kokoadmin_usertype").Value = "PENGARAH"
