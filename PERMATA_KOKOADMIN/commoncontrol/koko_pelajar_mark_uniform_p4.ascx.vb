...
Public Class koko_pelajar_mark_uniform_p4
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        For i As Integer = 0 To datRespondent.Rows.Count - 1
            ...
            strSQL = "UPDATE koko_pelajar SET Uniform_PencapaianP4=" & txtPencapaian.Text & ",Uniform_PenglibatanP4=" & txtPenglibatan.Text & ",Uniform_JawatanP4=" & txtJawatan.Text & ",Uniform_KehadiranP4=" & txtKehadiran.Text & " WHERE StudentID='" & datRespondent.DataKeys(i).Value.ToString & "' AND Tahun='" & Request.QueryString("tahun") & "'"
        ...
        '--calculate P4
        strRet = oCommon.set_pelajar_Gred(Request.QueryString("tahun"), "P4")
        '--debug
        'Response.Write(strRet)

        strRet = oCommon.set_pelajar_Jumlah(Request.QueryString("tahun"), "P4")
        '--debug
        'Response.Write(strRet)
