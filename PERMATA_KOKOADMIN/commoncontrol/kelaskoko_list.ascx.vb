...
Public Class kelaskoko_list
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT *,(SELECT COUNT(*) FROM koko_kelaskokopelajar WHERE koko_kelaskokopelajar.KelasKokoID=koko_kelaskoko.KelasKokoID) as JumlahPelajar  FROM koko_kelaskoko WHERE KokoID=" & Request.QueryString("kokoid")
    ...
    Private Sub datRespondent_SelectedIndexChanging(sender As Object, e As GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Try
            Select Case Server.HtmlEncode(Request.Cookies("kokoadmin_usertype").Value)
                Case "ADMIN"
                    Response.Redirect("admin.kelaskoko.view.aspx?kelaskokoid=" & strKeyID & "&admin_ID=" & Request.QueryString("admin_ID"))
                Case "INSTRUKTOR"
                Case "PENSYARAH"
                Case "PENGARAH"
                Case Else
    ...
    Protected Sub btnCreate_Click(sender As Object, e As EventArgs) Handles btnCreate.Click
        Response.Redirect("admin.kelaskoko.create.aspx?kokoid=" & Request.QueryString("kokoid") & "&admin_ID=" & Request.QueryString("admin_ID"))
    ...
    Private Sub datRespondent_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles datRespondent.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim strKeyID As String = datRespondent.DataKeys(e.Row.RowIndex).Value.ToString  'KelasKokoID

            lblInstruktor = e.Row.FindControl("lblInstruktor")
            strSQL = "SELECT koko_instruktor.fullname from koko_instruktor,koko_kelaskoko WHERE koko_instruktor.kokoinstruktorid=koko_kelaskoko.kokoinstruktorid AND koko_kelaskoko.KelasKokoID=" & strKeyID
