    ...
    Private Sub datRespondent_SelectedIndexChanging(sender As Object, e As GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Try
            Select Case Server.HtmlEncode(Request.Cookies("kokoadmin_usertype").Value)
                ...
                Case "PENSYARAH"
                Case "PENGARAH"
                    Response.Redirect("pengarah.tempahan.view.aspx?tempahanid=" & strKeyID & "&admin_ID=" & Request.QueryString("admin_ID"))
                Case Else
        ...
        For i = 0 To datRespondent.Rows.Count - 1 Step i + 1
            ...
            If Not chkUpdate Is Nothing Then
                ...
                If chkUpdate.Checked = True Then
                    ...
                    If UpdateStatusTempahan.Value <> "SILA PILIH" Then

                        strSQL = "Update koko_tempahandetail set StatusTempahan = '" & UpdateStatusTempahan.Value & "' where TempahanID = '" & strKey & "'"
                        strRet = oCommon.ExecuteSQL(strSQL)

                    Else

                        lblMsg.Text = "Sila pilih filter dibawah"
