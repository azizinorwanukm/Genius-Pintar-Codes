<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="koko_kolejpermata_list.ascx.vb" Inherits="permatapintar.koko_kolejpermata_list" %>
            ...
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Mandatory">
                        <ItemTemplate>
                            <asp:Label ID="Mandatory" runat="server" Text='<%# Bind("IsMandatory")%>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left" />
                    </asp:TemplateField>
