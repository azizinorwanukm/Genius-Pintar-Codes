            ...
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Kehadiran">
                        <ItemTemplate>
                            <asp:TextBox ID="txtKehadiran" runat="server" Width="50px" MaxLength="6" Text='<%# Bind("Persatuan_Kehadiran", "{0:n2}")%>'></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Jawatan">
                        <ItemTemplate>
                            <asp:TextBox ID="txtJawatan" runat="server" Width="50px" MaxLength="6" Text='<%# Bind("Persatuan_Jawatan", "{0:n2}")%>'></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Penglibatan">
                        <ItemTemplate>
                            <asp:TextBox ID="txtPenglibatan" runat="server" Width="50px" MaxLength="6" Text='<%# Bind("Persatuan_Penglibatan", "{0:n2}")%>'></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Pencapaian">
                        <ItemTemplate>
                            <asp:TextBox ID="txtPencapaian" runat="server" Width="50px" MaxLength="6" Text='<%# Bind("Persatuan_Pencapaian", "{0:n2}")%>'></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
