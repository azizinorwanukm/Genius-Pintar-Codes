<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="koko_pelajar_mark_uniform_p3.ascx.vb" Inherits="permatapintar.koko_pelajar_mark_uniform_p3" %>
            ...
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Pencapaian">
                        <ItemTemplate>
                            <asp:TextBox ID="txtPencapaian" runat="server" Width="50px" MaxLength="3" Text='<%# Bind("Uniform_PencapaianP3", "{0:n0}")%>'></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Penglibatan">
                        <ItemTemplate>
                            <asp:TextBox ID="txtPenglibatan" runat="server" Width="50px" MaxLength="3" Text='<%# Bind("Uniform_PenglibatanP3", "{0:n0}")%>'></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Jawatan">
                        <ItemTemplate>
                            <asp:TextBox ID="txtJawatan" runat="server" Width="50px" MaxLength="3" Text='<%# Bind("Uniform_JawatanP3", "{0:n0}")%>'></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Kehadiran">
                        <ItemTemplate>
                            <asp:TextBox ID="txtKehadiran" runat="server" Width="50px" MaxLength="3" Text='<%# Bind("Uniform_KehadiranP3", "{0:n0}")%>'></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
