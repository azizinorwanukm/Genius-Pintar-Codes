<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="kelaskoko_create.ascx.vb" Inherits="permatapintar.kelaskoko_create" %>
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Tambah Kumpulan Baru
        </td>
    </tr>
    <tr>
