<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="koko_list_uniform.ascx.vb" Inherits="permatapintar.koko_list_uniform" %>
...
<asp:Panel ID="pnlContents" runat="server">
    ...
    <table class="fbform">
        <tr class="fbform_header">
            <td style="width: 80%;">Senarai Badan Beruniform&nbsp;<asp:Label ID="lblTahun" runat="server" Text="" ForeColor="Red"></asp:Label>&nbsp;|
                ...
                <asp:GridView ID="datUniform" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Pelajar#">
                            <ItemTemplate>
                                <asp:Label ID="JumlahUniform" runat="server" Text='<%# Bind("JumlahPelajar")%>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
...
<asp:Label ID="lblFieldname" runat="server" Text='UniformID'></asp:Label>
