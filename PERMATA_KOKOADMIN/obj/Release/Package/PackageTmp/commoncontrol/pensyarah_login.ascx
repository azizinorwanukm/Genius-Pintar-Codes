<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="pensyarah_login.ascx.vb" Inherits="permatapintar.pensyarah_login1" %>
...
<table class="fbform">
    ...
    <tr>
        ...
        <td>
            :<asp:TextBox ID="txtPwd" runat="server" TextMode="Password" Width="200px" MaxLength="15"></asp:TextBox>&nbsp;*<br />
