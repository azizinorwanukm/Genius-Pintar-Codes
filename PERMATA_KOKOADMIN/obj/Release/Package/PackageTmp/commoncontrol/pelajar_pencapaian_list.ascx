<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="pelajar_pencapaian_list.ascx.vb" Inherits="permatapintar.pelajar_pencapaian_list" %>
...
<table class="fbform">
    ...
    <tr>
        <td>Disahkan:</td>
        <td>
            <select name="selDisahkan" id="selDisahkan" style="width: 200px;" runat="server">
                <option value="ALL" selected="selected">ALL</option>
        ...
        <td></td>
        <td>
            <asp:CheckBox ID="chkUpdated" Checked="true" runat="server" Text="Sudah mengisi pencapaian." />
        </td>
    </tr>
    <tr>
...
<table class="fbform">
            ...
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Rumah Sukan">
                     ...
                     <asp:TemplateField HeaderText="Disahkan">
                        <ItemTemplate>
                            <asp:Label ID="Disahkan" runat="server" Text='<%# Bind("Disahkan")%>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left" />
                    </asp:TemplateField>
    ...
    <tr>
        <td> <asp:Button ID="btnSah" runat="server" Text="Sahkan Semua" CssClass="fbbutton" Visible="true" />
            &nbsp;
