<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="koko_pelajar_mark_sukanmandatory_p2.ascx.vb" Inherits="permatapintar.koko_pelajar_mark_sukanmandatory_p2" %>
...
<table class="fbform">
    ...
    <tr>
        <td>Kumpulan: <asp:DropDownList ID="ddlKumpulan2" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlKumpulan2_SelectedIndexChanged"></asp:DropDownList></td>
    </tr>
    <tr>
        <td>
