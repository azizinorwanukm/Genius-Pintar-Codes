<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="studentprofile_schoolprofile_select.ascx.vb" Inherits="permatapintar.studentprofile_schoolprofile_select" %>
