...
<table class="fbform">
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtAddress1" runat="server" Width="250px" MaxLength="250"></asp:TextBox>&nbsp;[Tempat Bekerja]
        </td>
    </tr>
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtAddress2" runat="server" Width="250px" MaxLength="250"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td>Poskod:
