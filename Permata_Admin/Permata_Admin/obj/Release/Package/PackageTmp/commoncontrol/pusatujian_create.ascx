...
<table class="fbform">
    ...
    <tr>
        ...
        <td>:<asp:TextBox ID="txtPusatJumlahLab" runat="server" Width="50px" MaxLength="5"></asp:TextBox>*
        </td>
    </tr>
    <tr>
        <td>Jum.Komputer
        </td>
        <td>:<asp:TextBox ID="txtPusatJumlahKomp" runat="server" Width="50px" MaxLength="5"></asp:TextBox>*
        </td>
    </tr>
    <tr>
        <td>Tahun Ujian
