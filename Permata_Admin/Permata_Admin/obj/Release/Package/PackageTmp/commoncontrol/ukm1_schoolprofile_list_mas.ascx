...
<table class="fbform">
    ...
    <tr>
        ...
        <td>Jenis Sekolah:</td>
        <td>
            <asp:DropDownList ID="ddlSchoolType" runat="server" AutoPostBack="false" Width="200px">
            </asp:DropDownList></td>
        <td></td>
        <td></td>
    </tr>
    ...
    <tr>
        ...
        <td></td>
        <td>
            <asp:CheckBox ID="CheckRuleAge2" runat="server" Text="Pelajar berumur 8-12 tahun"  /></td>
    </tr>
     <tr>
        <td></td>
        <td>
        ...
        <td></td>
        <td>
            <asp:CheckBox ID="chkMark" runat="server" Text="Markah UKM1 > 5%" Checked="true" /></td>
    </tr>
    <tr>
