<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="studentprofile_pindah.ascx.vb" Inherits="permatapintar.studentprofile_pindah" %>
...
<table class="fbform">
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtStudentFullname" runat="server" Width="200px" MaxLength="200"></asp:TextBox></td>
        <td class="fbtd_left">MYKAD#:</td>
        <td>
            <asp:TextBox ID="txtMYKAD" runat="server" Width="200px" MaxLength="150"></asp:TextBox>&nbsp;</td>
    </tr>
    <tr>
        <td>Tahun Lahir:</td>
        <td>
...
*Nota: Ujian UKM1 dan UKM2 akan dipindahkan ke sekolah baru. Tahun Ujian:<asp:Label ID="lblExamYear" runat="server" Text="" Font-Bold="true"></asp:Label>
