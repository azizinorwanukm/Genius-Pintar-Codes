<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="schoolprofile_studentprofile_select_new.ascx.vb" Inherits="permatapintar.schoolprofile_studentprofile_select_new" %>
