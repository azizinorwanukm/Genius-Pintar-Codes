...
<table class="fbform">
    ...
    <tr>
        <td colspan="4">
            <asp:Button ID="btnSearch" runat="server" Text="Cari " CssClass="fbbutton" />&nbsp;<i>Nota:Kosongkan Tarikh untuk carian semua.</i>
        </td>
    </tr>
</table>
...
<table class="fbform">
    ...
    <tr>
        <td>
            ...
            Sessi:
            <asp:CheckBox ID="chkPagi" runat="server" Text="PAGI" />&nbsp;
            <asp:CheckBox ID="chkTghari" runat="server" Text="TENGAHARI" />&nbsp;
            <asp:CheckBox ID="chkPetang" runat="server" Text="PETANG" />
        </td>
    </tr>
</table>
<p><i>Nota: Pilih tarikh di atas untuk kemaskini Tarikh dan Sessi.</i></p>
