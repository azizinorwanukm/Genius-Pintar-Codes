<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="schoolprofile_pusatujian_select.ascx.vb"
    Inherits="permatapintar.schoolprofile_pusatujian_select" %>
<table class="fbform">
...
<table class="fbform">
    ...
    <tr>
        <td>
            <asp:Button ID="btnCreate" runat="server" Text="Daftar Pusat Ujian Baru " CssClass="fbbutton" />&nbsp;
        </td>
    </tr>
</table>
