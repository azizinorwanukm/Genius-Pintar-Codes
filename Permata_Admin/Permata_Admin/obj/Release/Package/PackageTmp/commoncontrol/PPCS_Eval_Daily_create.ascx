<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="PPCS_Eval_Daily_create.ascx.vb"
    Inherits="permatapintar.PPCS_Eval_Daily_create1" %>
<table class="fbform">
    <tr class="fbform_header">
        <td class="fbsection_sap" colspan="3">LAPORAN HARIAN. Tarikh:<asp:Label ID="lblSelectedDate" runat="server" Text=""></asp:Label>&nbsp;
