<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ukm1_school_summary.ascx.vb"
    Inherits="permatapintar.ukm1_school_summary" %>
<table class="fbform">
    <tr class="fbform_header">
        <td>Ringkasan Ujian Sekolah. 50 Sekolah Tertinggi Jumlah Pelajar &nbsp;&nbsp;[<asp:Label
            ID="lblDatetime" runat="server" Text=""></asp:Label>]
        </td>
    </tr>
    <tr>
        <td>
