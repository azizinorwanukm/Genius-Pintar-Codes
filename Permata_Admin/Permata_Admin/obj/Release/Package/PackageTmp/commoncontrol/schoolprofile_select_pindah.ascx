<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="schoolprofile_select_pindah.ascx.vb" Inherits="permatapintar.schoolprofile_select_pindah" %>
...
*Nota: Ujian UKM1 dan UKM2 akan dipindahkan ke sekolah baru.
