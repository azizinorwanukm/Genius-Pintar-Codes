...
<table class="fbform">
    ...
    <tr>
        ...
        <td><asp:CheckBox ID="chkRuleAge" runat="server" Text="Semak Had Umur 8-15 tahun (8 tahun - beragama Islam sahaja)" Checked="true" /></td>
        <td></td>
    </tr>
</table>
<br />
...
*Using UKM2.DOB_Year. To fix please run UKM2 SQL fix on DB Server