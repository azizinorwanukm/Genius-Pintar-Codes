<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/adminop/adminoperator.Master" CodeBehind="studentuni.update.aspx.vb" Inherits="permatapintar.studentuni_update1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="fbform">
        <tr class="fbform_header">
            <td>
                <asp:Label ID="Label2" runat="server" Text="Maklumat Pelajar>Kemaskini Maklumat Universiti" CssClass="lblBreadcrum"></asp:Label>
            </td>
        </tr>
    </table>
