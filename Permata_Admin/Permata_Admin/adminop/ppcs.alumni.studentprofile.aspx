<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/adminop/adminoperator.Master" CodeBehind="ppcs.alumni.studentprofile.aspx.vb" Inherits="permatapintar.ppcs_alumni_studentprofile1" %>
...
<%@ Register Src="../commoncontrol/PPCS_Eval_End_list.ascx" TagName="PPCS_Eval_End_list"
    TagPrefix="uc9" %>
<%@ Register src="../commoncontrol/studentuni_view.ascx" tagname="studentuni_view" tagprefix="uc10" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    &nbsp;<uc10:studentuni_view ID="studentuni_view1" runat="server" />
