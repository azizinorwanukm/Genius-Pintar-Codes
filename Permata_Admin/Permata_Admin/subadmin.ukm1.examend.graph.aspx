<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/subadmin.Master" CodeBehind="subadmin.ukm1.examend.graph.aspx.vb" Inherits="permatapintar.subadmin_ukm1_examend_graph" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" href="amcharts/javascript/style.css" type="text/css">
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="fbform">
        <tr class="fbform_header">
            <td>
                Carta Ringkasan JUMLAH MULA Mengikut Tarikh
            </td>
        </tr>
    </table>
    <div id="chartdiv" style="width: 100%; height: 500px; margin-bottom: 10px;">
    </div>
</asp:Content>