...
Partial Public Class ukm2_studentgender_summary1
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT master_Gender.StudentGender,(SELECT COUNT(*) FROM UKM2,StudentProfile WHERE UKM2.StudentID=StudentProfile.StudentID AND StudentProfile.StudentGender=master_Gender.StudentGender AND UKM2.Examyear='" & ddlExamYear.Text & "'" & strWhereIn & ") as Jumlah FROM master_Gender"
