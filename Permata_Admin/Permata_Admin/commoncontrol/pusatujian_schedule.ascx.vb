...
Partial Public Class pusatujian_schedule
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Dim strMonth As String = oCommon.DoPadZeroLeft(Now.Month, 2)
            selExamMonth.Value = strMonth
    ...
    Private Function getSQL() As String
        ...
        Dim strOrder As String = " ORDER BY a.TarikhUjian,a.SessiUKM2,b.PusatState,b.PusatCity,b.PusatName"

        tmpSQL = "SELECT DISTINCT a.PusatCode,a.TarikhUjian,a.SessiUKM2,b.PusatState,b.PusatCity,b.PusatName,(SELECT COUNT(*) FROM UKM2 WHERE ExamYear=a.ExamYear and PusatCode=b.PusatCode AND TarikhUjian=a.TarikhUjian AND SessiUKM2=a.SessiUKM2) as JumPelajar FROM UKM2 a,PusatUjian b"

        strWhere = " WITH (NOLOCK) WHERE a.PusatCode=b.PusatCode AND b.PusatTahun='" & ddlExamYear.Text & "'"
        ...
        ''TarikhUjian month
        If Not selExamMonth.Value = "ALL" Then
            strWhere += " AND a.TarikhUjian LIKE '%-" & selExamMonth.Value & "-%'"
        End If

        ''PusatState
        If Not ddlSchoolState.Text = "ALL" Then
            strWhere += " AND b.PusatState='" & ddlSchoolState.Text & "'"
        End If

        ''PusatPPD
        If Not ddlSchoolPPD.Text = "ALL" Then
            strWhere += " AND b.PusatPPD='" & ddlSchoolPPD.Text & "'"
        End If

        ''TarikhUjian
        If Not txtTarikhUjian.Text.Length = 0 Then
            strWhere += " AND a.TarikhUjian='" & oCommon.FixSingleQuotes(txtTarikhUjian.Text) & "'"
        End If
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Try
            Select Case getUserProfile_UserType()
                ...
                Case "ADMINOP"
                    Response.Redirect("pusatujian.kehadiran.pelajar.aspx?pusatcode=" & strKeyID & "&examyear=" & ddlExamYear.Text)
                Case "SUBADMIN"
