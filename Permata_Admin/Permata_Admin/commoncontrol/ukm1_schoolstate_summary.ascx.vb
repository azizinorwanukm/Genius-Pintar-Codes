...
Public Class ukm1_schoolstate_summary
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT SchoolState,(SELECT COUNT(*) FROM UKM1 WITH (NOLOCK) WHERE UKM1.SchoolState=SchoolState.SchoolState AND UKM1.ExamYear='" & ddlExamYear.Text & "'" & strWhereIn & ") as Jumlah"
    ...
    Private Sub datRespondent_SelectedIndexChanging(sender As Object, e As GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Try
            Select Case getUserProfile_UserType()
                Case "ADMIN"
                    Response.Redirect("admin.ukm1.schoolstate.student.list.aspx?schoolstate=" & strKeyID & "&examyear=" & ddlExamYear.Text & "&dob_year=" & ddlDOB_Year.Text & "&iscount=" & chkRuleAge.Checked)
                Case "SUBADMIN"
                    Response.Redirect("subadmin.ukm1.schoolstate.student.list.aspx?schoolstate=" & strKeyID & "&examyear=" & ddlExamYear.Text & "&dob_year=" & ddlDOB_Year.Text & "&iscount=" & chkRuleAge.Checked)
                Case "ADMINOP"
                    Response.Redirect("ukm1.schoolstate.student.list.aspx?schoolstate=" & strKeyID & "&examyear=" & ddlExamYear.Text & "&dob_year=" & ddlDOB_Year.Text & "&iscount=" & chkRuleAge.Checked)
                Case Else
