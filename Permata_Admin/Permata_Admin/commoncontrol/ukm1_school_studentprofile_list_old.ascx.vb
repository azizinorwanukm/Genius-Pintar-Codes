...
Partial Public Class ukm1_school_studentprofile_list_old
    ...
    Private Function getSQL() As String
        ...
        tmpSQL += " LEFT OUTER JOIN UKM1 ON StudentSchool.SchoolID=UKM1.SchoolID"
        strWhere += " WHERE StudentSchool.SchoolID='" & Request.QueryString("oldschoolid") & "'"
        strWhere += " AND UKM1.SchoolID='" & Request.QueryString("oldschoolid") & "'"
