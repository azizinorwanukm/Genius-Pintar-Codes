...
Partial Public Class ppcs_school_studentprofile_list
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT StudentProfile.StudentID,StudentProfile.StudentFullname,StudentProfile.MYKAD,StudentProfile.AlumniID,StudentProfile.DOB_Year,StudentProfile.StudentRace,PPCS.PPCSStatus FROM PPCS"
        ...
        strWhere = " WHERE PPCS.PPCSDate='" & Request.QueryString("ppcsdate") & "' AND StudentSchool.SchoolID='" & Request.QueryString("schoolid") & "'"
