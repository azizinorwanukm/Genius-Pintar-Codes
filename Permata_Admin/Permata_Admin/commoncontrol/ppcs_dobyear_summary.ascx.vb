...
Public Class ppcs_dobyear_summary
    ...
    Private Function getSQL01() As String
        ...
        '--PPCSStatus
        If Not ddlPPCSStatusBangsa.Text = "ALL" And ddlTawaran2.Text = "ALL" Then
        ...
        If Not ddlTawaran2.Text = "ALL" Then
            strWhere += " AND PPCS.StatusTawaran='" & ddlTawaran2.Text & "'"
        End If
    ...
    Private Sub statusTawaran_list()
        ...
        ddlTawaran2.Items.Add(New ListItem("ALL", "ALL"))
        ddlTawaran2.Items.Add(New ListItem("TERIMA", "TERIMA"))
        ddlTawaran2.Items.Add(New ListItem("TOLAK", "TOLAK"))
    End Sub
    ...
    Private Sub ddlTawaran2_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlTawaran2.TextChanged
        If Not ddlTawaran2.SelectedValue = "ALL" Then
            ddlPPCSStatusBangsa.Enabled = False
        Else
            ddlPPCSStatusBangsa.Enabled = True
        End If
    End Sub
