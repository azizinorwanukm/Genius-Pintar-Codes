...
Partial Public Class schoolprofile_list
    ...
    Private Function getSQL() As String
        ...
        Dim strOrder As String = " ORDER BY SchoolCode,SchoolName,SchoolState,SchoolPPD,SchoolCity ASC"

        tmpSQL = "SELECT SchoolID,SchoolCode,SchoolName,SchoolAddress,SchoolPostcode,SchoolCity,SchoolState,SchoolType,SchoolLokasi,SchoolNoTel,SchoolPPD FROM SchoolProfile"
        strWhere = " WITH (NOLOCK) WHERE SchoolProfile.IsDeleted='" & selIsDeleted.Value & "'"
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Try
            ...
            Select Case getUserProfile_UserType()
                Case "ADMIN"
                    Response.Redirect("admin.studentprofile.create.aspx?schoolid=" & strKeyID)
                Case Else
