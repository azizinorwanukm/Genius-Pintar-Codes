<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ukm1_schoolppd_summary.ascx.vb" Inherits="permatapintar.ukm1_schoolppd_summary" %>
...
<table class="fbform">
    ...
    <tr>
        ...
        <td></td>
        <td><asp:CheckBox ID="chkRuleAge" runat="server" Text="Pelajar berumur 8-15 tahun (8 tahun - beragama Islam sahaja)" Checked="true" /></td>
    </tr>
    ...
    <tr>
        <td>
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                CellPadding="4" ForeColor="#333333" GridLines="None" DataKeyNames="SchoolPPD"
