...
Public Class schoolprofile_select_pindah
    ...
    Private Function getSQL() As String
        ...
        Try
            tmpSQL = "SELECT SchoolProfile.SchoolID,SchoolProfile.SchoolState,SchoolProfile.SchoolPPD,SchoolProfile.SchoolCity,SchoolProfile.SchoolCode,SchoolProfile.SchoolName,SchoolProfile.SchoolLokasi,(SELECT COUNT(*) FROM StudentSchool WHERE SchoolProfile.SchoolID=StudentSchool.SchoolID) as Jumlah,SchoolProfile.isDeleted FROM SchoolProfile"
    ...
    Private Sub btnPindah_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPindah.Click
        ...
        Select Case getUserProfile_UserType()
            Case "ADMIN"
                Response.Redirect("admin.schoolprofile.list.pindah.aspx?pindahid=" & strPindahID & "&examyear=" & lblExamYear.Text)
            Case "SUBADMIN"
                Response.Redirect("subadmin.schoolprofile.list.pindah.aspx?pindahid=" & strPindahID & "&examyear=" & lblExamYear.Text)
            Case "ADMINOP"
                Response.Redirect("schoolprofile.list.pindah.aspx?pindahid=" & strPindahID & "&examyear=" & lblExamYear.Text)
            Case "KPT"
            Case "ASASI"
            Case Else
