...
<table class="fbform">
    ...
    <tr>
        ...
        <td>Agama:</td>
        <td>
            <asp:DropDownList ID="ddlStudentReligion" runat="server" AutoPostBack="false" Width="200px"></asp:DropDownList></td>
    </tr>
    <tr>
        <td>Tahun Lahir:</td>
        <td>
            <asp:DropDownList ID="ddlDOB_Year" runat="server" AutoPostBack="false" Width="200px"></asp:DropDownList></td>
        <td>Status PPCS:</td>
        <td>
    ...
    <tr>
        <td colspan="4">
            <asp:Button ID="btnSearch02" runat="server" Text="Cari " CssClass="fbbutton" />
        </td>
    </tr>
</table>
&nbsp;
<table class="fbform">
    ...
    <tr class="fbform_msg">
        <td>
            <asp:Label ID="lblMsgTop" runat="server" Text="" ForeColor="Red"></asp:Label></td>
    </tr>
</table>
&nbsp;
<table class="fbform">
    ...
    <tr>
        ...
        <td>Status PPCS:</td>
        <td>
            <asp:DropDownList ID="ddlPPCSStatusBangsa" runat="server" AutoPostBack="false" Width="200px"></asp:DropDownList>
        </td>
    </tr>
    <tr>
        <td class="fbform_sap" colspan="2">&nbsp;</td>
        <td class="fbtd_left">Status Tawaran:</td>
        <td>
            <asp:DropDownList ID="ddlTawaran2" runat="server" AutoPostBack="true" Width="200px"></asp:DropDownList>
        </td>
    </tr>
    <tr>
        <td colspan="4">&nbsp;<asp:Button ID="btnSearch01" runat="server" Text="Cari " CssClass="fbbutton" />
        </td>
    </tr>
</table>
<br />
