...
Public Class studentprofile_pindah
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT * FROM StudentProfile WITH (NOLOCK)"
        strWhere += " WHERE StudentID IS NOT NULL"
    ...
    Protected Sub btnPindah_Click(sender As Object, e As EventArgs) Handles btnPindah.Click
        ...
        Response.Redirect("admin.studentprofile.schoolprofile.select.aspx?pindahid=" & strPindahID & "&examyear=" & oCommon.getAppsettings("DefaultExamYear"))
