...
Partial Public Class ppcs_offer_status
    ...
    Private Sub Execute_02()
        ...
        For i = 0 To datRespondent.Rows.Count - 1 Step i + 1
            ...
            If Not chkUpdate Is Nothing Then
                If chkUpdate.Checked = True Then
                    ...
                    ''Response.Write(strID)
                    ''--UPDATE
                    strSQL = "UPDATE PPCS WITH (UPDLOCK) SET PPCSStatus='TOLAK',StatusTawaran='TOLAK',StatusReason='" & oCommon.FixSingleQuotes(txtStatusReason.Text) & "',StatusDate='" & oCommon.getNow & "' WHERE StudentID='" & strID & "' AND PPCSDate='" & ddlPPCSDate.Text & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                    If Not strRet = "0" Then
                        lblMsg.Text = "NOK: " & strRet
                    End If
        ...
        txtStatusReason.Text = ""
        strRet = BindData(datRespondent)
        lblMsg.Text = "Berjaya mengemaskini Status PPCSStatus=TOLAK dan StatusTawaran=TOLAK"
    ...
    Private Sub Execute_04()
        ...
        If chkALL.Checked = True Then
            ...
            If strRet = "0" Then
                txtStatusReason.Text = ""
                strRet = BindData(datRespondent)
                lblMsg.Text = "Berjaya mengemaskini kesemua pelajar Sessi PPCS " & ddlPPCSDate.Text & " DisplayStatus=Y"
            End If
            Exit Sub
        End If
        ...
        For i = 0 To datRespondent.Rows.Count - 1 Step i + 1
            ...
            If Not chkUpdate Is Nothing Then
                If chkUpdate.Checked = True Then
                    Dim strID As String = datRespondent.DataKeys(i).Value.ToString
                    strSQL = "UPDATE PPCS WITH (UPDLOCK) SET DisplayStatus='Y' WHERE StudentID='" & strID & "' AND PPCSDate='" & ddlPPCSDate.Text & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                    If Not strRet = "0" Then
                        lblMsg.Text = "NOK: " & strRet
                    End If
        ...
        txtStatusReason.Text = ""
        strRet = BindData(datRespondent)
        lblMsg.Text = "Berjaya mengemaskini DisplayStatus=Y"
    ...
    Private Sub Execute_05()
        ...
        If chkALL.Checked = True Then
            ...
            If strRet = "0" Then
                txtStatusReason.Text = ""
                strRet = BindData(datRespondent)
                lblMsg.Text = "Berjaya mengemaskini kesemua pelajar Sessi PPCS " & ddlPPCSDate.Text & " DisplayStatus=N"
            End If
            Exit Sub
        End If
        ...
        For i = 0 To datRespondent.Rows.Count - 1 Step i + 1
            ...
            If Not chkUpdate Is Nothing Then
                If chkUpdate.Checked = True Then
                    Dim strID As String = datRespondent.DataKeys(i).Value.ToString
                    strSQL = "UPDATE PPCS WITH (UPDLOCK) SET DisplayStatus='N' WHERE StudentID='" & strID & "' AND PPCSDate='" & ddlPPCSDate.Text & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                    If Not strRet = "0" Then
                        lblMsg.Text = "NOK: " & strRet
                    End If
        ...
        txtStatusReason.Text = ""
        strRet = BindData(datRespondent)
        lblMsg.Text = "Berjaya mengemaskini DisplayStatus=N"
