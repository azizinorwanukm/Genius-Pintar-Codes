...
Partial Public Class ukm1_dobyear_list
    ...
    Private Function getSQL() As String
        ...
        Try
            tmpSQL = "SELECT StudentProfile.StudentID,StudentProfile.StudentFullname,StudentProfile.MYKAD,StudentProfile.AlumniID,StudentProfile.DOB_Year,StudentProfile.StudentRace,SchoolProfile.SchoolID,SchoolProfile.SchoolState,SchoolProfile.SchoolPPD,SchoolProfile.SchoolCity,SchoolProfile.SchoolCode,SchoolProfile.SchoolName,SchoolProfile.SchoolLokasi,UKM1.Status FROM UKM1"
            ...
            strWhere += " WHERE UKM1.ExamYear='" & lblExamYear.Text & "'"

            '--SchoolState
            If Not lblSchoolState.Text = "ALL" Then
                strWhere += " AND UKM1.SchoolState='" & lblSchoolState.Text & "'"
            End If

            '--DOB_Year
            If Not lblDOB_Year.Text = "ALL" Then
                strWhere += " AND StudentProfile.DOB_Year='" & lblDOB_Year.Text & "'"
            End If
