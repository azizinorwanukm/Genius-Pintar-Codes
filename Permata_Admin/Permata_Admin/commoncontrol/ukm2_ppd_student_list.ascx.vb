...
Public Class ukm2_ppd_student_list1
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT StudentProfile.StudentProfileID,StudentProfile.StudentID,StudentProfile.MYKAD,StudentProfile.AlumniID,StudentProfile.StudentFullname,StudentProfile.StudentGender,StudentProfile.StudentRace,StudentProfile.StudentReligion,UKM2.DOB_Year,UKM2.Status,SchoolProfile.SchoolState,SchoolProfile.SchoolPPD FROM UKM2"
        ...
        '--SchoolPPD
        strWhere += " AND UKM2.SchoolPPD='" & Request.QueryString("schoolppd") & "'"
        '--dob_year
        If Not Request.QueryString("dob_year") = "ALL" Then
            strWhere += " AND UKM2.DOB_Year='" & Request.QueryString("dob_year") & "'"
        End If
