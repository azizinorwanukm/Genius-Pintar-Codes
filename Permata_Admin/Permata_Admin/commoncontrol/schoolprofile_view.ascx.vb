...
Partial Public Class schoolprofile_view
    ...
    Private Sub getTotalStudent()
        strSQL = "SELECT COUNT(*) FROM StudentSchool WHERE SchoolID='" & Request.QueryString("schoolid") & "'"
    ...
    Private Sub lnkEdit_Click(sender As Object, e As EventArgs) Handles lnkEdit.Click
        ...
        Select Case getUserProfile_UserType()
            ...
            Case "ADMINOP"
                Response.Redirect("schoolprofile.update.aspx?schoolid=" & Request.QueryString("schoolid"))
            Case "SUBADMIN"
