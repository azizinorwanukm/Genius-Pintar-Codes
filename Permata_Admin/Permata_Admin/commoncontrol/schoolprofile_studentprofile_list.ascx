<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="schoolprofile_studentprofile_list.ascx.vb"
    Inherits="permatapintar.schoolprofile_studentprofile_list" %>
<table class="fbform">
    <tr class="fbform_header">
        <td>Senarai Pelajar Berdaftar.
        </td>
        <td style="text-align:right;">Tahun Lahir:<asp:DropDownList ID="ddlDOB_Year" runat="server" AutoPostBack="true" Width="100px">
        </asp:DropDownList></td>
    </tr>
    <tr>
        <td colspan="2">
