...
Partial Public Class ppcs_state_sort
    ...
    Private Function getSQL() As String
        ...
        Dim strGroupBy As String = " GROUP BY SchoolProfile.SchoolState"
        Dim strOrder As String = " ORDER BY Jumlah DESC"

        tmpSQL = "SELECT SchoolProfile.SchoolState,COUNT(SchoolProfile.SchoolState) as Jumlah FROM PPCS"
