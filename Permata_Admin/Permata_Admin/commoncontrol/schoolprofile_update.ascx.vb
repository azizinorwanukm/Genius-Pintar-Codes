...
Partial Public Class schoolprofile_update
        ...
        Try
            ...
            If MyTable.Rows.Count > 0 Then
                ...
                If Not IsDBNull(ds.Tables(0).Rows(0).Item("SchoolState")) Then
                    ddlSchoolState.Text = ds.Tables(0).Rows(0).Item("SchoolState")
                Else
                    ddlSchoolState.Text = ""
                End If

                If Not IsDBNull(ds.Tables(0).Rows(0).Item("SchoolCountry")) Then
                    selSchoolCountry.Value = ds.Tables(0).Rows(0).Item("SchoolCountry")
                Else
                    selSchoolCountry.Value = ""
                End If
                ...
                End If
                If Not IsDBNull(ds.Tables(0).Rows(0).Item("IsDeleted")) Then
                    selIsDeleted.Value = ds.Tables(0).Rows(0).Item("IsDeleted")
                Else
                    selIsDeleted.Value = ""
                End If
    ...
    Private Function schoolprofile_update() As Boolean
        ''--UPDATE UKM1 also
        strSQL = "UPDATE UKM1_" & getUKM1Year & " WITH (UPDLOCK) SET SchoolCity='" & oCommon.FixSingleQuotes(txtSchoolCity.Text.ToUpper) & "',SchoolState='" & ddlSchoolState.Text & "',SchoolType='" & ddlSchoolType.Text & "',SchoolPPD='" & oCommon.FixSingleQuotes(txtSchoolPPD.Text.ToUpper) & "',SchoolLokasi='" & selSchoolLokasi.Value & "' WHERE SchoolID='" & lblSchoolID.Text & "'"
        strRet = oCommon.ExecuteSQL(strSQL)

        strSQL = "UPDATE UKM1 WITH (UPDLOCK) SET SchoolCity='" & oCommon.FixSingleQuotes(txtSchoolCity.Text.ToUpper) & "',SchoolState='" & ddlSchoolState.Text & "',SchoolType='" & ddlSchoolType.Text & "',SchoolPPD='" & oCommon.FixSingleQuotes(txtSchoolPPD.Text.ToUpper) & "',SchoolLokasi='" & selSchoolLokasi.Value & "' WHERE SchoolID='" & lblSchoolID.Text & "'"
        strRet = oCommon.ExecuteSQL(strSQL)
        If Not strRet = "0" Then
            lblMsg.Text = "Update UKM1 fail: " & strRet
        End If

        ''--UPDATE UKM2 also
        strSQL = "UPDATE UKM2 WITH (UPDLOCK) SET SchoolCity='" & oCommon.FixSingleQuotes(txtSchoolCity.Text.ToUpper) & "',SchoolState='" & ddlSchoolState.Text & "',SchoolType='" & ddlSchoolType.Text & "',SchoolPPD='" & oCommon.FixSingleQuotes(txtSchoolPPD.Text.ToUpper) & "',SchoolLokasi='" & selSchoolLokasi.Value & "' WHERE SchoolID='" & lblSchoolID.Text & "'"
        strRet = oCommon.ExecuteSQL(strSQL)
        If Not strRet = "0" Then
            lblMsg.Text = "Update UKM2 fail: " & strRet
        End If

        strSQL = "UPDATE SchoolProfile WITH (UPDLOCK) SET SchoolCountry='" & selSchoolCountry.Value & "',SchoolCode='" & oCommon.FixSingleQuotes(txtSchoolCode.Text.ToUpper) & "',SchoolName='" & oCommon.FixSingleQuotes(txtSchoolName.Text.ToUpper) & "',SchoolAddress='" & oCommon.FixSingleQuotes(txtSchoolAddress.Text.ToUpper) & "',SchoolPostcode='" & oCommon.FixSingleQuotes(txtSchoolPostcode.Text) & "',SchoolCity='" & oCommon.FixSingleQuotes(txtSchoolCity.Text.ToUpper) & "',SchoolState='" & ddlSchoolState.Text & "',SchoolType='" & ddlSchoolType.Text & "',SchoolPPD='" & oCommon.FixSingleQuotes(txtSchoolPPD.Text.ToUpper) & "',SchoolNoTel='" & oCommon.FixSingleQuotes(txtSchoolNoTel.Text) & "',SchoolNoFax='" & oCommon.FixSingleQuotes(txtSchoolNoFax.Text) & "',SchoolEmail='" & oCommon.FixSingleQuotes(txtSchoolEmail.Text) & "',SchoolLokasi='" & selSchoolLokasi.Value & "',IsDeleted='" & selIsDeleted.Value & "' WHERE SchoolID='" & lblSchoolID.Text & "'"
        strRet = oCommon.ExecuteSQL(strSQL)
        ''--debug
    ...
    Private Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        If schoolprofile_update() = True Then
            lblMsg.Text = "Berjaya kemaskini maklumat sekolah."
        End If
