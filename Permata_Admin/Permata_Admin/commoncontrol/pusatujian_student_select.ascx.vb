...
Partial Public Class pusatujian_student_select
    ...
    Private Function getSQL() As String
        ...
        strWhere = " WHERE UKM2.ExamYear='" & ddlExamYear.Text & "' AND UKM2.PusatCode IS NULL"
        ...
        If Not ddlStudentState.Text = "ALL" Then
            strWhere += " AND StudentProfile.StudentState='" & ddlStudentState.Text & "'"
        End If
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Select Case getUserProfile_UserType()
            ...
            Case "ADMINOP"
                Response.Redirect("pusatujian.student.assign.aspx?pusatcode=" & Request.QueryString("pusatcode") & "&studentid=" & strKeyID)
            Case "SUBADMIN"
    ...
    Private Sub Execute_01()
        ...
        '--UPDATE PusatCode UKM2 NULL
        strSQL = "UPDATE UKM2 SET PusatCode=NULL,TarikhUjian=NULL,SessiUKM2=NULL WHERE PusatCode='" & Request.QueryString("pusatcode") & "'"
        strRet = oCommon.ExecuteSQL(strSQL)
    ...
    Private Sub Execute_03()
        Select Case getUserProfile_UserType()
            ...
            Case "ADMINOP"
                Response.Redirect("pusatujian.student.list.aspx?pusatcode=" & Request.QueryString("pusatcode") & "&examyear=" & Request.QueryString("examyear"))
            Case "SUBADMIN"
    ...
    Private Sub Execute_04()
        Select Case getUserProfile_UserType()
            ...
            Case "ADMINOP"
                Response.Redirect("pusatujian.petugas.select.aspx?pusatcode=" & Request.QueryString("pusatcode") & "&examyear=" & Request.QueryString("examyear"))
            Case "SUBADMIN"
    ...
    Private Sub Execute_05()
        Select Case getUserProfile_UserType()
            ...
            Case "ADMINOP"
                Response.Redirect("pusatujian.petugas.list.aspx?pusatcode=" & Request.QueryString("pusatcode") & "&examyear=" & Request.QueryString("examyear"))
            Case "SUBADMIN"
            ...
            If Not chkUpdate Is Nothing Then
                If chkUpdate.Checked = True Then
                    ...
                    If Not strRet = "0" Then
                        lblMsgTop.Text += "NOK:" & strID & strRet & vbCrLf
                    End If
                End If
            End If
        Next

        If lblMsgTop.Text.Length = 0 Then
            strRet = BindData(datRespondent)
            lblMsgTop.Text = "BERJAYA mengemaskini Pusat Ujian UKM2 pelajar."
        End If
