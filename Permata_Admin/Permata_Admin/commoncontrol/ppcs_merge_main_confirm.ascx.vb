    ...
    Private Function MergeAccount(ByVal strStudentID As String) As Boolean
        ...
        Using connection As New SqlConnection(strconn)
            ...
            Try
                ...
                Dim examyear As String = oCommon.getFieldValue("SELECT ExamYear FROM UKM1 WHERE StudentID = '" & strStudentID & "'")


                strSQL = "UPDATE UKM1_" & getUKM1Year & " WITH (UPDLOCK) SET StudentID='" & Request.QueryString("mainstudentid") & "' WHERE StudentID='" & strStudentID & "'"
                command.CommandText = strSQL
                command.ExecuteNonQuery()
    ...
    Private Function StudentProfile_Delete(ByVal strStudentID As String) As Boolean
        ...
        Using connection As New SqlConnection(strconn)
            ...
            Try
                ...
                lblMsg.Text += "DELETE Maklumat Pelajar berjaya!" & strRet & "<br />"
                Return True
