...
Public Class schoolpindah_list
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT * FROM SchoolPindah"
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Try
            Select Case getUserProfile_UserType()
                Case "ADMIN"
                    Response.Redirect("kpm.schoolprofile.students.list.aspx?examyear=" & oCommon.getAppsettings("DefaultExamYear") & "&schoolid=" & strKeyID)
                Case "SUBADMIN"
                    Response.Redirect("subadmin.schoolprofile.students.list.aspx?examyear=" & oCommon.getAppsettings("DefaultExamYear") & "&schoolid=" & strKeyID)
                Case "JPN"
                    Response.Redirect("jpn.schoolprofile.students.list.aspx?examyear=" & oCommon.getAppsettings("DefaultExamYear") & "&schoolid=" & strKeyID)
                Case "KPM"
                    Response.Redirect("kpm.schoolprofile.students.list.aspx?examyear=" & oCommon.getAppsettings("DefaultExamYear") & "&schoolid=" & strKeyID)
                Case "KPT"
                Case "MRSM"
    ...
    Private Function ukm1_schoolprofile_update(ByVal strNewSchoolID As String, ByVal strOldSchoolID As String) As Boolean
        ...
        If Not strRet = "0" Then
            lblMsg.Text += "Err. ukm1_schoolprofile_update:" & strRet
            Return False
        End If
    ...
    Private Sub SchoolPindah_delete()
        ...
        strRet = oCommon.ExecuteSQL(strSQL)
        If strRet = "0" Then
            lblMsgTop.Text += "BERJAYA memadamkan maklumat sementara sekolah.<br/>"
            bSuccess = True
        Else
            lblMsgTop.Text += "Error. SchoolPindah_delete:" & strRet
            bSuccess = False
        End If
