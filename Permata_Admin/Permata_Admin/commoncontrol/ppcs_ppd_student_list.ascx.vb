...
Public Class ppcs_ppd_student_list
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ppcsdate_list()
                ddlPPCSDate.Text = Request.QueryString("ppcsdate")

                SchoolState_list()
                ddlSchoolState.Text = Request.QueryString("schoolstate")

                schoolprofile_PPD_list()
                ddlSchoolPPD.Text = Request.QueryString("schoolppd")

                master_dobyear_list()
                ddlDOB_Year.Text = Request.QueryString("dob_year")

                PPCSStatus_list()
                ddlPPCSStatus.Text = Request.QueryString("ppcsstatus")
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT StudentProfile.StudentProfileID,StudentProfile.StudentID,StudentProfile.MYKAD,StudentProfile.AlumniID,StudentProfile.StudentFullname,StudentProfile.StudentGender,StudentProfile.StudentRace,StudentProfile.StudentReligion,StudentProfile.DOB_Year,PPCS.PPCSStatus,SchoolProfile.SchoolState,SchoolProfile.SchoolPPD FROM PPCS"
