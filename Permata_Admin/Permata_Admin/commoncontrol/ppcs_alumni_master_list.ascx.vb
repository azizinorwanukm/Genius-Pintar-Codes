...
Partial Public Class ppcs_alumni_master_list
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT DISTINCT PPCS.StudentID,StudentProfile.StudentFullname,StudentProfile.StudentFullname,StudentProfile.MYKAD,StudentProfile.StudentEmail , StudentProfile.StudentContactNo, StudentProfile.AlumniID,StudentProfile.DOB_Year,StudentProfile.StudentReligion,StudentProfile.StudentGender,StudentProfile.StudentRace,StudentProfile.StudentAddress1,StudentProfile.StudentAddress2,StudentProfile.StudentPostcode,StudentProfile.StudentCity,StudentProfile.StudentState,SchoolProfile.SchoolCity,SchoolProfile.SchoolState,PPCS.PPCSStatus,PPCS.StatusTawaran FROM PPCS"
        ...
        tmpSQL += " WHERE StudentProfile.AlumniID IS NOT NULL"
        ...
        Else
            strOrder = " ORDER BY StudentProfile.AlumniID"
        End If
    ...
    '    Dim strFilename As String = "PPCS_Alumni_" & oCommon.getRandom & ".txt"
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Select Case getUserProfile_UserType()
            ...
            Case "ADMINOP"
                Response.Redirect("ppcs.alumni.studentprofile.aspx?studentid=" & strKeyID)
            Case "SUBADMIN"
                Response.Redirect("subadmin.ppcs.alumni.studentprofile.aspx?studentid=" & strKeyID)
            Case "KPT"
            Case "ASASI"
            Case Else
        End Select
