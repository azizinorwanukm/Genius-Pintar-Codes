...
Partial Public Class ukm1_schooltype_summary
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Select Case getUserProfile_UserType()
            Case "ADMIN"
                Response.Redirect("admin.ukm1.schooltype.list.aspx?examyear=" & ddlExamYear.Text & "&schooltype=" + Server.UrlEncode(strKeyID) & "&iscount=" & chkRuleAge.Checked)
            Case "SUBADMIN"
                Response.Redirect("subadmin.ukm1.schooltype.list.aspx?examyear=" & ddlExamYear.Text & "&schooltype=" + Server.UrlEncode(strKeyID) & "&iscount=" & chkRuleAge.Checked)
            Case "KPT"
            Case "ASASI"
            Case Else
