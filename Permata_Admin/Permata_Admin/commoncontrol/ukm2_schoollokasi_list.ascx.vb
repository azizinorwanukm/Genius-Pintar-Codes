...
Partial Public Class ukm2_schoollokasi_list1
    ...
    Private Function getSQL() As String
        ...
        Try
            tmpSQL = "SELECT StudentProfile.StudentID,SchoolProfile.SchoolID,SchoolProfile.SchoolState,SchoolProfile.SchoolPPD,SchoolProfile.SchoolCity,SchoolProfile.SchoolCode,SchoolProfile.SchoolName,SchoolProfile.SchoolLokasi,StudentProfile.StudentFullname,StudentProfile.MYKAD,StudentProfile.AlumniID FROM UKM2"
            ...
            If Not Request.QueryString("schoollokasi") = "ALL" Then
                strWhere += " AND UKM2.SchoolLokasi='" & Request.QueryString("schoollokasi") & "'"
            End If
