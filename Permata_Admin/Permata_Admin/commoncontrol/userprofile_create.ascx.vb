...
Partial Public Class userprofile_create
    ...
    Protected Sub btnCreate_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCreate.Click
        ...
        ''--UPDATE UKM1 also
        strSQL = "INSERT INTO UserProfile (Fullname,LoginID,Pwd,UserType,State,Active) VALUES ('" & oCommon.FixSingleQuotes(txtFullname.Text.ToUpper) & "','" & oCommon.FixSingleQuotes(txtLoginID.Text) & "','" & oDes.EncryptData(txtPwd.Text) & "','" & oCommon.FixSingleQuotes(ddlUserType.Text.ToUpper) & "','" & ddlSchoolState.Text & "','" & selIsActive.Value & "')"
