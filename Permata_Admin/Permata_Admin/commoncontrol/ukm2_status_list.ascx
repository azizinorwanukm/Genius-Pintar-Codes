...
<table class="fbform">
    ...
    <tr>
        <td colspan="3">
            ...
            <asp:Label ID="lblInfo" runat="server" Text="[Kosongkan Tarikh MULA untuk melihat semua rekod]" ForeColor="Red" Font-Italic="true"></asp:Label>&nbsp;
        ...
        <td>
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="STOPTime">
                        <ItemTemplate>
...
Update STOP Time: Immediately set STOP time pelajar. Tak perlu logout dan login semula<br />
Update Masa Tambahan: Pelajar perlu LOGOUT dan LOGIN semula untuk mendapat masa tambahan baru berdasarkan masa terakhir dia berhenti.
