<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ukm1_schoolprofile_list.ascx.vb"
    Inherits="permatapintar.ukm1_schoolprofile_list" %>
...
<table class="fbform">
    ...
    <tr>
        <td>IsDeleted:</td>
        <td>
            <select name="selIsDeleted" id="selIsDeleted" style="width: 200px;" runat="server">
    ...
    <tr>
        ...
        <td></td>
        <td>
            <asp:CheckBox ID="chkRuleAge2" runat="server" Text="Pelajar berumur 8-12 tahun (8 tahun - beragama Islam sahaja)" Checked="false" />
        </td>
    </tr>
    <tr>
...
<table class="fbform">
    ...
    <tr>
        <td>
            ...
            <asp:Button ID="btnDelete" runat="server" Text="Delete Sekolah" CssClass="fbbutton" Visible="false"/>&nbsp;
            <asp:Button ID="btnUpdate" runat="server" Text="Kemaskini Sekolah" CssClass="fbbutton" Visible="false" />
        </td>
    </tr>
</table>
<asp:Button ID="btnPindah" runat="server" Text="Pindah Sekolah" CssClass="fbbutton" Visible="false"/>&nbsp;
