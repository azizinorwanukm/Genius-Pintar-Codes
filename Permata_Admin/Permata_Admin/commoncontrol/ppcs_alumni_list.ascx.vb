...
Partial Public Class ppcs_alumni_list
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT DISTINCT(a.StudentID),b.StudentFullname,b.MYKAD,b.AlumniID,c.Examyear as UKM1Year,c.ModA,c.ModB,c.ModC,c.TotalPercentage as UKM1Percentage,d.ExamYear as UKM2Year,d.VCI,d.PRI,d.WMI,d.PSI,d.TotalPercentage as UKM2Percentage,a.ExamYear as PPCSYear"
        tmpSQL += " FROM PPCS a,StudentProfile b,UKM1 c,UKM2 d"
        strWhere = " WITH (NOLOCK) WHERE(a.StudentID = b.StudentID AND a.StudentID = c.StudentID AND a.StudentID = d.StudentID)"
        ...
        strOrder = " ORDER BY b.StudentFullname,b.MYKAD,c.ExamYear,d.ExamYear,a.ExamYear"
