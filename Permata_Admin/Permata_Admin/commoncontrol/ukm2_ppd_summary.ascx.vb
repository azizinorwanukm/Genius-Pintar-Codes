...
Public Class ukm2_ppd_summary
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT SchoolProfile.SchoolState,SchoolProfile.SchoolPPD,COUNT(*) as Jumlah FROM UKM2"
    ...
    Private Sub datRespondent_SelectedIndexChanging(sender As Object, e As GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Try
            Select Case getUserProfile_UserType()
                Case "ADMIN"
                    Response.Redirect("admin.ukm2.ppd.student.list.aspx?schoolppd=" & strKeyID & "&examyear=" & ddlExamYear.Text & "&dob_year=" & ddlDOB_Year.Text)
                Case "ADMINOP"
                    Response.Redirect("ukm2.ppd.student.list.aspx?schoolppd=" & strKeyID & "&examyear=" & ddlExamYear.Text & "&dob_year=" & ddlDOB_Year.Text)
                Case "SUBADMIN"
                    Response.Redirect("subadmin.ukm2.ppd.student.list.aspx?schoolppd=" & strKeyID & "&examyear=" & ddlExamYear.Text & "&dob_year=" & ddlDOB_Year.Text)
                Case Else
