...
Public Class schoolprofile_list_pindah
    ...
    Private Function getSQL() As String
        ...
        Try
            tmpSQL = "SELECT SchoolProfile.SchoolID,SchoolProfile.SchoolState,SchoolProfile.SchoolPPD,SchoolProfile.SchoolCity,SchoolProfile.SchoolCode,SchoolProfile.SchoolName,SchoolProfile.SchoolLokasi,(SELECT COUNT(*) FROM StudentSchool WHERE StudentSchool.SchoolID=SchoolProfile.SchoolID) AS Jumlah FROM SchoolProfile"
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Try
            Select Case getUserProfile_UserType()
                Case "ADMIN"
                    Response.Redirect("admin.schoolprofile.list.pindah.confirm.aspx?pindahid=" & Request.QueryString("pindahid") & "&schoolid=" & strKeyID)
                Case "SUBADMIN"
                    Response.Redirect("subadmin.schoolprofile.list.pindah.confirm.aspx?pindahid=" & Request.QueryString("pindahid") & "&schoolid=" & strKeyID)
                Case "KPT"
                Case "ASASI"
                Case Else
