...
Partial Public Class ukm2_status_list
    ...
    Private Sub master_menu_list()
        ...
        Select Case getUserProfile_UserType()
            ...
            Case "ADMINOP"
                selLang.Visible = True
            Case "SUBADMIN"
                '--dr siti allow 20160825
                selLang.Visible = True
            Case "UKM"
                '--dr siti request for pengawas 14-aug-2014
                selLang.Visible = True
            Case Else
    ...
    Private Function getSQL(ByVal nType As Integer) As String
        ...
        Select Case selSort.Value
            Case "0"
                strOrder = " ORDER BY UKM2.ExamStart DESC"
            Case "1"
        ...
        If nType = 1 Then
            '--export with mark
            tmpSQL = "SELECT UKM2.StudentID,UKM2.HostAddress,StudentProfile.MYKAD,StudentProfile.AlumniID,StudentProfile.StudentFullname,StudentProfile.DOB_Year,StudentProfile.StudentCity,StudentProfile.StudentState,StudentProfile.Kecenderungan,SchoolProfile.SchoolID,SchoolProfile.SchoolState,SchoolProfile.SchoolPPD,SchoolProfile.Schoolcity,SchoolProfile.SchoolCode,SchoolProfile.Schoolname,UKM2.ExamStart,UKM2.ExamEnd,UKM2.ExamStopTime,UKM2.AdditionalMinute,UKM2.TimeTaken,UKM2.SelectedLang,UKM2.IsHadir,UKM2.IsLogin,UKM2.ExamYear,UKM2.TarikhUjian,UKM2.SessiUKM2,UKM2.Status,UKM2.LastPage,ParentProfile.FamilyContactNo,ParentProfile.FatherFullname,PusatUjian.PusatCode,PusatUjian.PusatState,PusatUjian.PusatName,UKM2.Mod01,UKM2.Mod02,UKM2.Mod03,UKM2.Mod04,UKM2.Mod05,UKM2.Mod06,UKM2.Mod07,UKM2.Mod08,UKM2.Mod09,UKM2.Mod10,UKM2.Mod11,UKM2.Mod12,UKM2.Mod13,UKM2.Mod14,UKM2.Mod15,UKM2.TotalScore,UKM2.TotalPercentage as ukm2TotalPercentage,UKM2.VCI,UKM2.PRI,UKM2.WMI,UKM2.PSI,UKM2.Mental_Age_Year,UKM2.Student_IQ FROM UKM2 WITH (NOLOCK)"
        Else
            '--export without mark
            tmpSQL = "SELECT UKM2.StudentID,UKM2.HostAddress,StudentProfile.MYKAD,StudentProfile.AlumniID,StudentProfile.StudentFullname,StudentProfile.DOB_Year,StudentProfile.StudentCity,StudentProfile.StudentState,StudentProfile.Kecenderungan,SchoolProfile.SchoolID,SchoolProfile.SchoolState,SchoolProfile.SchoolPPD,SchoolProfile.Schoolcity,SchoolProfile.SchoolCode,SchoolProfile.Schoolname,UKM2.ExamStart,UKM2.ExamEnd,UKM2.ExamStopTime,UKM2.AdditionalMinute,UKM2.TimeTaken,UKM2.SelectedLang,UKM2.IsHadir,UKM2.IsLogin,UKM2.ExamYear,UKM2.TarikhUjian,UKM2.SessiUKM2,UKM2.Status,UKM2.LastPage,UKM2.TotalScore,UKM2.TotalPercentage as ukm2TotalPercentage,ParentProfile.FamilyContactNo,ParentProfile.FatherFullname,PusatUjian.PusatCode,PusatUjian.PusatState,PusatUjian.PusatName FROM UKM2 WITH (NOLOCK)"
        End If
    ...
    '--Reset ExamStart. Hanya bagi pelajar yg LastPage<>'ukm2.end.aspx'
        ...
        For i = 0 To datRespondent.Rows.Count - 1 Step i + 1
            ...
            If Not chkUpdate Is Nothing Then
                If chkUpdate.Checked = True Then
                    ...
                    '--LastPage<>'ukm2.end.aspx'
                    strSQL = "UPDATE UKM2 WITH (UPDLOCK) SET ExamStart=NULL,ExamEnd=NULL,Status='NEW',IsHadir='Y' WHERE StudentID='" & strID & "' AND ExamYear='" & ddlExamYear.Text & "' AND LastPage<>'ukm2.end.aspx'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                    If Not strRet = "0" Then
                        lblMsg.Text += "NOK:" & strID & strRet & vbCrLf
                    End If
    ...
    Private Sub Execute_11()
        Try
            strSQL = "UPDATE UKM2 WITH (UPDLOCK) SET DisplayStatus='Y' WHERE ExamYear='" & ddlExamYear.Text & "'"
            strRet = oCommon.ExecuteSQL(strSQL)
            If Not strRet = "0" Then
                lblMsg.Text += "NOK:" & strRet & vbCrLf
            Else
                lblMsg.Text = "Berjaya kemaskini DisplayStatus=Y bagi Tahun Ujian pilihan."
            End If
    ...
    Private Sub Execute_12()
        Try
            strSQL = "UPDATE UKM2 WITH (UPDLOCK) SET DisplayStatus='N' WHERE ExamYear='" & ddlExamYear.Text & "'"
            strRet = oCommon.ExecuteSQL(strSQL)
            If Not strRet = "0" Then
                lblMsg.Text += "NOK:" & strRet & vbCrLf
            Else
                lblMsg.Text = "Berjaya kemaskini DisplayStatus=N bagi Tahun Ujian pilihan."
            End If
        ...
        For i = 0 To datRespondent.Rows.Count - 1 Step i + 1
            ...
            If Not chkUpdate Is Nothing Then
                If chkUpdate.Checked = True Then
                    ...
                    strSQL = "UPDATE UKM2 WITH (UPDLOCK) SET ExamStopTime=DATEADD(MINUTE, " & oCommon.FixSingleQuotes(txtAdditionalMinute.Text) & ", ExamStopTime) WHERE StudentID='" & strID & "' AND ExamYear='" & ddlExamYear.Text & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                    If Not strRet = "0" Then
                        lblMsg.Text += "NOK:" & strID & strRet & vbCrLf
                    End If
        ...
        For i = 0 To datRespondent.Rows.Count - 1 Step i + 1
            ...
            If Not chkUpdate Is Nothing Then
                If chkUpdate.Checked = True Then
                    ...
                    strSQL = "UPDATE UKM2 WITH (UPDLOCK) SET AdditionalMinute=" & oCommon.FixSingleQuotes(txtAdditionalMinute.Text) & " WHERE StudentID='" & strID & "' AND ExamYear='" & ddlExamYear.Text & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                    If Not strRet = "0" Then
                        lblMsg.Text += "NOK:" & strID & strRet & vbCrLf
                    End If
