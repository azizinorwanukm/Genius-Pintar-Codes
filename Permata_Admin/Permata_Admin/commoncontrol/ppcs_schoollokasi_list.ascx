<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ppcs_schoollokasi_list.ascx.vb" Inherits="permatapintar.ppcs_schoollokasi_list1" %>
<table class="fbform">
    <tr class="fbform_header">
        <td>Ringkasan Lokasi>Senarai Sekolah
        </td>
    </tr>
    <tr>
        <td>
