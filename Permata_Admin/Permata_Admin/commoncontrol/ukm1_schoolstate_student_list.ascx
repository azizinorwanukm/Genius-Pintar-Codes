<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ukm1_schoolstate_student_list.ascx.vb" Inherits="permatapintar.ukm1_schoolstate_student_list" %>
            ...
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Nama Sekolah">
                        <ItemTemplate>
                            <asp:Label ID="SchoolState" runat="server" Text='<%# Bind("SchoolName")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Kod">
                        <ItemTemplate>
                            <asp:Label ID="SchoolState" runat="server" Text='<%# Bind("SchoolCode")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
