...
Partial Public Class ukm1_schoolprofile_list_mas
    ...
    Private Function getSQL() As String
        ...
        If chkRuleAge.Checked = True Then
            ...
            If CheckRuleAge2.Checked = True Then
                strWhereAge2 = "AND ('" & ddlExamYear.Text & "' - CAST(DOB_Year as int)) >= 8 AND ('" & ddlExamYear.Text & "' - CAST(DOB_Year as int)) <= 12 "
            End If

            '--check markah
            Dim strJumlahWhere As String = ""
            If chkMark.Checked = True Then
                strJumlahWhere = " AND UKM1.TotalPercentage>5"
            End If
            strJumlah = "(SELECT COUNT(*) FROM UKM1 WITH (NOLOCK) WHERE SchoolProfile.SchoolID=UKM1.SchoolID " & strJumlahWhere & " AND UKM1.Examyear='" & ddlExamYear.Text & "'" & strWhereIn & " " & strWhereAge2 & " ) as Jumlah"
        ...
        Try
            ...
            tmpSQL += strJumlah
            tmpSQL += " FROM SchoolProfile WITH (NOLOCK)"
            ...
            If Not ddlSchoolType.Text = "ALL" Then
                strWhere += " AND SchoolType='" & ddlSchoolType.Text & "'"
            End If
