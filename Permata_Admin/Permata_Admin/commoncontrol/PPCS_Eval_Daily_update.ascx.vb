...
Partial Public Class PPCS_Eval_Daily_update1
    ...
    Private Sub ppcs_eval_load()
        ...
        Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strConn)
        strSQL = "SELECT * FROM ppcs_eval_daily WHERE ppcsevalid=" & Request.QueryString("ppcsevalid")
        ...
        Try
            ...
            If MyTable.Rows.Count > 0 Then
                If Not IsDBNull(MyTable.Rows(nRows).Item("DateCreated")) Then
                    lblSelectedDate.Text = MyTable.Rows(nRows).Item("DateCreated").ToString
                Else
