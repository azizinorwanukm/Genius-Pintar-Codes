...
Public Class ukm1_schoolstate_student_list
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT StudentProfile.StudentProfileID,StudentProfile.StudentID,StudentProfile.MYKAD,StudentProfile.AlumniID,StudentProfile.StudentFullname,StudentProfile.StudentGender,StudentProfile.StudentRace,StudentProfile.StudentReligion,"

        tmpSQL += " UKM1.DOB_Year,UKM1.Status,UKM1.SchoolState,SchoolProfile.SchoolCode,"
        tmpSQL += " SchoolProfile.SchoolName FROM UKM1"
        tmpSQL += " LEFT OUTER JOIN StudentProfile ON UKM1.StudentID=StudentProfile.StudentID"
        tmpSQL += " LEFT JOIN SchoolProfile ON UKM1.SchoolID= SchoolProfile.SchoolID"
