...
Public Class ukm1_schoolprofile_select
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Try
            Select Case getUserProfile_UserType()
                Case "ADMIN"
                    Response.Redirect("admin.ukm1.schoolprofile.students.list.aspx?examyear=" & ddlExamYear.Text & "&schoolid=" & strKeyID & "&iscount=" & chkRuleAge.Checked)
                Case "ADMINOP"
                    Response.Redirect("ukm1.schoolprofile.students.list.aspx?examyear=" & ddlExamYear.Text & "&schoolid=" & strKeyID & "&iscount=" & chkRuleAge.Checked)
                Case "SUBADMIN"
                    Response.Redirect("subadmin.ukm1.schoolprofile.students.list.aspx?examyear=" & ddlExamYear.Text & "&schoolid=" & strKeyID & "&iscount=" & chkRuleAge.Checked)
                Case "KPT"
                Case "MRSM"
                Case "ASASI"
                Case Else
