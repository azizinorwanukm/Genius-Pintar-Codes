...
Partial Public Class studentprofile_update_mykad
        ...
        Try
            ...
            If MyTable.Rows.Count > 0 Then
                ...
                If Not IsDBNull(ds.Tables(0).Rows(0).Item("StudentType")) Then
                    ddlStudentType.Text = ds.Tables(0).Rows(0).Item("StudentType")
                Else
                    ddlStudentType.Text = ""
                End If
    ...
    Private Function StudentProfile_update() As String
        ...
        Try
            ...
            ''log
            Dim strLog As String = oCommon.TransactionLog("studentprofile_update_mykad", oCommon.FixSingleQuotes(strSQL), Request.UserHostAddress, CType(Session.Item("permata_admin"), String))
    ...
    Private Function ukm1_DOBYear_StudentReligion_update() As Boolean
        ...
        strSQL = "UPDATE UKM1_" & getUKM1Year & " WITH (UPDLOCK) SET IsCount=" & nIsCount & ",DOB_Year='" & oCommon.FixSingleQuotes(ddlDOB_Year.Text) & "',StudentReligion='" & oCommon.FixSingleQuotes(ddlStudentReligion.Text) & "' WHERE StudentID='" & Request.QueryString("studentid") & "' AND ExamYear='" & Now.Year & "'"
        strRet = oCommon.ExecuteSQL(strSQL)
