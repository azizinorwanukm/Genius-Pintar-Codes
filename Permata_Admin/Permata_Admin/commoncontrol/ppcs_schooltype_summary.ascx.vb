...
Partial Public Class ppcs_schooltype_summary1
    ...
    Private Function getSQL() As String
        ...
        Dim strGroupby As String = " GROUP BY SchoolProfile.SchoolType"
        ...
        'strWhere = " WITH (NOLOCK) WHERE a.StudentID=b.StudentID AND b.SchoolID=c.SchoolID AND a.PPCSStatus='LAYAK'"

        tmpSQL = "SELECT  SchoolProfile.SchoolType, COUNT(*) as Jumlah FROM PPCS"
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Select Case getUserProfile_UserType()
            Case "ADMIN"
                Response.Redirect("ppcs.schooltype.list.aspx?schooltype=" + Server.UrlEncode(strKeyID) & "&ppcsstatus=" & ddlPPCSStatus.Text & "&ppcsdate=" & ddlPPCSDate.Text)
            Case "ADMINOP"
                Response.Redirect("ppcs.schooltype.list.aspx?schooltype=" + Server.UrlEncode(strKeyID) & "&ppcsstatus=" & ddlPPCSStatus.Text & "&ppcsdate=" & ddlPPCSDate.Text)
            Case "SUBADMIN"
                Response.Redirect("subadmin.ppcs.schooltype.list.aspx?schooltype=" + Server.UrlEncode(strKeyID) & "&ppcsstatus=" & ddlPPCSStatus.Text & "&ppcsdate=" & ddlPPCSDate.Text)
            Case "KPT"
            Case "ASASI"
            Case Else
