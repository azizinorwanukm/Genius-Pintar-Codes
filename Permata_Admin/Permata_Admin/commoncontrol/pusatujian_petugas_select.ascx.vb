...
Partial Public Class pusatujian_petugas_select
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If Not IsPostBack Then
                calTarikh.SelectedDate = DateTime.Today
    ...
    Private Sub btnAssign_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAssign.Click
        ...
        lblMsgTop.Text = "Berjaya mengemaskini rekod baru bagi Petugas Pusat Ujian."
    ...
    Private Sub btnDate_Click(sender As Object, e As ImageClickEventArgs) Handles btnDate.Click
        ...
        If calTarikh.Visible Then
            ...
            If DateTime.TryParse(txtTarikhSearch.Text, [date]) Then
    ...
    Private Sub calTarikh_SelectionChanged(sender As Object, e As EventArgs) Handles calTarikh.SelectionChanged
        txtTarikhSearch.Text = calTarikh.SelectedDate.ToString("yyyy-MM-dd")
