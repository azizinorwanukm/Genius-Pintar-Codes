...
Public Class subadmin_schoolprofile_confirm_change
    ...
    Private Function StudentSchool_insert() As String
        ...
        ''log
        oCommon.TransactionLog("subadmin.schoolprofile.confirm.change", oCommon.FixSingleQuotes(strSQL), Request.UserHostAddress, CType(Session.Item("permata_admin"), String))
