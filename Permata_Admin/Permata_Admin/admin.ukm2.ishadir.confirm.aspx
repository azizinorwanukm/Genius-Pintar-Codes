<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/admin.Master"
    CodeBehind="admin.ukm2.ishadir.confirm.aspx.vb" Inherits="permatapintar.admin_ukm2_ishadir_confirm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="fbform">
        <tr>
            <td class="fbtd_left">Tahun Ujian:<asp:DropDownList ID="ddlExamYear" runat="server" Width="200px">
            </asp:DropDownList>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Reset ExamStart: ExamStart=NULL,ExamEnd=NULL,Status=NULL,IsHadir='Y'.<br />
                Markah tidak dikemaskini.<br />
                Reset UKM2: Set Kehadiran='Y' dan Markah NULL<br />
            </td>
        </tr>
