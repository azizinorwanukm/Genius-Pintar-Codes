...
Partial Public Class kpm_studentschool_schoolprofile_confirm
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        btnStudentSchoolUpdate.Attributes.Add("onclick", "return confirm('Pasti ingin memindahkan pelajar tersebut?');")
    ...
    Private Sub btnStudentSchoolUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnStudentSchoolUpdate.Click
        ...
        Try
            ''update studentschool. ALL student moved. Tanpa mengira Tahun Ujian.
            ...
            ''update isdeleted only for XXX schoolcode. Automatically DELETED. Request by Dr Siti
            ...
            ''audit trail. Pindah ujian pelajar bagi tahun pilihan
            UKM1_History_insert()

            '--update UKM1 to new schoolid profile. berdasarkan tahun pilihan
            ukm1_schoolprofile_update()

            '--update UKM2 to new schoolid profile. berdasarkan tahun pilihan
