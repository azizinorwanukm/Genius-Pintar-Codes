<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/admin.Master"
    CodeBehind="schoolprofile.confirm.change.aspx.vb" Inherits="permatapintar.schoolprofile_confirm_change" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="fbform">
        ...
        <tr>
            <td></td>
            <td>
                <asp:Button ID="btnConfirm" runat="server" Text="Kemaskini" CssClass="fbbutton" />&nbsp;|&nbsp;<asp:LinkButton ID="lnkStudentProfileView" runat="server">Paparan Maklumat Pelajar</asp:LinkButton></td>
        </tr>
    </table>
