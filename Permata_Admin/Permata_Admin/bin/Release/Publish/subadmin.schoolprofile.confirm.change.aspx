<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/subadmin.Master" CodeBehind="subadmin.schoolprofile.confirm.change.aspx.vb" Inherits="permatapintar.subadmin_schoolprofile_confirm_change" %>


<%@ Register Src="commoncontrol/schoolprofile_view_change.ascx" TagName="schoolprofile_view_change"
    TagPrefix="uc1" %>
    ...
    <table class="fbform">
        ...
        <tr>
            ...
            <td>
                ...
                </asp:DropDownList>&nbsp;[Jika sekolah terkini, tidak perlu masukkan Tarikh Akhir]
            </td>
        </tr>
        <tr class="fbform_msg">
            <td colspan="2">
        ...
        <tr>
            <td colspan="2">
                <asp:Button ID="btnConfirm" runat="server" Text="Kemaskini" CssClass="fbbutton" />&nbsp;|&nbsp;<asp:LinkButton ID="lnkStudentProfileView" runat="server">Maklumat Pelajar</asp:LinkButton>
            </td>
        </tr>
    </table>
