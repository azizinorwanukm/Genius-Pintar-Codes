<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ukm2_studentprofile_studentrace_list.ascx.vb" Inherits="permatapintar.ukm2_studentprofile_studentrace_list" %>

<table class="fbform">
    <tr class="fbform_header">
        <td>Senarai Pelajar. Bangsa: <asp:Label ID="lblStudentRace" runat="server" Text=""></asp:Label>
        </td>
    </tr>
    <tr>
        <td>
