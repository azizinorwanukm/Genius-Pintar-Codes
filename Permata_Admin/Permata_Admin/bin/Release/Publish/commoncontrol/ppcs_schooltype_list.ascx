<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ppcs_schooltype_list.ascx.vb"
    Inherits="permatapintar.ppcs_schooltype_list1" %>
<table class="fbform">
    <tr class="fbform_header">
        <td>
            Ringkasan Jenis Sekolah>Senarai Sekolah&nbsp;<asp:Label ID="lblSchoolType" runat="server"
                Text=""></asp:Label>&nbsp;[<asp:Label ID="lblDatetime" runat="server" Text=""></asp:Label>]
        </td>
    </tr>
    <tr>
        <td>
