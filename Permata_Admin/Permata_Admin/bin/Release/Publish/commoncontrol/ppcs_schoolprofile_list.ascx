<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ppcs_schoolprofile_list.ascx.vb"
    Inherits="permatapintar.ppcs_schoolprofile_list1" %>
<table class="fbform">
...
<table class="fbform">
    <tr class="fbform_header">
        <td>Senarai Sekolah. Mengikut urutan tertinggi.
        </td>
    </tr>
    <tr>
        <td>
