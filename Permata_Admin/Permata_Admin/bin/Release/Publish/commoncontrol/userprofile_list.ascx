<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="userprofile_list.ascx.vb"
    Inherits="permatapintar.userprofile_list" %>
...
<table class="fbform">
    ...
    <tr>
        <td>
            ...
            <asp:Button ID="btnActive" runat="server" Text="Activate" CssClass="fbbutton" />&nbsp;
            <asp:Button ID="btnDeactive" runat="server" Text="Deactivate" CssClass="fbbutton" />&nbsp;
        </td>
    </tr>
</table>
