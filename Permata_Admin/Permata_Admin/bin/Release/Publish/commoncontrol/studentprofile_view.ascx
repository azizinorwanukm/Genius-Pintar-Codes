...
<table class="fbform">
    ...
    <tr>
        ...
        <td>:<asp:Label ID="lblPwd" runat="server" Text="" CssClass="fblabel_view"></asp:Label>&nbsp;[Kata
    ...
    <tr>
        ...
        <td>:<asp:Label ID="lblStudentType" runat="server" Text="" CssClass="fblabel_view"></asp:Label>
        </td>
    </tr>
