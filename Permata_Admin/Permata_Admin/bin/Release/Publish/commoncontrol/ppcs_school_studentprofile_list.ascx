<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ppcs_school_studentprofile_list.ascx.vb" Inherits="permatapintar.ppcs_school_studentprofile_list" %>
<table class="fbform">
    <tr class="fbform_header">
        <td>Ringkasan Jenis Sekolah>Senarai Pelajar PPCS
        </td>
    </tr>
    <tr>
        <td>
