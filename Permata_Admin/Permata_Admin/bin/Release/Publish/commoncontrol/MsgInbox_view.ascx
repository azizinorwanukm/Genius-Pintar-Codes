...
<table class="fbform">
    ...
    <tr>
        ...
        <td>:<asp:TextBox ID="txtMsgTo" runat="server" Width="450px" MaxLength="50" Text="" ReadOnly="true" CssClass="fbreadonly"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td>Subjek
        </td>
        <td>:<asp:TextBox ID="txtMsgSubject" runat="server" Width="450px" MaxLength="500" ReadOnly="true" CssClass="fbreadonly"></asp:TextBox>*
        </td>
    </tr>
    <tr>
        <td style="vertical-align: top;">Mesej
        </td>
        <td style="vertical-align: top;">&nbsp;<asp:TextBox ID="txtMsgBody" runat="server" Width="450px" TextMode="MultiLine" Rows="20" ReadOnly="true" CssClass="fbreadonly"></asp:TextBox>*
        </td>
    </tr>
    <tr>
        <td>&nbsp;
