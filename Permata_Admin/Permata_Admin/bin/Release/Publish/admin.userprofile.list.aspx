<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/admin.Master"
    CodeBehind="admin.userprofile.list.aspx.vb" Inherits="permatapintar.admin_userprofile_list" %>

<%@ Register Src="commoncontrol/userprofile_list.ascx" TagName="userprofile_list" TagPrefix="uc1" %>
