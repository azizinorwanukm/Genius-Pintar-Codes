<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="lecturer_Create.ascx.vb" Inherits="KPP_SYS.lecturer_Create" %>
...
<div style="width: 100%; background-color: #f2f2f2; text-align: center; border-radius: 25px; border: 5px solid #8c8c8c;">
    ...
    <div class="row gridViewRespond" style="background-color: #f2f2f2; display: inline-block; width: 100%; border-radius: 25px; margin-top: 20px">
        ...
        <div class="col-md-3 w3-text-black" style="text-align: left; padding-left: 23px">
            ...
            <asp:DropDownList CssClass="btn btn-default font ddl" ID="staff_City" runat="server" Style="width: 100%; border-radius: 25px;"></asp:DropDownList>
        </div>
        <div class="col-md-3 w3-text-black" style="text-align: left; padding-left: 23px">
            <p></p>
            <asp:Label CssClass="Label" runat="server" Style="width: 20%">State : </asp:Label>
            <asp:DropDownList CssClass="btn btn-default font ddl" ID="staff_State" Style="width: 100%; border-radius: 25px;" runat="server"></asp:DropDownList>
        </div>   
        <div class="col-md-6 w3-text-black" style="text-align: left; padding-left: 23px">
            <p></p>
        ...
        <div class="col-md-6 w3-text-black" style="text-align: left; padding-left: 23px">
            <p></p>
            <asp:Label CssClass="Label" runat="server" Style="width: 20%">Position : </asp:Label>
            <asp:DropDownList CssClass="btn btn-default font ddl" ID="staff_Position" Style="width: 100%; border-radius: 25px;" runat="server" ></asp:DropDownList>
        </div>
    </div>
