<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="student_Detail.ascx.vb" Inherits="KPP_SYS.student_Detail" %>
<style>
    .image-upload > input {
        display: none;
    }
        ...
        <div class="row" style="background-color: #f2f2f2; display: inline-block; width: 100%; border-radius: 25px; margin-top: 20px">
            ...
            <div class="col-md-3 w3-text-black" style="text-align: left; padding-left: 23px">
                ...
                <asp:Label CssClass="Label" runat="server" Style="width: 20%"> Student Year : </asp:Label>
                 <asp:TextBox CssClass="textbox" ID="txtStudent_Year" Style="width: 100%; border-radius: 25px;" runat="server" Enabled ="false" ></asp:TextBox>
            </div>
            <div class="col-md-3 w3-text-black" style="text-align: left; padding-left: 23px">
                <p></p>
                <asp:Label CssClass="Label" runat="server"> Student Level : </asp:Label>
                 <asp:TextBox CssClass="textbox" ID="txtStudent_Level" Style="width: 100%; border-radius: 25px;" runat="server" Enabled ="false" ></asp:TextBox>
            </div>
            <div class="col-md-3 w3-text-black" style="text-align: left; padding-left: 23px">
                <p></p>
                <asp:Label CssClass="Label" runat="server" Style="width: 20%"> Student Sem : </asp:Label>
                 <asp:TextBox CssClass="textbox" ID="txtStudent_Sem" Style="width: 100%; border-radius: 25px;" runat="server" Enabled ="false" ></asp:TextBox>
            </div>
            <div class="col-md-6 w3-text-black" style="text-align: left; padding-left: 23px">
                <p></p>
