<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="exam_Transcript.ascx.vb" Inherits="KPP_SYS.exam_Transcript" %>
...
<div class="gridViewRespond" style="width: 100%; background-color: #f2f2f2; text-align: center; border-radius: 25px; border: 5px solid #8c8c8c;">
    ...
    <div class="row" style="background-color: #f2f2f2; display: inline-block; width: 100%; border-radius: 25px; text-align: left; padding-left: 23px;">
        ...
        <asp:DropDownList ID="ddlstudent_Year" runat="server" AutoPostBack="false" CssClass="btn btn-default font ddl"></asp:DropDownList>
...
<div class="gridViewRespond" style="width: 100%; background-color: #f2f2f2; border-radius: 25px; border: 5px solid #8c8c8c;">
    ...
    <div class="w3-text-black" style="margin-left: 23px; margin-top: 10px; margin-bottom: 10px">
        ...
        <button id="BtnGenerate" runat="server" class="btn btn-info" style="background-color: #005580; border-radius: 25px;" title="Print"><i class="fa fa-list-alt w3-large w3-text-white"></i></button>
    </div>
