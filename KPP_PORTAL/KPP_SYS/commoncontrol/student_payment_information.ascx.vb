...
Public Class student_payment_information
    ...
    Private Sub Year_Load()
        ...
        strSQL = "SELECT distinct year from student_Level where year ='" & Now.Year & "' and std_ID = '" & data_ID & "'"
    ...
    Private Function BindData(ByVal gvTable As GridView) As Boolean
        ...
        Try
            ...
            Dim gender As String = "Select student_Sex from student_info where std_ID = '" & data_ID & "'"
    ...
    Private Function getSQL() As String
        ...
        strWhere = " WHERE payment_transaction.std_ID = '" & data_ID & "'"
