<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="parent_guardian2Detail.ascx.vb" Inherits="KPP_SYS.parent_guardian2Detail" %>
    ...
    <div style="display: none;" id="guard2_info">
        <div class="row" style="background-color: #f2f2f2; display: inline-block; width: 100%; border-radius: 25px; margin-top: 20px">
            ...
            <div class="col-md-3 w3-text-black" style="text-align: left; padding-left: 23px">
                ...
                <asp:TextBox CssClass="textbox" ID="P2_txtCity" Style="width: 100%; border-radius: 25px;" runat="server"></asp:TextBox>
            </div>
            <div class="col-md-3 w3-text-black" style="text-align: left; padding-left: 23px">
                <p></p>
