<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="parent_guardianTwo.ascx.vb" Inherits="KPP_SYS.parent_guardianTwo" %>

<div class="gridViewRespond" style="width: 100%; background-color: #f2f2f2; text-align: center; border-radius: 25px; border: 5px solid #8c8c8c;">
    <button id="penjaga2_info" type="button" class="btn btn-info" style="background-color: #800000; display: inline-block; width: 100%; border-radius: 25px; width: 100%" onclick="guardian2_info()" value="0">Guardian Information <i class="fa fa-fw fa fa-caret-down w3-left"></i></button>
