<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="parent_imagePayment_details.ascx.vb" Inherits="KPP_SYS.parent_imagePayment_details" %>
...
<div style="background-color: #F2F2F2; border: 5px solid #F2F2F2; margin-bottom: 3vh" class="w3-card-2 font">
    ...
    <div style="padding-top: 1vh; padding-left: 1.1vw; padding-bottom: 1vh" class="w3-text-black">
        Menu &nbsp; : &nbsp; Payment &nbsp; / &nbsp; 
         <asp:HyperLink ID="hyperlinkInvoiceInformation" runat="server"> Invoice Information </asp:HyperLink>
        &nbsp; / &nbsp; View Invoice
    </div>
</div>
...
<div style="background-color: #F2F2F2; border: 5px solid #F2F2F2;" class="w3-card-2">
    ...
    <div style="padding-top: 3vh; padding-left: 1vw; padding-bottom: 1vh; white-space: nowrap; height: 76vh" id="View_StudentInvoice" runat="server" class="sc4">
        ...
        <br />
         ...
         <div style="overflow-y: scroll; height: 38vh" class="table-responsive sc4 font">
            <asp:GridView ID="datRespondent" runat="server" class="table w3-text-black gridViewRespond" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Quantity" ItemStyle-Width="8%">
                        <ItemTemplate>
                             <asp:TextBox ID="txtIT_Quantity" Width="100%" class="id1" runat="server" Text='<%# Eval("IT_Quantity") %>' Enabled="true" />
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Unit Price (RM)" ItemStyle-Width="12%">
                        <ItemTemplate>
                            <asp:Label ID="FIM_Price" class="id1" runat="server" Text='<%# Eval("FIM_Price") %>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Total Price (RM)" ItemStyle-Width="12%">
                        <ItemTemplate>
         ...
         <div class="w3-text-black font" style="text-align: left; padding-left: 1vw; padding-top:1vh;">
            <asp:Label CssClass="Label" runat="server" Style="width: 100%"> Description : </asp:Label>
            <asp:TextBox runat="server" ID="txt_desc" Style="width: 50vw;"></asp:TextBox>
        </div>
         <div class="w3-text-black" style="text-align: left; padding-left: 1vw; padding-top:2vh;">
             <button id="BtnUpdateInvoice" runat="server" class="btn btn-success" style="top: 1vh; display: inline-block; font-size:0.8vw"> Update Invoice Information </button>
            <button id="BtnBayar" runat="server" class="btn btn-info" style="top: 1vh; display: inline-block; font-size:0.8vw"> Make Payment</button>
            <button id="BtnRefresh" runat="server" class="btn btn-warning" style="top: 1vh; display: inline-block; font-size:0.8vw"> Reload Status</button>
        </div>
