<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="student_List_Table.ascx.vb" Inherits="KPP_SYS.student_List_Table" %>
...
<div class="gridViewRespond" style="width: 100%; background-color: #f2f2f2; text-align: center; border-radius: 25px; border: 5px solid #8c8c8c;">
    ...
    <div id="btnReg" style="display: none">
        <div class="row" style="background-color: #f2f2f2; display: inline-block; width: 100%; border-radius: 25px; text-align: left; padding-left: 23px; margin-bottom: 10px;">
            <button id="btnRegNewStudent" runat="server" type="button" class="btn btn-info" style="background-color: #009900; border-radius: 25px;" title="Add Student"><i class="fa fa-plus w3-large w3-text-white"></i></button>
            <br />
        </div>
    </div>
