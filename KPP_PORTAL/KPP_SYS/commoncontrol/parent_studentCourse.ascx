<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="parent_studentCourse.ascx.vb" Inherits="KPP_SYS.parent_studentCourse" %>
            ...
            <asp:GridView ID="datRespondent" runat="server" class="table w3-text-black " AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Course Code" ItemStyle-Width="150">
                     ...
                     <asp:TemplateField HeaderText="Course Semester" ItemStyle-Width="150">
                        <ItemTemplate>
