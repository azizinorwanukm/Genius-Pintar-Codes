<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="lecturer_List_Table.ascx.vb" Inherits="KPP_SYS.lecturer_List_Table" %>
...
<div class="gridViewRespond" style="width: 100%; background-color: #f2f2f2; text-align: center; border-radius: 25px; border: 5px solid #8c8c8c;">
    ...
    <div class="row" style="background-color: #f2f2f2; display: inline-block; width: 100%; border-radius: 25px;">
        ...
        <div class="col-md-3 w3-text-black" style="text-align: left; padding-left: 10px">
            <p></p>
            <button id="btnSearch" runat="server" class="btn btn-info" style="background-color: #005580; border-radius: 25px;" title="Save"><i class="fa fa-search w3-large w3-text-white"></i></button>
        </div>
    </div>
