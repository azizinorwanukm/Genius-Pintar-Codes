<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="class_List_Table.ascx.vb" Inherits="KPP_SYS.class_List_Table" %>
...
<div id="div_search" style="width: 100%; background-color: #f2f2f2; text-align: center; border-radius: 25px; border: 5px solid #8c8c8c">
    ...
    <div class="table w3-text-black gridViewRespond">
        <div class="row" style="background-color: #f2f2f2; display: inline-block; width: 100%; border-radius: 25px; margin-top: 20px; margin-bottom: 10px; text-align: left; padding-left: 23px">
            <asp:DropDownList CssClass="btn btn-default font ddl" ID="filterYear" runat="server" AutoPostBack="True" OnSelectedIndexChanged="filterYear_Changed"></asp:DropDownList>
            <asp:DropDownList CssClass="btn btn-default font ddl" ID="filterLect" runat="server" AutoPostBack="True" OnSelectedIndexChanged="filterLect_Changed"></asp:DropDownList>
        </div>
    </div>
</div>
<br />
    ...
    <div style="overflow-y: scroll;overflow-x: hidden; height: 450px" class="table-responsive">
        <asp:GridView ID="datRespondent" runat="server" class="table w3-text-black gridViewRespond" AutoGenerateColumns="False" AllowPaging="True" PageSize="9"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Class Name" ItemStyle-Width="400">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Staff ID" ItemStyle-Width="150">
                    <ItemTemplate>
                        <asp:Label ID="staff_ID" class="id1" runat="server" Text='<%# Eval("staff_ID") %>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Left" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Staff Name" ItemStyle-Width="150">
                    <ItemTemplate>
