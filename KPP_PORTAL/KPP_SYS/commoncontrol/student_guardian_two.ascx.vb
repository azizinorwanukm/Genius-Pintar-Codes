...
Public Class student_guardian_two
    ...
    Private Sub Loadpage()
        ...
        ''parent_info
        strSQL = "SELECT * from parent_Info Left Join student_info ON parent_Info.parent_ID = student_info.parent_motherID WHERE student_info.std_ID ='" & data_ID & "' and parent_info.parent_No = '2'"
