...
Public Class student_homepage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                ElseIf getStatus = "RI" Then ''Reference Information
    ...
    Private Sub btnStudentInfo_ServerClick(sender As Object, e As EventArgs) Handles btnStudentInfo.ServerClick
        Response.Redirect("pelajar_login_berjaya.aspx?std_ID=" + Request.QueryString("std_ID") + "&status=SI")
    End Sub

    Private Sub btnParentInfo_ServerClick(sender As Object, e As EventArgs) Handles btnParentInfo.ServerClick
        Response.Redirect("pelajar_login_berjaya.aspx?std_ID=" + Request.QueryString("std_ID") + "&status=FI")
    End Sub

    Private Sub btnCourseInfo_ServerClick(sender As Object, e As EventArgs) Handles btnCourseInfo.ServerClick
        Response.Redirect("pelajar_login_berjaya.aspx?std_ID=" + Request.QueryString("std_ID") + "&status=CI")
    End Sub

    Private Sub btnCocurInfo_ServerClick(sender As Object, e As EventArgs) Handles btnCocurInfo.ServerClick
        Response.Redirect("pelajar_login_berjaya.aspx?std_ID=" + Request.QueryString("std_ID") + "&status=COI")
    End Sub

    Private Sub btnExamInfo_ServerClick(sender As Object, e As EventArgs) Handles btnExamInfo.ServerClick
        Response.Redirect("pelajar_login_berjaya.aspx?std_ID=" + Request.QueryString("std_ID") + "&status=EI")
    End Sub

    Private Sub btnHostelInfo_ServerClick(sender As Object, e As EventArgs) Handles btnHostelInfo.ServerClick
        Response.Redirect("pelajar_login_berjaya.aspx?std_ID=" + Request.QueryString("std_ID") + "&status=HI")
    End Sub

    Private Sub btnDiscInfo_ServerClick(sender As Object, e As EventArgs) Handles btnDiscInfo.ServerClick
        Response.Redirect("pelajar_login_berjaya.aspx?std_ID=" + Request.QueryString("std_ID") + "&status=DI")
    End Sub

    Private Sub btnRefInfo_ServerClick(sender As Object, e As EventArgs) Handles btnRefInfo.ServerClick
        Response.Redirect("pelajar_login_berjaya.aspx?std_ID=" + Request.QueryString("std_ID") + "&status=RI")
    End Sub
    ...
    Private Sub btnUpdateStudentInfo_ServerClick(sender As Object, e As EventArgs) Handles btnUpdateStudentInfo.ServerClick
        ...
        If txtstudentMykad.Text <> "" And txtstudentMykad.Text.Length < 13 Then
            ...
            If txtstudentPostcode.Text = "" Or IsNumeric(txtstudentPostcode.Text) And Regex.IsMatch(txtstudentPostcode.Text, "^[0-9]+$") Then
                ...
                If txtstudentName.Text <> "" And Not IsNothing(txtstudentName.Text) Then
                    ...
                    If txtstudentPhone.Text <> "" And Regex.IsMatch(txtstudentPhone.Text, "^[0-9]+$") Then
    ...
    Private Sub btnUpdateStudentPassword_ServerClick(sender As Object, e As EventArgs) Handles btnUpdateStudentPassword.ServerClick

        Dim getOldPassword As String = "Select student_Password from student_info where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "'"
        ...
        If txtOldPassword.Text = dataOldPassword Then
            ...
            If txtNewPassword.Text <> "" And Regex.IsMatch(txtNewPassword.Text, "^[A-Za-z0-9]+$") Then
                ...
                strSQL = "Update student_info set student_Password = '" & txtNewPassword.Text & "' where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and student_Status = 'Access' and student_Password = '" & txtOldPassword.Text & "'"
                strRet = oCommon.ExecuteSQL(strSQL)

                ShowMessage(" Update Student Password ", MessageType.Success)
    ...
    Private Sub LoadPageGuardian()
        ...
        strSQL = "  Select UPPER(parent_Name) parent_Name, parent_IC, parent_MobileNo, UPPER(parent_Email) parent_Email, UPPER(parent_Status) parent_Status,
                    ...
                    WHERE student_info.std_ID ='" & data_ID & "' and parent_info.parent_No = '1'"
        ...
        If MyTable.Rows.Count > 0 Then
            ...
            If Not IsDBNull(ds.Tables(0).Rows(0).Item("parent_Salary")) Then
                ddlsalaryP1.SelectedValue = ds.Tables(0).Rows(0).Item("parent_Salary")
            Else
                ddlsalaryP1.SelectedIndex = 0
            End If

            If Not IsDBNull(ds.Tables(0).Rows(0).Item("parent_Condition")) Then
                Dim statusP1 As String = ds.Tables(0).Rows(0).Item("parent_Condition")

                If statusP1 = "Alive" Then
                    Parent1_RadioStatusAlive.Checked = True
                ElseIf statusP1 = "Passed Away" Then
        ...
        strSQL = "   Select UPPER(parent_Name) parent_Name, parent_IC, parent_MobileNo, UPPER(parent_Email) parent_Email, UPPER(parent_Status) parent_Status,
                    ...
                    WHERE student_info.std_ID ='" & data_ID & "' and parent_info.parent_No = '2'"
        ...
        If MyTables.Rows.Count > 0 Then
            ...
            If Not IsDBNull(dT.Tables(0).Rows(0).Item("parent_Salary")) Then
                ddlsalaryP2.SelectedValue = dT.Tables(0).Rows(0).Item("parent_Salary")
            Else
                ddlsalaryP2.SelectedIndex = 0
            End If

            If Not IsDBNull(dT.Tables(0).Rows(0).Item("parent_Condition")) Then
                Dim statusP2 As String = dT.Tables(0).Rows(0).Item("parent_Condition")

                If statusP2 = "Alive" Then
                    Parent2_RadioStatusAlive.Checked = True
                ElseIf statusP2 = "Passed Away" Then
    ...
    Private Sub BtnUpdateFamilyInformation_ServerClick(sender As Object, e As EventArgs) Handles BtnUpdateFamilyInformation.ServerClick
        ...
        Dim find_P1ID As String = "Select parent_fatherID from student_info where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "'"
        Dim data_P1ID As String = oCommon.getFieldValue(find_P1ID)

        Dim find_P2ID As String = "Select parent_motherID from student_info where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "'"
        Dim data_P2ID As String = oCommon.getFieldValue(find_P2ID)

        strSQL = "  Update parent_info set parent_Name = '" & oCommon.FixSingleQuotes(txtGuardianNameOne.Text) & "', parent_MobileNo = '" & txtPhoneNoOne.Text & "', parent_Work = '" & txtJobOne.Text & "', parent_Status = '" & txtRelationshipOne.Text & "', parent_Email = '" & Parent1_Email.Text & "', parent_Condition = '" & P1_RStatus & "' where parent_ID = '" & data_P1ID & "'"
        strRet = oCommon.ExecuteSQL(strSQL)
        ...
        strSQL = "  Update parent_info set parent_Name = '" & oCommon.FixSingleQuotes(txtGuardianNameTwo.Text) & "', parent_MobileNo = '" & txtPhoneNoTwo.Text & "', parent_Work = '" & txtJobTwo.Text & "', parent_Status = '" & txtRelationshipTwo.Text & "', parent_Email = '" & Parent2_Email.Text & "', parent_Condition = '" & P2_RStatus & "' where parent_ID = '" & data_P2ID & "'"
        strRet = oCommon.ExecuteSQL(strSQL)
    ...
    Private Sub Year_List()
        strSQL = "select distinct year from student_level where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "'"
        Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strConn)
        Dim sqlDA As New SqlDataAdapter(strSQL, objConn)
    ...
    Private Sub Year_Examination_List()
        strSQL = "  select distinct student_Level.year from student_Level
                    ...
                    where student_info.std_ID = '" + oCommon.Student_securityLogin(Request.QueryString("std_ID")) + "'"
    ...
    Private Sub Examination_List()
        ...
        If data_Check = "off" Or data_Check = "Off" Or data_Check = "OFF" Then
            ...
            data_Exam = "   select max(exam_result.exam_ID) from exam_result
                            ...
                            where course.year = '" & ddlYearExam.SelectedValue & "' and course.std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "'"
            ...
            If ddlYearExam.SelectedIndex > 0 And ddlYearExam.SelectedValue = Now.Year Then
                strSQL = "  select distinct exam_info.exam_Name from exam_result left join exam_info on exam_result.exam_ID = exam_info.exam_ID
                            ...
                            and exam_info.exam_ID < '" & strRet & "' and student_info.std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "'"
            Else
                strSQL = "  select distinct exam_info.exam_Name from exam_result left join exam_info on exam_result.exam_ID = exam_info.exam_ID
                            left join course on exam_result.course_ID = course.course_ID left join student_info on course.std_ID = student_info.std_ID
                            where student_info.student_Status = 'Access' and course.year = '" & ddlYearExam.SelectedValue & "' and exam_info.exam_Year = '" & ddlYearExam.SelectedValue & "' 
        ...
        ElseIf data_Check = "on" Or data_Check = "On" Or data_Check = "ON" Then
            ...
            strSQL = "  select distinct exam_info.exam_Name from exam_result left join exam_info on exam_result.exam_ID = exam_info.exam_ID
                        left join course on exam_result.course_ID = course.course_ID left join student_info on course.std_ID = student_info.std_ID
                        where student_info.student_Status = 'Access' and course.year = '" & ddlYearExam.SelectedValue & "' and exam_info.exam_Year = '" & ddlYearExam.SelectedValue & "'
                        and student_info.std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "'"
        End If
    ...
    Private Sub collect_Data()
        ...
        If get_ExamStatus = "On" Or get_ExamStatus = "on" Or get_ExamStatus = "ON" Then
            ...
            ''get Student Level
            strSQL = "select distinct student_level from student_level where year = '" & ddlYearExam.SelectedValue & "' and std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "'"
            ...
            Dim check_portfolio_percen As String = "select stat_portfolio from student_Png where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and year = '" & ddlYearExam.SelectedValue & "'"
            Dim Confirm_Portfolio As String = oCommon.getFieldValue(check_portfolio_percen)

            ''get cocuricullum percentage on / off
            Dim check_cocuricullum_percen As String = "select stat_kokurikulum from student_Png where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and year = '" & ddlYearExam.SelectedValue & "'"
            Dim Confirm_Cocuricullum As String = oCommon.getFieldValue(check_cocuricullum_percen)

            ''get research percentage on / off
            Dim check_research_percen As String = "select stat_penyelidikan from student_Png where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and year = '" & ddlYearExam.SelectedValue & "'"
            Dim Confirm_Research As String = oCommon.getFieldValue(check_research_percen)

            ''get self development percentage on / off
            Dim check_self_percen As String = "select stat_kendiri from student_Png where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and year = '" & ddlYearExam.SelectedValue & "'"
            Dim Confirm_Self As String = oCommon.getFieldValue(check_self_percen)

            ''print Portfolio
            If Confirm_Portfolio = "On" Then
                strSQL = "SELECT grade FROM [ExamSlip_Portfolio] where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and exam_Year = '" & ddlYearExam.SelectedValue & "' "
                txt_portfolio_grade.Text = oCommon.getFieldValue(strSQL)

                strSQL = "SELECT gpa FROM [ExamSlip_Portfolio] where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and exam_Year = '" & ddlYearExam.SelectedValue & "' "
            ...
            If Confirm_Research = "On" Then
                strSQL = "SELECT grade FROM [ExamSlip_Research] where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and exam_Year = '" & ddlYearExam.SelectedValue & "' "
                txt_research_grade.Text = oCommon.getFieldValue(strSQL)

                strSQL = "SELECT gpa FROM [ExamSlip_Research] where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and exam_Year = '" & ddlYearExam.SelectedValue & "' "
            ...
            If Confirm_Self = "On" Then
                ...
                If get_StudentLevel <> "Level 1" And get_StudentLevel <> "Level 2" Then
                    strSQL = "SELECT grade FROM [ExamSlip_SelfDevelopment_ASAS] where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and exam_Year = '" & ddlYearExam.SelectedValue & "' "
                    txt_sd_grade.Text = oCommon.getFieldValue(strSQL)

                    strSQL = "SELECT gpa FROM [ExamSlip_SelfDevelopment_ASAS] where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and exam_Year = '" & ddlYearExam.SelectedValue & "' "
                    txt_sd_point.Text = oCommon.getFieldValue(strSQL)

                    ''Get CGPA on SD Row
                    strSQL = "SELECT png from student_Png where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and year = '" & ddlYearExam.SelectedValue & "' and student_type = 'ASAS'"
                    txt_pd_gpa.Text = oCommon.getFieldValue(strSQL)

                    strSQL = "SELECT pngs from student_Png where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and year = '" & ddlYearExam.SelectedValue & "' and student_type = 'ASAS'"
                    txt_pd_cgpa.Text = oCommon.getFieldValue(strSQL)

                ElseIf get_StudentLevel = "Level 1" Or get_StudentLevel = "Level 2" Then
                    strSQL = "SELECT grade FROM [ExamSlip_SelfDevelopment_TAHAP] where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and exam_Year = '" & ddlYearExam.SelectedValue & "' "
                    txt_pd_grade.Text = oCommon.getFieldValue(strSQL)

                    strSQL = "SELECT gpa FROM [ExamSlip_SelfDevelopment_TAHAP] where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and exam_Year = '" & ddlYearExam.SelectedValue & "' "
                    txt_pd_point.Text = oCommon.getFieldValue(strSQL)

                    ''Get CGPA on PD Row
                    strSQL = "SELECT png from student_Png where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and year = '" & ddlYearExam.SelectedValue & "' and student_type = 'TAHAP'"
                    txt_pd_gpa.Text = oCommon.getFieldValue(strSQL)

                    strSQL = "SELECT pngs from student_Png where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and year = '" & ddlYearExam.SelectedValue & "' and student_type = 'TAHAP'"
                    txt_pd_cgpa.Text = oCommon.getFieldValue(strSQL)
                End If
            ...
            If Confirm_Cocuricullum = "On" Then
                ...
                Dim studentData As String = "Select student_Mykad from student_info where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "'"
            ...
            strSQL = "  select SUM(subject_CreditHour) FROM [ExamSlip_SubjectName] 
                        where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and exam_Year = '" & ddlYearExam.SelectedValue & "' "
    ...
    Private Sub btnPrintMalay_ServerClick(sender As Object, e As EventArgs) Handles btnPrintMalay.ServerClick
        ...
        If get_ExamStatus = "On" Or get_ExamStatus = "on" Or get_ExamStatus = "ON" Then
            ...
            tmpSQL_Nama = "SELECT subject_NameBM FROM [ExamSlip_SubjectName] 
                                  where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and exam_Year = '" & ddlYearExam.SelectedValue & "' order by course_Name, subject_NameBM ASC"
            ...
            ''print self development
            If Confirm_Self = "On" Then
                Dim level As String = "select student_Level from student_level where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and year = '" & ddlYearExam.SelectedValue & "' "
            ...
            ''print student name
            Dim stdName As String = "select student_Name from student_info where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "'"
            Dim dataStdName As String = oCommon.getFieldValue(stdName)

            ''print student id
            Dim stdID As String = "select student_ID from student_info where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "'"
            Dim dataStdID As String = oCommon.getFieldValue(stdID)

            ''print student mykad
            Dim stdMykad As String = "select student_Mykad from student_info where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "'"
            ...
            ''get PNG & PNGK 
            Dim check_png_exist_data As String = "select png from student_Png where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and year = '" & ddlYearExam.SelectedValue & "'"
            Dim exist_png_data As String = oCommon.getFieldValue(check_png_exist_data)

            Dim check_pngs_exist_data As String = "select pngs from student_Png where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and year = '" & ddlYearExam.SelectedValue & "'"
            ...
            tmpSQL = "select komp_akademik from student_Png where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and year = '" & ddlYearExam.SelectedValue & "'"
            Dim academic_value As String = oCommon.getFieldValue(tmpSQL)

            tmpSQL = "select komp_kokurikulum from student_Png where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and year = '" & ddlYearExam.SelectedValue & "'"
            Dim cocuricullum_value As String = oCommon.getFieldValue(tmpSQL)

            tmpSQL = "select komp_portfolio from student_Png where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and year = '" & ddlYearExam.SelectedValue & "'"
            Dim portfolio_value As String = oCommon.getFieldValue(tmpSQL)

            tmpSQL = "select komp_penyelidikan from student_Png where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and year = '" & ddlYearExam.SelectedValue & "'"
            Dim research_value As String = oCommon.getFieldValue(tmpSQL)

            tmpSQL = "select komp_kendiri from student_Png where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and year = '" & ddlYearExam.SelectedValue & "'"
            ...
            Dim get_ENG_KOD As String = "select course.subject_ID from course left join subject_info on course.subject_ID = subject_info.subject_ID
                                                  where subject_info.subject_Name like '%AP English%' and subject_info.subject_year = '" & ddlYearExam.SelectedValue & "' and course.std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "'"
    ...
    Private Sub btnPrintEnglish_ServerClick(sender As Object, e As EventArgs) Handles btnPrintEnglish.ServerClick
        ...
        If get_ExamStatus = "On" Or get_ExamStatus = "on" Or get_ExamStatus = "ON" Then
            ...
            tmpSQL_Nama = "SELECT subject_Name FROM [ExamSlip_SubjectName] 
                                  where std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "' and exam_Name = '" & ddlExamination.SelectedValue & "' and exam_Year = '" & ddlYearExam.SelectedValue & "' order by course_Name, subject_Name ASC"
            Dim SQA As New SqlDataAdapter(tmpSQL_Nama, strConn)
