<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="student_CourseList.ascx.vb" Inherits="KPP_SYS.student_CourseList" %>
            ...
            <asp:GridView ID="datRespondent" runat="server" class="table w3-text-black " AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Sem" ItemStyle-Width="150">
                        <ItemTemplate>
                            <asp:Label ID="subject_sem" class="id1" runat="server" Text='<%# Eval("student_Sem") %>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left" />
                    </asp:TemplateField>
