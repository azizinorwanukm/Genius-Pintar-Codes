<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="student_marks.ascx.vb" Inherits="KPP_SYS.student_marks1" %>
<style>
    /ddl{
        border-radius:25px;
    }
    ...
    <div class="row gridViewRespond" style="background-color: #f2f2f2; display: inline-block; width: 100%; border-radius: 25px; margin-top: 10px;margin-bottom:10px">
        <div class="col-md-6 w3-text-black" style="text-align: left; padding-left: 23px">
         ...
         <div class="col-md-12 w3-text-black" style="text-align: left; padding-left: 23px; margin-top: 5px;">
            ...
            <asp:DropDownList ID="ddl_subject" runat="server" AutoPostBack="true" class="btn btn-default font ddl" style="border-radius: 25px;" onselectedindexchanged="ddlSubject_SelectedIndexChanged" ></asp:DropDownList>
        </div>
    </div>
</div>
<br />
