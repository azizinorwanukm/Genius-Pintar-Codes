<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="student_cocurricular_information.ascx.vb" Inherits="KPP_SYS.student_cocurricular_information" %>
...
<div class="gridViewRespond" style="width: 100%; background-color: #f2f2f2; text-align: center; border-radius: 25px; border: 5px solid #8c8c8c;">
    <button id="cocurricular_data" type="button" class="btn btn-info" style="background-color: #800000; display: inline-block; width: 100%; border-radius: 25px; width: 100%" onclick="cocurricular_info()" value="0">Cocurricular Information <i class="fa fa-fw fa fa-caret-down w3-left"></i></button>
    <div style="display: none;" id="koko_info">
