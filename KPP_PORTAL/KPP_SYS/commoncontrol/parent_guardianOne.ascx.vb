...
Public Class parent_guardianOne
    ...
    Private Sub Loadpage()
        ...
        Dim parent_data_male As String = "select parent_fatherID from student_info where std_ID = '" & Request.QueryString("std_ID") & "'"
        Dim dataParentID As String = getFieldValue(parent_data_male, strConn)

        strSQL = "SELECT * from parent_Info 
                  left join student_Info on student_info.parent_fatherID=parent_Info.parent_ID 
                  WHERE student_info.parent_fatherID ='" & dataParentID & "' "
