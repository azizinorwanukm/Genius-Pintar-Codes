...
Public Class guardian2_DetailStd
    ...
    Private Sub btnGuardianUpdate_ServerClick(sender As Object, e As EventArgs) Handles btnGuardianUpdate.ServerClick
                                ...
                                If ddlparent_State.SelectedValue <> "0" Then
                                    ...
                                    If parent_Postcode.Text = "" Or IsNumeric(parent_Postcode.Text) Then
                                        ...
                                        strSQL = "UPDATE parent_Info set parent_Name='" & parent_Name.Text & "',parent_IC='" & parent_IC.Text & "',parent_State='" & ddlparent_State.SelectedValue & "',
                                                ...
                                                parent_HomeAddress='" & parent_Address.Text & "',parent_City='" & P2_txtCity.Text & "',parent_Postcode='" & parent_Postcode.Text & "',
                                                parent_Work='" & parent_work.Text & "',parent_Salary='" & ddlsalary.SelectedValue & "',parent_WorkAddress='" & parent_WorkAddress.Text & "',
                                        ...
                                        If strRet = 0 Then
                                            ...
                                            Using PJGDATA As New SqlCommand("INSERT into ActivityTrail_BtmLvl(Log_Date,Activity,Login_ID,User_HostAddress,Page,Name_Matters) 
                                                     values ('" & DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss") & "','Update Parent Data','" & data_ID & "','" & Net.Dns.GetHostByName(host).AddressList(0).ToString() & "','pelajar_update_profile.aspx','" & parent_Name.Text & "')", objConn)
                                                objConn.Open()
        ...
        If errorCount = 20 Then
            Response.Redirect("pelajar_update_profile.aspx?result=20&std_ID=" + Request.QueryString("std_ID") + "")
        ElseIf errorCount = 21 Then
            Response.Redirect("pelajar_update_profile.aspx?result=21&std_ID=" + Request.QueryString("std_ID") + "")
        ElseIf errorCount = 22 Then
            Response.Redirect("pelajar_update_profile.aspx?result=22&std_ID=" + Request.QueryString("std_ID") + "")
        ElseIf errorCount = 23 Then
            Response.Redirect("pelajar_update_profile.aspx?result=23&std_ID=" + Request.QueryString("std_ID") + "")
        ElseIf errorCount = 24 Then
            Response.Redirect("pelajar_update_profile.aspx?result=24&std_ID=" + Request.QueryString("std_ID") + "")
        ElseIf errorCount = 25 Then
            Response.Redirect("pelajar_update_profile.aspx?result=25&std_ID=" + Request.QueryString("std_ID") + "")
        ElseIf errorCount = 26 Then
            Response.Redirect("pelajar_update_profile.aspx?result=26&std_ID=" + Request.QueryString("std_ID") + "")
        ElseIf errorCount = 27 Then
            Response.Redirect("pelajar_update_profile.aspx?result=27&std_ID=" + Request.QueryString("std_ID") + "")
        ElseIf errorCount = 28 Then
            Response.Redirect("pelajar_update_profile.aspx?result=28&std_ID=" + Request.QueryString("std_ID") + "")
        ElseIf errorCount = 29 Then
            Response.Redirect("pelajar_update_profile.aspx?result=29&std_ID=" + Request.QueryString("std_ID") + "")
        ElseIf errorCount = 30 Then
            Response.Redirect("pelajar_update_profile.aspx?result=30&std_ID=" + Request.QueryString("std_ID") + "")
        End If
    End Sub
End Class