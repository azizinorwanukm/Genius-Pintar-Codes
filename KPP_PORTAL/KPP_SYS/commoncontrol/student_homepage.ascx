<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="student_homepage.ascx.vb" Inherits="KPP_SYS.student_homepage" %>
...
<div style="background-color: #F2F2F2; border: 5px solid #F2F2F2;" class="w3-card-2">
    ...
    <div style="padding-top: 3vh; padding-left: 1vw; padding-bottom: 1vh; overflow-y: scroll; white-space: nowrap; height: 70vh" id="StudentInformation" runat="server" class="sc4">
        <table class="w3-text-black font" style="text-align: left; padding-left: 1vw; border: hidden; margin-left: 1vw">
            ...
            <tr>
                ...
                <td>
                    <p></p>
                    &nbsp : &nbsp
                   <asp:TextBox runat="server" ID="txtstudentCity" Style="width: 20vw" CssClass="textboxcss"></asp:TextBox>
                </td>
                <td>
                    <p></p>
                    &nbsp &nbsp  &nbsp &nbsp  &nbsp &nbsp 
        ...
        <div class="w3-text-black" style="text-align: left; padding-left: 1vw; padding-top: 1vh; display: inline-block">
            <button id="btnUpdateStudentPassword" runat="server" class="btn btn-success" style="top: 1vh; display: inline-block; font-size: 0.8vw">Update Password</button>
        </div>
    </div>
    ...
    <div style="padding-top: 3vh; padding-left: 1vw; padding-bottom: 1vh; overflow-y: scroll; white-space: nowrap; height: 70vh" id="ParentInformation" runat="server" class="sc4">
        <table class="w3-text-black font" style="text-align: left; padding-left: 1vw; border: hidden; margin-left: 1vw">
            <tr>
                ...
                <td>
                    <p></p>
                    &nbsp : &nbsp
                    <asp:TextBox runat="server" ID="txtGuardianNameTwo" Style="width: 28vw" CssClass="textboxcss"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <p></p>
                    &nbsp : &nbsp
                    <asp:TextBox runat="server" ID="txtMykadNumberOne" Style="width: 10vw" CssClass="textboxcss" Enabled="false"></asp:TextBox>
                </td>
                <td>
                    <p></p>
                    &nbsp &nbsp  &nbsp &nbsp  &nbsp
            ...
            <tr>
                ...
                <td>
                    <p></p>
                    &nbsp : &nbsp
                    <asp:TextBox runat="server" ID="txtPhoneNoTwo" Style="width: 20vw" CssClass="textboxcss"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <p></p>
                    &nbsp : &nbsp
                    <asp:TextBox runat="server" ID="txtRelationshipTwo" Style="width: 20vw" CssClass="textboxcss" placeholder="Father / Mother / Uncle / Grandmother "></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <p></p>
                    &nbsp : &nbsp
                    <asp:TextBox runat="server" ID="txtJobTwo" Style="width: 20vw" CssClass="textboxcss"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <p></p>
                    &nbsp : &nbsp
                    <asp:DropDownList ID="ddlsalaryP1" runat="server" AutoPostBack="false" CssClass=" btn btn-default font" Style="font-size: 0.8vw" Enabled="false"></asp:DropDownList>
                </td>
                <td>
                    <p></p>
                    &nbsp &nbsp 
                ...
                <td>
                    <p></p>
                    &nbsp : &nbsp
                     <asp:DropDownList ID="ddlsalaryP2" runat="server" AutoPostBack="false" CssClass=" btn btn-default font" Style="font-size: 0.8vw" Enabled="false"></asp:DropDownList>
                </td>
            </tr>
        ...
        <div class="w3-text-black" style="text-align: left; padding-left: 1vw; display: inline-block">
            <button id="BtnUpdateFamilyInformation" runat="server" class="btn btn-success" style="top: 8px; display: inline-block; font-size: 0.8vw">Update Information</button>
        </div>
    </div>
