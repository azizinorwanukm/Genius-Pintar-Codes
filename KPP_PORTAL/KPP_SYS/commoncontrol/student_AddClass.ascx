<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="student_AddClass.ascx.vb" Inherits="KPP_SYS.student_AddClass" %>
...
<div class="gridViewRespond" style="width: 100%; background-color: #f2f2f2; text-align: center; border-radius: 25px; border: 5px solid #8c8c8c;">
    ...
    <div class="row" style="background-color: #f2f2f2; display: inline-block; width: 100%; border-radius: 25px;">
        <div class="col-md-12 w3-text-black" style="text-align: left; padding-left: 23px">
            <p></p>
            <asp:DropDownList ID="ddl_year" runat="server" AutoPostBack="true" CssClass=" btn btn-default font ddl"  style="width:190px;" onselectedindexchanged="ddlLevel_SelectedIndexChanged" ></asp:DropDownList>
            ...
            <asp:DropDownList ID="ddl_sem" runat="server" AutoPostBack="true" CssClass=" btn btn-default font ddl" style="width:190px;" onselectedindexchanged="ddlClass_SelectedIndexChanged" DataTextField="-Select Foundation/Level first-" ></asp:DropDownList>
        </div>
    </div>
    <p></p>
</div>
...
<div class="gridViewRespond" style="width: 100%; background-color: #f2f2f2; text-align: center; border-radius: 25px; border: 5px solid #8c8c8c;">
    ...
    <div class="row" style="background-color: #f2f2f2; display: inline-block; width: 100%; border-radius: 25px; margin-top: 20px; text-align: left; padding-left: 23px">
        <asp:DropDownList ID="ddlclassChoose" runat="server" AutoPostBack="false" CssClass=" btn btn-default font ddl" style="width:190px;"></asp:DropDownList>
