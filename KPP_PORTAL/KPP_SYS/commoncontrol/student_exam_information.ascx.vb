...
Public Class student_exam_information
    ...
    Private Function getSQL() As String
        ...
        strWhere = " where student_info.std_ID = '" + data_ID + "'
                ...
                If Not chkUpdate Is Nothing Then
                    ...
                    If chkUpdate.Checked = True Then
                        ...
                        If Confirm_Cocuricullum = "on" Then
                            If ddlexam.SelectedValue = "Exam 1" Or ddlexam.SelectedValue = "Exam 5" Or ddlexam.SelectedValue = "Exam 9" Then
                            ...
                            ElseIf ddlexam.SelectedValue = "Exam 2" Or ddlexam.SelectedValue = "Exam 6" Or ddlexam.SelectedValue = "Exam 10" Then
                            ...
                            ElseIf ddlexam.SelectedValue = "Exam 3" Or ddlexam.SelectedValue = "Exam 7" Or ddlexam.SelectedValue = "Exam 11" Then
                            ...
                            ElseIf ddlexam.SelectedValue = "Exam 4" Or ddlexam.SelectedValue = "Exam 8" Or ddlexam.SelectedValue = "Exam 12" Then
                        ...
                        ''get PNG & PNGK 
                        Dim check_png_exist_data As String = "select png from student_Png where std_ID = '" & strKey & "' and exam_Name = '" & ddlexam.SelectedValue & "' and year = '" & ddlyear.SelectedValue & "'"
                        Dim exist_png_data As String = getFieldValue(check_png_exist_data, strConn)

                        Dim check_pngs_exist_data As String = "select pngs from student_Png where std_ID = '" & strKey & "' and exam_Name = '" & ddlexam.SelectedValue & "' and year = '" & ddlyear.SelectedValue & "'"
