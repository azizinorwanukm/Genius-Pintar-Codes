...
Public Class student_examData
    ...
    Private Sub Exam()
        ...
        If data_Check = "off" Then
            ...
            data_Exam = "  select max(exam_result.exam_ID) from exam_result
                        ...
                        where course.year = '" & ddlyear.SelectedValue & "' and course.std_ID = '" & oCommon.Student_securityLogin(Request.QueryString("std_ID")) & "'"
    ...
    Private Sub Btnprint_ServerClick(sender As Object, e As EventArgs) Handles Btnprint.ServerClick
        ...
        Dim dataSTD As String = oCommon.Student_securityLogin(Request.QueryString("std_ID"))
