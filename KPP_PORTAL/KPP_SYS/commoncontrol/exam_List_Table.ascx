<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="exam_List_Table.ascx.vb" Inherits="KPP_SYS.exam_List_Table" %>
...
<div class="gridViewRespond" style="width: 100%; background-color: #f2f2f2; text-align: center; border-radius: 25px; border: 5px solid #8c8c8c;">
    ...
    <div class="row" style="background-color: #f2f2f2; display: inline-block; width: 100%; border-radius: 25px; margin-bottom: 10px; text-align: left; padding-left: 23px">
        <button id="btnRegExam" type="button" runat="server" class="btn btn-info" style="background-color: #009900; border-radius: 25px;" title="Add Exam"><i class="fa fa-plus w3-large w3-text-white"></i></button>
    </div>
</div>
