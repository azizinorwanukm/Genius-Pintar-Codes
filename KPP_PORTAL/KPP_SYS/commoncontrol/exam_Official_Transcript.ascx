<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="exam_Official_Transcript.ascx.vb" Inherits="KPP_SYS.exam_Official_Transcript" %>
...
<div class="gridViewRespond" style="width: 100%; background-color: #f2f2f2; border-radius: 25px; border: 5px solid #8c8c8c;">
    ...
    <div class="w3-text-black" style="margin-left: 23px ;margin-top:10px;margin-bottom:10px">
        ...
        <p></p>
        <asp:Label CssClass="Label" runat="server"> Type Transcript : </asp:Label>
        <asp:DropDownList ID="ddlTypeTranscripts" runat="server" AutoPostBack="false" class=" btn btn-default font ddl"></asp:DropDownList>
