<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="lecturer_attendanceData.ascx.vb" Inherits="KPP_SYS.lecturer_attendanceData" %>
...
<div class="gridViewRespond" style="width: 100%; background-color: #f2f2f2; text-align: center; border-radius: 25px; border: 5px solid #8c8c8c;">
    ...
    <div class="row" style="background-color: #f2f2f2; display: inline-block; width: 100%; border-radius: 25px;">
        ...
        <div class="row" style="background-color: #f2f2f2; display: inline-block; width: 100%; border-radius: 25px; margin-top: 20px; text-align: left; padding-left: 23px">
            <asp:DropDownList ID="ddlYear" runat="server" AutoPostBack="true" CssClass=" btn btn-default font ddl" Style="width: 150px;" OnSelectedIndexChanged="ddlYear_SelectedIndexChanged"></asp:DropDownList>
            <asp:DropDownList ID="ddlMonth" runat="server" AutoPostBack="true" CssClass=" btn btn-default font ddl" Style="width: 150px;" OnSelectedIndexChanged="ddlMonth_SelectedIndexChanged"></asp:DropDownList>
        </div>
        <div class="row" style="background-color: #f2f2f2; display: inline-block; width: 100%; border-radius: 25px; margin-top: 20px; text-align: left; padding-left: 23px; object-position: left">
            <asp:Button ID="selectdatePicker" runat="server" CssClass="btn btn-default font" OnClick="selectdatePicker_Click" Text="Select Date" ForeColor="Black" Width="250px" />
            <asp:Calendar CssClass="calendarCSS" ID="datePicker" runat="server" Visible="False" WeekendDayStyle-BackColor="Yellow" BackColor="White" ForeColor="Black" SelectedDayStyle-ForeColor="AliceBlue" Width="350px" BorderColor="White" BorderWidth="1px" Font-Names="Verdana" Font-Size="9pt" Height="250px" NextPrevFormat="FullMonth">
        ...
        <asp:GridView ID="addRespondent" runat="server" class="table w3-text-black " AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Status" ItemStyle-Width="200" HeaderStyle-VerticalAlign="Middle">
                    <ItemTemplate>
                        <asp:DropDownList ID="attendance_Status" runat="server" class="id1" CssClass=" btn btn-default font ddl" Style="width: 150px;">
    ...
    <div style="overflow-y: scroll; overflow-x: hidden; height: 420px" class="table-responsive">
        <asp:GridView ID="viewRespondent" runat="server" class="table w3-text-black " AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Student ID" ItemStyle-Width="50" HeaderStyle-CssClass="centerHeader">
                    <ItemTemplate>
                        <asp:Label ID="course_ID" class="id1" runat="server" Text='<%# Eval("student_ID") %>'></asp:Label>
                    </ItemTemplate>
...
<div class="row" style="background-color: #f2f2f2; display: inline-block; width: 100%; border-radius: 25px; padding-left: 23px; text-align: left;">
    ...
    <asp:Button ID="selectDeletedatePicker" runat="server" CssClass=" btn btn-default font" OnClick="selectDeletedatePicker_Click" Text="Select Date To Delete" ForeColor="Black" Width="250px" />
    ...
    <button id="btnDelete" runat="server" class="btn btn-info" style="background-color: #005580; border-radius: 25px;" title="Delete"><i class="fa fa-close w3-large w3-text-white"></i></button>
</div>
