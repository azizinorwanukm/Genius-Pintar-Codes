<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="lecturer_view_course.ascx.vb" Inherits="KPP_SYS.lecturer_view_course" %>
...
<div class="gridViewRespond" style="width: 100%; background-color: #f2f2f2; text-align: center; border-radius: 25px; border: 5px solid #8c8c8c;">
    ...
    <div class="row" style="background-color: #f2f2f2; display: inline-block; width: 100%; border-radius: 25px; text-align: left; padding-left: 23px">
        ...
        <asp:DropDownList ID="ddlCourseLevel" runat="server" AutoPostBack="true" CssClass="btn btn-default font ddl"></asp:DropDownList>
        <asp:DropDownList ID="ddlCourseSem" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlCourseSem_SelectedIndexChanged" CssClass="btn btn-default font ddl"></asp:DropDownList>       
        <asp:DropDownList ID="ddlClass" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlClass_SelectedIndexChanged" CssClass="btn btn-default font ddl"></asp:DropDownList>
