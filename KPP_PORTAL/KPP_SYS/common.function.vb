...
Public Class Commonfunction
    ...
    Function formatDateDay(ByVal dtDate As Date) As String
        Return dtDate.ToString("dddd dd-MM-yyyy hh:mm")
    ...
    Public Function securityLogin(ByVal Text As String) As String
        ...
        Else
            Dim accessID As String = "select MAX(std_ID) from student_SecurityID where loginID_Number = '" & Text & "'"
            Dim accessData As String = getFieldValue(accessID)

            ''check if data is exist
            If accessData <> "" Then

                Dim saveDate As String = "select MAX(datetime) from student_SecurityID where loginID_Number = '" & Text & "'"
    ...
    Public Function Student_securityLogin(ByVal Text As String) As String
        ...
        Else
            ...
            If data_userID <> "" Then
                ...
                Dim saveDate As String = "select datetime from student_SecurityID where security_ID = '" & accessData & "'"
                Dim DataDate As Integer = Integer.Parse(getFieldValue(saveDate))
    ...
    Public Function random() As String
        ...
        Dim r As New Random
        Const passwordLength As Integer = 50
    ...
    Public Function getAppsettings(ByVal strconfigCode As String) As String
        ...
        strRet = getFieldValuePermata(strSQL)
    ...
    Public Function getFieldValuePermata(ByVal strSQL As String) As String
        If strSQL.Length = 0 Then
            Return ""
        End If
        'If isBlockText(strSQL) = True Then
