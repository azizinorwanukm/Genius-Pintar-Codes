<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/admin.Master" CodeBehind="admin_edit_pelajar_data.aspx.vb" Inherits="KPP_MS.admin_edit_pelajar_data" %>
...
<%@ Register Src="~/commoncontrol/cocurricular_Detail.ascx" TagPrefix="uc1" TagName="cocurricular_Detail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function student_Koko() {
            if (document.getElementById("Cocurricular").value == 0) {
                document.getElementById("std_koko").style.display = "block";
                document.getElementById("Cocurricular").value = 1;
            }

            else if (document.getElementById("Cocurricular").value == 1) {
                document.getElementById("std_koko").style.display = "none";
                document.getElementById("Cocurricular").value = 0;
            }
        }
    </script>
    ...
    <uc1:cocurricular_Detail runat="server" id="cocurricular_Detail" />
