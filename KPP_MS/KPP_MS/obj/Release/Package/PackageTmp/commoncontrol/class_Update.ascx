...
<div class="gridViewRespond" style="width: 100%; background-color: #f2f2f2; text-align: center; border-radius: 25px; border: 5px solid #8c8c8c;">
    ...
    <div class="row" style="background-color: #f2f2f2; display: inline-block; width: 100%; border-radius: 25px; margin-top: 20px">
        ...
        <div class="col-md-3 w3-text-black" style="text-align: left; padding-left: 23px">
            ...
            <asp:DropDownList style="width:190px; border-radius: 25px;" CssClass="w3-text-black btn btn-default ddl" ID="ddlclass_Level" runat="server" AutoPostBack="true" ></asp:DropDownList>
        </div>
        <div class="col-md-3 w3-text-black" style="text-align: left; padding-left: 23px">
            <p></p>
            <asp:Label CssClass="Label" runat="server"> Staff Name : </asp:Label>
            <asp:DropDownList style="width:190px; border-radius: 25px;" CssClass="w3-text-black btn btn-default ddl" ID="ddlstaff_ID" runat="server" AutoPostBack="true"></asp:DropDownList>
        </div>
        <div class="col-md-6 w3-text-black" style="text-align: left; padding-left: 23px">
            <p></p>
