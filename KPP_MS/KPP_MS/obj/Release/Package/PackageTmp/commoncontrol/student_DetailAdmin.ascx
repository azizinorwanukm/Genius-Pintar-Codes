<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="student_DetailAdmin.ascx.vb" Inherits="KPP_MS.student_DetailAdmin" %>
    ...
    <div style="display: none;" id="std_info">
        <div class="row" style="background-color: #f2f2f2; display: inline-block; width: 100%; border-radius: 25px; margin-top: 20px">
            <div class="col-md-6 w3-text-black image-upload" style="text-align: center; padding-left: 23px">
                ...
                <label for="ctl00_ContentPlaceHolder1_student_DetailAdmin_uploadPhoto">
            ...
            <div class="col-md-3 w3-text-black" style="text-align: left; padding-left: 23px">
                ...
                <asp:DropDownList ID="ddlYear_registered" runat="server" AutoPostBack="false" CssClass=" btn btn-default ddl" Style="width: 100%;"></asp:DropDownList>
            </div>
            <div class="col-md-3 w3-text-black" style="text-align: left; padding-left: 23px">
                <p></p>
