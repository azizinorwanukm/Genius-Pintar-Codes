...
<div style="background-color: #F2F2F2; border: 5px solid #F2F2F2; margin-bottom: 3vh" class="w3-card-2 font">
    ...
    <div style="padding-top: 1vh; padding-left: 1.1vw; padding-bottom: 1vh" class="w3-text-black">
        Menu &nbsp; : &nbsp; Counselor &nbsp; / &nbsp; Self Development
    </div>
</div>
    ...
    <div style="padding-top: 3vh; padding-left: 1vw; padding-bottom: 1vh; overflow-y: scroll; white-space: nowrap; height: 70vh" class="sc4">
        ...
        <div style="overflow-y: scroll; height: 56vh" class="table-responsive sc4 font">
            <asp:GridView ID="datRespondent" runat="server" class="table w3-text-black " AutoGenerateColumns="False"
                BackColor="#FFFAFA" DataKeyNames="sd_id" BorderStyle="None" GridLines="None"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Class" ItemStyle-Width="5%">
                     ...
                     <asp:TemplateField HeaderText="ATM" ItemStyle-Width="5%">
                        <ItemTemplate>
                            <asp:TextBox ID="txtattendance_mark" Width="100%" class="id1" runat="server" Text='<%# Eval("attendance_mark") %>' Enabled="true" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="SDM" ItemStyle-Width="5%">
                        <ItemTemplate>
                            <asp:TextBox ID="txtselfdevelopment_mark" Width="100%" class="id1" runat="server" Text='<%# Eval("selfdevelopment_mark") %>' Enabled="true" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Total" ItemStyle-Width="5%">
                        <ItemTemplate>
                            <asp:Label ID="txtsd_total" class="id1" runat="server" Text='<%# Eval("sd_total") %>' Enabled="true"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Grade" ItemStyle-Width="5%">
                        <ItemTemplate>
                            <asp:Label ID="txtsd_grade" class="id1" runat="server" Text='<%# Eval("sd_grade") %>' Enabled="true"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
                <EmptyDataTemplate>
                    <asp:Label runat="server" Class="id1 w3-text-black"><b> No Self Development Information Are Recorded </b> </asp:Label>
                </EmptyDataTemplate>
        ...
        <div class="w3-text-black" style="text-align: left; padding-left: 1vw; padding-top: 1vh; display: inline-block">
            <asp:Label CssClass="Label font" runat="server" Style="width: 100%"> <b>Notes:</b> <b>ATM</b> = Attendance Mark, <b>REM</b> = Reflection Mark, <b>ASM</b> = Assignment Mark, <b>LEM</b> = Leadership Mark, <b>CSM</b> = Community Services Mark<br />
            <b>Notes:</b>  <b>SDM</b> = Self Development Mark, <b>RTM</b> = Room Tidiness Mark, <b>APM</b> = Appearance Mark, <b>MM</b> = Merit Mark</asp:Label>
        </div>
    </div>
</div>
