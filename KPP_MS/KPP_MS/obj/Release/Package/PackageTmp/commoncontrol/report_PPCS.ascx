<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="report_PPCS.ascx.vb" Inherits="KPP_MS.report_PPCS" %>
...
<div class="gridViewRespond" style="width: 100%; background-color: #f2f2f2; text-align: center; border-radius: 25px; border: 5px solid #8c8c8c;">
    ...
    <p style="background-color: #800000; text-align: center; display: inline-block; width: 100%; border-radius: 25px">PPCS Data</p>
    <br />
