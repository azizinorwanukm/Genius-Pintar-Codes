...
<div style="background-color: #F2F2F2; border: 5px solid #F2F2F2;" class="w3-card-2">
    <div style="padding-top: 1vh; padding-left: 1vw; padding-bottom: 1vh; border-bottom: 3px solid #567572FF;">
        <button id="btnViewResearchStundet" runat="server" style="top: 8px; display: inline-block; font-size:0.8vw">View Student Group & Supervisor</button>
        <button id="btnRegisterResearchStudent" runat="server" style="top: 8px; display: inline-block; font-size:0.8vw">Register Student Group & Supervisor</button>
    </div>

    <div style="padding-top: 3vh; padding-left: 1vw; padding-bottom: 1vh; white-space: nowrap; height: 70vh" id="RegisterResearchStudent" runat="server">
        ...
        <div class="w3-text-black" style="text-align: left; padding-left: 1.2vw; display: inline-block">
            ...
            <asp:DropDownList ID="ddl_class" runat="server" CssClass=" btn btn-default font" AutoPostBack="true" style="font-size:0.8vw"></asp:DropDownList>
        </div>
       ...
       <div style="overflow-y: scroll; height: 49vh;" class="table-responsive sc4 font">
            <asp:GridView ID="datRespondent" runat="server" class="table w3-text-black gridViewRespond" AutoGenerateColumns="False"
                ...
                <EmptyDataTemplate>
                    <asp:Label runat="server" Class="id1 w3-text-black"><b> No Research Student Information Are Recorded </b> </asp:Label>
                </EmptyDataTemplate>
        ...
        <div class="w3-text-black" style="text-align: left; padding-left: 1vw; padding-top:1vh; display: inline-block;">
            <asp:Label CssClass="Label font" runat="server" Style="width: 100%"> Group : </asp:Label>
            <asp:TextBox class="textboxcss" runat ="server" ID="txt_group" Style="width: 250px;font-size:0.8vw"></asp:TextBox>
        </div>
        <div class="w3-text-black" style="text-align: left; padding-left: 1.2vw; display: inline-block">
            <asp:Label CssClass="Label font" runat="server" Style="width: 100%"> Supervisor : </asp:Label>
            <asp:DropDownList CssClass="btn btn-default font" ID="ddl_staff" runat="server" style="font-size:0.8vw"></asp:DropDownList>
        </div>
        <div class="w3-text-black" style="text-align: left; padding-left: 1.2vw; display: inline-block">
            <button id="btnAddStudent" runat="server" class="btn btn-success" style="top: 1vh; display: inline-block; font-size:0.8vw">Add Student</button>
        </div>
    </div>


    <div style="padding-top: 3vh; padding-left: 1vw; padding-bottom: 1vh; white-space: nowrap; height: 70vh" id="ViewResearchStundet" runat="server">

        <div class="w3-text-black" style="text-align: left; padding-left: 1vw; display: inline-block">
            <asp:Label CssClass="Label font" runat="server" Style="width: 100%"> Year : </asp:Label>
            <asp:DropDownList ID="ddl_ViewYear" runat="server" CssClass=" btn btn-default font" AutoPostBack="true" style="font-size:0.8vw"></asp:DropDownList>
        </div>
        <div class="w3-text-black" style="text-align: left; padding-left: 1.2vw; display: inline-block">
            <asp:Label CssClass="Label font" runat="server" Style="width: 100%"> Group Name : </asp:Label>
            <asp:DropDownList ID="ddl_ViewGroup" runat="server" CssClass=" btn btn-default font" AutoPostBack="true" style="font-size:0.8vw"></asp:DropDownList>
        </div>
        <div class="w3-text-black" style="text-align: left; padding-left: 1.2vw; display: inline-block">
            <asp:Label CssClass="Label font" runat="server" Style="width: 100%"> Supervisor : </asp:Label>
            <asp:DropDownList ID="ddl_ViewStaff" runat="server" CssClass=" btn btn-default font" AutoPostBack="true" style="font-size:0.8vw"></asp:DropDownList>
        </div>
         ...
         <div style="overflow-y: scroll; height: 56vh;" class="table-responsive sc4 font">
            <asp:GridView ID="viewRespondent" runat="server" class="table w3-text-black gridViewRespond" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Supervisor" ItemStyle-Width="30%">
                        <ItemTemplate>
