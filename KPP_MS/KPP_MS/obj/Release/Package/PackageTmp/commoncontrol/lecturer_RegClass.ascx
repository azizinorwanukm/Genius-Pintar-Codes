...
<div class="gridViewRespond" style="width: 100%; background-color: #f2f2f2; text-align: center; border-radius: 25px; border: 5px solid #8c8c8c;">
    ...
    <div class="row" style="background-color: #f2f2f2; display: inline-block; width: 100%; border-radius: 25px;">
        ...
        <div class="col-md-6 w3-text-black" style="text-align: left; padding-left: 10px">
            <p></p>
            <asp:LinkButton Style="background-color: #005580; border-radius: 25px; display: inline-block;" runat="server" ID="searchBtn" Text="Search &#160; <i class='fa fa-search w3-large w3-text-white'></i>" OnClick="searchBtn_Click" CssClass="btn btn-info" title="Search" />
        </div>
    </div>
    <div class="row" style="background-color: #f2f2f2; display: inline-block; width: 100%; border-radius: 25px;">
        <div class="col-md-12 w3-text-black" style="text-align: left; padding-left: 23px">
            <p></p>
            <asp:DropDownList ID="ddlFilterSems" runat="server" AutoPostBack="true" onselectedindexchanged="ddlFilterSems_SelectedIndexChanged" CssClass=" btn btn-default ddl" Style="width: 190px;"></asp:DropDownList>
            <asp:DropDownList ID="ddlFilterType" runat="server" AutoPostBack="true" onselectedindexchanged="ddlFilterType_SelectedIndexChanged" CssClass=" btn btn-default ddl" Style="width: 190px;"></asp:DropDownList>
            <asp:DropDownList ID="ddlFilterStdntYear" runat="server" AutoPostBack="true" onselectedindexchanged="ddlFilterStdntYear_SelectedIndexChanged" CssClass=" btn btn-default ddl" Style="width: 190px;"></asp:DropDownList>
        </div>
    </div>
</div>
<br />
<div class="gridViewRespond" style="width: 100%; background-color: #f2f2f2; text-align: center; border-radius: 25px; border: 5px solid #8c8c8c;">
    ...
    <div class="row" style="background-color: #f2f2f2; display: inline-block; width: 100%; border-radius: 25px; margin-bottom: 10px; text-align: left; padding-left: 23px">
        <asp:DropDownList ID="ddlclassChoose" runat="server" class="btn btn-default" Style="background-color: #f2f2f2; display: inline-block; border-radius: 25px; text-align: left; padding-left: 23px"></asp:DropDownList>
        <asp:DropDownList ID="ddlstaffChoose" runat="server" class="btn btn-default" Style="background-color: #f2f2f2; display: inline-block; border-radius: 25px; text-align: left; padding-left: 23px"></asp:DropDownList>
        <button id="Btnsimpan" runat="server" class="btn btn-info" style="display: inherit; background-color: #005580; border-radius: 25px;" title="Save">Save &#160;<i class="fa fa-save w3-large w3-text-white"></i></button>
