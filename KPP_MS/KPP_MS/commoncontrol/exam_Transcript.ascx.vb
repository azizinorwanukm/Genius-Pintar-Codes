...
Public Class exam_Transcript
    ...
    Private Sub class_info(ByVal level As String)
        strSQL = "select * from class_info where class_year = '" & ddlyear.SelectedValue & "' and class_level = '" & level & "' and class_type = 'Compulsory'"
        Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strConn)
        Dim sqlDA As New SqlDataAdapter(strSQL, objConn)
    ...
    Private Sub load_page()
        ...
        If MyTableLevel.Rows.Count > 0 Then
            If Not IsDBNull(dsLevel.Tables(0).Rows(0).Item("student_Level")) Then
                ...
                class_info(ddlstudent_Year.SelectedValue)
            Else
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "select distinct student_info.std_ID, student_info.student_Name, student_info.student_Mykad, student_info.student_ID, student_level.student_Level,
                  student_Png.png, student_Png.pngs,class_info.class_Name
                  from student_Png
    ...
    Private Sub Cal_PNG(ByVal strKey As String)
        ...
        Dim exist_png As String = oCommon.getFieldValue(check_png_exist)
    ...
    Private Sub Cal_PNGK(ByVal strKey As String)
        ...
        Dim Confirm_Academic As String = oCommon.getFieldValue(check_academic_percen)
        ...
        pngk = Math.Round(answer, 2)

        strSQL = "select exam_EndDate from exam_Info where exam_year = '" & ddlyear.SelectedValue & "' and exam_Name = '" & ddlexam_Name.SelectedValue & "'"
    ...
    Private Sub ddlstudent_Year_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddlstudent_Year.SelectedIndexChanged
        ...
        If ddlstudent_Year.SelectedValue = "Foundation 1" Then
            level = "Foundation 1"
        ElseIf ddlstudent_Year.SelectedValue = "Foundation 2" Then
            level = "Foundation 2"
        ElseIf ddlstudent_Year.SelectedValue = "Foundation 3" Then
            level = "Foundation 3"
        ElseIf ddlstudent_Year.SelectedValue = "Level 1" Then
            level = "Level 1"
        ElseIf ddlstudent_Year.SelectedValue = "Level 2" Then
            level = "Level 2"
        End If
                                            ...
                                            <tr>    
                                                ...
                                                <table>
                                                    <tr style='width:100%'>
                                                        ...
                                                        <td style='width:70%'>: " & dataStdName & "</td>
                                                    </tr>     
                                                    <tr style='width:100%'>
                                                        <td style='width:30%'> No Kad Pengenalan </td>
                                                        <td style='width:70%'>: " & dataStdMykad & "</td>
                                                    </tr>     
                                                    <tr style='width:100%'>
                                                        <td style='width:30%'> No Kad Matrik </td>
                                                        <td style='width:70%'>: " & dataStdID & "</td>
                                                    </tr>  
                                                    <tr style='width:100%'>
                                                        <td style='width:30%'> Peperiksaan </td>
                                                        <td style='width:70%'>: " & dataExmName & "</td>
                                                    </tr>
                                                </table>                                                                                    
                                            </tr>   
                                            <tr>
    ...
    Private Sub datRespondent_RowDeleting(sender As Object, e As GridViewDeleteEventArgs) Handles datRespondent.RowDeleting
        ...
        Dim url As String = "admin_peperiksaan_popup.aspx?admin_ID=" & Request.QueryString("admin_ID") & "&std_ID=" & strKeyName & "&exam_ID=" & find_ExamID & "&year=" & ddlyear.SelectedValue

        Dim s As String = "window.open('" & url & "', 'popup_window', 'width=750,height=500,left=300,top=300,resizable=no');"
