...
Public Class student_DetailLecturer
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                txtbreadcrum2.Text = "Homeroom &nbsp; / &nbsp; Search Student "
                previousPage.NavigateUrl = String.Format("~/pengajar_senarai_pelajar.aspx?stf_ID=" + Request.QueryString("stf_ID") + "")
                ...
                ElseIf getStatus = "EI" Then ''Examination information
                ...
                ElseIf getStatus = "EHI" Then ''Examination History Information
    ...
    Private Sub btnStudentInfo_ServerClick(sender As Object, e As EventArgs) Handles btnStudentInfo.ServerClick
        Response.Redirect("pengajar_pelajar_detail.aspx?std_ID=" + Request.QueryString("std_ID") + "&status=SI" + "&stf_ID=" + Request.QueryString("stf_ID"))
    End Sub

    Private Sub btnParentInfo_ServerClick(sender As Object, e As EventArgs) Handles btnParentInfo.ServerClick
        Response.Redirect("pengajar_pelajar_detail.aspx?std_ID=" + Request.QueryString("std_ID") + "&status=FI" + "&stf_ID=" + Request.QueryString("stf_ID"))
    End Sub

    Private Sub btnCourseInfo_ServerClick(sender As Object, e As EventArgs) Handles btnCourseInfo.ServerClick
        Response.Redirect("pengajar_pelajar_detail.aspx?std_ID=" + Request.QueryString("std_ID") + "&status=CI" + "&stf_ID=" + Request.QueryString("stf_ID"))
    End Sub

    Private Sub btnCocurInfo_ServerClick(sender As Object, e As EventArgs) Handles btnCocurInfo.ServerClick
        Response.Redirect("pengajar_pelajar_detail.aspx?std_ID=" + Request.QueryString("std_ID") + "&status=COI" + "&stf_ID=" + Request.QueryString("stf_ID"))
    End Sub

    Private Sub btnExamInfo_ServerClick(sender As Object, e As EventArgs) Handles btnExamInfo.ServerClick
        Response.Redirect("pengajar_pelajar_detail.aspx?std_ID=" + Request.QueryString("std_ID") + "&status=EI" + "&stf_ID=" + Request.QueryString("stf_ID"))
    End Sub

    Private Sub btnHostelInfo_ServerClick(sender As Object, e As EventArgs) Handles btnHostelInfo.ServerClick
        Response.Redirect("pengajar_pelajar_detail.aspx?std_ID=" + Request.QueryString("std_ID") + "&status=HI" + "&stf_ID=" + Request.QueryString("stf_ID"))
    End Sub

    Private Sub btnDiscInfo_ServerClick(sender As Object, e As EventArgs) Handles btnDiscInfo.ServerClick
        Response.Redirect("pengajar_pelajar_detail.aspx?std_ID=" + Request.QueryString("std_ID") + "&status=DI" + "&stf_ID=" + Request.QueryString("stf_ID"))
    End Sub

    Private Sub btnExamHistoryInfo_ServerClick(sender As Object, e As EventArgs) Handles btnExamHistoryInfo.ServerClick
        Response.Redirect("pengajar_pelajar_detail.aspx?std_ID=" + Request.QueryString("std_ID") + "&status=EHI" + "&stf_ID=" + Request.QueryString("stf_ID"))
    End Sub

    Private Sub btnRefInfo_ServerClick(sender As Object, e As EventArgs) Handles btnRefInfo.ServerClick
        Response.Redirect("pengajar_pelajar_detail.aspx?std_ID=" + Request.QueryString("std_ID") + "&status=RI" + "&stf_ID=" + Request.QueryString("stf_ID"))
    End Sub
    ...
    Private Sub State_list()
        strSQL = "SELECT Parameter FROM setting WHERE Type='State' order by Parameter ASC  "
        Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strConn)
        Dim sqlDA As New SqlDataAdapter(strSQL, objConn)
    ...
    Private Sub Stream_List()
        If Session("SchoolCampus") = "APP" Then
            strSQL = "select UPPER(Parameter) Parameter, Value from setting where type = 'Stream' and Value = 'PS'"
        Else
            strSQL = "select UPPER(Parameter) Parameter, Value from setting where type = 'Stream' and Value <> 'Temp'"
        End If
    ...
    Private Sub Campus_List()
        ...
        If Session("SchoolCampus") = "APP" Then
            strSQL = "select UPPER(Parameter) Parameter, Value from setting where type = 'Pusat Campus' and Value = 'APP'"
        Else
            strSQL = "select UPPER(Parameter) Parameter, Value from setting where type = 'Pusat Campus'"
        End If
    ...
    Protected Sub ddlStateOfBirth_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddlStateOfBirth.SelectedIndexChanged
        Try
            If ddlStateOfBirth.SelectedValue = "Others" Then
                Country_list()
            Else
    ...
    Private Sub LoadPageStudent()
        ...
        strSQL = "  SELECT UPPER(student_Name) student_Name, UPPER(Student_Email) student_Email, UPPER(student_Sex) student_Sex, UPPER(student_Address) student_Address, UPPER(student_City) student_City, UPPER(student_Level) student_Level, UPPER(student_Sem) student_Sem, student_CountryOfBirth,
                    student_info.student_ID, student_Mykad, student_FonNo, student_Level.year, student_PostalCode, student_Photo, student_Race, student_State, student_StateOfBirth, student_Stream, student_Campus, student_Religion FROM student_info 
        ...
        If MyTable.Rows.Count > 0 Then
            ...
            If Not IsDBNull(ds.Tables(0).Rows(0).Item("student_Photo")) Then
                ...
                student_Photo.ImageUrl = "~/kppsys/httpdocs/" & redirectText.Substring(2)
            Else
                student_Photo.ImageUrl = "~/kppsys/httpdocs/student_Image/user.png"
            End If
                            ...
                            If txtstudentGender.Text <> "" And Regex.IsMatch(txtstudentGender.Text, "^[A-Za-z]+$") Then
                                ...
                                If txtstudentEmail.Text <> "" Then
                                    ...
                                    strSQL = " UPDATE student_info set student_Mykad='" & txtstudentMykad.Text & "',
                                                student_Sex='" & txtstudentGender.Text & "',student_Name='" & oCommon.FixSingleQuotes(txtstudentName.Text.ToUpper) & "',student_Email='" & txtstudentEmail.Text & "',
    ...
    Private Function getSQL() As String
        ...
        strWhere += " AND course.year = '" & ddlCourseYear.SelectedValue & "' and subject.subject_Campus = '" & Session("SchoolCampus") & "' and class_info.class_Campus = '" & Session("SchoolCampus") & "'"
        strWhere += " AND subject_info.subject_Sem = '" & ddlCourseSemester.SelectedValue & "' and student_info.student_Campus = '" & Session("SchoolCampus") & "'"
    ...
    Protected Sub OnRowUpdating(ByVal sender As Object, ByVal e As GridViewUpdateEventArgs)
        ...
        Else
            ''get subject_ID
            Dim subjectID As String = "select subject_ID from subject_info where subject_code = '" + txtSubjectCode.Text + "' and subject_year = '" & ddlCourseYear.SelectedValue & "' and subject_sem = '" & ddlCourseSemester.SelectedValue & "' and subject_Campus = '" & Session("SchoolCampus") & "'"
            ...
            If datasubjectID.Length > 0 Then
                ...
                ''get class type
                Dim classType As String = "select distinct class_type from class_info where class_Name = '" & txtClassName.Text & "' and class_year = '" & ddlCourseYear.SelectedValue & "' and class_Campus = '" & Session("SchoolCampus") & "'"
                ...
                If datasubjectType <> "Compulsory" And dataclassType = "Electives" Then
                    ...
                    ''get class ID 
                    Dim classID As String = "select class_ID from class_info where class_Name = '" + txtClassName.Text + "' and class_year = '" & ddlCourseYear.SelectedValue & "' and class_sem = '" & ddlCourseSemester.SelectedValue & "' and class_Campus = '" & Session("SchoolCampus") & "'"
                ...
                ElseIf datasubjectType = "Compulsory" And dataclassType = "Compulsory" Then
                    ...
                    Dim classID As String = "select class_ID from class_info where class_Name = '" + txtClassName.Text + "' and class_year = '" & ddlCourseYear.SelectedValue & "' and class_Campus = '" & Session("SchoolCampus") & "'"
                    Dim dataclassID As String = oCommon.getFieldValue(subjectID)
