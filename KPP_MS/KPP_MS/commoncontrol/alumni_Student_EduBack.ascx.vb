...
Public Class alumni_Student_EduBack
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "Select * from alumni_educationBackground"
        strWhere = " WHERE std_id IS NOT NULL and std_id='" & Request.QueryString("std_ID") & "'"
        strWhere += " and course.year = '" & ddl_graduateKPPYear.SelectedValue & "'"
        strWhere += " and student_level.year = '" & ddl_spmYear.SelectedValue & "'"
    ...
    Private Sub year_list()
        ...
        Try
            ...
            ddl_graduateKPPYear.DataSource = ds
            ddl_graduateKPPYear.DataTextField = "Parameter"
            ddl_graduateKPPYear.DataValueField = "Parameter"
            ddl_graduateKPPYear.DataBind()
            ddl_graduateKPPYear.Items.Insert(0, New ListItem("Select Year", String.Empty))
        Catch ex As Exception
    ...
    Private Sub btnStudentUpdate_ServerClick(sender As Object, e As EventArgs) Handles btnStudentUpdate.ServerClick
        Dim strKeyID As String = Request.QueryString("std_ID")
        Response.Redirect("alumni_student_EditEduback.aspx?std_ID=" + strKeyID + "&admin_ID=" + Request.QueryString("admin_ID") + " ")
    End Sub
End Class