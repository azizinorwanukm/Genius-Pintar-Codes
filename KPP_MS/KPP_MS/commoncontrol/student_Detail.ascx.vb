...
Public Class student_Detail
    ...
    Private Sub btnStudentUpdate_ServerClick(sender As Object, e As EventArgs) Handles btnStudentUpdate.ServerClick
        ...
        If errorCount = 1 Then
            Response.Redirect("pelajar_update_profile.aspx?result=-1&std_ID=" + access)
        ElseIf errorCount = 0 Then
            Response.Redirect("pelajar_update_profile.aspx?result=1&std_ID=" + access)
        ElseIf errorCount = 2 Then
            Response.Redirect("pelajar_update_profile.aspx?result=2&std_ID=" + access)
        ElseIf errorCount = 3 Then
            Response.Redirect("pelajar_update_profile.aspx?result=3&std_ID=" + access)
        ElseIf errorCount = 4 Then
            Response.Redirect("pelajar_update_profile.aspx?result=4&std_ID=" + access)
        ElseIf errorCount = 5 Then
            Response.Redirect("pelajar_update_profile.aspx?result=5&std_ID=" + access)
        ElseIf errorCount = 6 Then
            Response.Redirect("pelajar_update_profile.aspx?result=6&std_ID=" + access)
        ElseIf errorCount = 7 Then
            Response.Redirect("pelajar_update_profile.aspx?result=7&std_ID=" + access)
        ElseIf errorCount = 8 Then
            Response.Redirect("pelajar_update_profile.aspx?result=8&std_ID=" + access)
        ElseIf errorCount = 9 Then
            Response.Redirect("pelajar_update_profile.aspx?result=9&std_ID=" + access)
        ElseIf errorCount = 10 Then
            Response.Redirect("pelajar_update_profile.aspx?result=10&std_ID=" + access)
        End If
    End Sub
