...
Public Class parent_guardian1Detail
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                userAccess = "select student_info.std_ID from parent_Info 
                              left join student_info on parent_Info.parent_ID = student_info.parent_fatherID  
                              where parent_ID = '" & Request.QueryString("parent_ID") & "' and parent_Info.parent_No = '1'"
    ...
    Private Sub btnGuardianUpdate_ServerClick(sender As Object, e As EventArgs) Handles btnGuardianUpdate.ServerClick
                                ...
                                If ddlparent_State.SelectedValue <> "0" Then
                                    ...
                                    If parent_Postcode.Text = "" Or IsNumeric(parent_Postcode.Text) Then
                                        ...
                                        strSQL = "UPDATE parent_Info set parent_Name='" & parent_Name.Text & "',parent_IC='" & parent_IC.Text & "',parent_State='" & ddlparent_State.SelectedValue & "',
                                            ...
                                            FROM parent_Info LEFT JOIN student_info ON parent_Info.parent_ID = student_info.parent_fatherID  WHERE student_info.std_ID ='" & access & "' and parent_info.parent_No = '1'"
        ...
        If errorCount = 20 Then
            Response.Redirect("penjaga_update_profile.aspx?result=20&parent_ID=" + Request.QueryString("parent_ID") + "")
        ElseIf errorCount = 21 Then
            Response.Redirect("penjaga_update_profile.aspx?result=21&parent_ID=" + Request.QueryString("parent_ID") + "")
        ElseIf errorCount = 22 Then
            Response.Redirect("penjaga_update_profile.aspx?result=22&parent_ID=" + Request.QueryString("parent_ID") + "")
        ElseIf errorCount = 23 Then
            Response.Redirect("penjaga_update_profile.aspx?result=23&parent_ID=" + Request.QueryString("parent_ID") + "")
        ElseIf errorCount = 24 Then
            Response.Redirect("penjaga_update_profile.aspx?result=24&parent_ID=" + Request.QueryString("parent_ID") + "")
        ElseIf errorCount = 25 Then
            Response.Redirect("penjaga_update_profile.aspx?result=25&parent_ID=" + Request.QueryString("parent_ID") + "")
        ElseIf errorCount = 26 Then
            Response.Redirect("penjaga_update_profile.aspx?result=26&parent_ID=" + Request.QueryString("parent_ID") + "")
        ElseIf errorCount = 27 Then
            Response.Redirect("penjaga_update_profile.aspx?result=27&parent_ID=" + Request.QueryString("parent_ID") + "")
        ElseIf errorCount = 28 Then
            Response.Redirect("penjaga_update_profile.aspx?result=28&parent_ID=" + Request.QueryString("parent_ID") + "")
        ElseIf errorCount = 29 Then
            Response.Redirect("penjaga_update_profile.aspx?result=29&parent_ID=" + Request.QueryString("parent_ID") + "")
        ElseIf errorCount = 30 Then
            Response.Redirect("penjaga_update_profile.aspx?result=30&parent_ID=" + Request.QueryString("parent_ID") + "")
        End If
    End Sub
End Class