...
Public Class Import_Export_student_marks
    ...
    Private Sub subject_info()
        ...
        Try
            ...
            ddlsubject_Name.Items.Insert(1, New ListItem("ALL", "ALL"))
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "select distinct course.course_ID, student_info.student_Name, student_info.student_Mykad, exam_Info.exam_Name, subject_info.subject_Name,class_info.class_Name,exam_result.marks,exam_result.grade
                  From exam_result 
        ...
        If ddlsubject_Name.SelectedValue = "ALL" Then
            strOrderby = " order by subject_info.subject_Name, student_info.student_Name ASC"
        Else
