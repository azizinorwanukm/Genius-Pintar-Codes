...
Public Class parent_guardian2Detail
        ...
        Try
            If Not IsPostBack Then
                ...
                userAccess = "select student_info.std_ID from parent_Info 
                              ...
                              where parent_ID = '" & Request.QueryString("parent_ID") & "' and parentt_Info.parent_No = '2'"
    ...
    Private Sub btnGuardianUpdate_ServerClick(sender As Object, e As EventArgs) Handles btnGuardianUpdate.ServerClick
        ...
        userAccess = "select student_info.std_ID from parent_Info 
                      left join student_info on parent_Info.parent_ID = student_info.parent_motherID 
                      where parent_ID = '" & Request.QueryString("parent_ID") & "' and parent_Info.parent_No = '2'"
        Dim access As String = getFieldValue(userAccess, strConn)
                                ...
                                If ddlparent_State.SelectedValue <> "0" Then
                                    ...
                                    If parent_Postcode.Text = "" Or IsNumeric(parent_Postcode.Text) Then
                                        ...
                                        strSQL = "UPDATE parent_Info set parent_Name='" & parent_Name.Text & "',parent_IC='" & parent_IC.Text & "',parent_State='" & ddlparent_State.SelectedValue & "',
                                            ...
                                            FROM parent_Info LEFT JOIN student_info ON parent_Info.parent_ID = student_info.parent_motherID WHERE student_info.std_ID ='" & access & "' and parent_info.parent_No = '2'"
