...
Public Class guardian_Detail
        ...
        Try
            If Not IsPostBack Then
                ...
                strSQL = "SELECT * from parent_Info 
                  ...
                  WHERE student_info.std_ID ='" & access & "' and parent_info.parent_No = '1'"
                '--debug
                ...
                If Table.Rows.Count > 0 Then
                    ...
                    If Not IsDBNull(dset.Tables(0).Rows(0).Item("parent_City")) Then
                        txtCity.Text = dset.Tables(0).Rows(0).Item("parent_City")
                    Else
                        txtCity.Text = ""
                    End If
    ...
    Private Sub btnGuardianUpdate_ServerClick(sender As Object, e As EventArgs) Handles btnGuardianUpdate.ServerClick
        ...
        If parent_Name.Text = "" Then

            If parent_IC.Text = "" Or (IsNumeric(parent_IC.Text) And parent_IC.Text.Length < 14) Then

                If parent_work.Text = "" Or Regex.IsMatch(parent_work.Text, "^[A-Za-z ]+$") Then
                    ...
                    If parent_Email.Text = "" Or Regex.IsMatch(parent_Email.Text, "^[a-zA-Z][\w\.-]*[a-zA-Z0-9]@[a-zA-Z0-9][\w\.-]*[a-zA-Z0-9]\.[a-zA-Z][a-zA-Z\.]*[a-zA-Z]$") Then
                        ...
                        If parent_Postcode.Text = "" Or IsNumeric(parent_Postcode.Text) Then
                            ...
                            strSQL = "UPDATE parent_Info set parent_Name='" & parent_Name.Text & "',parent_IC='" & parent_IC.Text & "',parent_State='" & ddlparent_State.SelectedValue & "',
                                            ...
                                            parent_City='" & txtCity.Text & "',parent_Postcode='" & parent_Postcode.Text & "',parent_Work='" & parent_work.Text & "',
                                            parent_Salary='" & ddlsalary.SelectedValue & "',
                                            parent_Work_Email='" & parent_Work_Email.Text & "'
                                            FROM parent_Info 
                                            LEFT JOIN student_info ON parent_Info.parent_ID = student_info.parent_fatherID  
                                            WHERE student_info.std_ID ='" & access & "' and parent_info.parent_No = '1'"
        ...
        If errorCount = 20 Then
            Response.Redirect("admin_edit_pelajar_data.aspx?result=20&std_ID=" + Request.QueryString("std_ID") + "&admin_ID=" + Request.QueryString("admin_ID"))
        ElseIf errorCount = 21 Then
            Response.Redirect("admin_edit_pelajar_data.aspx?result=21&std_ID=" + Request.QueryString("std_ID") + "&admin_ID=" + Request.QueryString("admin_ID"))
        ElseIf errorCount = 22 Then
            Response.Redirect("admin_edit_pelajar_data.aspx?result=22&std_ID=" + Request.QueryString("std_ID") + "&admin_ID=" + Request.QueryString("admin_ID"))
        ElseIf errorCount = 23 Then
            Response.Redirect("admin_edit_pelajar_data.aspx?result=23&std_ID=" + Request.QueryString("std_ID") + "&admin_ID=" + Request.QueryString("admin_ID"))
        ElseIf errorCount = 24 Then
            Response.Redirect("admin_edit_pelajar_data.aspx?result=24&std_ID=" + Request.QueryString("std_ID") + "&admin_ID=" + Request.QueryString("admin_ID"))
        ElseIf errorCount = 25 Then
            Response.Redirect("admin_edit_pelajar_data.aspx?result=25&std_ID=" + Request.QueryString("std_ID") + "&admin_ID=" + Request.QueryString("admin_ID"))
        ElseIf errorCount = 26 Then
            Response.Redirect("admin_edit_pelajar_data.aspx?result=26&std_ID=" + Request.QueryString("std_ID") + "&admin_ID=" + Request.QueryString("admin_ID"))
        ElseIf errorCount = 27 Then
            Response.Redirect("admin_edit_pelajar_data.aspx?result=27&std_ID=" + Request.QueryString("std_ID") + "&admin_ID=" + Request.QueryString("admin_ID"))
        ElseIf errorCount = 28 Then
            Response.Redirect("admin_edit_pelajar_data.aspx?result=28&std_ID=" + Request.QueryString("std_ID") + "&admin_ID=" + Request.QueryString("admin_ID"))
        ElseIf errorCount = 29 Then
            Response.Redirect("admin_edit_pelajar_data.aspx?result=29&std_ID=" + Request.QueryString("std_ID") + "&admin_ID=" + Request.QueryString("admin_ID"))
        ElseIf errorCount = 30 Then
            Response.Redirect("admin_edit_pelajar_data.aspx?result=30&std_ID=" + Request.QueryString("std_ID") + "&admin_ID=" + Request.QueryString("admin_ID"))
        End If
    End Sub
End Class