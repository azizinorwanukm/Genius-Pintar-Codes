<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="lecturer_counselor_Detail_Case.ascx.vb" Inherits="KPP_MS.lecturer_counselor_Detail_Case" %>
    ...
    <div style="width: 100%; background-color: #f2f2f2; text-align: center; border-radius: 25px; border: 5px solid #8c8c8c;">
        ...
        <div class="row gridViewRespond" style="background-color: #f2f2f2; display: inline-block; width: 100%; border-radius: 25px;">
            ...
            <div class="col-md-6 w3-text-black" style="text-align: left; padding-left: 23px;">
                ...
                <asp:Label CssClass="Label" runat="server" ID="CurrentDate" Style="width: 80%; font-weight: bold;"></asp:Label>
            </div>
        ...
        <div id="dis_type">
            ...
            <div class="row gridViewRespond" style="background-color: #f2f2f2; display: inline-block; width: 100%; border-radius: 25px; margin-top: 10px">
                ...
                <div class="col-md-6 w3-text-black" style="text-align: left; padding-left: 23px">
                    ...
                    <asp:Label CssClass="Label" runat="server" ID="Action_box" Style="width: 80%; font-weight: bold;"> </asp:Label>
                </div>
            </div>
