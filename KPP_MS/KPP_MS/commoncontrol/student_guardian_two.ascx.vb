...
Public Class student_guardian_two
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                userAccess = "select std_ID from student_info where std_ID = '" & id & "'"
    ...
    Private Sub Loadpage(ByVal Access As String)
        ''parent_info
        strSQL = "SELECT * from parent_Info Left Join student_info ON parent_Info.parent_ID = student_info.parent_motherID WHERE student_info.std_ID ='" & Access & "' and parent_info.parent_No = '2'"
        '--debug
