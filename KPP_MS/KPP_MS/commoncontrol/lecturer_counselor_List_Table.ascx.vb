...
Public Class lecturer_counselor_List_Table
    ...
    Private Function getSQL() As String
        ...
        strWhere += " and dicipline_info.Dicipline_Date like '%" & ddlyear.SelectedValue & "%' and counseling_info.stf_ID = '" & oCommon.Staff_securityLogin(Request.QueryString("stf_ID")) & "'"
    ...
    Private Sub datRespondent_RowEditing(sender As Object, e As GridViewEditEventArgs) Handles datRespondent.RowEditing
        ...
        Try
            Response.Redirect("pengajar_detail_kaunselor.aspx?klsr_id=" + strKeyID + "&stf_ID=" + Request.QueryString("stf_ID"))
        Catch ex As Exception
