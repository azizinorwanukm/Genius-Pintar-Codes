...
<div style="width: 100%; background-color: #f2f2f2; text-align: center; border-radius: 25px; border: 5px solid #8c8c8c;">
    ...
    <div class="row gridViewRespond" style="background-color: #f2f2f2; display: inline-block; width: 100%; border-radius: 25px; margin-top: 10px; margin-bottom: 10px">
        <div class="col-md-6 w3-text-black" style="text-align: left; padding-left: 23px">
            ...
            <asp:DropDownList ID="ddl_exam" runat="server" AutoPostBack="true" class="btn btn-default ddl" Style="border-radius: 25px;" ></asp:DropDownList>
        </div>
        <div class="col-md-12 w3-text-black" style="text-align: left; padding-left: 23px; margin-top: 5px;">
            <asp:DropDownList ID="ddl_level" runat="server" AutoPostBack="true" class="btn btn-default ddl" Style="border-radius: 25px;" ></asp:DropDownList>
            <asp:DropDownList ID="ddl_class" runat="server" AutoPostBack="true" class="btn btn-default ddl" Style="border-radius: 25px;" ></asp:DropDownList>
        ...
        <asp:GridView ID="datRespondent" runat="server" class="table w3-text-black " AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Marks">
                    <ItemTemplate>
                        <asp:TextBox ID="txtmarks" Width="40px" class="id1" runat="server" Text='<%# Eval("marks") %>' />
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Left" />
                </asp:TemplateField>
