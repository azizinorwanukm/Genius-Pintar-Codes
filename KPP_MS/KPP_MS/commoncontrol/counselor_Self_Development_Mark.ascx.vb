...
Public Class counselor_Self_Development_Mark
    ...
    Private Function getSQL() As String
        ...
        Dim strOrderby As String = " ORDER BY A.sd_total, E.student_Name ASC"

        tmpSQL = " SELECT * from self_developmet_mark A
            ...
            If Not chkUpdate Is Nothing Then
                ...
                If chkUpdate.Checked = True Then
                    ...
                    Dim find_stdid As String = "select std_ID from course
                                                ...
                                                left join self_development_mark on exam_result.id = self_development_mark.examresult_id where sd_id = '" & strKey & "'"
                    ...
                    Dim find_total_mark As String = "select sd_total from self_development_mark where sd_id = '" & strKey & "'"
                    ...
                    If data_total_mark.Length > 0 Then
                        ...
                        ''update to database
                        strSQL = "UPDATE INTO self_development_mark
                                  ...
                                  sd_total_demerit = '" & get_sumponint & "', sd_total_attitude ='" & total_attitude & "',
                                  sd_total = '" & total_mark & "'
                                  Where sd_id = '" & strKey & "'"
                        strRet = oCommon.ExecuteSQL(strSQL)

                        Dim select_examresultid As String = "select examresult_id from self_development_mark where sd_id = '" & strKey & "'"
                    ...
                    Else
                        ...
                        If result = "True" Then
                            ''update to database
                            strSQL = "UPDATE INTO self_development_mark SET
                                      ...
                                      sd_total_attitude ='" & total_attitude & "',
                                      sd_total = '" & total_mark & "'
                                      Where sd_id = '" & strKey & "'"
                            strRet = oCommon.ExecuteSQL(strSQL)
    ...
    Private Function percen_checking(leadership As String, communityservice As String, reflection As String, assignment As String, appearance As String, roomtidiness As String, attitude As String, pd_id As String)
        ...
        Dim find_checking_leadership As String = "select leadership_percen from self_development_mark where sd_id = '" & pd_id & "'"
        Dim get_checking_leadership As String = oCommon.getFieldValue(find_checking_leadership)

        ''checking coomunityservice percen
        Dim find_checking_communityservice As String = "select communityservice_percen from self_development_mark where sd_id = '" & pd_id & "'"
        ...
        Dim find_checking_reflection As String = "select reflection_percen from self_development_mark where sd_id = '" & pd_id & "'"
        Dim get_checking_reflection As String = oCommon.getFieldValue(find_checking_reflection)

        ''checking assignment percen
        Dim find_checking_assignment As String = "select assignment_percen from self_development_mark where sd_id = '" & pd_id & "'"
        Dim get_checking_assignment As String = oCommon.getFieldValue(find_checking_assignment)

        ''checking appearance percen
        Dim find_checking_appearance As String = "select appearance_percen from self_development_mark where sd_id = '" & pd_id & "'"
        Dim get_checking_appearance As String = oCommon.getFieldValue(find_checking_appearance)

        ''checking roomtidiness percen
        Dim find_checking_roomtidiness As String = "select roomtidiness_percen from self_development_mark where sd_id = '" & pd_id & "'"
        Dim get_checking_roomtidiness As String = oCommon.getFieldValue(find_checking_roomtidiness)

        ''checking attitude percen
        Dim find_checking_attitude As String = "select attitude_percen from self_development_mark where sd_id = '" & pd_id & "'"
