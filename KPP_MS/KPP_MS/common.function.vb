...
Public Class Commonfunction
    ...
    Public Function PNG(ByVal strKey As String, ByVal ddlexam_Name As String, ByVal ddlyear As String) As String
        ...
        If valueA <> 0.0 And valueB <> 0.0 Then
            'answer = Math.Round(valueA / valueB, 2)
            answer = valueA / valueB
        End If

        If answer <> 0.00 Then
            ''round to two decimal places and display
            pngData_STUDENT = answer
        Else
        ...
        Dim PNG_PortFolio As Decimal = 0.0
        Dim PNG_Research As Decimal = 0.0
        Dim PNG_SelfDevelopment As Decimal = 0.0
        ...
        If Confirm_Cocuricullum = "on" Or Confirm_Cocuricullum = "On" Then
            ...
            Dim data_Mykad As String = getFieldValue(get_Mykad)

            Dim get_StudentID As String = "select StudentID from StudentProfile where MYKAD = '" & data_Mykad & "'"
            Dim data_StudentID As String = getFieldValue_Permata(get_StudentID)

            Dim Peperiksaan_Name As String = ""
            Dim get_cocuricullum As String = ""
            Dim data_koko As String = ""

            If ddlexam_Name = "Exam 2" Or ddlexam_Name = "Exam 6" Or ddlexam_Name = "Exam 10" Then
                Peperiksaan_Name = "P1"

                get_cocuricullum = "select KOKO" & Peperiksaan_Name & " from koko_pelajar where StudentID = '" & data_StudentID & "' and Tahun = '" & ddlyear & "'"
                data_koko = getFieldValue_Permata(get_cocuricullum)

            ElseIf ddlexam_Name = "Exam 4" Or ddlexam_Name = "Exam 7" Or ddlexam_Name = "Exam 8" Or ddlexam_Name = "Exam 12" Then
                Peperiksaan_Name = "P2"
            ...
            Else
                PNG_Cocuricullum = Decimal.Parse(data_koko)
            End If
        ...
        If strRet >= get_date Then
            ...
            If dataExist <> dataExmCode Then
                ...
                Using PNGDATA As New SqlCommand("INSERT into student_Png(std_ID,exam_Name,year,png,komp_akademik,komp_kokurikulum,komp_portfolio,komp_penyelidikan,komp_kendiri,stat_akademik,stat_kokurikulum,stat_portfolio,stat_penyelidikan,stat_kendiri) 
                                                 values ('" & strKey & "','" & dataExmCode & "','" & ddlyear & "','" & PNGS & "',
                                                         '" & percen_academic & "','" & percen_cocuricullum & "','" & percen_portfolio & "','" & percen_research & "','" & percen_selfdevelopment & "',
                                                         '" & Confirm_Academic & "','" & Confirm_Cocuricullum & "','" & Confirm_Portfolio & "','" & Confirm_Research & "','" & Confirm_Self & "')", objConn)
                    objConn.Open()
            ...
            ElseIf dataExist = dataExmCode Then
                ...
                strSQL = "UPDATE student_Png SET png ='" & PNGS & "', komp_akademik = '" & percen_academic & "', komp_kokurikulum = '" & percen_cocuricullum & "', komp_portfolio = '" & percen_portfolio & "',
                          ...
                          WHERE std_ID ='" & strKey & "' and exam_Name = '" & dataExmCode & "' and year = '" & ddlyear & "'"
    ...
    Public Function PNG_ENG(ByVal strKey As String, ByVal ddlexam_Name As String, ByVal ddlyear As String) As String
