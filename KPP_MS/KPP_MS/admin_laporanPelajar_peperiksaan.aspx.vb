...
Public Class admin_laporanPelajar_peperikssan
    ...
    Private Sub student_class()
        ...
        strSQL = "select * from class_info where class_year = '" & ddlYear.SelectedValue & "' and class_type = 'Compulsory' and class_Level = '" & ddlLevel.SelectedValue & "'
    ...
    Private Sub subject_data()
        Try
            ...
            If exam_data = "Exam 1" Or exam_data = "Exam 2" Or exam_data = "Exam 5" Or exam_data = "Exam 6" Then
                get_ExamLevel = "Sem 1"
            ElseIf exam_data = "Exam 3" Or exam_data = "Exam 4" Or exam_data = "Exam 7" Then
                get_ExamLevel = "Sem 2"
            End If

            strSQL = "SELECT subject_ID, subject_Name FROM subject_info WHERE subject_StudentYear = '" & ddlLevel.SelectedValue & "' and subject_year = '" & ddlYear.SelectedValue & "' and subject_sem = '" & get_ExamLevel & "'"
            Dim sqlDA As New SqlDataAdapter(strSQL, objConn)
    ...
    Private Function getSQL() As String
        ...
        strSelect = "SELECT course.std_ID, student_info.student_Name, student_info.student_Mykad, class_info.class_Name,
