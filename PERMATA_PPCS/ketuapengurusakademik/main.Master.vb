...
Partial Public Class main3
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            ''lblCourse.Text = " KELAS:" & Server.HtmlEncode(Request.Cookies("ppcs_classcode").Value) & " - " & Server.HtmlEncode(Request.Cookies("ppcs_classnamebm").Value)
