<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/penguruspejabat/main.Master" CodeBehind="schoolprofile.confirm.change.aspx.vb" Inherits="permatapintar.schoolprofile_confirm_change" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblStartDate" runat="server" Text="" CssClass="fblabel_view" Visible="false"></asp:Label>
    <asp:Label ID="lblEndDate" runat="server" Text="" CssClass="fblabel_view" Visible="false"></asp:Label>
</asp:Content>
