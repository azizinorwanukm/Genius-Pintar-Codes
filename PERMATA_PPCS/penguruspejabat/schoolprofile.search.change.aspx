<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/penguruspejabat/main.Master" CodeBehind="schoolprofile.search.change.aspx.vb" Inherits="permatapintar.schoolprofile_search_change" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="fbform">
        ...
        <tr>
            <td>
                Negeri:&nbsp;
                <asp:DropDownList ID="ddlSchoolState" AutoPostBack="false" runat="server">
                </asp:DropDownList>
                *
                <%--Bandar:&nbsp;
    ...
    <table class="fbform">
        ...
        <tr>
            <td>
                <asp:Label Font-Size="Large" ID="lblNewSchool" runat="server" Text="*Jika Pelajar / Guru / Ibu bapa  tidak memilih sekolah sedia ada dalam senarai database KPM dan MARA, maka pelajar tidak akan dipertimbangkan untuk ke ujian UKM2. Kod XXX hanya untuk <b>sekolah antarabangsa dan persendirian sahaja.</b>"></asp:Label>
            </td>
        </tr>
    </table>
</asp:Content>