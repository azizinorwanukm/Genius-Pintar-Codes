<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/admin/admin.Master" CodeBehind="viewPembantuPelajarDetails.aspx.vb" Inherits="permatapintar.viewPembantuPelajarDetails" %>
...
<table class="fbform">
        ...
        <tr>
            ...
            <td>
                ...
                </asp:DropDownList><asp:Button ID="btnCode" runat="server" Text=" Kod Kursus " CssClass="fbbutton" />
            </td>
        </tr>
        <tr>
            <td>
