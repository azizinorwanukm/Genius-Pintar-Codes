...
Partial Public Class pelajar_class_assign_02
    ...
    Private Sub ClearScreen()
        ...
        strSQL = "SELECT * FROM ppcs_class WHERE CourseID='" & strCourseID & "' ORDER BY ClassCode"
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Response.Redirect("pelajar.class.assign.03.aspx?courseid=" & Request.QueryString("courseid") & "&classid=" & strKeyID & "&courseyear=" & Request.QueryString("courseyear"))
