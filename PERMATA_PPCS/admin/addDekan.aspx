<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/admin/admin.Master"
    CodeBehind="addDekan.aspx.vb" Inherits="permatapintar.addDekan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="fbform">
        <tr>
            <td colspan="4">Tambah Pengurus Akademik
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4">Senarai Pengurus Akademik ( Klik pilih untuk mengemaskini atau menghapus data )
            </td>
        </tr>
        <tr>
            <td colspan="4">
