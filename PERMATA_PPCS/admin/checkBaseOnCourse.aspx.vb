...
Partial Public Class checkBaseOnCourse
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            strcoursecode = Request.QueryString("courseCode")

            If Not IsPostBack Then
                ClearScreen(strcoursecode)
            End If
    ...
    Private Sub ClearScreen(ByVal strcoursecode As String)
        lblMsg.Text = ""

        lblTotal.Text = ""

        strSQL = "SELECT * from ukm2_login WHERE courseCode='" & strcoursecode & "' ORDER BY usertype desc"
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Response.Redirect("viewDetails.aspx?ICnumber=" & strKeyID)
