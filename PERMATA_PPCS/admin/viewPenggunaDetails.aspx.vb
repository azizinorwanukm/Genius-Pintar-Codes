...
Partial Public Class viewPenggunaDetails
    ...
    Protected Sub btnadd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnadd.Click
        Try
            ...
            strSQL = "UPDATE ukm2_login WITH (UPDLOCK) SET loginid='" & txtemail.Text & "',fullname='" & txtfullname.Text & "',ICnumber='" & txtIC.Text & "',contactno='" & txtcontactno.Text & "',courseName='" & txtcourse.Text & "',courseCode='" & txtcoursecode.Text & "',usertype='KETUA MODUL',address='" & txtaddress.Text & "' WHERE loginid='" & strloginid & "'"
