...
Partial Public Class addPembantu
    ...
    Private Sub ClearScreen()
        ...
        strSQL = "SELECT * from ukm2_login WHERE usertype='PEMBANTU PENGAJAR' ORDER BY userid desc"
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Response.Redirect("viewPembantuDetails.aspx?loginid=" & strKeyID)
    ...
    Protected Sub btnadd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnadd.Click
        Try
            ...
            strSQL = "INSERT INTO ukm2_login(loginid,pwd,fullname,ICnumber,contactno,courseName,courseCode,usertype,address,className,ImageFilename) VALUES ('" & txtemail.Text & "','" & txtpwd.Text & "','" & txtfullname.Text & "','" & txtIC.Text & "','" & txtcontactno.Text & "','" & txtcourse.Text & "','" & txtcoursecode.Text & "','PEMBANTU PENGAJAR','" & txtaddress.Text & "','" & txtclass.Text & "','" & strImageFilename & "')"
