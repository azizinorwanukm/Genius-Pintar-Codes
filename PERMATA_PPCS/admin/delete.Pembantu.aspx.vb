...
Partial Public Class delete_Pembantu
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            '------------------------------------------------------
            'GET USERTYPE
            cmd = New SqlCommand("select usertype from ukm2_login", con)
            con.Open()
            ...
            While dr.Read()
                ...
                If dr(0).ToString().Length > 0 Then
                    ...
                    txtList.Items.Add(dr(0).ToString())
                    ' Response.Write(dr(0).ToString())
                End If
            End While
        ...
        Try
            ...
            If MyTable.Rows.Count > 0 Then
                ...
                If Not IsDBNull(ds.Tables(0).Rows(0).Item("usertype")) Then
                    txtList.Text = ds.Tables(0).Rows(0).Item("usertype")
                Else
                    txtList.Text = "NA"
                End If
