...
Partial Public Class admin_instructorList
    ...
    Private Sub ClearScreen()
        ...
        If searchusername.Text.Length > 0 Then
            strSQL = "SELECT * from ukm2_login where fullname LIKE '%" & searchusername.Text & "%' ORDER BY userid desc"
        Else
            strSQL = "SELECT * from ukm2_login WHERE usertype='PENGAJAR' ORDER BY userid desc"
        End If
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        strSQL = "SELECT courseCode from ukm2_login WHERE loginid='" & strKeyID & "'"
        strcourseCode = oCommon.getFieldValue(strSQL)

        '--Response.Write(strKeyID)
        Response.Redirect("viewInstructorDetails.aspx?loginid=" & strKeyID & " & courseCode=" & strcourseCode)
