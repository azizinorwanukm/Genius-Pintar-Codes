<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="spiritual.others.02.ascx.vb" Inherits="permatapintar.spiritual_others_02" %>
<table class="fbform">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo01" runat="server" Text="06."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo02" runat="server" Text="07."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo03" runat="server" Text="08."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo04" runat="server" Text="09."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo05" runat="server" Text="10."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo06" runat="server" Text="11."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo07" runat="server" Text="12."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo08" runat="server" Text="13."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo09" runat="server" Text="14."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo10" runat="server" Text="15."></asp:Label>
        </td>
        <td class="fbsection_article">
