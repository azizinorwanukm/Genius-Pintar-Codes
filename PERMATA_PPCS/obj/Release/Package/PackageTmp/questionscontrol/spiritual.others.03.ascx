<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="spiritual.others.03.ascx.vb" Inherits="permatapintar.spiritual_others_03" %>
<table class="fbform">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo01" runat="server" Text="16."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo02" runat="server" Text="17."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo03" runat="server" Text="18."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo04" runat="server" Text="19."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo05" runat="server" Text="20."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo06" runat="server" Text="21."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo07" runat="server" Text="22."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo08" runat="server" Text="23."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo09" runat="server" Text="24."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo10" runat="server" Text="25."></asp:Label>
        </td>
        <td class="fbsection_article">
