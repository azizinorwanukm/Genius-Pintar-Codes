<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/admin/admin.Master"
    CodeBehind="course.list.ketuamodul.aspx.vb" Inherits="permatapintar.course_list_ketuamodul" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="fbform">
        <tr class="fbform_header">
            <td>Pengurusan Am>Menentukan Ketua Modul
            </td>
        </tr>
    </table>
    <table class="fbform">
        ...
        <tr>
            <td class="fbtd_left">Pilih Kursus</td>
            <td>
                <asp:RadioButtonList ID="rbKetuaModulType" runat="server" EnableViewState="False"
                    RepeatDirection="Horizontal" RepeatLayout="Flow">
                    <asp:ListItem Value="BM" Selected="True">B. Malaysia</asp:ListItem>
                    <asp:ListItem Value="BI">B. English</asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
        <tr>
                ...
                <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Ketua Modul (BM)">
                            <ItemTemplate>
                                <asp:Label ID="lblNamaKetuaModul" runat="server" Text='<%# Bind("NamaKetuaModul") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Ketua Modul (BI)">
                            <ItemTemplate>
                                <asp:Label ID="lblNamaKetuaModulBI" runat="server" Text='<%# Bind("NamaKetuaModulBI") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
