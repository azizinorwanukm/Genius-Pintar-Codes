<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/admin/admin.Master"
    CodeBehind="instructorList.aspx.vb" Inherits="permatapintar.admin_instructorList"
    Title="" %>
    ...
    <table class="fbform">
        ...
        <tr>
            <td style="text-align: left;">
                Nama Pengajar :<asp:TextBox ID="searchusername" runat="server" MaxLength="254" Width="250px"></asp:TextBox>&nbsp;<asp:Button
