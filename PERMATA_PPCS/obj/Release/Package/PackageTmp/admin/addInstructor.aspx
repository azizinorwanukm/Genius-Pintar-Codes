<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/admin/admin.Master"
    CodeBehind="addInstructor.aspx.vb" Inherits="permatapintar.addInstructor" Title="" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="fbform">
        ...
        <tr>
            <td colspan="4">Senarai Pengajar ( Klik pilih untuk mengemaskini atau menghapus data )
            </td>
        </tr>
        <tr>
            <td colspan="4">
