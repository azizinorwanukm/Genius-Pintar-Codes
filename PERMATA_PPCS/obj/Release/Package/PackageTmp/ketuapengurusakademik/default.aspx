<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ketuapengurusakademik/main.Master"
    CodeBehind="default.aspx.vb" Inherits="permatapintar._default9" %>
    ...
    <table width="100%" border="0px" style="vertical-align: top;">
        <tr>
            <td class="fbsection_header">
                Selamat datang KETUA PENGURUS AKADEMIK ke Program Perkhemahan Cuti Sekolah PERMATApintar Negara
                2010
            </td>
        </tr>
        <tr>
            <td class="fbsection_article">
                <b>Perhatian.</b>
                <p>
                    Anda dibenarkan untuk melihat kesemua Laporan Penaksiran Akademik, Inventori Tingkahlaku
                    dan Soalselidik Spiritual.
                </p>
                <p>
