<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="class_search_view.ascx.vb" Inherits="permatapintar.class_search_view" %>
...
<table class="fbform">
    ...
    <tr>
        <td></td>
        <td colspan="3">
            <asp:Button ID="btnRefresh" runat="server" Text="Search " CssClass="fbbutton" /></td>
    </tr>
