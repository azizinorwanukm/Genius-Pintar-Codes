<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="laporan_keseluruhan_view.ascx.vb"
    Inherits="permatapintar.laporan_keseluruhan_view8" %>
<table class="fbform" width="100%">
    <tr class="fbform_header">
        <td>
            Laporan Penaksiran Akademik: <asp:Label ID="lblPPCSDate" runat="server" Text="" ForeColor="Black"></asp:Label>
        </td>
    </tr>
</table>
<table width="100%">
...
<table class="fbform" width="100%">
    ...
    <tr>
        <td colspan="2">
            <asp:TextBox ID="txtQ001Remarks" runat="server" TextMode="MultiLine" Rows="25" Width="98%"
