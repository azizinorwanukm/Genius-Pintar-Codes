<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="laporan_harian_print.ascx.vb"
    Inherits="permatapintar.laporan_harian_print" %>
<table class="fbform">
    <tr>
        <td class="fbsection_sap" colspan="2">
            <asp:Label ID="lblMsgTop" runat="server" Text="" ForeColor="Red"></asp:Label>
        </td>
        <td class="fbsection_sap" style="text-align: right;">
            &nbsp;
        </td>
    </tr>
    <tr class="fbsection_bold">
        ...
        <td style="width: 50%;">
            <asp:Label ID="lblJawapan" runat="server" Text="Tahap"></asp:Label>
        </td>
    </tr>
    <tr class="fbsection_bold">
        <td style="width: 2%;">
    ...
    <tr>
        ...
        <td>
            <asp:Label ID="lblQ001Remarks" runat="server" Text=""></asp:Label>
        </td>
    </tr>
    <tr>
        <td class="fbsection_article">
    ...
    <tr>
        ...
        <td>
            <asp:Label ID="lblQ002Remarks" runat="server" Text=""></asp:Label>
        </td>
    </tr>
    <tr>
        <td class="fbsection_article">
    ...
    <tr>
        ...
        <td>
            <asp:Label ID="lblQ003Remarks" runat="server" Text=""></asp:Label>
        </td>
    </tr>
    <tr>
        <td class="fbsection_article">
    ...
    <tr>
        ...
        <td>
            <asp:Label ID="lblQ004Remarks" runat="server" Text=""></asp:Label>
        </td>
    </tr>
    <tr>
        <td class="fbsection_article">
    ...
    <tr>
        ...
        <td>
            <asp:Label ID="lblQ005Remarks" runat="server" Text=""></asp:Label>
        </td>
    </tr>
    <tr>
        <td class="fbsection_article">
    ...
    <tr>
        ...
        <td>
            <asp:Label ID="lblQ006Remarks" runat="server" Text=""></asp:Label>
        </td>
    </tr>
    <tr>
        <td class="fbsection_article">
    ...
    <tr>
        ...
        <td>
            <asp:Label ID="lblQ007Remarks" runat="server" Text=""></asp:Label>
        </td>
    </tr>
    <tr>
        <td class="fbsection_article">
    ...
    <tr>
        ...
        <td>
            <asp:Label ID="lblQ008Remarks" runat="server" Text=""></asp:Label>
        </td>
    </tr>
    <tr>
        <td class="fbsection_article">
    ...
    <tr>
        ...
        <td>
            <asp:Label ID="lblQ009Remarks" runat="server" Text=""></asp:Label>
        </td>
    </tr>
    <tr>
        <td class="fbsection_article">
    ...
    <tr>
        ...
        <td>
            <asp:Label ID="lblQ010Remarks" runat="server" Text=""></asp:Label>
        </td>
    </tr>
    <tr>
