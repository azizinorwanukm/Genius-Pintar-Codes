<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="laporan.akhir.create.ascx.vb"
    Inherits="permatapintar.laporan_akhir_create1" %>
<table class="fbform">
    ...
    <tr>
        <td colspan="3">
            ...
            <asp:Button ID="btnCreate" runat="server" Text="Jana Laporan Akhir PDF" CssClass="fbbutton" Visible="false" />&nbsp;<asp:HyperLink
                ID="hyPDF" runat="server" Target="_blank" Visible="false">Klik disini.</asp:HyperLink>
        </td>
    </tr>
</table>
