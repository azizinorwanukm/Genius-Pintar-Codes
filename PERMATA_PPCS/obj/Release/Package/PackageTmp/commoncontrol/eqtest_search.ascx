<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="eqtest_search.ascx.vb" Inherits="permatapintar.eqtest_search" %>
            ...
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Index">
                        <ItemTemplate>
                            <asp:Label ID="ScorePercentage" runat="server" Text='<%# Bind("ScorePercentage", "{0:n2}") %>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left" />
                    </asp:TemplateField>
