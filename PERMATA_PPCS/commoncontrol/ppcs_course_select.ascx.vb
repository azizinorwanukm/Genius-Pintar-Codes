...
Partial Public Class ppcs_course_select
    ...
    Private Function getSQL() As String
        ...
        '--add more filter. ketua modul boleh nampak course dia sahaja
        Select Case lblUserType.Text
            Case "ADMIN"
            Case "KETUA MODUL"
                strWhere += " AND KetuaModul='" & lblGUID.Text & "'"
            Case Else
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Select Case strMod
            Case "01"
                Response.Redirect("laporan.pelajar.class.select.aspx?mod=" & strMod & "&courseid=" & strKeyID & "&ppcsdate=" & ddlPPCSDate.Text)
            Case "02"
                Response.Redirect("admin.laporan.keseluruhan.class.select.aspx?mod=" & strMod & "&courseid=" & strKeyID & "&ppcsdate=" & ddlPPCSDate.Text)
            Case "03"
                Response.Redirect("laporan.keseluruhan.class.select.aspx?mod=" & strMod & "&courseid=" & strKeyID & "&ppcsdate=" & ddlPPCSDate.Text)
            Case "04"   'admin Menentukan Kelas
                Response.Redirect("student.profile.class.list.aspx?mod=" & strMod & "&courseid=" & strKeyID & "&ppcsdate=" & ddlPPCSDate.Text)
            Case "10"
                Response.Redirect("cetak.laporan.akhir.class.select.aspx?mod=" & strMod & "&courseid=" & strKeyID & "&ppcsdate=" & ddlPPCSDate.Text)
            Case Else
