<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="studentprofile_ppcs_create.ascx.vb"
    Inherits="permatapintar.studentprofile_ppcs_create" %>
<table class="fbform">
    ...
    <tr>
        ...
        <td>
            <select name="selStudentGender" id="selStudentGender" style="width: 200px;" runat="server">
                <option value="LELAKI" selected="selected">LELAKI</option>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtAlumniID" runat="server" Width="200px" MaxLength="10"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <asp:TextBox ID="txtNoPelajar" runat="server" Width="200px" MaxLength="10"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td>
