...
Public Class studentprofile_ukm3_alumniid_update
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        btnUpdate.Attributes.Add("onclick", "return confirm('Pasti ingin mengemaskini No Pelajar?');")
    ...
    Private Sub PPCS_Class_list()
        strSQL = "SELECT ClassCode FROM PPCS_Class WHERE PPCSDate='" & ddlPPCSDate.Text & "' ORDER BY ClassCode"
        Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strConn)
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT a.StudentID,b.StudentFullname,b.MYKAD,b.AlumniID,b.DOB_Year,b.StudentGender,b.NoPelajar,d.CourseCode,e.ClassCode,a.TotalPercentage,a.PPMT,a.Program,a.StatusTawaran,a.StatusDate,a.StatusReason FROM UKM3 a, StudentProfile b, PPCS c,PPCS_Course d,PPCS_Class e"
        strWhere = " WITH (NOLOCK) WHERE a.StudentID=b.StudentID AND a.StudentID=c.StudentID AND c.CourseID=d.CourseID AND c.ClassID=e.ClassID AND c.PPCSStatus='LAYAK' AND c.StatusTawaran='TERIMA' AND c.PPCSDate ='" & ddlPPCSDate.Text & "'"
        ...
        If Not ddlClassCode.Text = "ALL" Then
            strWhere += " AND e.ClassCode ='" & ddlClassCode.Text & "'"
        End If
    ...
    Private Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        Try
            For i As Integer = 0 To datRespondent.Rows.Count - 1
                ...
                Dim gridTextBox As TextBox = DirectCast(row.FindControl("txtAlumniID"), TextBox)

                strSQL = "UPDATE StudentProfile SET AlumniID='" & gridTextBox.Text & "' WHERE StudentID='" & datRespondent.DataKeys(i).Value.ToString & "'"
                strRet = oCommon.ExecuteSQL(strSQL)
                If Not strRet = "0" Then
                    lblMsgFunc.Text += ":" & datRespondent.DataKeys(i).Value.ToString
                End If
            ...
            ''refresh screen
            strRet = BindData(datRespondent)
            If lblMsgFunc.Text.Length = 0 Then
                lblMsgFunc.Text = "Berjaya kemaskini Profil Pelajar. AlumniID."
            Else
                lblMsgFunc.Text += ".Error!"
            End If

        Catch ex As Exception
            lblMsgFunc.Text = "System Err:" & ex.Message
        End Try

    End Sub

    Private Function isNoPelajarExist(ByVal strNoPelajar As String) As Boolean
        If Not strNoPelajar.Length = 0 Then
            strSQL = "SELECT NoPelajar FROM StudentProfile WHERE NoPelajar='" & oCommon.FixSingleQuotes(strNoPelajar) & "'"
    ...
    Private Sub ddlPPCSDate_TextChanged(sender As Object, e As EventArgs) Handles ddlPPCSDate.TextChanged
        PPCS_Class_list()
