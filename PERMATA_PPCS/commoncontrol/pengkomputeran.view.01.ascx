<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="pengkomputeran.view.01.ascx.vb"
    Inherits="permatapintar.pengkomputeran_view_01" %>
<table class="fbform">
    ...
    <tr>
        ...
        <td class="fbsection_article">
            <asp:CheckBoxList ID="cblQ007" runat="server">
            </asp:CheckBoxList>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="fbsection_article">
            <asp:CheckBoxList ID="cblQ008" runat="server">
            </asp:CheckBoxList>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="fbsection_article">
            <asp:CheckBoxList ID="cblQ009" runat="server">
            </asp:CheckBoxList>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="fbsection_article">
            <asp:CheckBoxList ID="cblQ010" runat="server">
            </asp:CheckBoxList>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="fbsection_article">
            <asp:RadioButtonList ID="Q11" runat="server" EnableViewState="False" RepeatDirection="Vertical"
                RepeatLayout="Flow">
                <asp:ListItem Value="1"></asp:ListItem>
                <asp:ListItem Value="2"></asp:ListItem>
            </asp:RadioButtonList>
    ...
    <tr>
        ...
        <td class="fbsection_article">
            <asp:RadioButtonList ID="Q12" runat="server" EnableViewState="False" RepeatDirection="Vertical"
                RepeatLayout="Flow">
                <asp:ListItem Value="1"></asp:ListItem>
                <asp:ListItem Value="2"></asp:ListItem>
                <asp:ListItem Value="3"></asp:ListItem>
