...
Partial Public Class ppcs_class_select
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Select Case strMod
            ...
            Case "02"
                Response.Redirect("admin.laporan.keseluruhan.student.list.aspx?mod=" & strMod & "&courseid=" & Request.QueryString("courseid") & "&classid=" & strKeyID & "&ppcsdate=" & Request.QueryString("ppcsdate"))
            Case "03"
