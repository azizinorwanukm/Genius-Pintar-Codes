<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="laporan.harian.view.ascx.vb"
    Inherits="permatapintar.laporan_harian_view" %>
<table class="fbform">
     <tr class="fbform_header">
        ...
        <td class="fbsection_sap" style="text-align:right;">
            <asp:LinkButton ID="lnkUpdate" runat="server" Visible="false">Kemaskini</asp:LinkButton> | Catatan <asp:ImageButton ID="imgbNota" ImageUrl="../icons/note.png" AlternateText="Nota" runat="server" />
        </td>
    </tr>
