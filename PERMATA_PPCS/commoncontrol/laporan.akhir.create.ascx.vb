...
Partial Public Class laporan_akhir_create1
    ...
    Private Function ppcs_eval_insert() As Boolean
        ...
        strSQL = "INSERT INTO ppcs_eval_end (StudentID,DateCreated,CreateBy,PPCSDate,ClassCode,ClassID,LastUpdate,Q001,Q001Remarks) Values ('" & Request.QueryString("studentid") & "','" & oCommon.getToday & "','" & Server.HtmlEncode(Request.Cookies("ppcs_myguid").Value) & "','" & Request.QueryString("ppcsdate") & "','" & strClassCode & "'," & Request.QueryString("classid") & ",'" & oCommon.getNow & "'," & Q1.SelectedValue & ",'" & oCommon.FixSingleQuotes(Q001Remarks.Text) & "')"
        strRet = oCommon.ExecuteSQL(strSQL)
        If strRet = "0" Then
            lblMsgTop.Text = "Rekod berjaya dikemaskini."
            lblMsg.Text = "Rekod berjaya dikemaskini."
