...
Partial Public Class ppcs_list_classid
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT PPCS.StudentID,StudentFullname,MYKAD,AlumniID,DOB_Year,SchoolName,SchoolCity,SchoolState,StudentReligion,PPCSStatus,PPCS_Course.CourseCode,PPCS_Class.ClassCode FROM PPCS"
        ...
        strWhere = " WHERE PPCS.ClassID=" & Request.QueryString("classid") & " AND PPCS.PPCSStatus='LAYAK'"
    ...
    Private Function getSQLEksport() As String
        Dim tmpSQL As String
        Dim strWhere As String = ""
        Dim strOrder As String = " ORDER BY b.StudentFullname"

        tmpSQL = "SELECT a.StudentID,b.StudentFullname,b.MYKAD,b.AlumniID,b.DOB_Year,b.StudentReligion,a.PPCSCourse,a.PPCSClass,d.SchoolName,d.SchoolCity,d.SchoolState FROM PPCS a, StudentProfile b, StudentSchool c, SchoolProfile d"
        strWhere = " WITH (NOLOCK) WHERE a.StudentID=b.StudentID AND a.StudentID=c.StudentID and c.SchoolID=d.SchoolID AND a.ClassID=" & Request.QueryString("classid") & " AND a.PPCSStatus='LAYAK'"

        getSQLEksport = tmpSQL & strWhere & strOrder
        ''--debug
        'Response.Write(getSQLEksport)

        Return getSQLEksport()
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Select Case strMod
            ...
            Case "04"
                Response.Redirect("studentprofile.view.aspx?studentid=" & strKeyID)
            Case "05"
                Response.Redirect("laporan.harian.create.aspx?mod=" & strMod & "&studentid=" & strKeyID & "&ppcsdate=" & Request.QueryString("ppcsdate") & "&courseid=" & Request.QueryString("courseid") & "&classid=" & Request.QueryString("classid"))
    ...
    Private Sub CreatePDF(ByVal tableColumns As DataColumnCollection, ByVal tableRows As DataRowCollection)
        ...
        Try
            ...
            For Each row In tableRows
                ...
                strSQL = "SELECT Q001Remarks FROM PPCS_Eval_End WHERE StudentID='" & rowItems(0).ToString() & "' AND PPCSDate='" & Request.QueryString("ppcsdate") & "'"
