<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="sainstest_search.ascx.vb" Inherits="permatapintar.sainstest_search" %>
...
<table class="fbform">
    <tr class="fbform_header">
        <td>Senarai Menduduki SCIENCE INTERESTS INVENTORY
        </td>
    </tr>
    <tr>
        <td>
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                CellPadding="3" ForeColor="Black" GridLines="Vertical" PageSize="25" DataKeyNames="SainsTestID"
