...
Partial Public Class admin_ppcsusers_update
    ...
    Private Sub Load_Details()
        ...
        Try
            ...
            If MyTable.Rows.Count > 0 Then
                ...
                End If
                ''--to compare changes
                lblLoginIDOld.Text = txtLoginID.Text
                ...
                If Not IsDBNull(ds.Tables(0).Rows(0).Item("Pwd")) Then
                    'Response.Write("Pwd:" & ds.Tables(0).Rows(0).Item("Pwd").ToString)
    ...
    Private Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        Try
            ...
            ''--login ID change
            If Not lblLoginIDOld.Text = txtLoginID.Text Then
            ...
            strSQL = "UPDATE PPCS_Users WITH (UPDLOCK) SET LoginID='" & oCommon.FixSingleQuotes(txtLoginID.Text) & "',Pwd='" & oDes.EncryptData(oCommon.FixSingleQuotes(txtPwd.Text)) & "',Fullname='" & oCommon.FixSingleQuotes(txtFullname.Text.ToUpper) & "',ICNo='" & oCommon.FixSingleQuotes(txtICNo.Text) & "',ContactNo='" & oCommon.FixSingleQuotes(txtContactNo.Text) & "',Address='" & oCommon.FixSingleQuotes(txtAddress.Text.ToUpper) & "',Postcode='" & oCommon.FixSingleQuotes(txtPostcode.Text) & "',City='" & oCommon.FixSingleQuotes(txtCity.Text.ToUpper) & "',State='" & oCommon.FixSingleQuotes(txtState.Text.ToUpper) & "' WHERE myGUID='" & Request.QueryString("myguid") & "'"
