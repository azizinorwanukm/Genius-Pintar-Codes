...
Partial Public Class laporan_harian_view
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            imgbNota.ToolTip = "Note"
            OpenPopUp(imgbNota, "laporan.harian.note.update.aspx?ppcsevalid=" & strppcsevalid, "", 650, 550)
    ...
    Private Sub lnkUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkUpdate.Click
        Response.Redirect("laporan.harian.update.aspx?mod=06&ppcsevalid=" & Request.QueryString("ppcsevalid") & "&studentid=" & Request.QueryString("studentid") & "&ppcsdate=" & Request.QueryString("ppcsdate") & "&courseid=" & Request.QueryString("courseid") & "&classid=" & Request.QueryString("classid"))
