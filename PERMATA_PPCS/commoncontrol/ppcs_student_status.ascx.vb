...
Partial Public Class ppcs_student_status
    ...
    Private Sub PPCSStatus_list()
        ...
        Try
            ...
            ddlPPCSStatusUpdate.DataSource = ds
            ddlPPCSStatusUpdate.DataTextField = "PPCSStatus"
            ddlPPCSStatusUpdate.DataValueField = "PPCSStatus"
            ddlPPCSStatusUpdate.DataBind()
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT PPCS.StudentID,StudentFullname,MYKAD,AlumniID,DOB_Year,SchoolName,SchoolCity,SchoolState,StudentReligion,StatusTawaran,PPCSStatus,PPCS_Course.CourseCode,PPCS_Class.ClassCode FROM PPCS"
    ...
    Private Sub btnAssign_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAssign.Click
        Dim strStatusTawaran As String = ""
        ...
        For i As Integer = 0 To datRespondent.Rows.Count - 1
            ...
            If isChecked Then
                If ddlPPCSStatusUpdate.Text = "TOLAK" Then
                    strSQL = "UPDATE PPCS SET PPCSStatus='" & ddlPPCSStatusUpdate.Text & "',CourseID=NULL,ClassID=NULL WHERE StudentID='" & datRespondent.DataKeys(i).Value.ToString & "' AND PPCSDate='" & ddlPPCSDate.Text & "'"
                Else
                    strSQL = "UPDATE PPCS SET PPCSStatus='" & ddlPPCSStatusUpdate.Text & "' WHERE StudentID='" & datRespondent.DataKeys(i).Value.ToString & "' AND PPCSDate='" & ddlPPCSDate.Text & "'"
                End If
        ...
        lblMsg.Text = "Berjaya kemaskini status pelajar."
