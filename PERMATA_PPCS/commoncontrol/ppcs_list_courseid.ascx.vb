...
Partial Public Class ppcs_list_courseid
    ...
    Private Function getSQL() As String
        ...
        strWhere = " WHERE PPCS.PPCSStatus='LAYAK' AND PPCS.CourseID=" & Request.QueryString("courseid")
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Select Case strMod
            ...
            Case "03"
            Case "04"
                '--not possible. only when we get the classid
                '--Response.Redirect("laporan.keseluruhan.view.aspx?mod=" & strMod & "&studentid=" & strKeyID & "&year=" & Request.QueryString("year") & "&courseid=" & Request.QueryString("courseid"))
            Case Else
