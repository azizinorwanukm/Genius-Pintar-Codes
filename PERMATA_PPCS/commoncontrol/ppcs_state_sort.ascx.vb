...
Partial Public Class ppcs_state_sort
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT c.SchoolState,COUNT(c.SchoolState) as TotalStudent FROM PPCS a,StudentSchool b,SchoolProfile c"
        strWhere = " WITH (NOLOCK) WHERE a.StudentID=b.StudentID AND b.SchoolID=c.SchoolID AND a.PPCSStatus='LAYAK' AND b.IsLatest='Y' AND a.IsHadir='Y' AND a.PPCSDate='" & ddlPPCSDate.Text & "'"
