...
Partial Public Class PPCS_Eval_End_update1
    ...
    Private Sub ppcs_eval_load()
        ...
        Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strConn)
        strSQL = "SELECT * FROM PPCS_Eval_End WHERE ppcsevalendid=" & Request.QueryString("ppcsevalendid")
    ...
    Private Function ppcs_eval_update() As Boolean
        ...
        strSQL = "UPDATE PPCS_Eval_End SET LastUpdate='" & oCommon.getNow & "',Q001=" & Q1.SelectedValue & ",Q001Remarks='" & oCommon.FixSingleQuotes(Q001Remarks.Text) & "' WHERE ppcsevalendid=" & Request.QueryString("ppcsevalendid")
