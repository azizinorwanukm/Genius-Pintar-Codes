...
Partial Public Class laporan_akhir_view
    ...
    Private Sub CreatePDF()
        ...
        Try
            ...
            strSQL = "SELECT PPCSDate FROM PPCS_Eval_End WHERE StudentID='" & Request.QueryString("studentid") & "' AND classid=" & Request.QueryString("classid")
    ...
    Private Function LoadPhoto(ByVal strValue As String) As Stream
        ...
        Dim sql As String = "SELECT SmallPhoto FROM StudentPhoto WHERE StudentID = @StudentID"
