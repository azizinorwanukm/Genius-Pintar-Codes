<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ppcs_class_assign.ascx.vb"
    Inherits="permatapintar.ppcs_class_assign" %>
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="4">
            Carian Pelajar PPCS. PPCS Date:<asp:Label ID="lblPPCSDate" runat="server" Text=""
...
<table class="fbform">
    ...
    <tr>
        <td>
            <asp:Button ID="btnAssign" runat="server" Text="Assign Kelas" CssClass="fbbutton" />
            <asp:Button ID="btnRemove" runat="server" Text="Remove Kelas" CssClass="fbbutton" />
        </td>
    </tr>
</table>
