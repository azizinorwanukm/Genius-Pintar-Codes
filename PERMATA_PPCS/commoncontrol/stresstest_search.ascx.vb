...
Public Class stresstest_search
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT StressTest.StressTestID,StressTest.LastUpdate,StressTest.Fullname,StressTest.EmailAdd,StudentProfile.StudentFullname,StudentProfile.StudentEmail,StudentProfile.AlumniID,StressTest.SurveyID,StressTest.LastPage,StressTest.IsCompleted,StressTest.ScorePercentage FROM StressTest"
        tmpSQL += " LEFT OUTER JOIN StudentProfile ON StressTest.StudentID=StudentProfile.StudentID"
        strWhere = " WHERE IsDeleted='N'"

        '--PPCSDate
        If Not ddlPPCSDate.Text = "ALL" Then
            strWhere += " AND StressTest.PPCSDate='" & ddlPPCSDate.Text & "'"
        End If

        '--IsCompleted
        If Not selIsCompleted.Value.Length = 0 Then
            strWhere += " AND StressTest.IsCompleted='" & selIsCompleted.Value & "'"
        End If
        ...
        If Not ddlSurveyID.Text = "ALL" Then
            strWhere += " AND StressTest.SurveyID='" & ddlSurveyID.Text & "'"
        End If

        If selOrderBy.Value = "1" Then
            strOrder = " ORDER BY StressTest.LastUpdate DESC"
        Else
            strOrder = " ORDER BY StressTest.ScorePercentage DESC"
        End If
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        ...
        For i As Integer = 0 To datRespondent.Rows.Count - 1
            ...
            If isChecked Then
                strSQL = "UPDATE StressTest SET IsDeleted='Y' WHERE StressTestID=" & datRespondent.DataKeys(i).Value.ToString
    ...
    Private Sub datRespondent_SelectedIndexChanging(sender As Object, e As GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        strSQL = "SELECT LoginID FROM StressTest WHERE StressTestID=" & strKeyID
        Dim strLoginID As String = oCommon.getFieldValue(strSQL)

        strSQL = "SELECT SurveyID FROM StressTest WHERE StressTestID=" & strKeyID
        Dim strSurveyID As String = oCommon.getFieldValue(strSQL)

        Dim strLink As String = oCommon.getAppsettings("DomainStressTest") & "home.candidate.aspx?culture=en-US&surveyid=" & strSurveyID & "&loginid=" & strLoginID
    ...
    Protected Sub btnIsComplete_Click(sender As Object, e As EventArgs) Handles btnIsComplete.Click
        ...
        For i As Integer = 0 To datRespondent.Rows.Count - 1
            ...
            If isChecked Then
                strSQL = "UPDATE StressTest SET IsCompleted='" & selSetIsCompleted.Value & "' WHERE StressTestID=" & datRespondent.DataKeys(i).Value.ToString
                oCommon.ExecuteSQL(strSQL)
            Else
                '--do nothing
            End If
