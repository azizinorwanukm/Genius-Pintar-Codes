...
Partial Public Class PPCS_Eval_End_create1
    ...
    Private Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        strSQL = "SELECT DateCreated FROM PPCS_Eval_End WHERE StudentID='" & Request.QueryString("studentid") & "' AND ClassID=" & Request.QueryString("classid")
    ...
    Private Function ppcs_eval_update() As Boolean
        ...
        strSQL = "UPDATE PPCS_Eval_End SET LastUpdate='" & oCommon.getNow & "',Q001=" & Q1.SelectedValue & ",Q001Remarks='" & oCommon.FixSingleQuotes(Q001Remarks.Text) & "' WHERE StudentID='" & Request.QueryString("studentid") & "' AND ClassID=" & Request.QueryString("classid")
        ...
        'strRet = oCommon.ppcs_activity_insert(Server.HtmlEncode(Request.Cookies("ppcs_myguid").Value), Server.HtmlEncode(Request.Cookies("ppcs_usertype").Value), "Kemaskini Laporan Akhir. Student ID: " & Request.QueryString("studentid") & " " & strRespFullname & " Kelas:" & strClass2010)
    ...
    Private Function ppcs_eval_insert() As Boolean
        ...
        strSQL = "INSERT INTO PPCS_Eval_End (StudentID,DateCreated,CreateBy,PPCSYear,PPCSDate,ClassCode,ClassID,LastUpdate,Q001,Q001Remarks) Values ('" & Request.QueryString("studentid") & "','" & oCommon.getToday & "','" & Server.HtmlEncode(Request.Cookies("ppcs_loginid").Value) & "','" & Request.QueryString("examyear") & "','" & Request.QueryString("ppcsdate") & "','" & strClassCode & "'," & Request.QueryString("classid") & ",'" & oCommon.getNow & "'," & Q1.SelectedValue & ",'" & oCommon.FixSingleQuotes(Q001Remarks.Text) & "')"
        strRet = oCommon.ExecuteSQL(strSQL)
        If strRet = "0" Then
            lblMsgTop.Text = "Rekod berjaya dikemaskini."
            lblMsg.Text = "Rekod berjaya dikemaskini."
        ...
        ' ''--update status
        'strRet = oCommon.ppcs_activity_insert(Server.HtmlEncode(Request.Cookies("ppcs_myguid").Value), Server.HtmlEncode(Request.Cookies("ppcs_usertype").Value), "Rekod baru Laporan Akhir. Student ID: " & Request.QueryString("studentid") & " " & strRespFullname & " Kelas:" & strClass2010)
    ...
    Private Sub CreatePDF()
        ...
        Try
            ...
            myDocument.Add(New Paragraph("Tel: +603-8921 7503 / 7521 / 7532/ 7533  Fax: +603-8921 7525   E-mel: permatapintar@ukm.edu.my", FontFactory.GetFont("Arial", 8, Font.NORMAL)))
