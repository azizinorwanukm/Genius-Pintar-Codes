...
Partial Public Class ppcs_student_search
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT PPCS.StudentID,StudentProfile.StudentFullname,StudentProfile.MYKAD,StudentProfile.AlumniID,StudentProfile.DOB_Year,StudentProfile.StudentReligion,StudentProfile.StudentGender,StudentProfile.StudentRace,StudentProfile.StudentAddress1,StudentProfile.StudentAddress2,StudentProfile.StudentPostcode,StudentProfile.StudentCity,StudentProfile.StudentState,ParentProfile.FatherFullname,ParentProfile.FatherJob,ParentProfile.FamilyContactNo,ParentProfile.MotherFullname,ParentProfile.MotherJob,ParentProfile.FamilyContactNoIbu,SchoolProfile.SchoolName,SchoolProfile.SchoolState,SchoolProfile.SchoolPPD,SchoolProfile.SchoolCity,SchoolProfile.SchoolLokasi,SchoolProfile.SchoolType,PPCS.PPCSStatus,PPCS_Course.CourseCode,PPCS_Course.CourseNameBM,PPCS_Class.ClassCode FROM PPCS"
