...
Partial Public Class ppcs_studentrace_summary1
    ...
    Private Function getSQL() As String
        ...
        strWhere = " WITH (NOLOCK) WHERE a.StudentID=b.StudentID AND a.PPCSStatus='LAYAK' AND a.IsHadir='Y'"
    ...
    Private Sub btnSearchRace_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearchRace.Click
        ...
        tmpSQL = "SELECT c.SchoolState,COUNT(c.SchoolState) as TotalStudent FROM PPCS a,StudentSchool b,SchoolProfile c,StudentProfile d"
