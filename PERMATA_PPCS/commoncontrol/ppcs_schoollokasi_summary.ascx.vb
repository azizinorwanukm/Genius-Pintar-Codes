...
Partial Public Class ppcs_schoollokasi_summary1
    ...
    Private Function getSQL() As String
        ...
        Dim strGroupby As String = " GROUP BY c.SchoolLokasi"
        ...
        strWhere = " WITH (NOLOCK) WHERE a.StudentID=b.StudentID AND b.SchoolID=c.SchoolID AND PPCSStatus='LAYAK' AND b.IsLatest='Y' AND a.IsHadir='Y'"
