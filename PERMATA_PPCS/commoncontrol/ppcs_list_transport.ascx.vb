...
Public Class ppcs_list_transport1
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT PPCS.StudentID,StudentProfile.StudentFullname,StudentProfile.MYKAD,StudentProfile.AlumniID,StudentProfile.DOB_Year,StudentProfile.StudentReligion,StudentProfile.StudentState,SchoolProfile.SchoolName,SchoolProfile.SchoolCity,SchoolProfile.SchoolState,PPCS_Course.CourseCode,PPCS_Class.ClassCode,PPCS.PPCSStatus,PPCS.NamaAsrama,PPCS.NoBilik,PPCS.isHadir,PPCS.IsScan,PPCS.IsPos,PPCS.TransportTypePergi,PPCS.RVPointPergi,ParentProfile.FamilyContactNo,ParentProfile.FamilyContactNoIbu FROM PPCS"
