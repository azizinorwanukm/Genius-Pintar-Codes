...
Partial Public Class ppcs_offer_status
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        btnUpdate.Attributes.Add("onclick", "return confirm('Pasti hendak mengemaskini status tawaran tersebut?');")
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT PPCS.StudentID,StudentProfile.StudentFullname,StudentProfile.MYKAD,StudentProfile.AlumniID,StudentProfile.StudentGender,StudentProfile.DOB_Year,StudentProfile.StudentReligion,StudentProfile.StudentRace,StudentProfile.StudentCity,StudentProfile.StudentState,SchoolProfile.SchoolName,SchoolProfile.SchoolCity,SchoolProfile.SchoolState,PPCS.PPCSStatus,PPCS.StatusTawaran,PPCS.StatusDate,PPCS.StatusReason,PPCS_Course.CourseCode,PPCS_Class.ClassCode FROM PPCS"
    ...
    Private Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        If selStatusTawaranUpdate.Value = "TOLAK" Then
            If txtStatusReason.Text.Length = 0 Then
                lblMsg.Text = "Masukkan sebab kenapa tawaran ditolak."
                Exit Sub
            End If
        End If
        ...
        For i = 0 To datRespondent.Rows.Count - 1 Step i + 1
            ...
            If Not chkUpdate Is Nothing Then
                If chkUpdate.Checked = True Then
                    ...
                    If setStatusTawaran(strID) = True Then
                        lblMsg.Text = "Berjaya mengemaskini status tawaran pelajar yang dipilih."
                    Else
    ...
    Private Function setStatusTawaran(ByVal strStudentID As String) As Boolean
        Dim strPPCSStatus As String = ""

        'reset reason
        If selStatusTawaranUpdate.Value = "TERIMA" Then
            strPPCSStatus = "LAYAK"
            txtStatusReason.Text = "-"
        Else
            '--TOLAK
            '--pelajar tolak automatik jadi TOLAK. Dr Siti 20131108
            strPPCSStatus = "TOLAK"
        End If

        ''--UPDATE
        strSQL = "UPDATE PPCS SET PPCSStatus='" & strPPCSStatus & "',StatusTawaran='" & selStatusTawaranUpdate.Value & "',StatusReason='" & oCommon.FixSingleQuotes(txtStatusReason.Text) & "',StatusDate='" & oCommon.getNow & "' WHERE StudentID='" & strStudentID & "' AND PPCSDate='" & ddlPPCSDate.Text & "'"
