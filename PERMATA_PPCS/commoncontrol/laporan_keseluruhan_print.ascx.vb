...
Partial Public Class laporan_keseluruhan_print1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        strPPCSDate = Request.QueryString("ppcsdate")
    ...
    Private Sub ClearScreen()
        ...
        strSQL = "SELECT * FROM PPCS_Eval_Daily WHERE PPCSDate='" & strPPCSDate & "' AND StudentID='" & strStudentID & "' ORDER BY DateCreated"
        strRet = BindData(datRespondent)

        strSQL = "SELECT * FROM PPCS_Eval_Weekly WHERE PPCSDate='" & strPPCSDate & "' AND StudentID='" & strStudentID & "' ORDER BY DateCreated"
        strRet = BindData(datMingguan)

        ''in literal format
        strSQL = "SELECT Q001Remarks FROM PPCS_Eval_End WHERE PPCSDate='" & strPPCSDate & "' AND StudentID='" & strStudentID & "' ORDER BY DateCreated"
    ...
    Private Sub datRespondent_SelectedIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        Response.Redirect("laporan.harian.view.aspx?ppcsevalid=" & strKeyID & "&studentid=" & strStudentID & "&year=" & Request.QueryString("year"))
    End Sub
    ...
    Private Sub lnkEditMingguan_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkEditMingguan.Click
        Response.Redirect("laporan.mingguan.create.aspx?mod=06&studentid=" & Request.QueryString("studentid") & "&year=" & Request.QueryString("year"))

    End Sub

    Private Sub lnkEditAkhir_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkEditAkhir.Click
        Response.Redirect("laporan.akhir.create.aspx?mod=07&studentid=" & Request.QueryString("studentid") & "&year=" & Request.QueryString("year"))

    End Sub

    Private Sub lnkEditHarian_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkEditHarian.Click
        Response.Redirect("laporan.harian.create.aspx?mod=06&studentid=" & Request.QueryString("studentid") & "&year=" & Request.QueryString("year"))
