<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="pengkomputeran.view.02.ascx.vb" Inherits="permatapintar.pengkomputeran_view_02" %>
<table class="fbform">
    <tr class="fbsection_bold">
        ...
        <td style="width: 50%;">
            <asp:Label ID="lblQPage02" runat="server" Text="Kemahiran komputer"></asp:Label>
        </td>
        <td style="width: 50%;">
            <asp:Label ID="lblAPage02" runat="server" Text="Jawapan anda"></asp:Label>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo01" runat="server" Text="13."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo02" runat="server" Text="14."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo03" runat="server" Text="15."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo04" runat="server" Text="16."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo05" runat="server" Text="17."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo06" runat="server" Text="18."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo07" runat="server" Text="19."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo08" runat="server" Text="20."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo09" runat="server" Text="21."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo10" runat="server" Text="22."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo11" runat="server" Text="23."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo12" runat="server" Text="24."></asp:Label>
        </td>
        <td class="fbsection_article">
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo13" runat="server" Text="25."></asp:Label>
        </td>
        <td class="fbsection_article">
            <asp:Label ID="lblQ013" runat="server" Text=""></asp:Label>
        </td>
        <td class="fbsection_article">
            <asp:RadioButtonList ID="Q13" runat="server" EnableViewState="False"
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo14" runat="server" Text="26."></asp:Label>
        </td>
        <td class="fbsection_article">
            <asp:Label ID="lblQ014" runat="server" Text=""></asp:Label>
        </td>
        <td class="fbsection_article">
            <asp:RadioButtonList ID="Q14" runat="server" EnableViewState="False"
                RepeatDirection="Horizontal" RepeatLayout="Flow">
                <asp:ListItem Value="1"></asp:ListItem>
                <asp:ListItem Value="2"></asp:ListItem>
            </asp:RadioButtonList>
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo15" runat="server" Text="27."></asp:Label>
        </td>
        <td class="fbsection_article">
            <asp:Label ID="lblQ015" runat="server" Text=""></asp:Label>
        </td>
        <td class="fbsection_article">
            <asp:RadioButtonList ID="Q15" runat="server" EnableViewState="False"
                RepeatDirection="Horizontal" RepeatLayout="Flow">
                <asp:ListItem Value="1"></asp:ListItem>
                <asp:ListItem Value="2"></asp:ListItem>
            </asp:RadioButtonList>
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo116" runat="server" Text="28."></asp:Label>
        </td>
        <td class="fbsection_article">
            <asp:Label ID="lblQ016" runat="server" Text=""></asp:Label>
        </td>
        <td class="fbsection_article">
            <asp:RadioButtonList ID="Q16" runat="server" EnableViewState="False"
                RepeatDirection="Horizontal" RepeatLayout="Flow">
                <asp:ListItem Value="1"></asp:ListItem>
                <asp:ListItem Value="2"></asp:ListItem>
            </asp:RadioButtonList>
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo17" runat="server" Text="29."></asp:Label>
        </td>
        <td class="fbsection_article">
            <asp:Label ID="lblQ017" runat="server" Text=""></asp:Label>
        </td>
        <td class="fbsection_article">
            <asp:RadioButtonList ID="Q17" runat="server" EnableViewState="False"
                RepeatDirection="Horizontal" RepeatLayout="Flow">
                <asp:ListItem Value="1"></asp:ListItem>
                <asp:ListItem Value="2"></asp:ListItem>
            </asp:RadioButtonList>
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo18" runat="server" Text="30."></asp:Label>
        </td>
        <td class="fbsection_article">
            <asp:Label ID="lblQ018" runat="server" Text=""></asp:Label>
        </td>
        <td class="fbsection_article">
            <asp:RadioButtonList ID="Q18" runat="server" EnableViewState="False"
                RepeatDirection="Horizontal" RepeatLayout="Flow">
                <asp:ListItem Value="1"></asp:ListItem>
                <asp:ListItem Value="2"></asp:ListItem>
            </asp:RadioButtonList>
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo19" runat="server" Text="31."></asp:Label>
        </td>
        <td class="fbsection_article">
            <asp:Label ID="lblQ019" runat="server" Text=""></asp:Label>
        </td>
        <td class="fbsection_article">
            <asp:RadioButtonList ID="Q19" runat="server" EnableViewState="False"
                RepeatDirection="Horizontal" RepeatLayout="Flow">
                <asp:ListItem Value="1"></asp:ListItem>
                <asp:ListItem Value="2"></asp:ListItem>
            </asp:RadioButtonList>
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo20" runat="server" Text="32."></asp:Label>
        </td>
        <td class="fbsection_article">
            <asp:Label ID="lblQ020" runat="server" Text=""></asp:Label>
        </td>
        <td class="fbsection_article">
            <asp:RadioButtonList ID="Q20" runat="server" EnableViewState="False"
                RepeatDirection="Horizontal" RepeatLayout="Flow">
                <asp:ListItem Value="1"></asp:ListItem>
                <asp:ListItem Value="2"></asp:ListItem>
            </asp:RadioButtonList>
    ...
    <tr>
        <td class="fbsection_article">
            <asp:Label ID="lblNo21" runat="server" Text="33."></asp:Label>
        </td>
        <td class="fbsection_article">
            <asp:Label ID="lblQ021" runat="server" Text=""></asp:Label>
        </td>
        <td class="fbsection_article">
            <asp:RadioButtonList ID="Q21" runat="server" EnableViewState="False"
                RepeatDirection="Horizontal" RepeatLayout="Flow">
                <asp:ListItem Value="1"></asp:ListItem>
                <asp:ListItem Value="2"></asp:ListItem>
            </asp:RadioButtonList>
