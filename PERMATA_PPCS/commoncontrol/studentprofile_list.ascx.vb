...
Partial Public Class studentprofile_list
    ...
    '--list base on ppcsdate and course
    Private Function getSQL() As String
        Dim tmpSQL As String
        Dim strWhere As String = ""
        Dim strOrder As String = " ORDER BY StudentFullname"

        tmpSQL = "SELECT * FROM PPCS a,StudentProfile b"
        strWhere = " WITH (NOLOCK) WHERE a.StudentID=b.StudentID AND CourseID=" & Request.QueryString("courseid")
