...
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="4">Ringkasan Sekolah.&nbsp;&nbsp;[<asp:Label ID="lblDatetime"
...
<table class="fbform">
    <tr class="fbform_header">
        <td>Ringkasan Sekolah. Status=LAYAK.
        </td>
    </tr>
    <tr>
        <td>
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:CommandField SelectText="[Pilih]" ShowSelectButton="True" HeaderText="Papar" Visible="false" />
