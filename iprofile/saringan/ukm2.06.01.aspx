<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master"
    CodeBehind="ukm2.06.01.aspx.vb" Inherits="permatapintar.ukm2_06_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>
        <asp:Label ID="ukm2_0600_header" runat="server" Text=""></asp:Label>[04/30]</h2>
    ...
    <table class="mytablemain">
        <tr>
            <td>
                <asp:Label ID="lbl06_01" runat="server" Text="PENSEL" CssClass="lbl02"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <asp:Label ID="lbl06_02" runat="server" Text="KUCING" CssClass="lbl02"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <asp:Label ID="lbl06_03" runat="server" Text="ROMPAK" CssClass="lbl02"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <asp:Label ID="lbl06_04" runat="server" Text="BECA" CssClass="lbl02"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
