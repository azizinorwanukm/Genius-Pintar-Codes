<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master"
    CodeBehind="ukm2.01.01.aspx.vb" Inherits="permatapintar.ukm2_01_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>
        <asp:Label ID="ukm2_0100_01" runat="server" Text=""></asp:Label>[1/13]</h2>
    <asp:Label ID="lbl01_instruction" runat="server" Text="Anda dikehendaki menyusun bentuk yang disediakan untuk membentuk rajah yang dipamerkan di bawah. Klik dan heret bentuk pilihan ke ruangan yang disediakan."></asp:Label>
