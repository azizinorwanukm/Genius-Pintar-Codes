<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master" CodeBehind="ukm2.06.08.aspx.vb" Inherits="permatapintar.ukm2_06_08" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>
        <asp:Label ID="ukm2_0600_header" runat="server" Text=""></asp:Label>[30/30]</h2>
    ...
    <table class="mytablemain">
        <tr>
            <td>
                <asp:Label ID="lbl06_29" runat="server" Text="ABAI" CssClass="lbl02"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <asp:Label ID="lbl06_30" runat="server" Text="NORMA" CssClass="lbl02"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
