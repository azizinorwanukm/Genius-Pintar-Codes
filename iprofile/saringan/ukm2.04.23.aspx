<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master" CodeBehind="ukm2.04.23.aspx.vb" Inherits="permatapintar.ukm2_04_23" %>
    ...
    <table class="mytablemain">
        <tr>
            <td class="mytablemain_td">
                <img src="images/04.23.01.jpg" alt="pasu" class="imgNormal" id="img01" name="img01" onclick='Javascript:Img_Onclick("1");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.23.02.jpg" alt="feri" class="imgNormal" id="img02" name="img02" onclick='Javascript:Img_Onclick("2");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.23.03.jpg" alt="epal" class="imgNormal" id="img03" name="img03" onclick='Javascript:Img_Onclick("3");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.23.04.jpg" alt="kipas" class="imgNormal" id="img04" name="img04" onclick='Javascript:Img_Onclick("4");' />
            </td>
        </tr>
        <tr>
            <td class="mytablemain_td">
                <img src="images/04.23.05.jpg" alt="topi" class="imgNormal" id="img05" name="img05" onclick='Javascript:Img_Onclick("5");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.23.06.jpg" alt="air" class="imgNormal" id="img06" name="img06" onclick='Javascript:Img_Onclick("6");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.23.07.jpg" alt="kereta lama" class="imgNormal" id="img07" name="img07" onclick='Javascript:Img_Onclick("7");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.23.08.jpg" alt="monalisa" class="imgNormal" id="img08" name="img08" onclick='Javascript:Img_Onclick("8");' />
            </td>
        </tr>
        <tr>
            <td class="mytablemain_td">
                <img src="images/04.23.09.jpg" alt="asam jawa" class="imgNormal" id="img09" name="img09" onclick='Javascript:Img_Onclick("9");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.23.10.jpg" alt="anjing" class="imgNormal" id="img10" name="img10" onclick='Javascript:Img_Onclick("10");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.23.11.jpg" alt="batik" class="imgNormal" id="img11" name="img11" onclick='Javascript:Img_Onclick("11");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.23.12.jpg" alt="berus gigi" class="imgNormal" id="img12" name="img12" onclick='Javascript:Img_Onclick("12");' />
            </td>
        </tr>
        <tr>
            <td colspan="4">
