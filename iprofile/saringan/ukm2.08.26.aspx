<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master" CodeBehind="ukm2.08.26.aspx.vb" Inherits="permatapintar.ukm2_08_26" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>
        <asp:Label ID="ukm2_0800_header" runat="server" Text=""></asp:Label>[26/38]</h2>
    ...
    <table class="mytablemain">
                ...
                <table class="mytableleft">
                    <tr>
                        <td class="mytableleft_td">
                            <img src="images/08.26.A.jpg" alt="answer1" />
                        </td>
                        <td class="mytableleft_td">
                            <img src="images/08.26.B.jpg" alt="answer1" />
                        </td>
                    </tr>
                    <tr>
                        <td class="mytableleft_td">
                            <img src="images/08.26.C.jpg" alt="answer1" />
                        </td>
                        <td class="mytableleft_td">
                            <img src="images/08.26.D.jpg" alt="answer1" />
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td class="mytablemain_td">
                <img src="images/08.26.01.jpg" alt="answer1" class="img08Normal" id="img01" name="img01"
                    onclick='Javascript:Img_Onclick("1");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/08.26.02.jpg" alt="answer2" class="img08Normal" id="img02" name="img02"
                    onclick='Javascript:Img_Onclick("2");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/08.26.03.jpg" alt="answer3" class="img08Normal" id="img03" name="img03"
                    onclick='Javascript:Img_Onclick("3");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/08.26.04.jpg" alt="answer4" class="img08Normal" id="img04" name="img04"
                    onclick='Javascript:Img_Onclick("4");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/08.26.05.jpg" alt="answer5" class="img08Normal" id="img05" name="img05"
