<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master" CodeBehind="ukm2.06.02.aspx.vb" Inherits="permatapintar.ukm2_06_02" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>
        <asp:Label ID="ukm2_0600_header" runat="server" Text=""></asp:Label>[08/30]</h2>
    ...
    <table class="mytablemain">
        <tr>
            <td>
                <asp:Label ID="lbl06_05" runat="server" Text="ANGKA" CssClass="lbl02"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <asp:Label ID="lbl06_06" runat="server" Text="KEMBALI" CssClass="lbl02"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <asp:Label ID="lbl06_07" runat="server" Text="TRADISIONAL" CssClass="lbl02"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <asp:Label ID="lbl06_08" runat="server" Text="ROSAK" CssClass="lbl02"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
