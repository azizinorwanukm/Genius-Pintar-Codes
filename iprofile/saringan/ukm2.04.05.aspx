<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master"
    CodeBehind="ukm2.04.05.aspx.vb" Inherits="permatapintar.ukm2_04_05" %>
    ...
    <table class="mytablemain">
        <tr>
            <td class="mytablemain_td">
                <img src="images/04.05.01.jpg" alt="durian" class="imgNormal" id="img01" name="img01" onclick='Javascript:Img_Onclick("1");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.05.02.jpg" alt="arnab" class="imgNormal" id="img02" name="img02" onclick='Javascript:Img_Onclick("2");' />
            </td>
        </tr>
        <tr>
            <td class="mytablemain_td">
                <img src="images/04.05.03.jpg" alt="anakkunci" class="imgNormal" id="img03" name="img03" onclick='Javascript:Img_Onclick("3");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.05.04.jpg" alt="kuching" class="imgNormal" id="img04" name="img04" onclick='Javascript:Img_Onclick("4");' />
            </td>
        </tr>
        <tr>
            <td colspan="2">
