<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master" CodeBehind="ukm2.11.06.aspx.vb" Inherits="permatapintar.ukm2_11_06" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <map name="shapes" id="shapes">
        <area onfocus="if(this.blur)this.blur()" class="mapnoborder" alt="X" shape="poly"
            coords="130,220,270,220,265,340,130,340"
    ...
    <h2>
        <asp:Label ID="ukm2_1100_header" runat="server" Text=""></asp:Label>[06/38]</h2>
        ...
        <tr>
            <td>
                <div id="divPic">
                    ...
                    <img src="images/11.06.jpg" alt="pic1" style="cursor: default;" usemap="#shapes" border='0' />
                </div>
            </td>
        </tr>
