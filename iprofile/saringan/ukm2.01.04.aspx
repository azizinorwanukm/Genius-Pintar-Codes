<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master"
    CodeBehind="ukm2.01.04.aspx.vb" Inherits="permatapintar.ukm2_01_04" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>
        <asp:Label ID="ukm2_0100_01" runat="server" Text=""></asp:Label>[4/13]</h2>
                ...
                <table class="mytableright">
                    <tr>
                        <td class="mytableright_td">
                            <img src="images/01.04.01.gif" alt="answer3" />
                        </td>
                    </tr>
                </table>
            </td>
