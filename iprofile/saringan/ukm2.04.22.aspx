<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master" CodeBehind="ukm2.04.22.aspx.vb" Inherits="permatapintar.ukm2_04_22" %>
    ...
    <table class="mytablemain">
        <tr>
            <td class="mytablemain_td">
                <img src="images/04.22.01.jpg" alt="benih" class="imgNormal" id="img01" name="img01" onclick='Javascript:Img_Onclick("1");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.22.02.jpg" alt="kipas tangan" class="imgNormal" id="img02" name="img02" onclick='Javascript:Img_Onclick("2");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.22.03.jpg" alt="bulu tangkis" class="imgNormal" id="img03" name="img03" onclick='Javascript:Img_Onclick("3");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.22.04.jpg" alt="biola" class="imgNormal" id="img04" name="img04" onclick='Javascript:Img_Onclick("4");' />
            </td>
        </tr>
        <tr>
            <td class="mytablemain_td">
                <img src="images/04.22.05.jpg" alt="skop" class="imgNormal" id="img05" name="img05" onclick='Javascript:Img_Onclick("5");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.22.06.jpg" alt="rantai" class="imgNormal" id="img06" name="img06" onclick='Javascript:Img_Onclick("6");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.22.07.jpg" alt="nyamuk" class="imgNormal" id="img07" name="img07" onclick='Javascript:Img_Onclick("7");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.22.08.jpg" alt="nasi" class="imgNormal" id="img08" name="img08" onclick='Javascript:Img_Onclick("8");' />
            </td>
        </tr>
        <tr>
            <td class="mytablemain_td">
                <img src="images/04.22.09.jpg" alt="piano" class="imgNormal" id="img09" name="img09" onclick='Javascript:Img_Onclick("9");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.22.10.jpg" alt="orang tua" class="imgNormal" id="img10" name="img10" onclick='Javascript:Img_Onclick("10");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.22.11.jpg" alt="spagetti" class="imgNormal" id="img11" name="img11" onclick='Javascript:Img_Onclick("11");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.22.12.jpg" alt="cincin" class="imgNormal" id="img12" name="img12" onclick='Javascript:Img_Onclick("12");' />
            </td>
        </tr>
        <tr>
            <td colspan="4">
