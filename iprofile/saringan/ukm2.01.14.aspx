<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master"
    CodeBehind="ukm2.01.14.aspx.vb" Inherits="permatapintar.ukm2_01_14" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>
        <asp:Label ID="ukm2_0100_01" runat="server" Text=""></asp:Label>[14/13]</h2>
        ...
        <tr>
            ...
            <td class="mytablemain_td">
                ...
                <table class="mytableright_border">
                    <tr>
                        <td class="mytableright_td_noborder">
                            <img src="images/answer2.gif" alt="blank" />
                        </td>
                        <td class="mytableright_td_noborder">
                            <img src="images/answer4.gif" alt="blank" />
                        </td>
                        <td class="mytableright_td_noborder">
                            <img src="images/answer3.gif" alt="blank" />
                        </td>
                        <td class="mytableright_td_noborder">
                            <img src="images/answer2.gif" alt="blank" />
                        </td>
                    ...
                    <tr>
                        <td class="mytableright_td_noborder">
                            <img src="images/answer1.gif" alt="blank" />
                        </td>
                        <td class="mytableright_td_noborder">
                            <img src="images/answer3.gif" alt="blank" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="mytableright_td_noborder">
                            <img src="images/answer5.gif" alt="blank" />
                        </td>
                        <td class="mytableright_td_noborder">
                            <img src="images/answer6.gif" alt="blank" />
                        </td>
                        <td class="mytableright_td_noborder">
                            <img src="images/answer1.gif" alt="blank" />
                        </td>
