<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master"
    CodeBehind="ukm2.01.11.aspx.vb" Inherits="permatapintar.ukm2_01_11" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%--<a href="#">
        <img src="images/logo.gif" title="Araken I-PROFILE" alt="Araken I-PROFILE" width="400"
            height="35" border="0" class="logo" /></a>--%>
     <h1>Araken I-PROFILE</h1>

    <h2>
        <asp:Label ID="ukm2_0100_01" runat="server" Text=""></asp:Label>[11/13]</h2>
                ...
                <table class="mytableright_border">
                    <tr>
                        <td class="mytableright_td">
                            <img src="images/01.11.01.gif" alt="answer3" />
                        </td>
                    </tr>
                </table>
            </td>
