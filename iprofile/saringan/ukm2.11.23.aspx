<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master" CodeBehind="ukm2.11.23.aspx.vb" Inherits="permatapintar.ukm2_11_23" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <map name="shapes" id="shapes">
        <area onfocus="if(this.blur)this.blur()" class="mapnoborder" alt="X" shape="poly"
            coords="160,230,270,230,260,250,160,260"
   ...
   <%-- <a href="#">
    ...
    <h2>
        <asp:Label ID="ukm2_1100_header" runat="server" Text=""></asp:Label>[23/38]</h2>
        ...
        <tr>
            <td>
                <div id="divPic">
                    ...
                    <img src="images/11.23.jpg" alt="pic1" style="cursor: default;" usemap="#shapes" border='0' />
                </div>
            </td>
        </tr>
