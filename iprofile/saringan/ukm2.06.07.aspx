<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master" CodeBehind="ukm2.06.07.aspx.vb" Inherits="permatapintar.ukm2_06_07" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>
        <asp:Label ID="ukm2_0600_header" runat="server" Text=""></asp:Label>[28/30]</h2>
    ...
    <table class="mytablemain">
        <tr>
            <td>
                <asp:Label ID="lbl06_25" runat="server" Text="TEKAL" CssClass="lbl02"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <asp:Label ID="lbl06_26" runat="server" Text="SUKARELA" CssClass="lbl02"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <asp:Label ID="lbl06_27" runat="server" Text="CERIA" CssClass="lbl02"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <asp:Label ID="lbl06_28" runat="server" Text="PETAH" CssClass="lbl02"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
