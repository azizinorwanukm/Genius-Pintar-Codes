<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master"
    CodeBehind="ukm2.11.00.aspx.vb" Inherits="permatapintar.ukm2_11_00" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p>&nbsp;</p>
    <asp:Label ID="lbl11_instruction_sample" runat="server" Text="Perhatikan gambar berikut. <b>Sila tunjuk dan klik pada bahagian yang tidak lengkap</b> untuk setiap paparan. Tanda X akan ditanda pada kawasan pilihan anda. Ini adalah contoh dan latihan semata-mata, tiada permarkahan diambil."></asp:Label>
    ...
    <table class="mytablemain">
        ...
        <tr>
            <td>
                ...
                <asp:Label ID="ukm2_1100_01" runat="server" Text="Tekan [Mula >>] jika anda sudah bersedia dan faham apa yang perlu dilakukan."></asp:Label>
            </td>
        </tr>
