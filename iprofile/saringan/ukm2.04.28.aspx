<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master" CodeBehind="ukm2.04.28.aspx.vb" Inherits="permatapintar.ukm2_04_28" %>
    ...
    <table class="mytablemain">
        <tr>
            <td class="mytablemain_td">
                <img src="images/04.28.01.jpg" alt="pelampung" class="imgNormal" id="img01" name="img01" onclick='Javascript:Img_Onclick("1");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.28.02.jpg" alt="jam" class="imgNormal" id="img02" name="img02" onclick='Javascript:Img_Onclick("2");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.28.03.jpg" alt="cermin mata" class="imgNormal" id="img03" name="img03" onclick='Javascript:Img_Onclick("3");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.28.04.jpg" alt="kayak" class="imgNormal" id="img04" name="img04" onclick='Javascript:Img_Onclick("4");' />
            </td>
        </tr>
        <tr>
            <td class="mytablemain_td">
                <img src="images/04.28.05.jpg" alt="khemah" class="imgNormal" id="img05" name="img05" onclick='Javascript:Img_Onclick("5");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.28.06.jpg" alt="teropong" class="imgNormal" id="img06" name="img06" onclick='Javascript:Img_Onclick("6");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.28.07.jpg" alt="kaktus" class="imgNormal" id="img07" name="img07" onclick='Javascript:Img_Onclick("7");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.28.08.jpg" alt="jamdinding" class="imgNormal" id="img08" name="img08" onclick='Javascript:Img_Onclick("8");' />
            </td>
        </tr>
        <tr>
            <td class="mytablemain_td">
                <img src="images/04.28.09.jpg" alt="kamera" class="imgNormal" id="img09" name="img09" onclick='Javascript:Img_Onclick("9");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.28.10.jpg" alt="sayur layu" class="imgNormal" id="img10" name="img10" onclick='Javascript:Img_Onclick("10");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.28.11.jpg" alt="kincir" class="imgNormal" id="img11" name="img11" onclick='Javascript:Img_Onclick("11");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.28.12.jpg" alt="manggis" class="imgNormal" id="img12" name="img12" onclick='Javascript:Img_Onclick("12");' />
            </td>
        </tr>
        <tr>
            <td colspan="4">
