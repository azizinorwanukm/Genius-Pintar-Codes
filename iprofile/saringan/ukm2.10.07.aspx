<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master"
    CodeBehind="ukm2.10.07.aspx.vb" Inherits="permatapintar.ukm2_10_07" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>
        <asp:Label ID="ukm2_1000_header" runat="server" Text=""></asp:Label>[49/62]</h2>
    ...
    <table class="mytablebottom" border="0px">
        ...
        <tr>
            <td class="mytd_10text">б
            </td>
            <td class="mytd_10text">ф
            </td>
            <td class="mytd_10blank">&nbsp;
            </td>
