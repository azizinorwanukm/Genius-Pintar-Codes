<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master" CodeBehind="ukm2.10.04.aspx.vb" Inherits="permatapintar.ukm2_10_04" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>
        <asp:Label ID="ukm2_1000_header" runat="server" Text=""></asp:Label>[28/62]</h2>
    ...
    <table class="mytablebottom" border="0px">
        ...
        <tr>
            ...
            <td class="mytd_10text">Ð
            </td>
            <td class="mytd_10blank">&nbsp;
            </td>
            <td class="mytd_codingtext">Æ
            </td>
        ...
        <tr>
            <td class="mytd_10text">Ξ
            </td>
            <td class="mytd_10text">Π
            </td>
            <td class="mytd_10blank">&nbsp;
            </td>
            <td class="mytd_codingtext">И
            </td>
            <td class="mytd_codingtext">Ш
            </td>
            <td class="mytd_codingtext">Җ
            </td>
