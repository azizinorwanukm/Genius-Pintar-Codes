<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master" CodeBehind="ukm2.13.04.aspx.vb" Inherits="permatapintar.ukm2_13_04" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>
        <asp:Label ID="ukm2_1300_header" runat="server" Text=""></asp:Label>[16/24]</h2>
    ...
    <table class="mytablemain">
        <tr>
            <td>
                <asp:Label ID="lbl13_13" runat="server" Text="Apakah makna “kesan rumah hijau”?"
        ...
        <tr>
            <td>
                <asp:Label ID="lbl13_14" runat="server" Text="Apakah pulau yang terbesar di dunia?"
                    CssClass="lbl02"></asp:Label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <asp:Label ID="lbl13_15" runat="server" Text="Negara manakah yang terletak di bawah paras laut?"
                    CssClass="lbl02"></asp:Label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <asp:Label ID="lbl13_16" runat="server" Text="Mengapa ketulan ais terapung di atas air? "
                    CssClass="lbl02"></asp:Label>
            </td>
        </tr>
        <tr>
