<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master" CodeBehind="ukm2.11.16.aspx.vb" Inherits="permatapintar.ukm2_11_16" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <map name="shapes" id="shapes">
        <area onfocus="if(this.blur)this.blur()" class="mapnoborder" alt="X" shape="poly" style="border: none; text-decoration: none;"
            coords="340,215,375,215,385,365,340,365"
            href="javascript:clicked_on('1');" id="1" />

        <area onfocus="if(this.blur)this.blur()" class="mapnoborder" alt="X" shape="rect" style="border: none; text-decoration: none;"
            coords="0,0,400,400"
    ...
    <h2>
        <asp:Label ID="ukm2_1100_header" runat="server" Text=""></asp:Label>[16/38]</h2>
        ...
        <tr>
            <td>
                <div id="divPic">
                    ...
                    <img src="images/11.16.jpg" alt="pic1" style="cursor: default;" usemap="#shapes" border='0' />
                </div>
            </td>
        </tr>
