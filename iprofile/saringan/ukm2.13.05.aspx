<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master" CodeBehind="ukm2.13.05.aspx.vb" Inherits="permatapintar.ukm2_13_05" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>
        <asp:Label ID="ukm2_1300_header" runat="server" Text=""></asp:Label>[20/24]</h2>
    ...
    <table class="mytablemain">
        <tr>
            <td>
                <asp:Label ID="lbl13_17" runat="server" Text="Apa itu prisma?"
        ...
        <tr>
            <td>
                <asp:Label ID="lbl13_18" runat="server" Text="Di manakah Dataran Tiananmen?"
                    CssClass="lbl02"></asp:Label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <asp:Label ID="lbl13_19" runat="server" Text="Apakah garisan yang menentukan perbezaan masa di dunia?"
                    CssClass="lbl02"></asp:Label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <asp:Label ID="lbl13_20" runat="server" Text="Berapakah jarak bumi ke bulan?"
                    CssClass="lbl02"></asp:Label>
            </td>
        </tr>
        <tr>
