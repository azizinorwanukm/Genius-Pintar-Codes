<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master" CodeBehind="ukm2.10.06.aspx.vb" Inherits="permatapintar.ukm2_10_06" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>
        <asp:Label ID="ukm2_1000_header" runat="server" Text=""></asp:Label>[42/62]</h2>
