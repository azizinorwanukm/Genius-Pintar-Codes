<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master"
    CodeBehind="ukm2.01.07.aspx.vb" Inherits="permatapintar.ukm2_01_07" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>
        <asp:Label ID="ukm2_0100_01" runat="server" Text=""></asp:Label>[7/13]</h2>
                ...
                <table class="mytableright_border">
                    <tr>
                        <td class="mytableright_td">
                            <img src="images/01.07.01.gif" alt="answer3" />
                        </td>
                    </tr>
                </table>
            </td>
