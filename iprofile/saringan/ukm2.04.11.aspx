<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master"
    CodeBehind="ukm2.04.11.aspx.vb" Inherits="permatapintar.ukm2_04_11" %>
    ...
    <table class="mytablemain">
        <tr>
            <td class="mytablemain_td">
                <img src="images/04.11.01.jpg" alt="khemah" class="imgNormal" id="img01" name="img01" onclick='Javascript:Img_Onclick("1");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.11.02.jpg" alt="rumah" class="imgNormal" id="img02" name="img02" onclick='Javascript:Img_Onclick("2");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.11.03.jpg" alt="kucing" class="imgNormal" id="img03" name="img03" onclick='Javascript:Img_Onclick("3");' />
            </td>
        </tr>
        <tr>
            <td class="mytablemain_td">
                <img src="images/04.11.04.jpg" alt="songkok" class="imgNormal" id="img04" name="img04" onclick='Javascript:Img_Onclick("4");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.11.05.jpg" alt="kayak" class="imgNormal" id="img05" name="img05" onclick='Javascript:Img_Onclick("5");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.11.06.jpg" alt="biola" class="imgNormal" id="img06" name="img06" onclick='Javascript:Img_Onclick("6");' />
            </td>
        </tr>
        <tr>
            <td colspan="3">
