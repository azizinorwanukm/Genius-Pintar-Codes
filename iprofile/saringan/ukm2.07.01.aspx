<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master" CodeBehind="ukm2.07.01.aspx.vb" Inherits="permatapintar.ukm2_07_01" %>
...
<!-- 
    ...
    function textticker1() {
        ...
        if (pos1++ == l) {
            ...
            //disable prev texbox
            aspnetForm.ctl00$ContentPlaceHolder1$txt07_01.disabled = true;
    ...
    <h2>
        <asp:Label ID="ukm2_0700_header" runat="server" Text=""></asp:Label>. No#:<asp:Label ID="lblCount" runat="server" Text=""></asp:Label>&nbsp;</h2>
    <asp:Label ID="lbl07_instruction" runat="server" Text="Lihat nombor dan abjad yang dipaparkan pada skrin anda selepas menekan butang [Mula]. Taipkan semula <b>nombor mengikut urutan menaik diikuti oleh abjad urutan menaik</b> dalam ruangan yang disediakan."></asp:Label>
    ...
    <table class="mytablemain">
        ...
        <tr>
            <td>
                <asp:TextBox ID="txt07_01" runat="server" TextMode="SingleLine" Rows="1" Width="250px" CssClass="myInput" Enabled="false" onpaste="return false"></asp:TextBox></td>
        </tr>
