<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master" CodeBehind="ukm2.04.26.aspx.vb" Inherits="permatapintar.ukm2_04_26" %>
    ...
    <table class="mytablemain">
        <tr>
            <td class="mytablemain_td">
                <img src="images/04.26.01.jpg" alt="bunga" class="imgNormal" id="img01" name="img01" onclick='Javascript:Img_Onclick("1");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.26.02.jpg" alt="basikal" class="imgNormal" id="img02" name="img02" onclick='Javascript:Img_Onclick("2");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.26.03.jpg" alt="cincin" class="imgNormal" id="img03" name="img03" onclick='Javascript:Img_Onclick("3");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.26.04.jpg" alt="orang tua" class="imgNormal" id="img04" name="img04" onclick='Javascript:Img_Onclick("4");' />
            </td>
        </tr>
        <tr>
            <td class="mytablemain_td">
                <img src="images/04.26.05.jpg" alt="penyapu" class="imgNormal" id="img05" name="img05" onclick='Javascript:Img_Onclick("5");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.26.06.jpg" alt="a-farmosa melaka" class="imgNormal" id="img06" name="img06" onclick='Javascript:Img_Onclick("6");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.26.07.jpg" alt="epal" class="imgNormal" id="img07" name="img07" onclick='Javascript:Img_Onclick("7");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.26.08.jpg" alt="gunting" class="imgNormal" id="img08" name="img08" onclick='Javascript:Img_Onclick("8");' />
            </td>
        </tr>
        <tr>
            <td class="mytablemain_td">
                <img src="images/04.26.09.jpg" alt="anggur" class="imgNormal" id="img09" name="img09" onclick='Javascript:Img_Onclick("9");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.26.10.jpg" alt="kereta lama" class="imgNormal" id="img10" name="img10" onclick='Javascript:Img_Onclick("10");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.26.11.jpg" alt="asam jawa" class="imgNormal" id="img11" name="img11" onclick='Javascript:Img_Onclick("11");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.26.12.jpg" alt="boya" class="imgNormal" id="img12" name="img12" onclick='Javascript:Img_Onclick("12");' />
            </td>
        </tr>
        <tr>
            <td colspan="4">
