<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master"
    CodeBehind="ukm2.04.08.aspx.vb" Inherits="permatapintar.ukm2_04_08" %>
    ...
    <table class="mytablemain">
        <tr>
            <td class="mytablemain_td">
                <img src="images/04.08.01.jpg" alt="epal" class="imgNormal" id="img01" name="img01" onclick='Javascript:Img_Onclick("1");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.08.02.jpg" alt="durian" class="imgNormal" id="img02" name="img02" onclick='Javascript:Img_Onclick("2");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.08.03.jpg" alt="anggur" class="imgNormal" id="img03" name="img03" onclick='Javascript:Img_Onclick("3");' />
            </td>
        </tr>
        <tr>
            <td class="mytablemain_td">
                <img src="images/04.08.04.jpg" alt="manggis" class="imgNormal" id="img04" name="img04" onclick='Javascript:Img_Onclick("4");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.08.05.jpg" alt="daun" class="imgNormal" id="img05" name="img05" onclick='Javascript:Img_Onclick("5");' />
            </td>
            <td class="mytablemain_td">
                <img src="images/04.08.06.jpg" alt="bunga" class="imgNormal" id="img6" name="img06" onclick='Javascript:Img_Onclick("6");' />
            </td>
        </tr>
        <tr>
            <td colspan="3">
