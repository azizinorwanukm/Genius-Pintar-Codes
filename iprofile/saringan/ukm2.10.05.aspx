<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/saringan/ukm2.main.Master" CodeBehind="ukm2.10.05.aspx.vb" Inherits="permatapintar.ukm2_10_05" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>
        <asp:Label ID="ukm2_1000_header" runat="server" Text=""></asp:Label>[35/62]</h2>
    ...
    <table class="mytablebottom" border="0px">
        ...
        <tr>
            ...
            <td class="mytd_codingtext">µ
            </td>
            <td class="mytd_codingtext">ß
            </td>
            <td class="mytd_codingtext">Ø
            </td>
            <td class="mytd_codingtext">Ŧ
            </td>
            <td class="mytd_codingtext">¥
            </td>
            <td class="mytd_10blank">&nbsp;
        ...
        <tr>
            <td class="mytd_10text">Ұ
            </td>
            <td class="mytd_10text">Ғ
            </td>
            <td class="mytd_10blank">&nbsp;
            </td>
            <td class="mytd_codingtext">&
