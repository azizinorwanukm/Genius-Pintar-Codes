<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master"
    CodeBehind="ukm2.drag.drop.aspx.vb" Inherits="permatapintar.ukm2_drag_drop" %>
                ...
                <table class="mytableright">
                    <tr>
                        <td class="mytableright_td">
                            <img src="saringan/images/answer1.gif" alt="answer3" />
                        </td>
                    </tr>
                    <tr>
                        <td class="mytableright_td">
                            <img src="saringan/images/answer3.gif" alt="blank" />
                        </td>
                    </tr>
                </table>
            </td>
                    ...
                    <tr>
                        <td class="mytablebottom_td">
                            <div id="Ans1_a" class="dragElement">
                                <img src="saringan/images/answer1.gif" id="Img1" alt="ans1" />
                            </div>
                        </td>
                        <td class="mytablebottom_td">
                            <div id="Ans2_a" class="dragElement">
                                <img src="saringan/images/answer2.gif" id="Img2" alt="ans1" />
                            </div>
                        </td>
                        <td class="mytablebottom_td">
                            <div id="Ans3_a" class="dragElement">
                                <img src="saringan/images/answer3.gif" id="Img3" alt="ans1" />
                            </div>
                        </td>
                        <td class="mytablebottom_td">
                            <div id="Ans4_a" class="dragElement">
                                <img src="saringan/images/answer4.gif" id="Img4" alt="ans1" />
                            </div>
                        </td>
                        <td class="mytablebottom_td">
                            <div id="Ans5_a" class="dragElement">
                                <img src="saringan/images/answer5.gif" id="Img5" alt="ans1" />
                            </div>
                        </td>
                        <td class="mytablebottom_td">
                            <div id="Ans6_a" class="dragElement">
                                <img src="saringan/images/answer6.gif" id="Img6" alt="ans1" />
                            </div>
                        </td>
                    </tr>
                </table>
